 ...
 *
 */
public class IsSaturday extends ColumnFilter {

    public IsSaturday(ColumnReference columnReference) {
        ...
        switch (type) {
            ...
            default:
                throw new UnsupportedOperationException(
                                "Columns of type " + type.name() + " do not support the operation " + "isSaturday() ");
        }
    }
}
