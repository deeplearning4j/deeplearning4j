...
public class TableFilteringTest {
    ...
    private final ColumnType[] types = {ColumnType.LOCAL_DATE, // date of poll
    ...
    public void testFilter3() {
        Table result = table.selectWhere(both(column("date").isInApril(), column("approval").isGreaterThan(70)));
    ...
    public void testFilter4() {
        Table result = table.select("who", "approval")
                        .where(and(column("date").isInApril(), column("approval").isGreaterThan(70)));
