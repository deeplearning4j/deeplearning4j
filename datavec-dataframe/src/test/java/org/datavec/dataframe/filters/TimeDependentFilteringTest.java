...
public class TimeDependentFilteringTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //Non-temporal clause
        Table nt = t.selectWhere(both(concept.isEqualTo(conceptA), (concept.isNotEqualTo(conceptB))));
    ...
    private static void generateTestData(Table t, int numberOfRecordsInTable, Stopwatch stopwatch) throws IOException {
        ...
        out.println("Time to generate " + numberOfRecordsInTable + " records: " + stopwatch.elapsed(TimeUnit.SECONDS)
                        + " seconds");
    }
