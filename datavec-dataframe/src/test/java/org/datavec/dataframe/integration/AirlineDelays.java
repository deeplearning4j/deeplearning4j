...
public class AirlineDelays {
    ...
    private AirlineDelays() throws Exception {
        ...
        System.out.println(String.format("loaded %d records in %d seconds", flights2008.rowCount(),
    ...
    static ColumnType[] heading = {ColumnType.INTEGER, // year
    ...
    private static ColumnType[] reduced_set = {ColumnType.SKIP, // year
                    ColumnType.INTEGER, // month
                    ColumnType.INTEGER, // day
                    ColumnType.CATEGORY, // dow
