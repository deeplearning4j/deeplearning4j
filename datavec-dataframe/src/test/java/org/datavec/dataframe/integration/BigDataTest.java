...
public class BigDataTest {
    ...
    static final ColumnType types[] = {ColumnType.LOCAL_DATE_TIME, ColumnType.LOCAL_DATE_TIME, ColumnType.CATEGORY,
                    ColumnType.CATEGORY, ColumnType.CATEGORY, ColumnType.CATEGORY, ColumnType.CATEGORY};
