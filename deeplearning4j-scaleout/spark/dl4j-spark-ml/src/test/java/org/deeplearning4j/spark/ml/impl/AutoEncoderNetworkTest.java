...
public class AutoEncoderNetworkTest {
    ...
    private MultiLayerConfiguration getNNConfiguration(){
        return new NeuralNetConfiguration.Builder()
                ...
                .list()
                .layer(0, new RBM.Builder().nIn(10).nOut(8).lossFunction(LossFunctions.LossFunction.KL_DIVERGENCE).build())
                .layer(1, new RBM.Builder().nIn(8).nOut(5).lossFunction(LossFunctions.LossFunction.KL_DIVERGENCE).build())
                ...
                .layer(4, new RBM.Builder().nIn(5).nOut(8).lossFunction(LossFunctions.LossFunction.KL_DIVERGENCE).build()) //decoding starts
                .layer(5, new OutputLayer.Builder(LossFunctions.LossFunction.MSE).activation("sigmoid").nIn(8).nOut(10).build())
