    ...
    public SharedTrainingResult run(SharedTrainingWorker worker) {
        ...
        if (isFirst.compareAndSet(false, true)) {
            ...
            if (wrapper == null) {
                ...
                MessageHandler handler = new WiredEncodingHandler(trainingConfiguration.getThreshold(), trainingConfiguration.getMinThreshold(), trainingConfiguration.getThresholdStep(), trainingConfiguration.getShakeFrequency());
