...
public class SharedTrainingAccumulationFunctionTest {
    ...
    public void testAccumulation1() throws Exception {
        ...
        SharedTrainingAccumulationTuple tuple1 = SharedTrainingAccumulationTuple.builder()
                .updaterStateArray(updates1)
                .scoreSum(1.0)
                .aggregationsCount(1)
                .build();

        SharedTrainingAccumulationTuple tuple2 = SharedTrainingAccumulationTuple.builder()
