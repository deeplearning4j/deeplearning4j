 ...
 * @author Alex Black
 */
public class VaeReconstructionProbWithKeyFunction<K> extends BasePairFlatMapFunctionAdaptee<Iterator<Tuple2<K, INDArray>>, K, Double> {
    ...
    public VaeReconstructionProbWithKeyFunction(Broadcast<INDArray> params, Broadcast<String> jsonConfig, boolean useLogProbability, int batchSize, int numSamples) {
        super(new VaeReconstructionProbWithKeyFunctionAdapter<K>(params, jsonConfig, useLogProbability, batchSize, numSamples));
    }
}
...
class VaeReconstructionProbWithKeyFunctionAdapter<K> extends BaseVaeReconstructionProbWithKeyFunctionAdapter<K> {
     ...
     */
    public VaeReconstructionProbWithKeyFunctionAdapter(Broadcast<INDArray> params, Broadcast<String> jsonConfig, boolean useLogProbability, int batchSize, int numSamples) {
