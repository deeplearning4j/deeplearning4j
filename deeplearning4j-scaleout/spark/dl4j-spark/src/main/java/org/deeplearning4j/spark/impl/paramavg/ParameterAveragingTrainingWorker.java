 ...
 * @author Alex Black
 */
public class ParameterAveragingTrainingWorker extends BaseTrainingWorker<ParameterAveragingTrainingResult> implements TrainingWorker<ParameterAveragingTrainingResult> {
