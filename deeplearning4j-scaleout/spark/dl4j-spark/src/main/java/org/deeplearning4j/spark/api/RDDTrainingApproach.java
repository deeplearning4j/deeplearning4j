 ...
 *
 * <b>Export</b>: first export the RDD to disk (temporary directory) and enforceTrainingConfig from that.
 * <b>Direct</b>: aka 'legacy mode': enforceTrainingConfig directly from the RDD. This has higher memory requirements and lower performance
