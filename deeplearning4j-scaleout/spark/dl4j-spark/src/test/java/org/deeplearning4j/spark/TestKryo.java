...
public class TestKryo extends BaseSparkKryoTest {
    ...
    public void testSerializationConfigurations(){
        ...
        MultiLayerConfiguration mlc = new NeuralNetConfiguration.Builder()
                ...
                .learningRateSchedule(m)
                .updater(Updater.NADAM)
                .list()
        ...
        ComputationGraphConfiguration cgc = new NeuralNetConfiguration.Builder()
                ...
                .learningRate(0.2)
                .learningRateDecayPolicy(LearningRatePolicy.Schedule)
                .learningRateSchedule(Collections.singletonMap(10,0.1))
                .updater(Updater.ADAM)
                .graphBuilder()
                .addInputs("in")
                .addLayer("out", new OutputLayer.Builder().nIn(10).nOut(10).build(), "in")
                .setOutputs("out")
                .build();
        ...
        Layer[] layers = new Layer[]{
                new OutputLayer.Builder().nIn(10).nOut(10).build(),
                new RnnOutputLayer.Builder().nIn(10).nOut(10).build(),
                new LossLayer.Builder().build(),
                new CenterLossOutputLayer.Builder().nIn(10).nOut(10).build(),
                new DenseLayer.Builder().nIn(10).nOut(10).build(),
                new ConvolutionLayer.Builder().nIn(10).nOut(10).build(),
                new SubsamplingLayer.Builder().build(),
                new Convolution1DLayer.Builder(2,2).nIn(10).nOut(10).build(),
                new ActivationLayer.Builder().activation(Activation.TANH).build(),
                new GlobalPoolingLayer.Builder().build(),
                new GravesLSTM.Builder().nIn(10).nOut(10).build(),
                new LSTM.Builder().nIn(10).nOut(10).build(),
    ...
    public void testScalaCollections(){
        ...
        scala.collection.immutable.Map<Integer, String> emptyImmutableMap = scala.collection.immutable.Map$.MODULE$.empty();
