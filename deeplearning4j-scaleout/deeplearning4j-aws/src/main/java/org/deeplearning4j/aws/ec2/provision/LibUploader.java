 ...
 *
 */
public class LibUploader implements UserInfo {
	...
	private static Logger log = LoggerFactory.getLogger(LibUploader.class);
	 ...
	 */
	public LibUploader(String host,String user,String password,int port) {
		super();
		this.host = host;
		this.user = user;
		this.port = port;
	 ...
	 * @param password the password to use if any
	 */
	public LibUploader(String host,String user,String password) {
	 ...
	 * @param password the password to use if any
	 */
	public LibUploader(String host,String user) {
		this(host,user,"",22);
	}
	 ...
	 * @param host host to connect to (public facing dns)
	 */
	public LibUploader(String host) {
		this(host,"root","",22);
	}
