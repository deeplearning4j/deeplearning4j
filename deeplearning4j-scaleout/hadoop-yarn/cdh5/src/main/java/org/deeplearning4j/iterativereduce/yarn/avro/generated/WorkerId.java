...
public class WorkerId extends org.apache.avro.specific.SpecificFixed {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"fixed\",\"name\":\"WorkerId\",\"namespace\":\"com.cloudera.org.deeplearning4j.iterativereduce.yarn.avro.generated\",\"size\":32}");
