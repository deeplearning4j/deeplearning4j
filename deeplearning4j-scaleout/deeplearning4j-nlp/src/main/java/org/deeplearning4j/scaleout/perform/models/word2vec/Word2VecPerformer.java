...
public class Word2VecPerformer implements WorkerPerformer {
     ...
     */
    public void trainSentence(final List<VocabWord> sentence,Word2VecWork work) {
        if(sentence == null || sentence.isEmpty())
            return;
        for(int i = 0; i < sentence.size(); i++) {
            nextRandom.set(nextRandom.get() * 25214903917L + 11);
            skipGram(i, sentence, (int) nextRandom.get() % window,work);
        }
     ...
     * @param sentence
     */
    public void skipGram(int i,List<VocabWord> sentence, int b,Word2VecWork work) {
        ...
        for(int a = b; a < end; a++) {
            if(a != window) {
                ...
                if(c >= 0 && c < sentence.size()) {
                    ...
                    iterateSample(work,word,lastWord);
                }
            }
        }
     ...
     */
    public  void iterateSample(Word2VecWork work,VocabWord w1, VocabWord w2) {
