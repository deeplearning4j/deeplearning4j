...
package org.deeplearning4j.nlp.uima.annotator;
...
import org.deeplearning4j.nlp.uima.tokenization.tokenizer.ConcurrentTokenizer;
...
public class TokenizerAnnotator extends Tokenizer {
    ...
    public static AnalysisEngineDescription getDescription(String languageCode) throws ResourceInitializationException {
        ...
        return AnalysisEngineFactory.createEngineDescription(ConcurrentTokenizer.class, opennlp.uima.util.UimaUtil.MODEL_PARAMETER,
