 ...
 */
@Slf4j
public class KerasModelReshapeEndToEndTest {
    ...
    public void importMnistMlpTensorFlowEndToEndModelTest() throws Exception {
        ClassPathResource modelResource =
                        new ClassPathResource(
                                "modelimport/keras/examples/mnist_mlp_reshape/mnist_mlp_reshape_tf_keras_1_model.h5",
                                        KerasModelReshapeEndToEndTest.class.getClassLoader());
        ...
        ClassPathResource outputsResource =
                        new ClassPathResource(
                                "modelimport/keras/examples/mnist_mlp_reshape/mnist_mlp_reshape_tf_keras_1_inputs_and_outputs.h5",
                                        KerasModelReshapeEndToEndTest.class.getClassLoader());
