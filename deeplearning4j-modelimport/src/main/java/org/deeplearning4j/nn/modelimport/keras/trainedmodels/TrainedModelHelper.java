...
public class TrainedModelHelper {
    ...
    private void download() throws IOException {
        if (!h5File.exists() && !userProvidedH5) {
            ...
            log.info("H5 weights not found in default location. Copying from URL " + h5URL + "\n\tto location "
        ...
        if (!jsonFile.exists() && !userProvidedJSON) {
            ...
            log.info("JSON config not found in default location. Copying from URL " + jsonURL + "\n\tto location "
