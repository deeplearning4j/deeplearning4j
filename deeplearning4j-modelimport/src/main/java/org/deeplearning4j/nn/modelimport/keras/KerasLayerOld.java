...
public class KerasLayerOld {
    ...
    /* Logging. */
    private static Logger log = LoggerFactory.getLogger(KerasLayerOld.class);
     ...
     */
    public KerasLayerOld(Map<String,Object> layerConfig)
     ...
     */
    public KerasLayerOld(Map<String,Object> layerConfig, boolean train)
            throws InvalidKerasConfigurationException, UnsupportedKerasConfigurationException {
...
//    }
     ...
     * @return              KerasLayerOld for input layer
     */
    public static KerasLayerOld createInputLayer(String layerName, int[] inputShape)
            throws InvalidKerasConfigurationException, UnsupportedKerasConfigurationException {
        ...
        return new KerasLayerOld(layerConfig, false);
    }
     ...
     * @return              KerasLayerOld for loss layer
     */
    public static KerasLayerOld createLossLayer(String layerName, String kerasLoss)
            throws InvalidKerasConfigurationException, UnsupportedKerasConfigurationException {
     ...
     * @return              KerasLayerOld for loss layer
     */
    public static KerasLayerOld createLossLayer(String layerName, String kerasLoss, boolean train)
            throws InvalidKerasConfigurationException, UnsupportedKerasConfigurationException {
        Map<String,Object> config = new HashMap<String,Object>();
        config.put(LAYER_FIELD_NAME, layerName);
        ...
        return new KerasLayerOld(layerConfig, train);
    }
