...
public class Counter<E> implements Serializable {
    ...
    public List<E> getSortedKeys() {
        org.datavec.api.berkeley.PriorityQueue<E> pq = this.asPriorityQueue();
     ...
     */
    public org.datavec.api.berkeley.PriorityQueue<E> asPriorityQueue() {
     ...
     * @return
     */
    public org.datavec.api.berkeley.PriorityQueue<E> asMinPriorityQueue() {
        org.datavec.api.berkeley.PriorityQueue<E> pq = new org.datavec.api.berkeley.PriorityQueue<E>(entries.size());
        for (Entry<E, Double> entry : entries.entrySet()) {
            pq.add(entry.getKey(), -entry.getValue());
        }
