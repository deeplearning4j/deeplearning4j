...
public class TransformProcessRecordReaderTests {
    ...
    public void simpleTransformTest() throws Exception {
        Schema schema = new Schema.Builder()
                ...
                .addColumnDouble("2")
                .addColumnDouble("3")
                .addColumnDouble("4").build();
        TransformProcess transformProcess = new TransformProcess.Builder(schema).removeColumns("0")
                .build();
        CSVRecordReader csvRecordReader = new CSVRecordReader();
        csvRecordReader.initialize(new FileSplit(new ClassPathResource("iris.dat").getFile()));
        TransformProcessRecordReader transformProcessRecordReader = new TransformProcessRecordReader(csvRecordReader,transformProcess);
    ...
    public void simpleTransformTestSequence() {
        ...
        TransformProcess transformProcess = new TransformProcess.Builder(schema).removeColumns("intcolumn2")
                .build();
