...
import org.nd4j.etl4j.api.transform.sequence.window.OverlappingTimeWindowFunction;
...
public class TestWindowFunctions {
    ...
    public void testTimeWindowFunctionExcludeEmpty(){
        ...
        WindowFunction wf = new TimeWindowFunction.Builder()
                .timeColumn("timecolumn")
                .windowSize(1,TimeUnit.SECONDS)
    ...
    public void testOverlappingTimeWindowFunctionExcludeEmpty(){
        ...
        //Window size: 2 seconds; calculated every 1 second
//        WindowFunction wf2 = new OverlappingTimeWindowFunction("timecolumn",2,TimeUnit.SECONDS,1,TimeUnit.SECONDS);
        WindowFunction wf2 = new OverlappingTimeWindowFunction.Builder()
                .timeColumn("timecolumn")
                .windowSize(2,TimeUnit.SECONDS)
                .windowSeparation(1,TimeUnit.SECONDS)
                .excludeEmptyWindows(true)
                .build();
        wf2.setInputSchema(schema);
