...
public interface INDArray {
     ...
     * @param dimension  the dimension to get the norm1 along
     ...
     * @param dimension  the dimension to get the norm2 along
     ...
     * @param dimension the dimension to get the product along
     ...
     * @param dimension the dimension to get the mean along
     ...
     * @param dimension  the dimension to get the sum along
