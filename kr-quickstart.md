...
[예제의 스칼라 버전은 여기를 참고하십시오.](https://github.com/kogecoo/dl4j-0.4-examples-scala).

## 다음 단계

위의 예제보다 더 자세한 내용은 저희의 [Full Installation 페이지](http://deeplearning4j.org/gettingstarted.html)를 참조하십시오.
