...
public class RecurrentAdvantageActorCriticTest {
    ...
    public void when_callingCompute_expect_valueAndPolicyComputedCorrectly() {
        ...
        when(threadCurrentMock.output(any(INDArray.class))).thenAnswer(invocation -> {
            ...
            result.put(CommonOutputNames.ActorCritic.Value, invocation.getArgument(0, INDArray.class).get(NDArrayIndex.point(0), NDArrayIndex.point(0), NDArrayIndex.all()).mul(-1.0));
