...
Deeplearning4J is integrated with Hadoop and Spark as well as runs on several backends that enable use of CPUs and GPus. The goal is for a plug and play solution that is more convention than configuration and allows for fast prototyping. 
...
---
## Installation
To install Deeplearning4J there are a couple approaches and more information can be found on the site at this [link](http://nd4j.org/getstarted.html).
