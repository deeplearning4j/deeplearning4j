...
The most recent stable release in Maven Central is `0.6.0`, and the current master is `0.6.1-SNAPSHOT`. For more on working with snapshots, see this [page](http://deeplearning4j.org/snapshot). 
