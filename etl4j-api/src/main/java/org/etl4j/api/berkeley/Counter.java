...
public class Counter<E> implements Serializable {
	...
	public List<E> getSortedKeys() {
		org.etl4j.api.berkeley.PriorityQueue<E> pq = this.asPriorityQueue();
	 ...
	 */
	public org.etl4j.api.berkeley.PriorityQueue<E> asPriorityQueue() {
		org.etl4j.api.berkeley.PriorityQueue<E> pq = new org.etl4j.api.berkeley.PriorityQueue<E>(entries.size());
		for (Entry<E, Double> entry : entries.entrySet()) {
	 ...
	 * @return
	 */
	public org.etl4j.api.berkeley.PriorityQueue<E> asMinPriorityQueue() {
		org.etl4j.api.berkeley.PriorityQueue<E> pq = new org.etl4j.api.berkeley.PriorityQueue<E>(entries.size());
		for (Entry<E, Double> entry : entries.entrySet()) {
			pq.add(entry.getKey(), -entry.getValue());
		}
