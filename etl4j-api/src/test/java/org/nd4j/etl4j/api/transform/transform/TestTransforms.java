...
import org.nd4j.etl4j.api.transform.condition.column.StringColumnCondition;
...
import org.nd4j.etl4j.api.transform.transform.categorical.CategoricalToIntegerTransform;
import org.nd4j.etl4j.api.transform.transform.categorical.CategoricalToOneHotTransform;
import org.nd4j.etl4j.api.transform.transform.categorical.IntegerToCategoricalTransform;
import org.nd4j.etl4j.api.transform.transform.categorical.StringToCategoricalTransform;
...
import org.nd4j.etl4j.api.transform.transform.condition.ConditionalCopyValueTransform;
import org.nd4j.etl4j.api.transform.transform.condition.ConditionalReplaceValueTransform;
...
import org.nd4j.etl4j.api.transform.transform.integer.ReplaceEmptyIntegerWithValueTransform;
import org.nd4j.etl4j.api.transform.transform.integer.ReplaceInvalidWithIntegerTransform;
...
import org.nd4j.etl4j.api.transform.transform.string.*;
import org.nd4j.etl4j.api.transform.transform.time.DeriveColumnsFromTimeTransform;
import org.nd4j.etl4j.api.transform.transform.time.StringToTimeTransform;
...
public class TestTransforms {
    ...
    public void testTimeMathOpTransform() {
        ...
        Schema out = transform.transform(schema);
        assertEquals(1, out.getColumnMetaData().size());
        assertEquals(ColumnType.Time, out.getType(0));
