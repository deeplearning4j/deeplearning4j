...
You can install both ND4J and Deeplearning4j separately via [Maven](https://maven.apache.org/download.cgi), a build automation tool used for Java projects. Maven installations involve: 

* Creating your root directory; e.g. deeplearning4j
* Creating a pom.xml file within that directory
* Adding dependencies and other information into that POM file. See the [Readme](https://github.com/SkymindIO/deeplearning4j/blob/master/README.md) for dependencies. 
* Once you do that, choose your IDE, and import the project via Maven. (Alternatively, you can run mvn install with the root.)
