...
public interface ParamInitializer {
     ...
     */
    void init(Map<String, INDArray> params, BaseNeuralNetConfiguration conf);
     ...
     */
    void init(Map<String,INDArray> params,BaseNeuralNetConfiguration conf,Configuration extraConf);
}
