...
public class GradientAdjustment {
     ...
     */
    public static void updateGradientAccordingToParams(BaseNeuralNetConfiguration conf,int iteration,Gradient gradient,int batchSize,Map<String,AdaGrad> adaGrad,Model model) {
     ...
     */
    public static void updateGradientAccordingToParams(BaseNeuralNetConfiguration conf,int iteration,AdaGrad adaGrad,INDArray gradient,INDArray params,int batchSize) {
        if(adaGrad == null)
