...
public class MathUtils  {
    ...
    public static double permutation(double n,double r) {
        double nFac= org.arbiter.util.MathUtils.factorial(n);
        double nMinusRFac= org.arbiter.util.MathUtils.factorial((n - r));
    ...
    public static double combination(double n,double r) {
        double nFac= org.arbiter.util.MathUtils.factorial(n);
        double rFac= org.arbiter.util.MathUtils.factorial(r);
        double nMinusRFac= org.arbiter.util.MathUtils.factorial((n - r));
    ...
    public static double bernoullis(double n,double k,double successProb) {
        ...
        double combo = org.arbiter.util.MathUtils.combination(n, k);
