...
public class LayerConfigTest {
    ...
    public void testMomentumLayerwiseOverride() {
        ...
        assertEquals(0.1, ((Nesterovs) ((BaseLayer)conf.getConf(0).getLayer()).getIUpdater()).getMomentumSchedule().get(0), 0.0);
        assertEquals(0.2, ((Nesterovs) ((BaseLayer)conf.getConf(1).getLayer()).getIUpdater()).getMomentumSchedule().get(0), 0.0);
