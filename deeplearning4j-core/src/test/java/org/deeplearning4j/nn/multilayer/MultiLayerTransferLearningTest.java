...
public class MultiLayerTransferLearningTest {
    ...
    @Test
    public void testPopAndProcessing() {
        ...
        MultiLayerNetwork modelNow =
                new MLNTransferLearning(modelToTweak)
        ...
        //modelNow should have the same architecture as modelExpectedArch
        assertTrue(modelExpectedArch.getLayerWiseConfigurations().getConf(0).toJson().equals(modelNow.getLayerWiseConfigurations().getConf(0).toJson()));
        ...
        assertTrue(modelExpectedArch.getLayerWiseConfigurations().getConf(2).toJson().equals(modelNow.getLayerWiseConfigurations().getConf(2).toJson()));
        assertTrue(modelExpectedArch.getLayerWiseConfigurations().getConf(3).toJson().equals(modelNow.getLayerWiseConfigurations().getConf(3).toJson()));
        assertTrue(modelExpectedArch.getLayerWiseConfigurations().getConf(4).toJson().equals(modelNow.getLayerWiseConfigurations().getConf(4).toJson()));
        assertTrue(modelExpectedArch.getLayerWiseConfigurations().getConf(5).toJson().equals(modelNow.getLayerWiseConfigurations().getConf(5).toJson()));
