...
public class MultiLayerTestRNN {
    ...
    public void testRnnTimeStepWithPreprocessor() {
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
                ...
                .list()
                .layer(0, new org.deeplearning4j.nn.conf.layers.GravesLSTM.Builder().nIn(10).nOut(10).activation("tanh").build())
                .layer(1, new org.deeplearning4j.nn.conf.layers.GravesLSTM.Builder().nIn(10).nOut(10).activation("tanh").build())
    ...
    public void testRnnTimeStepWithPreprocessorGraph() {
        ...
        ComputationGraphConfiguration conf = new NeuralNetConfiguration.Builder()
                ...
                .graphBuilder()
                .addInputs("in")
                .addLayer("0", new org.deeplearning4j.nn.conf.layers.GravesLSTM.Builder().nIn(10).nOut(10).activation("tanh").build(), "in")
                .addLayer("1", new org.deeplearning4j.nn.conf.layers.GravesLSTM.Builder().nIn(10).nOut(10).activation("tanh").build(), "0")
