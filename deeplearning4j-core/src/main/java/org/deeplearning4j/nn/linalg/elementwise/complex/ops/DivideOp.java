 ...
 * @author Adam Gibson
 */
public class DivideOp extends BaseComplexTwoArrayElementWiseOp {
    /**
     ...
     */
    public DivideOp(ComplexNDArray from, ComplexNDArray to, ComplexNDArray other, ComplexDouble scalarValue) {
     ...
     * @param other
     */
    public DivideOp(ComplexNDArray from, ComplexNDArray to, ComplexNDArray other) {
        super(from, to, other);
    }
     ...
     * @param scalarValue the scalar value to apply
     */
    public DivideOp(ComplexNDArray from, ComplexNDArray to, ComplexDouble scalarValue) {
        super(from, to, scalarValue);
    }

    public DivideOp(ComplexNDArray from) {
        super(from);
    }
     ...
     * @param to
     */
    public DivideOp(ComplexNDArray from, ComplexNDArray to) {
        super(from, to);
    }

    public DivideOp(ComplexNDArray from, ComplexDouble scalarValue) {
    ...
    public ComplexDouble apply(ComplexDouble value,int i) {
        return getFromOrigin(i).div(value);
    }
