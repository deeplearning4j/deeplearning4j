...
public class AddOp extends BaseTwoArrayElementWiseOp {
     ...
     */
    public AddOp(NDArray from, NDArray to, NDArray other, double scalarValue) {
     ...
     * @param other
     */
    public AddOp(NDArray from, NDArray to, NDArray other) {
        super(from, to, other);
    }

    public AddOp(NDArray from) {
        super(from);
    }
     ...
     * @param to
     */
    public AddOp(NDArray from, NDArray to) {
        super(from, to);
    }

    public AddOp(NDArray from, double scalarValue) {
     ...
     * @param scalarValue the scalar value to apply
     */
    public AddOp(NDArray from, NDArray to, double scalarValue) {
