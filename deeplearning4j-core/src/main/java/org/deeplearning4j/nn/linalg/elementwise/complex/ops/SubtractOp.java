 ...
 * @author Adam Gibson
 */
public class SubtractOp extends BaseComplexTwoArrayElementWiseOp {
     ...
     */
    public SubtractOp(ComplexNDArray from, ComplexNDArray to, ComplexNDArray other, ComplexDouble scalarValue) {
     ...
     * @param other
     */
    public SubtractOp(ComplexNDArray from, ComplexNDArray to, ComplexNDArray other) {
        super(from, to, other);
    }
     ...
     * @param scalarValue the scalar value to apply
     */
    public SubtractOp(ComplexNDArray from, ComplexNDArray to, ComplexDouble scalarValue) {
        super(from, to, scalarValue);
    }

    public SubtractOp(ComplexNDArray from) {
        super(from);
    }
     ...
     * @param to
     */
    public SubtractOp(ComplexNDArray from, ComplexNDArray to) {
        super(from, to);
    }

    public SubtractOp(ComplexNDArray from, ComplexDouble scalarValue) {
    ...
    public ComplexDouble apply(ComplexDouble value,int i) {
        return getFromOrigin(i).sub(value);
    }
