...
public class MultiplyOp extends BaseTwoArrayElementWiseOp {
     ...
     */
    public MultiplyOp(NDArray from, NDArray to, NDArray other, double scalarValue) {
     ...
     * @param other
     */
    public MultiplyOp(NDArray from, NDArray to, NDArray other) {
        super(from, to, other);
    }
     ...
     * @param scalarValue the scalar value to apply
     */
    public MultiplyOp(NDArray from, NDArray to, double scalarValue) {
        super(from, to, scalarValue);
    }

    public MultiplyOp(NDArray from) {
        super(from);
    }
     ...
     * @param to
     */
    public MultiplyOp(NDArray from, NDArray to) {
        super(from, to);
    }

    public MultiplyOp(NDArray from, double scalarValue) {
