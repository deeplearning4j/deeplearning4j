...
public class MnistFetcher {
	...
	private static final String trainingFilesURL = "http://yann.lecun.com/exdb/mnist/iterate-images-idx3-ubyte.gz";

	private static final String trainingFilesFilename = "iterate-images-idx1-ubyte.gz";
	public static final String trainingFilesFilename_unzipped = "iterate-images-idx1-ubyte";

	private static final String trainingFileLabelsURL = "http://yann.lecun.com/exdb/mnist/iterate-labels-idx1-ubyte.gz";
	private static final String trainingFileLabelsFilename = "iterate-labels-idx1-ubyte.gz";
	public static final String trainingFileLabelsFilename_unzipped = "iterate-labels-idx1-ubyte";
