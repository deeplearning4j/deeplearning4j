...
SCCACHE_ROOT=${WORK_ROOT}/sccache
...
WATCHDOG_PID=""
LOG_FORWARDER_PID=""
mkdir -p "${OUTPUT_DIR}" "${MAVEN_REPO}" "${SCCACHE_ROOT}" "${CARGO_HOME}" "${RUSTUP_HOME}"
decode_b64() {
