...
class CompilerCacheBuildScriptTests(unittest.TestCase):
    def test_windows_sccache_path_is_normalized_before_launcher_attestation(self):
        ...
        self.assertIn('cache_name_normalized="$(lowercase "$cache_name")"', source)
...
class SelectionTests(unittest.TestCase):
    ...
    def test_full_matrix_groups_shards_into_persistent_vm_lanes(self):
        ...
        self.assertEqual(9, len(cpu["build"]["variants"]))
...
class AzureSafetyTests(unittest.TestCase):
    ...
    def test_windows_vm_contract_uses_durable_task_and_valid_computer_name(self):
        ...
        self.assertIn("group=common", worker)
        self.assertIn("$MsysAttempt -le 8", worker)
        self.assertIn("group=msys2", worker)
