...
public final class FlatResult extends Table {
  ...
  public IntTriple timing(int j) { return timing(new IntTriple(), j); }
  public IntTriple timing(IntTriple obj, int j) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
