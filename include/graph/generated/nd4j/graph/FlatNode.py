...
def FlatNodeStart(builder): builder.StartObject(15)
...
def FlatNodeAddInput(builder, input): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(input), 0)
def FlatNodeStartInputVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def FlatNodeAddInputPaired(builder, inputPaired): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(inputPaired), 0)
def FlatNodeStartInputPairedVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def FlatNodeAddDataType(builder, dataType): builder.PrependInt8Slot(6, dataType, 0)
...
def FlatNodeAddDimensions(builder, dimensions): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(dimensions), 0)
def FlatNodeStartDimensionsVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def FlatNodeAddDevice(builder, device): builder.PrependInt32Slot(11, device, 0)
def FlatNodeAddScalar(builder, scalar): builder.PrependFloat32Slot(12, scalar, 0.0)
