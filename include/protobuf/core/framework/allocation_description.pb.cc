...
namespace protobuf_allocation_5fdescription_2eproto {
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "allocation_description.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void AddDescriptorsImpl() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "allocation_description.proto", &protobuf_RegisterTypes);
...
AllocationDescription::AllocationDescription()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_allocation_5fdescription_2eproto::InitDefaults();
  }
  SharedCtor();
...
const ::google::protobuf::Descriptor* AllocationDescription::descriptor() {
  protobuf_allocation_5fdescription_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_allocation_5fdescription_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
::google::protobuf::Metadata AllocationDescription::GetMetadata() const {
  protobuf_allocation_5fdescription_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_allocation_5fdescription_2eproto::file_level_metadata[kIndexInFileMessages];
}
