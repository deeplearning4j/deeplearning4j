...
namespace protobuf_tensor_5fdescription_2eproto {
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "tensor_description.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void AddDescriptorsImpl() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "tensor_description.proto", &protobuf_RegisterTypes);
...
TensorDescription::TensorDescription()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_tensor_5fdescription_2eproto::InitDefaults();
  }
  SharedCtor();
...
const ::google::protobuf::Descriptor* TensorDescription::descriptor() {
  protobuf_tensor_5fdescription_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_tensor_5fdescription_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
::google::protobuf::Metadata TensorDescription::GetMetadata() const {
  protobuf_tensor_5fdescription_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_tensor_5fdescription_2eproto::file_level_metadata[kIndexInFileMessages];
}
