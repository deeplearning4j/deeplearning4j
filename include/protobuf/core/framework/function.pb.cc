...
class FunctionDef_AttrEntryDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<FunctionDef::FunctionDef_AttrEntry> {
} _FunctionDef_AttrEntry_default_instance_;
class FunctionDef_RetEntryDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<FunctionDef::FunctionDef_RetEntry> {
...
file_level_metadata[1].reflection = FunctionDef::FunctionDef_AttrEntry::CreateReflection(file_level_metadata[1].descriptor, _FunctionDef_AttrEntry_default_instance_.get_mutable());
...
void TableStruct::InitDefaultsImpl() {
  ...
  ::tensorflow::protobuf_op_5fdef_2eproto::InitDefaults();
  _FunctionDefLibrary_default_instance_.DefaultConstruct();
  _FunctionDef_AttrEntry_default_instance_.DefaultConstruct();
  _FunctionDef_RetEntry_default_instance_.DefaultConstruct();
  _FunctionDef_default_instance_.DefaultConstruct();
  _GradientDef_default_instance_.DefaultConstruct();
  _FunctionDef_AttrEntry_default_instance_.get_mutable()->set_default_instance(_FunctionDef_AttrEntry_default_instance_.get_mutable());
  _FunctionDef_AttrEntry_default_instance_.get_mutable()->InitAsDefaultInstance();
  _FunctionDef_RetEntry_default_instance_.get_mutable()->set_default_instance(_FunctionDef_RetEntry_default_instance_.get_mutable());
  _FunctionDef_RetEntry_default_instance_.get_mutable()->InitAsDefaultInstance();
...
void AddDescriptorsImpl() {
  ...
  ::tensorflow::protobuf_op_5fdef_2eproto::AddDescriptors();
...
FunctionDefLibrary::FunctionDefLibrary()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_function_2eproto::InitDefaults();
  }
  SharedCtor();
...
::google::protobuf::uint8* FunctionDefLibrary::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0, n = this->gradient_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        2, this->gradient(i), deterministic, target);
  }
...
::google::protobuf::uint8* FunctionDef::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0, n = this->node_def_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        3, this->node_def(i), deterministic, target);
  }
