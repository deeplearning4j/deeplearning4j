...
namespace protobuf_reader_5fbase_2eproto {
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "reader_base.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void AddDescriptorsImpl() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "reader_base.proto", &protobuf_RegisterTypes);
...
ReaderBaseState::ReaderBaseState()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_reader_5fbase_2eproto::InitDefaults();
  }
  SharedCtor();
...
const ::google::protobuf::Descriptor* ReaderBaseState::descriptor() {
  protobuf_reader_5fbase_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_reader_5fbase_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
::google::protobuf::Metadata ReaderBaseState::GetMetadata() const {
  protobuf_reader_5fbase_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_reader_5fbase_2eproto::file_level_metadata[kIndexInFileMessages];
}
