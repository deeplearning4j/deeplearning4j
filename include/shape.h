 ...
 */
   ...
   */
    ...
    __host__ __device__
#endif
    inline Nd4jIndex tadLength(int *shapeInfo,int *dimension,int dimensionLength) {
    ...
    *
    */
    inline Nd4jIndex tadOffset(int index,int *shapeInfo,int *dimension,int dimensionLength) {
        if(dimensionLength > 1) {
