...
Deeplearning4j aims to be cutting-edge plug and play, more convention than configuration. By following its conventions, you get an [infinitely scalable](../scaleout.html) deep-learning architecture. This Java deep-learning library has a domain-specific language (DSL) for neural networks, to turn their multiple knobs. 
