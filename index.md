...
Deeplearning4j is *distributed*. Training can take place in the cluster, which means it can handle massive amounts of data. Training takes place in parallel using downpour stochastic gradient descent, which is asynchronous, and produces highly compact deep-learning models.
