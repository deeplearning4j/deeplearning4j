...
public class DataFrames extends DataFramesBase {
    ...
    public static Dataset<Row> toDataFrame(Schema schema, JavaRDD<List<Writable>> data) {
        ...
        Dataset<Row> dataFrame = sqlContext.createDataFrame(rows, fromSchema(schema));
        return dataFrame;
    }
    ...
    public static Dataset<Row> toDataFrameSequence(Schema schema, JavaRDD<List<List<Writable>>> data) {
        ...
        Dataset<Row> dataFrame = sqlContext.createDataFrame(rows, fromSchemaSequence(schema));
        return dataFrame;
    }
