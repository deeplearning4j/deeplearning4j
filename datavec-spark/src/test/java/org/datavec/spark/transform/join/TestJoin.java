...
public class TestJoin extends BaseSparkTest {
    ...
    public void testJoinManyToMany(){
        Schema schema1 = new Schema.Builder()
                .addColumnLong("id")
                .addColumnCategorical("category", Arrays.asList("cat0","cat1","cat2"))
                .build();

        Schema schema2 = new Schema.Builder()
                .addColumnLong("otherId")
                .addColumnCategorical("otherCategory", Arrays.asList("cat0","cat1","cat2"))
                .build();
