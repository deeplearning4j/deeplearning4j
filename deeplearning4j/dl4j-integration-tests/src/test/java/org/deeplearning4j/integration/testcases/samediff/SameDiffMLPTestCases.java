    ...
    public static TestCase getLenetMnist() {
        return new TestCase() {
            ...
            public Object getConfiguration() throws Exception {
                ...
                SDVariable w0 = sd.var("w0", Nd4j.rand(DataType.FLOAT, 784, 20));

                SDVariable w1 = sd.var("w1", Nd4j.rand(DataType.FLOAT, 20, 50));
                SDVariable b1 = sd.var("b2", Nd4j.rand(DataType.FLOAT, 20));


                SDVariable w4 = sd.var("w2", Nd4j.rand(DataType.FLOAT, 50, 500));
                SDVariable b4 = sd.var("b2", Nd4j.rand(DataType.FLOAT, 50));

                SDVariable w5 = sd.var("w3", Nd4j.rand(DataType.FLOAT, 500, outputNum));
                SDVariable b5 = sd.var("b3", Nd4j.rand(DataType.FLOAT, 500));


                SDVariable layer0 = sd.cnn.conv1d("layer0", in, w0, new Conv1DConfig());

                Pooling2DConfig layer1Subsampling = new Pooling2DConfig();
                layer1Subsampling.setKH(2);
                layer1Subsampling.setKW(2);
                layer1Subsampling.setSH(2);
                layer1Subsampling.setSW(2);

                SDVariable layer1 = sd.cnn.maxPooling2d("layer1", layer0.mmul(w1).add(b1), layer1Subsampling);
                SDVariable layer2 = sd.cnn.conv1d("layer2", layer1.mmul(w2).add(b2), w2, new Conv1DConfig());

                Pooling2DConfig layer3Subsampling = new Pooling2DConfig();
                layer1Subsampling.setKH(2);
                layer1Subsampling.setKW(2);
                layer1Subsampling.setSH(2);
                layer1Subsampling.setSW(2);
                ...
                SDVariable layer3 = sd.cnn.maxPooling2d("layer3", layer2.mmul(w3).add(b3), layer3Subsampling);
