...
print("Saving model with embedding into Conv1D layer for backend {} and keras major version {}".format(backend, major_version))
model.save("{}embedding_conv1d_{}_{}.h5".format(base_path, backend, major_version))
