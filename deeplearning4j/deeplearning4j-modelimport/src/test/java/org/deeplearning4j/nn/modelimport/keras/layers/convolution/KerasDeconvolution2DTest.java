...
public class KerasDeconvolution2DTest {
    ...
    @Test
    public void testDeconvolution2DLayer() throws Exception {
    ...
    private void buildDeconvolution2DLayer(KerasLayerConfiguration conf, Integer kerasVersion, boolean withDilation)
            throws Exception {
