 ...
 * @author Max Pumperla
 */
@DisplayName("Keras Deconvolution 2 D Test")
class KerasDeconvolution2DTest extends BaseDL4JTest {
    ...
    @Test
    @DisplayName("Test Deconvolution 2 D Layer")
    void testDeconvolution2DLayer() throws Exception {
        buildDeconvolution2DLayer(conf1, keras1, false);
        buildDeconvolution2DLayer(conf2, keras2, false);
        buildDeconvolution2DLayer(conf2, keras2, true);
    }

    private void buildDeconvolution2DLayer(KerasLayerConfiguration conf, Integer kerasVersion, boolean withDilation) throws Exception {
        Map<String, Object> layerConfig = new HashMap<>();
        layerConfig.put(conf.getLAYER_FIELD_CLASS_NAME(), conf.getLAYER_CLASS_NAME_DECONVOLUTION_2D());
