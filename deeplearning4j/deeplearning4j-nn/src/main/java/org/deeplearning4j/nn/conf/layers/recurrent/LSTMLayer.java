...
/**
 * LSTMLayer recurrent neural network layer without peephole connections. Supports CuDNN acceleration - see <a
 * href="https://deeplearning4j.org/cudnn>https://deeplearning4j.org/cudnn</a> for details
 *
 * @author Alex Black
 * @see GravesLSTMLayer GravesLSTMLayer class for an alternative LSTMLayer (with peephole connections)
 */
@Data
@NoArgsConstructor
@ToString(callSuper = true)
@EqualsAndHashCode(callSuper = true)
public class LSTMLayer extends AbstractLSTM {

    private double forgetGateBiasInit;
    private IActivation gateActivationFn = new ActivationSigmoid();

    private LSTMLayer(Builder builder) {
        super(builder);
    ...
    public Layer instantiate(NeuralNetConfiguration conf, Collection<TrainingListener> trainingListeners,
        ...
        LayerValidation.assertNInNOutSet("LSTMLayer", getLayerName(), layerIndex, getNIn(), getNOut());
        org.deeplearning4j.nn.layers.recurrent.LSTMLayer ret = new org.deeplearning4j.nn.layers.recurrent.LSTMLayer(conf);
