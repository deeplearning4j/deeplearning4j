 ...
 * Greff et al. 2015, "LSTMLayer: A Search Space Odyssey", pg11. This is the "no peephole" variant in said paper
 * <a href="http://arxiv.org/pdf/1503.04069.pdf">http://arxiv.org/pdf/1503.04069.pdf</a>
 *
 * @author Alex Black
 * @see GravesLSTMLayer GravesLSTMLayer class, for the version with peephole connections
 */
@Slf4j
public class LSTMLayer extends BaseRecurrentLayer<org.deeplearning4j.nn.conf.layers.recurrent.LSTMLayer> {
