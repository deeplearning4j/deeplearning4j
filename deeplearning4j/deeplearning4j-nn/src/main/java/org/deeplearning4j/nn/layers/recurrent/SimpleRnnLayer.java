 ...
 *
 * Note that other architectures (LSTMLayer, etc) are usually more effective, especially for longer time series
 *
 * @author Alex Black
 */
public class SimpleRnnLayer extends BaseRecurrentLayer<org.deeplearning4j.nn.conf.layers.recurrent.SimpleRnnLayer> {
    public static final String STATE_KEY_PREV_ACTIVATION = "prevAct";

    public SimpleRnnLayer(NeuralNetConfiguration conf) {
        super(conf);
    }
