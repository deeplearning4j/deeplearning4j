...
public class Upsampling1DLayer extends BaseUpsamplingLayer {

    protected int[] size;

    protected Upsampling1DLayer(UpsamplingBuilder builder) {
        super(builder);
    ...
    public org.deeplearning4j.nn.api.Layer instantiate(NeuralNetConfiguration conf,
        ...
        org.deeplearning4j.nn.layers.convolution.upsampling.Upsampling1DLayer ret =
                        new org.deeplearning4j.nn.layers.convolution.upsampling.Upsampling1DLayer(conf);
    ...
    @Override
    public Upsampling1DLayer clone() {
        Upsampling1DLayer clone = (Upsampling1DLayer) super.clone();
        return clone;
    }
    ...
    public LayerMemoryReport getMemoryReport(InputType inputType) {
        ...
        return new LayerMemoryReport.Builder(layerName, Upsampling1DLayer.class, inputType, outputType).standardMemory(0, 0) //No params
    ...
    public static class Builder extends UpsamplingBuilder<Builder> {
        ...
        public Upsampling1DLayer build() {
            return new Upsampling1DLayer(this);
        }
