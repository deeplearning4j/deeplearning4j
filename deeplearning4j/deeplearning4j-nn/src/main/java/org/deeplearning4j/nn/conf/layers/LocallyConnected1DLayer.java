...
public class LocallyConnected1DLayer extends SameDiffLayer {
    ...
    protected LocallyConnected1DLayer(Builder builder) {
        super(builder);
    ...
    private LocallyConnected1DLayer() {
    ...
    public InputType getOutputType(int layerIndex, InputType inputType) {
        ...
        return InputTypeUtil.getOutputTypeCnn1DLayers(inputType, kernel, stride, padding, 1, cm, nOut, layerIndex,
                        getLayerName(), LocallyConnected1DLayer.class);
    }
    ...
    public static class Builder extends SameDiffLayer.Builder<Builder> {
        ...
        public LocallyConnected1DLayer build() {
            ...
            return new LocallyConnected1DLayer(this);
        }
    }
}
