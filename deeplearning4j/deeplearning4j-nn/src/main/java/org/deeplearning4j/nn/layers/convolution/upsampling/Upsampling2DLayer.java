 ...
 */
@Slf4j
public class Upsampling2DLayer extends AbstractLayer<org.deeplearning4j.nn.conf.layers.convolutional.upsampling.Upsampling2DLayer> {


    public Upsampling2DLayer(NeuralNetConfiguration conf) {
        super(conf);
    }

    public Upsampling2DLayer(NeuralNetConfiguration conf, INDArray input) {
        super(conf, input);
    }
