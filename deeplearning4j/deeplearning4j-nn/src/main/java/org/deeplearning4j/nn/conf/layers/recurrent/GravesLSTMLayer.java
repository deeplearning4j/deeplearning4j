...
/**
 * LSTMLayer recurrent net, based on Graves: Supervised Sequence Labelling with Recurrent Neural Networks
...
public class GravesLSTMLayer extends AbstractLSTM {
    ...
    public Layer instantiate(NeuralNetConfiguration conf, Collection<TrainingListener> trainingListeners,
        ...
        LayerValidation.assertNInNOutSet("GravesLSTMLayer", getLayerName(), layerIndex, getNIn(), getNOut());
        org.deeplearning4j.nn.layers.recurrent.GravesLSTMLayer ret =
                        new org.deeplearning4j.nn.layers.recurrent.GravesLSTMLayer(conf);
    ...
    public static class Builder extends AbstractLSTM.Builder<Builder> {
        ...
        public GravesLSTMLayer build() {
            return new GravesLSTMLayer(this);
        }
    }
