...
public class Convolution2DLayer extends FeedForwardLayer {
    ...
    /**
     * Convolution2DLayer nIn in the input layer is the number of channels nOut is the number of filters to be used in the
     ...
     */
    protected Convolution2DLayer(BaseConvBuilder<?> builder) {
        super(builder);
    ...
    @Override
    public Convolution2DLayer clone() {
        Convolution2DLayer clone = (Convolution2DLayer) super.clone();
    ...
    public Layer instantiate(NeuralNetConfiguration conf, Collection<TrainingListener> trainingListeners,
        ...
        LayerValidation.assertNInNOutSet("Convolution2DLayer", getLayerName(), layerIndex, getNIn(), getNOut());

        org.deeplearning4j.nn.layers.convolution.Convolution2DLayer ret =
                        new org.deeplearning4j.nn.layers.convolution.Convolution2DLayer(conf);
    ...
    public InputType getOutputType(int layerIndex, InputType inputType) {
        ...
        return InputTypeUtil.getOutputTypeCnnLayers(inputType, kernelSize, stride, padding, dilation, convolutionMode,
                        nOut, layerIndex, getLayerName(), Convolution2DLayer.class);
    }
    ...
    public LayerMemoryReport getMemoryReport(InputType inputType) {
        ...
        return new LayerMemoryReport.Builder(layerName, Convolution2DLayer.class, inputType, outputType)
    ...
    public static class Builder extends BaseConvBuilder<Builder> {
        ...
        public Convolution2DLayer build() {
            ConvolutionUtils.validateConvolutionModePadding(convolutionMode, padding);
            ConvolutionUtils.validateCnnKernelStridePadding(kernelSize, stride, padding);

            return new Convolution2DLayer(this);
        }
