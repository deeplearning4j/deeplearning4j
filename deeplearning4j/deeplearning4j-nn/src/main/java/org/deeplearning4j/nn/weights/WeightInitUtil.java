...
public class WeightInitUtil {
     ...
     * Note: Defaults to fortran ('f') order arrays for the weights. Use {@link #initWeights(double, double, int[], WeightInit, Distribution, char, INDArray)}
     * to control this
     *
    ...
    /**
     * Initializes a matrix with the given weight initialization scheme.
     * Note: Defaults to fortran ('f') order arrays for the weights. Use {@link #initWeights(double, double, long[], WeightInit, Distribution, char, INDArray)}
     * to control this
     *
     * @param shape      the shape of the matrix
     * @param initScheme the scheme to use
