 ...
 */
@Slf4j
public class Upsampling3DLayer extends AbstractLayer<org.deeplearning4j.nn.conf.layers.convolutional.upsampling.Upsampling3DLayer> {


    public Upsampling3DLayer(NeuralNetConfiguration conf) {
        super(conf);
    }

    public Upsampling3DLayer(NeuralNetConfiguration conf, INDArray input) {
        super(conf, input);
    }
