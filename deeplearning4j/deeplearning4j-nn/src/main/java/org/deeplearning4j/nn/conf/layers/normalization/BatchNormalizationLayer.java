...
package org.deeplearning4j.nn.conf.layers.normalization;
...
public class BatchNormalizationLayer extends FeedForwardLayer {
    ...
    private BatchNormalizationLayer(Builder builder) {
        super(builder);
    ...
    @Override
    public BatchNormalizationLayer clone() {
        BatchNormalizationLayer clone = (BatchNormalizationLayer) super.clone();
        return clone;
    }
    ...
    public Layer instantiate(NeuralNetConfiguration conf, Collection<TrainingListener> trainingListeners,
        ...
        LayerValidation.assertNOutSet("BatchNormalizationLayer", getLayerName(), layerIndex, getNOut());

        org.deeplearning4j.nn.layers.normalization.BatchNormalizationLayer ret =
                        new org.deeplearning4j.nn.layers.normalization.BatchNormalizationLayer(conf);
    ...
    public LayerMemoryReport getMemoryReport(InputType inputType) {
        ...
        return new LayerMemoryReport.Builder(layerName, BatchNormalizationLayer.class, inputType, outputType)
    ...
    public static class Builder extends FeedForwardLayer.Builder<Builder> {
         ...
         * (non-CuDNN) implementation for BatchNormalizationLayer will be used
         *
         */
        protected boolean cudnnAllowFallback = true;
        ...
        @Override
        public BatchNormalizationLayer build() {
            return new BatchNormalizationLayer(this);
        }
    }
