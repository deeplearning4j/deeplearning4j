...
/** Parametrized Rectified Linear Unit (PReLULayer)
 *
 ...
 * @author Max Pumperla
 */
public class PReLULayer extends BaseLayer<org.deeplearning4j.nn.conf.layers.feedforeward.PReLULayer> {

    long[] axes = layerConf().getSharedAxes();


    public PReLULayer(NeuralNetConfiguration conf) {
        super(conf);
    }

    public PReLULayer(NeuralNetConfiguration conf, INDArray input) {
        super(conf, input);
    }
