...
public class Upsampling3DLayer extends BaseUpsamplingLayer {

    protected int[] size;

    protected Upsampling3DLayer(UpsamplingBuilder builder) {
        super(builder);
        this.size = builder.getSize();
    }

    @Override
    public Upsampling3DLayer clone() {
        return (Upsampling3DLayer) super.clone();
    }
    ...
    public org.deeplearning4j.nn.api.Layer instantiate(NeuralNetConfiguration conf,
        ...
        org.deeplearning4j.nn.layers.convolution.upsampling.Upsampling3DLayer ret =
                        new org.deeplearning4j.nn.layers.convolution.upsampling.Upsampling3DLayer(conf);
    ...
    public LayerMemoryReport getMemoryReport(InputType inputType) {
        ...
        return new LayerMemoryReport.Builder(layerName, Upsampling3DLayer.class, inputType, outputType).standardMemory(0, 0) //No params
    ...
    public static class Builder extends UpsamplingBuilder<Builder> {
        ...
        public Upsampling3DLayer build() {
            return new Upsampling3DLayer(this);
        }

        @Override
        public void setSize(int[] size) {
            this.size = ValidationUtils.validate3(size, "size");
        }
    }
