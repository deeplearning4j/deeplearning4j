...
public class LocalResponseNormalizationLayer extends Layer {
    ...
    private LocalResponseNormalizationLayer(Builder builder) {
        super(builder);
        this.k = builder.k;
        this.n = builder.n;
    ...
    @Override
    public LocalResponseNormalizationLayer clone() {
        LocalResponseNormalizationLayer clone = (LocalResponseNormalizationLayer) super.clone();
        return clone;
    }
    ...
    public org.deeplearning4j.nn.api.Layer instantiate(NeuralNetConfiguration conf,
        ...
        org.deeplearning4j.nn.layers.normalization.LocalResponseNormalizationLayer ret =
                        new org.deeplearning4j.nn.layers.normalization.LocalResponseNormalizationLayer(conf);
    ...
    public static class Builder extends Layer.Builder<Builder> {
        ...
        @Override
        public LocalResponseNormalizationLayer build() {
            return new LocalResponseNormalizationLayer(this);
        }
    }
