...
public class Subsampling2DLayer extends NoParamLayer {
    ...
    @Override
    public Subsampling2DLayer clone() {
        Subsampling2DLayer clone = (Subsampling2DLayer) super.clone();
    ...
    public LayerMemoryReport getMemoryReport(InputType inputType) {
        ...
        return new LayerMemoryReport.Builder(layerName, Subsampling2DLayer.class, inputType, outputType)
    ...
    public static class Builder extends BaseSubsamplingBuilder<Builder> {
        ...
        public Subsampling2DLayer build() {
