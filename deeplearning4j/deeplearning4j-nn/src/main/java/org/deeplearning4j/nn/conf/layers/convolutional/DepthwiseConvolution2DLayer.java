...
public class DepthwiseConvolution2DLayer extends Convolution2DLayer {
    ...
    protected DepthwiseConvolution2DLayer(Builder builder) {
        super(builder);
    ...
    @Override
    public DepthwiseConvolution2DLayer clone() {
        DepthwiseConvolution2DLayer clone = (DepthwiseConvolution2DLayer) super.clone();
    ...
    public Layer instantiate(NeuralNetConfiguration conf, Collection<TrainingListener> trainingListeners,
        ...
        LayerValidation.assertNInNOutSet("DepthwiseConvolution2DLayer", getLayerName(), layerIndex, getNIn(), getNOut());

        org.deeplearning4j.nn.layers.convolution.DepthwiseConvolution2DLayer ret = new org.deeplearning4j.nn.layers.convolution.DepthwiseConvolution2DLayer(conf);
    ...
    public InputType getOutputType(int layerIndex, InputType inputType) {
        ...
        return InputTypeUtil.getOutputTypeCnnLayers(inputType, kernelSize, stride, padding, dilation, convolutionMode,
                        nOut, layerIndex, getLayerName(), org.deeplearning4j.nn.layers.convolution.DepthwiseConvolution2DLayer.class);
    }
    ...
    public static class Builder extends BaseConvBuilder<Builder> {
        ...
        public DepthwiseConvolution2DLayer build() {
