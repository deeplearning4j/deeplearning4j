...
public class Subsampling3DLayer extends NoParamLayer {
    ...
    protected Convolution3DLayer.DataFormat dataFormat = Convolution3DLayer.DataFormat.NCDHW; //Default for 1.0.0-beta3 and earlier (before config added)
    ...
    public InputType getOutputType(int layerIndex, InputType inputType) {
        ...
        return InputTypeUtil
                .getOutputTypeCnn3DLayers(inputType, kernelSize, stride, padding, new int[] {1, 1, 1}, // no dilation
    ...
    public boolean isPretrainParam(String paramName) {
        throw new UnsupportedOperationException("Subsampling2DLayer does not contain parameters");
    }
    ...
    public static class Builder extends BaseSubsamplingBuilder<Builder> {
         ...
         */
        protected Convolution3DLayer.DataFormat dataFormat = Convolution3DLayer.DataFormat.NCDHW;
         ...
         */
        public Builder dataFormat(Convolution3DLayer.DataFormat dataFormat) {
        ...
        public void setKernelSize(int[] kernelSize) {
            this.kernelSize = ValidationUtils.validate3(kernelSize, "kernelSize");
        }

        @Override
        public void setStride(int[] stride) {
            this.stride = ValidationUtils.validate3(stride, "stride");
        }

        @Override
        public void setPadding(int[] padding) {
            this.padding = ValidationUtils.validate3(padding, "padding");
        }

        public void setDilation(int[] dilation) {
            this.dilation = ValidationUtils.validate3(dilation, "dilation");
        }
    }
    ...
    protected static abstract class BaseSubsamplingBuilder<T extends BaseSubsamplingBuilder<T>>
         ...
         * (non-CuDNN) implementation for Convolution2DLayer will be used
         */
        protected boolean cudnnAllowFallback = true;
