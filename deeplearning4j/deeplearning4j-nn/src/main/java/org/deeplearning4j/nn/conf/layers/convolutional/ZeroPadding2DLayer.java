...
public class ZeroPadding2DLayer extends NoParamLayer {

    private int[] padding;

    public ZeroPadding2DLayer(int padTopBottom, int padLeftRight) {
        this(new Builder(padTopBottom, padLeftRight));
    }

    public ZeroPadding2DLayer(int padTop, int padBottom, int padLeft, int padRight) {
        this(new Builder(padTop, padBottom, padLeft, padRight));
    }

    private ZeroPadding2DLayer(Builder builder) {
        super(builder);
    ...
    public org.deeplearning4j.nn.api.Layer instantiate(NeuralNetConfiguration conf,
        ...
        org.deeplearning4j.nn.layers.convolution.ZeroPadding2DLayer ret =
                        new org.deeplearning4j.nn.layers.convolution.ZeroPadding2DLayer(conf);
    ...
    public InputPreProcessor getPreProcessorForInputType(InputType inputType) {
        Preconditions.checkArgument(inputType != null, "Invalid input for ZeroPadding2DLayer layer (layer name=\""
    ...
    public LayerMemoryReport getMemoryReport(InputType inputType) {
        ...
        return new LayerMemoryReport.Builder(layerName, ZeroPadding2DLayer.class, inputType, outputType)
    ...
    public static class Builder extends Layer.Builder<Builder> {
        ...
        public ZeroPadding2DLayer build() {
            for (int p : padding) {
                if (p < 0) {
