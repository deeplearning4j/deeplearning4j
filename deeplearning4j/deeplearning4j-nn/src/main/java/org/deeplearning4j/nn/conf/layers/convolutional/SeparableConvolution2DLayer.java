...
public class SeparableConvolution2DLayer extends Convolution2DLayer {
    ...
    /**
     * SeparableConvolution2DLayer layer nIn in the input layer is the number of channels nOut is the number of filters to be
     ...
     */
    protected SeparableConvolution2DLayer(Builder builder) {
        super(builder);
    ...
    @Override
    public SeparableConvolution2DLayer clone() {
        SeparableConvolution2DLayer clone = (SeparableConvolution2DLayer) super.clone();
    ...
    public Layer instantiate(NeuralNetConfiguration conf, Collection<TrainingListener> trainingListeners,
        ...
        LayerValidation.assertNInNOutSet("SeparableConvolution2DLayer", getLayerName(), layerIndex, getNIn(), getNOut());
    ...
    public InputType getOutputType(int layerIndex, InputType inputType) {
        ...
        return InputTypeUtil.getOutputTypeCnnLayers(inputType, kernelSize, stride, padding, dilation, convolutionMode,
                        nOut, layerIndex, getLayerName(), org.deeplearning4j.nn.layers.convolution.SeparableConvolution2DLayer.class);
    }
    ...
    public static class Builder extends BaseConvBuilder<Builder> {
        ...
        public SeparableConvolution2DLayer build() {
