...
public class LocallyConnected2DLayer extends SameDiffLayer {
    ...
    protected LocallyConnected2DLayer(Builder builder) {
        super(builder);
    ...
    private LocallyConnected2DLayer() {
    ...
    public InputType getOutputType(int layerIndex, InputType inputType) {
        ...
        return InputTypeUtil.getOutputTypeCnnLayers(inputType, kernel, stride, padding, new int[] {1, 1}, cm, nOut,
                        layerIndex, getLayerName(), LocallyConnected2DLayer.class);
    }
    ...
    public static class Builder extends SameDiffLayer.Builder<Builder> {
        ...
        public LocallyConnected2DLayer build() {
            ...
            return new LocallyConnected2DLayer(this);
        }
    }
}
