 ...
 */
@Slf4j
public class Upsampling1DLayer extends Upsampling2DLayer {


    public Upsampling1DLayer(NeuralNetConfiguration conf) {
        super(conf);
    }

    public Upsampling1DLayer(NeuralNetConfiguration conf, INDArray input) {
        super(conf, input);
    }
    ...
    protected int[] getSize(){
        return ((org.deeplearning4j.nn.conf.layers.convolutional.upsampling.Upsampling1DLayer)conf.getLayer()).getSize();
    }
    ...
    public INDArray activate(boolean training, LayerWorkspaceMgr workspaceMgr) {
        ...
        // call 2D Subsampling2DLayer's activate method
