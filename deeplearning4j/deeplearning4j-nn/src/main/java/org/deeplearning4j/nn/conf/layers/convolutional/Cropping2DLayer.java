...
public class Cropping2DLayer extends NoParamLayer {
     ...
     */
    public Cropping2DLayer(int cropTopBottom, int cropLeftRight) {
     ...
     */
    public Cropping2DLayer(int cropTop, int cropBottom, int cropLeft, int cropRight) {
     ...
     */
    public Cropping2DLayer(int[] cropping) {
        this(new Builder(cropping));
    }

    protected Cropping2DLayer(Builder builder) {
        super(builder);
    ...
    public org.deeplearning4j.nn.api.Layer instantiate(NeuralNetConfiguration conf,
        ...
        org.deeplearning4j.nn.layers.convolution.Cropping2DLayer ret = new org.deeplearning4j.nn.layers.convolution.Cropping2DLayer(conf);
    ...
    public InputPreProcessor getPreProcessorForInputType(InputType inputType) {
        Preconditions.checkArgument(inputType != null, "Invalid input for Cropping2DLayer layer (layer name=\""
    ...
    public static class Builder extends Layer.Builder<Builder> {
        ...
        public Cropping2DLayer build() {
            return new Cropping2DLayer(this);
        }

        public void setCropping(int[] cropping) {
            int[] crop = ValidationUtils.validate4(cropping, "cropping");
            ...
            Preconditions.checkArgument(crop[0] >= 0 && crop[1] >= 0 && crop[2] >= 0 && crop[3] >= 0,
