...
/**
 * LSTMLayer layer implementation.
 ...
 * Greff et al. 2015, "LSTMLayer: A Search Space Odyssey", pg11. This is the "vanilla" variant in said paper
 * <a href="http://arxiv.org/pdf/1503.04069.pdf">http://arxiv.org/pdf/1503.04069.pdf</a>
 *
 * @author Alex Black
 * @see LSTMLayer LSTMLayer class, for the version without peephole connections
 * @deprecated Will be eventually removed. Use {@link LSTMLayer} instead, which has similar prediction accuracy, but supports
 * CuDNN for faster network training on CUDA (Nvidia) GPUs
 */
@Deprecated
@Slf4j
public class GravesLSTMLayer extends BaseRecurrentLayer<org.deeplearning4j.nn.conf.layers.recurrent.GravesLSTMLayer> {
    public static final String STATE_KEY_PREV_ACTIVATION = "prevAct";
    public static final String STATE_KEY_PREV_MEMCELL = "prevMem";

    protected FwdPassReturn cachedFwdPass;

    public GravesLSTMLayer(NeuralNetConfiguration conf) {
        super(conf);
    }

    public GravesLSTMLayer(NeuralNetConfiguration conf, INDArray input) {
        super(conf, input);
    }
...
//            cacheMode = CacheMode.NONE;
        ...
        //TODO LSTMLayer cache mode is disabled for now - not passing all tests
        cacheMode = CacheMode.NONE;
    ...
    public Pair<INDArray, MaskState> feedForwardMaskArray(INDArray maskArray, MaskState currentMaskState,
                    int minibatchSize) {
        //LSTMLayer (standard, not bi-directional) don't make any changes to the data OR the mask arrays
