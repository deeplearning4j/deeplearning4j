...
/**
 * RepeatVectorLayer layer configuration.
 *
 * RepeatVectorLayer takes a mini-batch of vectors of shape (mb, length) and a repeat factor n and outputs a 3D tensor of
...
public class RepeatVectorLayer extends FeedForwardLayer {

    private int n = 1;

    protected RepeatVectorLayer(Builder builder) {
        super(builder);
        this.n = builder.n;
    }

    @Override
    public RepeatVectorLayer clone() {
        return (RepeatVectorLayer) super.clone();
    }
    ...
    public InputType getOutputType(int layerIndex, InputType inputType) {
        if (inputType == null || inputType.getType() != InputType.Type.FF) {
            throw new IllegalStateException("Invalid input for RepeatVectorLayer layer (layer name=\"" + getLayerName()
    ...
    public LayerMemoryReport getMemoryReport(InputType inputType) {
        ...
        return new LayerMemoryReport.Builder(layerName, RepeatVectorLayer.class, inputType, outputType).standardMemory(0, 0)
    ...
    public static class Builder<T extends Builder<T>> extends FeedForwardLayer.Builder<T> {
        ...
        /**
         * Set repetition factor for RepeatVectorLayer layer
         */
        ...
        public RepeatVectorLayer build() {
            return new RepeatVectorLayer(this);
        }
    }
}
