 ...
 */
@Slf4j
public class SpaceToBatchLayer extends AbstractLayer<org.deeplearning4j.nn.conf.layers.convolutional.SpaceToBatchLayer> {

    public SpaceToBatchLayer(NeuralNetConfiguration conf) {
        super(conf);
    }

    public SpaceToBatchLayer(NeuralNetConfiguration conf, INDArray input) {
        super(conf, input);
    }
