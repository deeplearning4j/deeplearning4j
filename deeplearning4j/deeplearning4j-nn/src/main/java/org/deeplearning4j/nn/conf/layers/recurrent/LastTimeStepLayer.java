...
/**
 * LastTimeStepLayer is a "wrapper" layer: it wraps any RNN (or CNN1D) layer, and extracts out the last time step during forward pass,
...
public class LastTimeStepLayer extends BaseWrapperLayer {
    ...
    private LastTimeStepLayer() {}

    public LastTimeStepLayer(Layer underlying) {
        super(underlying);
    ...
    public org.deeplearning4j.nn.api.Layer instantiate(NeuralNetConfiguration conf,
        ...
        conf2.setLayer(((LastTimeStepLayer) conf2.getLayer()).getUnderlying());
        return new org.deeplearning4j.nn.layers.recurrent.LastTimeStepLayer(underlying.instantiate(conf2, trainingListeners, layerIndex, layerParamsView,
                        initializeParams));
    }
