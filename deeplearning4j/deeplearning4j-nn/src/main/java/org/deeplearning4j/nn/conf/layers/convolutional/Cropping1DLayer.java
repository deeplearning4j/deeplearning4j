...
public class Cropping1DLayer extends NoParamLayer {
     ...
     */
    public Cropping1DLayer(int cropTopBottom) {
     ...
     */
    public Cropping1DLayer(int cropTop, int cropBottom) {
     ...
     */
    public Cropping1DLayer(int[] cropping) {
        this(new Builder(cropping));
    }

    protected Cropping1DLayer(Builder builder) {
        super(builder);
    ...
    public org.deeplearning4j.nn.api.Layer instantiate(NeuralNetConfiguration conf,
        ...
        org.deeplearning4j.nn.layers.convolution.Cropping1DLayer ret = new org.deeplearning4j.nn.layers.convolution.Cropping1DLayer(conf);
    ...
    public InputPreProcessor getPreProcessorForInputType(InputType inputType) {
        Preconditions.checkArgument(inputType != null, "Invalid input for Cropping1DLayer layer (layer name=\""
    ...
    public static class Builder extends Layer.Builder<Builder> {
        ...
        public Cropping1DLayer build() {
            return new Cropping1DLayer(this);
        }

        public void setCropping(int[] cropping) {
            int[] crop = ValidationUtils.validate2(cropping, "cropping");
