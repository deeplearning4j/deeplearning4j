...
public class Cropping3DLayer extends NoParamLayer {
     ...
     */
    public Cropping3DLayer(int cropDepth, int cropHeight, int cropWidth) {
     ...
     */
    public Cropping3DLayer(int cropLeftD, int cropRightD, int cropLeftH, int cropRightH, int cropLeftW, int cropRightW) {
     ...
     */
    public Cropping3DLayer(int[] cropping) {
        this(new Builder(cropping));
    }

    protected Cropping3DLayer(Builder builder) {
        super(builder);
    ...
    public org.deeplearning4j.nn.api.Layer instantiate(NeuralNetConfiguration conf,
        ...
        org.deeplearning4j.nn.layers.convolution.Cropping3DLayer ret = new org.deeplearning4j.nn.layers.convolution.Cropping3DLayer(conf);
    ...
    public InputPreProcessor getPreProcessorForInputType(InputType inputType) {
        Preconditions.checkArgument(inputType != null, "Invalid input for Cropping3DLayer " + "layer (layer name=\""
    ...
    public static class Builder extends Layer.Builder<Builder> {
        ...
        public Cropping3DLayer build() {
            return new Cropping3DLayer(this);
        }

        public void setCropping(int[] cropping) {
            int[] crop = ValidationUtils.validate6(cropping, "cropping");
            ...
            Preconditions.checkArgument(crop[0] >= 0 && crop[1] >= 0
                            && crop[2] >= 0 && crop[3] >= 0
                            && crop[4] >= 0 && crop[5] >= 0,
                    "Invalid arguments: crop dimensions must be >= 0. Got [ld, rd, lh, rh, lw, rw] = "
