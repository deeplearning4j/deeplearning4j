...
public class Convolution3DLayer extends Convolution2DLayer {
     ...
     */
    public Convolution3DLayer(Builder builder) {
        super(builder);
    ...
    @Override
    public Convolution3DLayer clone() {
        Convolution3DLayer clone = (Convolution3DLayer) super.clone();
    ...
    public Layer instantiate(NeuralNetConfiguration conf, Collection<TrainingListener> iterationListeners,
        ...
        LayerValidation.assertNInNOutSet("Convolution3DLayer", getLayerName(), layerIndex, getNIn(), getNOut());

        org.deeplearning4j.nn.layers.convolution.Convolution3DLayer ret = new org.deeplearning4j.nn.layers.convolution.Convolution3DLayer(conf);
    ...
    public InputType getOutputType(int layerIndex, InputType inputType) {
        if (inputType == null || inputType.getType() != InputType.Type.CNN3D) {
            throw new IllegalStateException("Invalid input for Convolution3DLayer layer (layer name=\"" + getLayerName()
        ...
        return InputTypeUtil.getOutputTypeCnn3DLayers(inputType, kernelSize, stride, padding, dilation, convolutionMode,
                        nOut, layerIndex, getLayerName(), org.deeplearning4j.nn.layers.convolution.Convolution3DLayer.class);
    }
