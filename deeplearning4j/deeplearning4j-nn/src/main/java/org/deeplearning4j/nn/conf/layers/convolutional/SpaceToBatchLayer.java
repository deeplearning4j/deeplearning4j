...
public class SpaceToBatchLayer extends NoParamLayer {
    ...
    public org.deeplearning4j.nn.api.Layer instantiate(NeuralNetConfiguration conf,
        ...
        org.deeplearning4j.nn.layers.convolution.SpaceToBatchLayer ret =
                        new org.deeplearning4j.nn.layers.convolution.SpaceToBatchLayer(conf);
    ...
    public static class Builder<T extends Builder<T>> extends Layer.Builder<T> {
        ...
        /**
         * Block size for SpaceToBatchLayer layer. Should be a length 2 array for the height and width
         * dimensions
         */
        protected int[] blocks;
