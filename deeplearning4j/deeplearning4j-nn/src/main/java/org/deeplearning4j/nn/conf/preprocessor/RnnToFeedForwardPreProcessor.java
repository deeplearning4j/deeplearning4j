 ...
 * For example, GravesLSTMLayer -> OutputLayer or GravesLSTMLayer -> DenseLayer<br>
 ...
 *
 * @author Alex Black
 * @see FeedForwardToRnnPreProcessor for opposite case (i.e., DenseLayer -> GravesLSTMLayer etc)
 */
@Data
@Slf4j
