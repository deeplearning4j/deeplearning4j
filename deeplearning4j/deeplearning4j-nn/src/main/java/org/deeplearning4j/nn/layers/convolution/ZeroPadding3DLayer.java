...
public class ZeroPadding3DLayer extends AbstractLayer<org.deeplearning4j.nn.conf.layers.ZeroPadding3DLayer> {
    ...
    public INDArray activate(boolean training, LayerWorkspaceMgr workspaceMgr) {
        ...
        var inShape = input.shape();
        var outD = inShape[2] + padding[0] + padding[1];
        var outH = inShape[3] + padding[2] + padding[3];
        var outW = inShape[4] + padding[4] + padding[5];
        var outShape = new long[] {inShape[0], inShape[1], outD, outH, outW};
