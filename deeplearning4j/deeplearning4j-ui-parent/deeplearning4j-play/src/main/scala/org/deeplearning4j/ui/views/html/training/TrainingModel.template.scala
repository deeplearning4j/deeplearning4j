...
<html lang="en">
    ...
    <body>
        ...
        <!-- Start JavaScript-->
        <script src="/assets/resources/webjars/requirejs/2.3.6/require.min.js"></script>
       ...
       <script>
               $(document).ready(function () """),format.raw/*293.46*/("""{"""),format.raw/*293.47*/("""
                   """),format.raw/*294.20*/("""renderModelGraph();
                   renderModelPage(true);
               """),format.raw/*296.16*/("""}"""),format.raw/*296.17*/(""");
       </script>

               <!-- Execute periodically (every 2 sec) -->
        <script>
                setInterval(function () """),format.raw/*301.41*/("""{"""),format.raw/*301.42*/("""
                    """),format.raw/*302.21*/("""renderModelPage(false);
                """),format.raw/*303.17*/("""}"""),format.raw/*303.18*/(""", 2000);
        </script>
    </body>
</html>
"""))
...
object TrainingModel extends TrainingModel_Scope0.TrainingModel
              /*
                  -- GENERATED --
                  DATE: Tue Jan 22 15:58:38 AEDT 2019
