...
<html lang="en">
    ...
    <body>
        ...
        """),format.raw/*263.39*/("""
        """),format.raw/*264.9*/("""<script src="/assets/js/jquery.cleditor.min.js"></script>
        ...
        <script>
                $(document).ready(function () """),format.raw/*273.47*/("""{"""),format.raw/*273.48*/("""
                    """),format.raw/*274.21*/("""renderOverviewPage(true);
                """),format.raw/*275.17*/("""}"""),format.raw/*275.18*/(""");
        </script>

            <!-- Execute periodically (every 2 sec) -->
        <script>
                setInterval(function () """),format.raw/*280.41*/("""{"""),format.raw/*280.42*/("""
                    """),format.raw/*281.21*/("""renderOverviewPage(false);
                """),format.raw/*282.17*/("""}"""),format.raw/*282.18*/(""", 2000);
        </script>
            <!-- End JavaScript-->
