...
<html lang="en">
    ...
    <body>
        ...
        <script>
                $(document).ready(function () """),format.raw/*292.47*/("""{"""),format.raw/*292.48*/("""
                    """),format.raw/*293.21*/("""renderSystemPage(true);
                    renderTabs();
                    selectMachine();
        ...
        <script>
                setInterval(function () """),format.raw/*304.41*/("""{"""),format.raw/*304.42*/("""
                    """),format.raw/*305.21*/("""renderSystemPage(false);
                """),format.raw/*306.17*/("""}"""),format.raw/*306.18*/(""", 2000);
        </script>
            <!--End JavaScript-->
