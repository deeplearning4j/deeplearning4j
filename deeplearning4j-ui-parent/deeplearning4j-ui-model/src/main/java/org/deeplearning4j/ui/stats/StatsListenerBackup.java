 ...
 */
@Slf4j
public class StatsListenerBackup implements RoutingIterationListener {
     ...
     */
    public StatsListenerBackup(StatsStorageRouter router) {
     ...
     */
    public StatsListenerBackup(StatsStorageRouter router, int listenerFrequency) {
        this(router, null, new DefaultStatsUpdateConfiguration.Builder().reportingFrequency(listenerFrequency).build(), null, null);
    }

    public StatsListenerBackup(StatsStorageRouter router, StatsInitializationConfiguration initConfig, StatsUpdateConfiguration updateConfig,
