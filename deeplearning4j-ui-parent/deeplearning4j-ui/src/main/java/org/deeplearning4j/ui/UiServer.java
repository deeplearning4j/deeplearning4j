...
import org.nd4j.shade.dwjackson.databind.DeserializationFeature;
import org.nd4j.shade.dwjackson.databind.SerializationFeature;
import org.nd4j.shade.dwjackson.databind.module.SimpleModule;
import org.nd4j.shade.dropwizard.Application;
import org.nd4j.shade.dropwizard.assets.AssetsBundle;
import org.nd4j.shade.dropwizard.jersey.jackson.JsonProcessingExceptionMapper;
import org.nd4j.shade.dropwizard.jetty.HttpConnectorFactory;
import org.nd4j.shade.dropwizard.lifecycle.ServerLifecycleListener;
import org.nd4j.shade.dropwizard.server.DefaultServerFactory;
...
import org.nd4j.shade.eclipse.jetty.server.Connector;
import org.nd4j.shade.eclipse.jetty.server.Server;
import org.nd4j.shade.eclipse.jetty.server.ServerConnector;
import org.nd4j.shade.eclipse.jetty.servlets.CrossOriginFilter;
