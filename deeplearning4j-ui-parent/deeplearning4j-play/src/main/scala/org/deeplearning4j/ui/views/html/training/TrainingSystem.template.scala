...
<html lang="en">
    ...
    <body>
        ...
        <script>
                setInterval(function () """),format.raw/*286.41*/("""{"""),format.raw/*286.42*/("""
                    """),format.raw/*287.21*/("""renderSystemPage(false);
                """),format.raw/*288.17*/("""}"""),format.raw/*288.18*/(""", 2000);
        </script>
            <!--End JavaScript-->
...
object TrainingSystem extends TrainingSystem_Scope0.TrainingSystem
              /*
                  -- GENERATED --
                  DATE: Mon Nov 07 11:00:08 AEDT 2016
