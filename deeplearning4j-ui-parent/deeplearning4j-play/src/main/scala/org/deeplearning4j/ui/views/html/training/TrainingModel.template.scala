...
<html lang="en">
    ...
    <body>
        ...
        <script>
				setInterval(function () """),format.raw/*222.29*/("""{"""),format.raw/*222.30*/("""
                    """),format.raw/*223.21*/("""renderModelPage();
                """),format.raw/*224.17*/("""}"""),format.raw/*224.18*/(""", 2000);
		</script>
    </body>
</html>
"""))
...
object TrainingModel extends TrainingModel_Scope0.TrainingModel
              /*
                  -- GENERATED --
                  DATE: Thu Nov 03 22:38:43 AEDT 2016
