    ...
    <body>
                            ...
                            <div class="box-header">
                                ...
                                <div style="float: right">
                                    <p class="stackControls center">
                                        <input class="btn btn-small" type="button" value=""""),_display_(/*192.92*/i18n/*192.96*/.getMessage("train.overview.chart.stdevBtn.activations")),format.raw/*192.152*/("""" onclick="selectStdevChart('stdevActivations')">
                                        <input class="btn btn-small" type="button" value=""""),_display_(/*193.92*/i18n/*193.96*/.getMessage("train.overview.chart.stdevBtn.gradients")),format.raw/*193.150*/("""" onclick="selectStdevChart('stdevGradients')">
                                        <input class="btn btn-small" type="button" value=""""),_display_(/*194.92*/i18n/*194.96*/.getMessage("train.overview.chart.stdevBtn.updates")),format.raw/*194.148*/("""" onclick="selectStdevChart('stdevUpdates')">
                                    </p>
                                </div>
                            </div>
                            <div class="box-content">
        ...
        <script>
                $(document).ready(function () """),format.raw/*249.47*/("""{"""),format.raw/*249.48*/("""
                    """),format.raw/*250.21*/("""renderOverviewPage();
        ...
        <script>
                setInterval(function () """),format.raw/*256.41*/("""{"""),format.raw/*256.42*/("""
                    """),format.raw/*257.21*/("""renderOverviewPage();
