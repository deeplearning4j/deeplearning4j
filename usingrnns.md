...
(a) that the time series may be of different lengths
(b) to align the input and labels - for each example individually - such that their last values occur at the same time step.
