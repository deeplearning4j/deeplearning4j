...
import org.nd4j.etl4j.audio.musicg.extension.NormalizedSampleAmplitudes;
import org.nd4j.etl4j.audio.musicg.extension.Spectrogram;
import org.nd4j.etl4j.audio.musicg.fingerprint.FingerprintManager;
import org.nd4j.etl4j.audio.musicg.fingerprint.FingerprintSimilarity;
import org.nd4j.etl4j.audio.musicg.fingerprint.FingerprintSimilarityComputer;
...
public class Wave implements Serializable{
	...
	public void trim(int leftTrimNumberOfSample, int rightTrimNumberOfSample) {
		...
		if (chunkSize>=0 && subChunk2Size>=0){
			...
			System.arraycopy(data, leftTrimNumberOfSample, trimmedData, 0,
					(int) subChunk2Size);
			data = trimmedData;
		}
		else{
