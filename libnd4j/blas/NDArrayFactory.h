...
namespace nd4j {
    ...
    public:
        ...
        static NDArray empty(nd4j::DataType dataType, nd4j::graph::LaunchContext* context = graph::LaunchContext::defaultContext());
        ...
        static ResultSet createSetOfArrs(const Nd4jLong numOfArrs, const void* buffer, const Nd4jLong* shapeInfo, const Nd4jLong* offsets, nd4j::graph::LaunchContext* context = graph::LaunchContext::defaultContext());
