    ...
    void NDArray::assign(const NDArray& other) {
        ...
        if (other.isScalar()) {
            if(this->isScalar()) {
                ...
                NativeOpExecutioner::execScalar(nullptr, scalar::CopyPws, _buffer, _shapeInfo, _buffer, _shapeInfo, other._buffer, other._shapeInfo, nullptr);
            }
            return;
        }
        ...
        if (ordering() == other.ordering() && _dataType == other._dataType && ews() == 1 && other.ews() == 1)
            ...
            NativeOpExecutioner::execTransformSame(nullptr, transform::Copy, other._buffer, other._shapeInfo, _buffer, _shapeInfo, nullptr, nullptr, nullptr);
        else
            NativeOpExecutioner::execPairwiseTransform(nullptr, pairwise::CopyPws, _buffer, _shapeInfo, other._buffer, other._shapeInfo, _buffer, _shapeInfo, nullptr);
...
// This method assigns given value to all elements in this NDArray
    void NDArray::assign(const double value) {
        ...
        NativeOpExecutioner::execScalar(nullptr, nd4j::scalar::CopyPws, _buffer, _shapeInfo, _buffer, _shapeInfo, temp.buffer(), temp.shapeInfo(), nullptr);
    }
...
// This method returns new copy of this NDArray, optionally in different order
    ...
    NDArray NDArray::varianceNumber(nd4j::variance::Ops op, bool biasCorrected) {
        ...
        NativeOpExecutioner::execSummaryStatsScalar(nullptr, op,this->getBuffer(), this->getShapeInfo(), nullptr, res.buffer(), res.shapeInfo(), biasCorrected);
        return res;
    }
...
// This method returns sum of all elements of this NDArray
    NDArray NDArray::sumNumber() const {
        ...
        NativeOpExecutioner::execReduceSameScalar(nullptr, nd4j::reduce::SameOps::Sum, _buffer, _shapeInfo, nullptr, res.buffer(), res.shapeInfo());
        return res;
    }
...
// This method returns mean number of this NDArray
    NDArray NDArray::meanNumber() const {
        ...
        NDArray res(DataTypeUtils::pickFloatingType(dataType()), _workspace);
        NativeOpExecutioner::execReduceFloatScalar(nullptr, nd4j::reduce::FloatOps::Mean, _buffer, _shapeInfo, nullptr, res.buffer(), res.shapeInfo());
        return res;
    }
...
void NDArray::reduceAlongDimension(nd4j::reduce::FloatOps op, NDArray* target, const std::vector<int>& dimensions, const bool keepDims, const bool supportOldShapes, const bool checkTargetShape) const {
    ...
    if(rankOf() == copy.size() || copy.empty())
        ...
        NativeOpExecutioner::execReduceFloatScalar(nullptr, op, this->getBuffer(), this->getShapeInfo(), nullptr, target->buffer(), target->shapeInfo());
    else {
        shape::TAD tad(_shapeInfo, copy.data(), copy.size());
        tad.createTadOnlyShapeInfo();
        tad.createOffsets();

        NativeOpExecutioner::execReduceFloat(nullptr, op, this->getBuffer(), this->getShapeInfo(), nullptr, target->getBuffer(), target->getShapeInfo(), copy.data(), copy.size(), tad.tadOnlyShapeInfo, tad.tadOffsets);
    }
}
...
void NDArray::reduceAlongDimension(nd4j::reduce::SameOps op, NDArray* target, const std::vector<int>& dimensions, const bool keepDims, const bool supportOldShapes, const bool checkTargetShape) const {
    ...
    if(rankOf() == copy.size() || copy.empty())
        //target->_buffer[0] = functions::reduce::ReduceFloatFunction<T>::template execScalar<OpName>(_buffer, _shapeInfo, extras);
        NativeOpExecutioner::execReduceSameScalar(nullptr, op, this->getBuffer(), this->getShapeInfo(), nullptr, target->buffer(), target->shapeInfo());
    else {
        shape::TAD tad(_shapeInfo, copy.data(), copy.size());
        tad.createTadOnlyShapeInfo();
        tad.createOffsets();

        NativeOpExecutioner::execReduceSame(nullptr, op, this->getBuffer(), this->getShapeInfo(), nullptr, target->getBuffer(), target->getShapeInfo(), copy.data(), copy.size(), tad.tadOnlyShapeInfo, tad.tadOffsets);
    }
}
...
void NDArray::reduceAlongDimension(nd4j::reduce::BoolOps op, NDArray* target, const std::vector<int>& dimensions, const bool keepDims, const bool supportOldShapes, const bool checkTargetShape) const {
    ...
    if(rankOf() == copy.size() || copy.empty())
        //target->_buffer[0] = functions::reduce::ReduceFloatFunction<T>::template execScalar<OpName>(_buffer, _shapeInfo, extras);
        NativeOpExecutioner::execReduceBoolScalar(nullptr, op, this->getBuffer(), this->getShapeInfo(), nullptr, target->buffer(), target->shapeInfo());
    else {
        shape::TAD tad(_shapeInfo, copy.data(), copy.size());
        tad.createTadOnlyShapeInfo();
        tad.createOffsets();

        NativeOpExecutioner::execReduceBool(nullptr, op, this->getBuffer(), this->getShapeInfo(), nullptr, target->getBuffer(), target->getShapeInfo(), copy.data(), copy.size(), tad.tadOnlyShapeInfo, tad.tadOffsets);
    }
}
...
void NDArray::reduceAlongDimension(nd4j::reduce::LongOps op, NDArray* target, const std::vector<int>& dimensions, const bool keepDims, const bool supportOldShapes, const bool checkTargetShape) const {
    ...
    if(rankOf() == copy.size() || copy.empty())
        //target->_buffer[0] = functions::reduce::ReduceFloatFunction<T>::template execScalar<OpName>(_buffer, _shapeInfo, extras);
        NativeOpExecutioner::execReduceLongScalar(nullptr, op, this->getBuffer(), this->getShapeInfo(), nullptr, target->buffer(), target->shapeInfo());
    else {
        shape::TAD tad(_shapeInfo, copy.data(), copy.size());
        tad.createTadOnlyShapeInfo();
        tad.createOffsets();

        NativeOpExecutioner::execReduceLong(nullptr, op, this->getBuffer(), this->getShapeInfo(), nullptr, target->getBuffer(), target->getShapeInfo(), copy.data(), copy.size(), tad.tadOnlyShapeInfo, tad.tadOffsets);
    }
}
...
//////////////////////////////////////////////////////////////////////////
    NDArray NDArray::reduceNumber(nd4j::reduce::FloatOps op, void *extraParams) const {
        ...
        NativeOpExecutioner::execReduceFloatScalar(nullptr, op, _buffer, _shapeInfo, extraParams, result.buffer(), result.shapeInfo());
        return result;
    }
    ...
    NDArray NDArray::reduceNumber(nd4j::reduce::SameOps op, void *extraParams) const {
        ...
        NativeOpExecutioner::execReduceSameScalar(nullptr, op, _buffer, _shapeInfo, extraParams, result.buffer(), result.shapeInfo());
        return result;
    }
    ...
    NDArray NDArray::reduceNumber(nd4j::reduce::BoolOps op, void *extraParams) const {
        ...
        NativeOpExecutioner::execReduceBoolScalar(nullptr, op, _buffer, _shapeInfo, extraParams, result.buffer(), result.shapeInfo());
        return result;
    }
    ...
    NDArray NDArray::reduceNumber(nd4j::reduce::LongOps op, void *extraParams) const {
        ...
        NativeOpExecutioner::execReduceLongScalar(nullptr, op, _buffer, _shapeInfo, extraParams, result.buffer(), result.shapeInfo());
        return result;
    }
...
//////////////////////////////////////////////////////////////////////////
    void NDArray::reduceNumber(nd4j::reduce::FloatOps op, NDArray& target, void *extraParams) const {
        ...
        NativeOpExecutioner::execReduceFloatScalar(nullptr, op, _buffer, _shapeInfo, extraParams, target._buffer, target._shapeInfo);
    }
    ...
    void NDArray::reduceNumber(nd4j::reduce::SameOps op, NDArray& target, void *extraParams) const {
        ...
        NativeOpExecutioner::execReduceSameScalar(nullptr, op, _buffer, _shapeInfo, extraParams, target._buffer, target._shapeInfo);
    }
    ...
    void NDArray::reduceNumber(nd4j::reduce::BoolOps op, NDArray& target, void *extraParams) const {
        ...
        NativeOpExecutioner::execReduceBoolScalar(nullptr, op, _buffer, _shapeInfo, extraParams, target._buffer, target._shapeInfo);
    }
    ...
    void NDArray::reduceNumber(nd4j::reduce::LongOps op, NDArray& target, void *extraParams) const {
        ...
        NativeOpExecutioner::execReduceLongScalar(nullptr, op, _buffer, _shapeInfo, extraParams, target._buffer, target._shapeInfo);
    }
...
//////////////////////////////////////////////////////////////////////////
    NDArray NDArray::indexReduceNumber(nd4j::indexreduce::Ops op, void *extraParams) {
        ...
        NativeOpExecutioner::execIndexReduceScalar(nullptr, op, _buffer, _shapeInfo, extraParams, res.buffer(), res.shapeInfo());
        return res;
    }
...
// perform array transformation
    void NDArray::applyTransform(nd4j::transform::FloatOps op, NDArray *target, void *extraParams) {
        ...
        NativeOpExecutioner::execTransformFloat(nullptr, op, _buffer, _shapeInfo, target->_buffer, target->_shapeInfo, extraParams, nullptr, nullptr);
    }
    ...
    void NDArray::applyTransform(nd4j::transform::SameOps op, NDArray *target, void *extraParams) {
        ...
        NativeOpExecutioner::execTransformSame(nullptr, op, this->_buffer, this->_shapeInfo, target->_buffer, target->_shapeInfo, extraParams, nullptr, nullptr);
    }
    ...
    void NDArray::applyTransform(nd4j::transform::BoolOps op, NDArray *target, void *extraParams) {
        ...
        NativeOpExecutioner::execTransformBool(nullptr, op, this->_buffer, this->_shapeInfo, target->_buffer, target->_shapeInfo, extraParams, nullptr, nullptr);
    }
    ...
    void NDArray::applyTransform(nd4j::transform::StrictOps op, NDArray *target, void *extraParams) {
        ...
        NativeOpExecutioner::execTransformStrict(nullptr, op, this->_buffer, this->_shapeInfo, target->_buffer, target->_shapeInfo, extraParams, nullptr, nullptr);
    }
...
// perform array transformation
    ...
    NDArray NDArray::transform(nd4j::transform::FloatOps op, void *extraParams) const {
        ...
        NativeOpExecutioner::execTransformFloat(nullptr, op, this->_buffer, this->_shapeInfo, result._buffer, result._shapeInfo, extraParams, nullptr, nullptr);
        return result;
    }
    ...
    NDArray NDArray::transform(nd4j::transform::SameOps op, void *extraParams) const {
        ...
        NativeOpExecutioner::execTransformSame(nullptr, op, this->_buffer, this->_shapeInfo, result._buffer, result._shapeInfo, extraParams, nullptr, nullptr);
        return result;
    }
    ...
    NDArray NDArray::transform(nd4j::transform::StrictOps op, void *extraParams) const {
        ...
        NDArray result(this->_shapeInfo, false, this->_workspace);
        NativeOpExecutioner::execTransformStrict(nullptr, op, this->_buffer, this->_shapeInfo, result._buffer, result._shapeInfo, extraParams, nullptr, nullptr);
        return result;
    }
    ...
    NDArray NDArray::transform(nd4j::transform::BoolOps op, void *extraParams) const {
        ...
        NativeOpExecutioner::execTransformBool(nullptr, op, this->_buffer, this->_shapeInfo, result._buffer, result._shapeInfo, extraParams, nullptr, nullptr);
        return result;
    }
...
void NDArray::applyPairwiseTransform(nd4j::pairwise::Ops op, const NDArray* other, NDArray *target, void *extraParams) const{
    ...
    NativeOpExecutioner::execPairwiseTransform(nullptr, op, this->_buffer, this->_shapeInfo, other->_buffer, other->_shapeInfo, target->_buffer, target->_shapeInfo, extraParams);
}
...
void NDArray::applyPairwiseTransform(nd4j::pairwise::BoolOps op, const NDArray *other, NDArray *target, void *extraParams) const{
    ...
    NativeOpExecutioner::execPairwiseBoolTransform(nullptr, op, this->_buffer, this->_shapeInfo, other->_buffer, other->_shapeInfo, target->_buffer, target->_shapeInfo, extraParams);
}
...
// This method applies in-place transpose to this array, so this array becomes transposed 
    ...
    bool NDArray::equalsTo(const NDArray *other, double eps) const {
        ...
        NativeOpExecutioner::execReduce3Scalar(nullptr, reduce3::EqualsWithEps, _buffer, _shapeInfo, ptr, other->_buffer, other->_shapeInfo, tmp.buffer(), tmp.shapeInfo());
...
//////////////////////////////////////////////////////////////////////////
    void NDArray::addRowVector(const NDArray *row, NDArray *target) const {
        ...
        NativeOpExecutioner::execBroadcast(nullptr, nd4j::broadcast::Ops::Add, _buffer, _shapeInfo, row->_buffer, row->_shapeInfo, target->getBuffer(), target->getShapeInfo(), dimension, 1, tad->tadOnlyShapeInfo, tad->tadOffsets, tad->tadOnlyShapeInfo, tad->tadOffsets);
}
...
//////////////////////////////////////////////////////////////////////////
    void NDArray::subRowVector(const NDArray *row, NDArray * target) const {
        ...
        NativeOpExecutioner::execBroadcast(nullptr, nd4j::broadcast::Ops::Subtract, _buffer, _shapeInfo, row->_buffer, row->_shapeInfo, target->getBuffer(), target->getShapeInfo(), dimension, 1, tad->tadOnlyShapeInfo, tad->tadOffsets, tad->tadOnlyShapeInfo, tad->tadOffsets);
}
...
//////////////////////////////////////////////////////////////////////////
    void NDArray::mulRowVector(const NDArray *row, NDArray *target) const {
        ...
        NativeOpExecutioner::execBroadcast(nullptr, nd4j::broadcast::Ops::Multiply, _buffer, _shapeInfo, row->_buffer, row->_shapeInfo, target->getBuffer(), target->getShapeInfo(), dimension, 1, tad->tadOnlyShapeInfo, tad->tadOffsets, tad->tadOnlyShapeInfo, tad->tadOffsets);
    }
...
//////////////////////////////////////////////////////////////////////////
    void NDArray::divRowVector(const NDArray *row, NDArray *target) const {
        ...
        NativeOpExecutioner::execBroadcast(nullptr, nd4j::broadcast::Divide, _buffer, _shapeInfo, row->_buffer, row->_shapeInfo, target->getBuffer(), target->getShapeInfo(),
...
// This method adds given row to all rows in this NDArray, this array becomes affected
    ...
    if (rankOf() != 2 || !row->isRowVector() || columns() != row->lengthOf())
        ...
        NativeOpExecutioner::execBroadcast(nullptr, nd4j::broadcast::Ops::Add, _buffer, _shapeInfo, row->_buffer, row->_shapeInfo, _buffer, _shapeInfo,
                                             dimension, 1, tad->tadOnlyShapeInfo, tad->tadOffsets,
                                             tad->tadOnlyShapeInfo, tad->tadOffsets);
    }
...
//////////////////////////////////////////////////////////////////////////
    void NDArray::addColumnVector(const NDArray *column, NDArray *target) const {
        ...
        NativeOpExecutioner::execBroadcast(nullptr, nd4j::broadcast::Ops::Add, _buffer, _shapeInfo, column->_buffer, column->_shapeInfo, target->getBuffer(), target->getShapeInfo(),
                                             dimension, 1, tad->tadOnlyShapeInfo, tad->tadOffsets,
                                             tad->tadOnlyShapeInfo, tad->tadOffsets);
}
...
// This method adds given column to all columns in this NDArray, this array becomes affected
    void NDArray::addiColumnVector(const NDArray *column) {
        ...
        NativeOpExecutioner::execBroadcast(nullptr, nd4j::broadcast::Ops::Add, _buffer, _shapeInfo, column->_buffer, column->_shapeInfo, _buffer, _shapeInfo,
                                             dimension, 1, tad->tadOnlyShapeInfo, tad->tadOffsets,
                                             tad->tadOnlyShapeInfo, tad->tadOffsets);
    }
...
// This method multiplies each column of this array by given argument-column, this array becomes affected
    void NDArray::muliColumnVector(const NDArray *column) {
        ...
        NativeOpExecutioner::execBroadcast(nullptr, nd4j::broadcast::Ops::Multiply, _buffer, _shapeInfo, column->_buffer, column->_shapeInfo, _buffer, _shapeInfo,
                                             dimension, 1, tad->tadOnlyShapeInfo, tad->tadOffsets,
                                             tad->tadOnlyShapeInfo, tad->tadOffsets);
    }
...
void NDArray::applyScalarArr(nd4j::scalar::BoolOps op, const NDArray* scalar, NDArray *target, void *extraParams) const {
    ...
    NativeOpExecutioner::execScalarBool(nullptr, op, _buffer, _shapeInfo, target->_buffer, target->_shapeInfo, scalar->_buffer, scalar->_shapeInfo, extraParams);
}
...
void NDArray::applyScalarArr(nd4j::scalar::Ops op, const NDArray* scalar, NDArray* target, void *extraParams) {
    ...
    NativeOpExecutioner::execScalar(nullptr, op, _buffer, _shapeInfo, target->_buffer, target->_shapeInfo, scalar->_buffer, scalar->_shapeInfo, extraParams);
}
...
// set new order and shape in case of suitable array length 
    ...
    if (shape::canReshape(this->rankOf(), this->_shapeInfo, shape.size(), shape.data(), order == 'f')) {
        ...
        NativeOpExecutioner::execTransformSame(nullptr, transform::Copy, _buffer, _shapeInfo, newBuffer, shapeInfoNew, nullptr, nullptr, nullptr);
...
//////////////////////////////////////////////////////////////////////////
    ...
    void NDArray::applyBroadcast(nd4j::broadcast::Ops op, const std::vector<int>& dimensions, const NDArray* tadArray, NDArray* target, void* extraArgs) {
        ...
        NativeOpExecutioner::execBroadcast(nullptr, op, this->_buffer, this->_shapeInfo, tadArray->_buffer, tadArray->_shapeInfo, result->_buffer, result->_shapeInfo, copy.data(), (int)copy.size(), tad.tadOnlyShapeInfo, tad.tadOffsets, tad.tadOnlyShapeInfo, tad.tadOffsets);
    }
    ...
    void NDArray::applyBroadcast(nd4j::broadcast::BoolOps op, const std::vector<int>& dimensions, const NDArray* tadArray, NDArray* target, void* extraArgs) {
        ...
        // TODO: eventually we want separate tads here
        NativeOpExecutioner::execBroadcastBool(nullptr, op, this->_buffer, this->_shapeInfo, tadArray->_buffer, tadArray->_shapeInfo, result->_buffer, result->_shapeInfo, copy.data(), (int)copy.size(), tad.tadOnlyShapeInfo, tad.tadOffsets, tad.tadOnlyShapeInfo, tad.tadOffsets);
    }
...
template void NDArray::pIdx(const Nd4jLong* indices, const bool value);
    ...
    void NDArray::applyIndexReduce(nd4j::indexreduce::Ops op, const NDArray* target, const std::vector<int>& dimensions, const void *extraParams) const {
        ...
        if (target->isScalar()) {
            ...
            NativeOpExecutioner::execIndexReduceScalar(nullptr, op, _buffer, _shapeInfo, const_cast<void *>(extraParams), target->getBuffer(), target->getShapeInfo());
        } else {
            std::vector<int> copy(dimensions);
            if (dimensions.size() > 1)
                std::sort(copy.begin(), copy.end());
            ...
            NativeOpExecutioner::execIndexReduce(nullptr, op, _buffer, _shapeInfo, const_cast<void *>(extraParams),
    ...
    NDArray* NDArray::applyIndexReduce(nd4j::indexreduce::Ops op,const std::vector<int>& dimensions, const void* extraParams ) const {
        ...
        if (rankOf() == copy.size()) {
            NativeOpExecutioner::execIndexReduceScalar(nullptr, op, _buffer, _shapeInfo, const_cast<void *>(extraParams), result->getBuffer(), result->getShapeInfo());
        } else {
            shape::TAD tad(_shapeInfo, copy.data(), copy.size());
            tad.createTadOnlyShapeInfo();
            tad.createOffsets();
    ...
    NDArray* NDArray::applyReduce3(nd4j::reduce3::Ops op, const NDArray* other, const void* extraParams) const {
        ...
        NativeOpExecutioner::execReduce3Scalar(nullptr, op, _buffer, _shapeInfo, params, other->_buffer, other->_shapeInfo, result->_buffer,result->_shapeInfo);
    ...
    NDArray* NDArray::applyAllReduce3(nd4j::reduce3::Ops op, const NDArray *other, const std::vector<int>& dimensions, const void* extraParams) const {
        ...
        NativeOpExecutioner::execReduce3All(nullptr, op, _buffer, _shapeInfo, params, other->_buffer, other->_shapeInfo, result->_buffer,result->_shapeInfo,
    ...
    NDArray* NDArray::applyReduce3(nd4j::reduce3::Ops op, const NDArray* other, const std::vector<int>& dimensions, const void* extraParams) const {
        ...
        if(rankOf() == copy.size() && other->rankOf() == copy.size())
            NativeOpExecutioner::execReduce3Scalar(nullptr, op, _buffer, _shapeInfo, params, other->_buffer, other->_shapeInfo, result->_buffer, result->shapeInfo());
        else {
            shape::TAD tadX(_shapeInfo, copy.data(), copy.size());
            tadX.createTadOnlyShapeInfo();
            tadX.createOffsets();
            ...
            NativeOpExecutioner::execReduce3(nullptr, op, _buffer, _shapeInfo, params, other->_buffer, other->_shapeInfo, result->_buffer,result->_shapeInfo, copy.data(), copy.size());
        }
    ...
    NDArray* NDArray::varianceAlongDimension(nd4j::variance::Ops op, const bool biasCorrected, const std::vector<int>& dimensions) const {
        ...
        if(rankOf() == copy.size() || copy.empty())
            NativeOpExecutioner::execSummaryStatsScalar(nullptr, op, _buffer, _shapeInfo, nullptr, result->buffer(), result->shapeInfo(), biasCorrected);
        else
            NativeOpExecutioner::execSummaryStats(nullptr, op, _buffer, _shapeInfo, nullptr, result->_buffer, result->_shapeInfo, copy.data(), copy.size(), biasCorrected);
    ...
    void NDArray::varianceAlongDimension(nd4j::variance::Ops op, const NDArray *target, const bool biasCorrected, const std::vector<int>& dimensions) {
        ...
        if(rankOf() == copy.size() || copy.empty())
            NativeOpExecutioner::execSummaryStatsScalar(nullptr, op, _buffer, _shapeInfo, nullptr, target->getBuffer(), target->getShapeInfo(), biasCorrected);
        else
            NativeOpExecutioner::execSummaryStats(nullptr, op, _buffer, _shapeInfo, nullptr, target->_buffer, target->_shapeInfo, copy.data(), copy.size(), biasCorrected);
    }
    ...
    NDArray NDArray::operator+(const NDArray& other) const {
        ...
        if (other.lengthOf() == lengthOf() && this->rankOf() == other.rankOf()) {
            ...
            NativeOpExecutioner::execPairwiseTransform(nullptr, nd4j::pairwise::Add, this->_buffer, this->_shapeInfo, other._buffer, other._shapeInfo, result._buffer, result._shapeInfo, nullptr);
            return result;
        }
...
NDArray NDArray::operator+(const T& scalar) const {
    ...
    NativeOpExecutioner::execScalar(nullptr, nd4j::scalar::Add, _buffer, _shapeInfo, result._buffer, result._shapeInfo, tmp.buffer(), tmp.shapeInfo(), nullptr);
    return result;
}
...
NDArray NDArray::operator-(const T& scalar) const {
    ...
    NDArray result(_shapeInfo, DataTypeUtils::pickPairwiseResultType(_dataType, DataTypeUtils::fromT<T>()), false, _workspace);
    NativeOpExecutioner::execScalar(nullptr, nd4j::scalar::Subtract, _buffer, _shapeInfo, result._buffer, result._shapeInfo, tmp.buffer(), tmp.shapeInfo(), nullptr);
    return result;
}
template NDArray NDArray::operator-(const double&   scalar) const;
template NDArray NDArray::operator-(const float&    scalar) const;
...
NDArray NDArray::operator*(const T& scalar) const {
    ...
    auto tmp = NDArrayFactory::create(scalar, _workspace);
    NDArray result(_shapeInfo, DataTypeUtils::pickPairwiseResultType(_dataType, DataTypeUtils::fromT<T>()), false, _workspace);
    NativeOpExecutioner::execScalar(nullptr, nd4j::scalar::Multiply, _buffer, _shapeInfo, result._buffer, result._shapeInfo, tmp.buffer(), tmp.shapeInfo(), nullptr);
    return result;
}
template NDArray NDArray::operator*(const double&   scalar) const;
template NDArray NDArray::operator*(const float&    scalar) const;
...
NDArray NDArray::operator/(const T& scalar) const {
    ...
    auto tmp = NDArrayFactory::create(scalar, _workspace);
    NDArray result(_shapeInfo, DataTypeUtils::pickPairwiseResultType(_dataType, DataTypeUtils::fromT<T>()), false, _workspace);
    NativeOpExecutioner::execScalar(nullptr, nd4j::scalar::Divide, _buffer, _shapeInfo, result._buffer, result._shapeInfo, tmp.getBuffer(), tmp.getShapeInfo(), nullptr);
    return result;
}
template NDArray NDArray::operator/(const double&   scalar) const;
template NDArray NDArray::operator/(const float&    scalar) const;
...
ND4J_EXPORT NDArray operator-(const float16& scalar, const NDArray & arr) {
    ...
    NativeOpExecutioner::execScalar(nullptr, nd4j::scalar::ReverseSubtract, arr.getBuffer(), arr.getShapeInfo(), result.getBuffer(), result.getShapeInfo(), tmp.getBuffer(), tmp.getShapeInfo(), nullptr);
    return result;
}
...
ND4J_EXPORT NDArray operator/(const bfloat16& scalar, const NDArray& arr) {
    ...
    auto tmp = NDArrayFactory::create(scalar, arr.getWorkspace());
    NDArray result(arr.getShapeInfo(), DataTypeUtils::pickPairwiseResultType(arr.dataType(), DataTypeUtils::fromT<bfloat16>()), false, arr.getWorkspace());
    NativeOpExecutioner::execScalar(nullptr, nd4j::scalar::ReverseDivide, arr.getBuffer(), arr.getShapeInfo(), result.getBuffer(), result.getShapeInfo(), tmp.getBuffer(), tmp.getShapeInfo(), nullptr);
    return result;
}
////////////////////////////////////////////////////////////////////////
ND4J_EXPORT NDArray operator/(const float16& scalar, const NDArray& arr) {
...
void NDArray::operator+=(const NDArray& other) {
    ...
    if (!this->isScalar() && other.isScalar()) {
        NativeOpExecutioner::execScalar(nullptr, nd4j::scalar::Add, this->_buffer, this->_shapeInfo, this->_buffer, this->_shapeInfo, other._buffer, other._shapeInfo, nullptr);
    }
    else if (other.lengthOf() == lengthOf() && this->rankOf() == other.rankOf()) {
        NativeOpExecutioner::execPairwiseTransform(nullptr, nd4j::pairwise::Add, this->_buffer, this->_shapeInfo, other._buffer, other._shapeInfo, this->_buffer, this->_shapeInfo, nullptr);
    }
    else{
...
void NDArray::operator-=(const NDArray& other) {
    ...
    if (!this->isScalar() && other.isScalar()) {
        NativeOpExecutioner::execScalar(nullptr, nd4j::scalar::Subtract, this->_buffer, this->_shapeInfo, this->_buffer, this->_shapeInfo, other._buffer, other._shapeInfo, nullptr);
    }
    else if (other.lengthOf() == lengthOf() && this->rankOf() == other.rankOf()) {
        NativeOpExecutioner::execPairwiseTransform(nullptr, nd4j::pairwise::Subtract, this->_buffer, this->_shapeInfo, other._buffer, other._shapeInfo, this->_buffer, this->_shapeInfo, nullptr);
    }
    else{
        Nd4jLong *bShape = nullptr;
        if(!ShapeUtils::evalBroadcastShapeInfo(*this, other, true, bShape, this->_workspace))
...
void NDArray::operator*=(const NDArray& other) {
    ...
    if (!this->isScalar() && other.isScalar()) {
        NativeOpExecutioner::execScalar(nullptr, nd4j::scalar::Multiply, this->_buffer, this->_shapeInfo, this->_buffer, this->_shapeInfo, other._buffer, other._shapeInfo, nullptr);
    }
    else if (other.lengthOf() == lengthOf() && this->rankOf() == other.rankOf()) {
        NativeOpExecutioner::execPairwiseTransform(nullptr, nd4j::pairwise::Multiply, this->_buffer, this->_shapeInfo, other._buffer, other._shapeInfo, this->_buffer, this->_shapeInfo, nullptr);
    }
    else{
        Nd4jLong *bShape = nullptr;
        if(!ShapeUtils::evalBroadcastShapeInfo(*this, other, true, bShape, this->_workspace))
...
void NDArray::operator/=(const NDArray& other) {
    ...
    if (!this->isScalar() && other.isScalar()) {
        NativeOpExecutioner::execScalar(nullptr, nd4j::scalar::Divide, this->_buffer, this->_shapeInfo, this->_buffer, this->_shapeInfo, other._buffer, other._shapeInfo, nullptr);
    }
    else if (other.lengthOf() == lengthOf() && this->rankOf() == other.rankOf()) {
        NativeOpExecutioner::execPairwiseTransform(nullptr, nd4j::pairwise::Divide, this->_buffer, this->_shapeInfo, other._buffer, other._shapeInfo, this->_buffer, this->_shapeInfo, nullptr);
    }
    else{
        Nd4jLong *bShape = nullptr;
        if(!ShapeUtils::evalBroadcastShapeInfo(*this, other, true, bShape, this->_workspace))
...
void NDArray::operator+=(const T value) {
    ...
    NativeOpExecutioner::execScalar(nullptr, nd4j::scalar::Add, this->_buffer, this->_shapeInfo, this->_buffer, this->_shapeInfo, tmp.buffer(), tmp.shapeInfo(), nullptr);
}
...
void NDArray::operator-=(const T value) {
    ...
    auto tmp = NDArrayFactory::create(value, _workspace);
    NativeOpExecutioner::execScalar(nullptr, nd4j::scalar::Subtract, this->_buffer, this->_shapeInfo, this->_buffer, this->_shapeInfo, tmp.buffer(), tmp.shapeInfo(), nullptr);
}
template void NDArray::operator-=(const double value);
template void NDArray::operator-=(const float value);
template void NDArray::operator-=(const float16 value);
...
void NDArray::operator*=(const T scalar) {
    ...
    auto tmp = NDArrayFactory::create(scalar, _workspace);
    NativeOpExecutioner::execScalar(nullptr, nd4j::scalar::Multiply, this->_buffer, this->_shapeInfo, this->_buffer, this->_shapeInfo, tmp.getBuffer(), tmp.getShapeInfo(), nullptr);
}
...
void NDArray::operator/=(const T scalar) {
    ...
    auto tmp = NDArrayFactory::create(scalar, _workspace);
    NativeOpExecutioner::execScalar(nullptr, nd4j::scalar::Divide, this->_buffer, this->_shapeInfo, this->_buffer, this->_shapeInfo, tmp.getBuffer(), tmp.getShapeInfo(), nullptr);
}
template void NDArray::operator/=(const double scalar);
template void NDArray::operator/=(const float scalar);
template void NDArray::operator/=(const float16 scalar);
...
template void NDArray::operator/=(const bool scalar);
    ...
    NDArray NDArray::operator-(const NDArray& other) const {
        ...
        if (other.lengthOf() == lengthOf() && this->rankOf() == other.rankOf()) {
            NDArray result(_shapeInfo, DataTypeUtils::pickPairwiseResultType(_shapeInfo, other._shapeInfo), false, this->_workspace);
            NativeOpExecutioner::execPairwiseTransform(nullptr, nd4j::pairwise::Subtract, this->_buffer, this->_shapeInfo, other._buffer, other._shapeInfo, result._buffer, result._shapeInfo, nullptr);
            return result;
        }
    ...
    NDArray NDArray::operator-() const {
        ...
        NDArray result(this->_shapeInfo, false, this->_workspace);
        NativeOpExecutioner::execTransformSame(nullptr, nd4j::transform::Neg, this->_buffer, this->_shapeInfo, result._buffer, result._shapeInfo, nullptr, nullptr, nullptr);
    ...
    NDArray NDArray::operator*(const NDArray& other) const {
        ...
        if (other.lengthOf() == lengthOf() && this->rankOf() == other.rankOf()) {
            NDArray result(_shapeInfo, DataTypeUtils::pickPairwiseResultType(_shapeInfo, other._shapeInfo), false, this->_workspace);
            NativeOpExecutioner::execPairwiseTransform(nullptr, nd4j::pairwise::Multiply, this->_buffer, this->_shapeInfo, other._buffer, other._shapeInfo, result._buffer, result._shapeInfo, nullptr);
            return result;
        }
    ...
    NDArray NDArray::operator/(const NDArray& other) const {
        ...
        if (other.lengthOf() == lengthOf() && this->rankOf() == other.rankOf()) {
            NDArray result(_shapeInfo, DataTypeUtils::pickPairwiseResultType(_shapeInfo, other._shapeInfo), false, this->_workspace);
            NativeOpExecutioner::execPairwiseTransform(nullptr, nd4j::pairwise::Divide, _buffer, _shapeInfo, other._buffer, other._shapeInfo, result._buffer, result._shapeInfo, nullptr);
            return result;
        }
...
#pragma omp parallel for if(rows > Environment::getInstance()->elementwiseThreshold()) schedule(guided) collapse (2)
    ...
    void NDArray::streamline(char o) {
        ...
        if (!isView()) {
            NativeOpExecutioner::execTransformSame(nullptr, transform::Copy, _buffer, _shapeInfo, newBuffer, newShape, nullptr, nullptr, nullptr);
