...
if [ -z "${LIBND4J_PLATFORM_EXT}" ]; then export LIBND4J_PLATFORM_EXT=${LIBND4J_PLATFORM_EXT_LIST[$TARGET_INDEX]}; fi
...
if [ -z "${TARGET_OS}" ]; then export LIBND4J_PLATFORM=${TARGET_OS}-${LIBND4J_PLATFORM_EXT}; fi
