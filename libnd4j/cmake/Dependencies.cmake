...
function(setup_zluda_download output_root)
    ...
    if(NOT SD_ZLUDA_VERSION STREQUAL "v6" AND
       NOT SD_ZLUDA_VERSION STREQUAL "v7-preview.8")
        message(FATAL_ERROR
            "Unsupported ZLUDA release ${SD_ZLUDA_VERSION}; use v7-preview.8 or v6")
    endif()

    if(WIN32)
        set(_zluda_platform "windows-x86_64")
        if(SD_ZLUDA_VERSION STREQUAL "v7-preview.8")
            set(_zluda_asset "zluda-windows-6e7abfd.zip")
            set(_zluda_sha256 "7138c9e33cc49b2a3c6f111c9cae5d90410fc01f127121be91b734aa9029a2f3")
        else()
    ...
    elseif(CMAKE_SYSTEM_NAME STREQUAL "Linux" AND
        ...
        if(SD_ZLUDA_VERSION STREQUAL "v7-preview.8")
            set(_zluda_asset "zluda-linux-6e7abfd2.tar.gz")
            set(_zluda_sha256 "e1d46358cfde90fdeb55c412dc96e90b9a23b0944a2a9a667462df7910122a96")
        else()
...
function(setup_triton)
    ...
    # The v16 recipe removes MinGW's archive-wide LLVM export-all flag
    # while preserving LLVM's native MinGW visibility attributes. Keep the
    # revision Windows/MinGW-only so unchanged Linux/Android packages remain
    # cache-compatible.
    ...
    if(NOT _TRITON_LLVM_INSTALL_COMPLETE)
        ...
        elseif(MINGW)
            ...
            # archives. The download-time patch removes that flag while retaining
            # MinGW's native visibility attributes for the annotated LLVM ABI.
