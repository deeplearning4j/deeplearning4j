...
if("${SDX_VARIANT}" STREQUAL "vulkan")
  ...
  if("${SDX_OS}" STREQUAL "windows")
    set(_provider_runtime_library "libnd4jvulkan.dll")
  elseif("${SDX_OS}" STREQUAL "macos" OR "${SDX_OS}" STREQUAL "darwin")
    set(_provider_runtime_library "libnd4jvulkan.dylib")
  else()
