        ...
        foreach(type ${UNIFIED_ACTIVE_TYPES})
            if(type STREQUAL "BOOL")
              ...
              elseif(type STREQUAL "INT8")
                set(SRCORE_TYPE_CPP_${idx} "int8_t" PARENT_SCOPE)
            elseif(type STREQUAL "UINT8")
                set(SRCORE_TYPE_CPP_${idx} "uint8_t" PARENT_SCOPE)
            elseif(type STREQUAL "INT16")
                set(SRCORE_TYPE_CPP_${idx} "int16_t" PARENT_SCOPE)
            elseif(type STREQUAL "UINT16")
                set(SRCORE_TYPE_CPP_${idx} "uint16_t" PARENT_SCOPE)
            elseif(type STREQUAL "INT32")
                set(SRCORE_TYPE_CPP_${idx} "int32_t" PARENT_SCOPE)
            elseif(type STREQUAL "UINT32")
                set(SRCORE_TYPE_CPP_${idx} "uint32_t" PARENT_SCOPE)
