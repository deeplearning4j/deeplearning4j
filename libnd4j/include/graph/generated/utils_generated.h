...
enum OpType {
  ...
  OpType_SCALAR = 9,
  OpType_SCALAR_BOOL = 10,
  OpType_BROADCAST = 11,
  OpType_BROADCAST_BOOL = 12,
  OpType_PAIRWISE = 13,
  OpType_PAIRWISE_BOOL = 14,
  OpType_REDUCE_3 = 15,
  OpType_SUMMARYSTATS = 16,
  OpType_SHAPE = 17,
  OpType_AGGREGATION = 18,
  OpType_RANDOM = 19,
  OpType_CUSTOM = 20,
  OpType_GRAPH = 21,
  OpType_VARIABLE = 30,
...
inline const OpType (&EnumValuesOpType())[25] {
