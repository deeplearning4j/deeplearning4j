...
public struct FlatNode : IFlatbufferObject
{
  ...
  public sd.graph.OpType OpType { get { int o = __p.__offset(8); return o != 0 ? (sd.graph.OpType)__p.bb.GetSbyte(o + __p.bb_pos) : sd.graph.OpType.TRANSFORM_FLOAT; } }
  public long OpNum { get { int o = __p.__offset(10); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public sd.graph.FlatProperties? Properties(int j) { int o = __p.__offset(12); return o != 0 ? (sd.graph.FlatProperties?)(new sd.graph.FlatProperties()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
...
#if ENABLE_SPAN_T
  public Span<int> GetInputBytes() { return __p.__vector_as_span<int>(14, 4); }
#else
  ...
  public sd.graph.IntPair? InputPaired(int j) { int o = __p.__offset(16); return o != 0 ? (sd.graph.IntPair?)(new sd.graph.IntPair()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
...
#if ENABLE_SPAN_T
  public Span<int> GetOutputBytes() { return __p.__vector_as_span<int>(18, 4); }
#else
...
#if ENABLE_SPAN_T
  public Span<double> GetExtraParamsBytes() { return __p.__vector_as_span<double>(20, 8); }
#else
...
#if ENABLE_SPAN_T
  public Span<long> GetExtraIntegerBytes() { return __p.__vector_as_span<long>(22, 8); }
#else
...
#if ENABLE_SPAN_T
  public Span<bool> GetExtraBoolsBytes() { return __p.__vector_as_span<bool>(24, 1); }
#else
...
#if ENABLE_SPAN_T
  public Span<int> GetDimensionsBytes() { return __p.__vector_as_span<int>(26, 4); }
#else
...
#if ENABLE_SPAN_T
  public Span<byte> GetScopeNameBytes() { return __p.__vector_as_span<byte>(32, 1); }
#else
...
#if ENABLE_SPAN_T
  public Span<byte> GetOpNameBytes() { return __p.__vector_as_span<byte>(36, 1); }
#else
  ...
  public sd.graph.DType OutputTypes(int j) { int o = __p.__offset(38); return o != 0 ? (sd.graph.DType)__p.bb.GetSbyte(__p.__vector(o) + j * 1) : (sd.graph.DType)0; }
  public int OutputTypesLength { get { int o = __p.__offset(38); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<sd.graph.DType> GetOutputTypesBytes() { return __p.__vector_as_span<sd.graph.DType>(38, 1); }
#else
  public ArraySegment<byte>? GetOutputTypesBytes() { return __p.__vector_as_arraysegment(38); }
#endif
  public sd.graph.DType[] GetOutputTypesArray() { int o = __p.__offset(38); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); sd.graph.DType[] a = new sd.graph.DType[l]; for (int i = 0; i < l; i++) { a[i] = (sd.graph.DType)__p.bb.GetSbyte(p + i * 1); } return a; }
  public sd.graph.FlatArray? Scalar { get { int o = __p.__offset(40); return o != 0 ? (sd.graph.FlatArray?)(new sd.graph.FlatArray()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
  ...
  public sd.graph.DType ExtraTypes(int j) { int o = __p.__offset(48); return o != 0 ? (sd.graph.DType)__p.bb.GetSbyte(__p.__vector(o) + j * 1) : (sd.graph.DType)0; }
  public int ExtraTypesLength { get { int o = __p.__offset(48); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<sd.graph.DType> GetExtraTypesBytes() { return __p.__vector_as_span<sd.graph.DType>(48, 1); }
#else
  public ArraySegment<byte>? GetExtraTypesBytes() { return __p.__vector_as_arraysegment(48); }
#endif
  public sd.graph.DType[] GetExtraTypesArray() { int o = __p.__offset(48); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); sd.graph.DType[] a = new sd.graph.DType[l]; for (int i = 0; i < l; i++) { a[i] = (sd.graph.DType)__p.bb.GetSbyte(p + i * 1); } return a; }
  public string ExtraStrings(int j) { int o = __p.__offset(50); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int ExtraStringsLength { get { int o = __p.__offset(50); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<sd.graph.FlatNode> CreateFlatNode(FlatBufferBuilder builder,
      int id = 0,
      StringOffset nameOffset = default(StringOffset),
      sd.graph.OpType opType = sd.graph.OpType.TRANSFORM_FLOAT,
      long opNum = 0,
      ...
      Offset<sd.graph.FlatArray> scalarOffset = default(Offset<sd.graph.FlatArray>),
      ...
      VectorOffset extraStringsOffset = default(VectorOffset)) {
  ...
  public static void AddOpType(FlatBufferBuilder builder, sd.graph.OpType opType) { builder.AddSbyte(2, (sbyte)opType, 0); }
  ...
  public static VectorOffset CreatePropertiesVector(FlatBufferBuilder builder, Offset<sd.graph.FlatProperties>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreatePropertiesVectorBlock(FlatBufferBuilder builder, Offset<sd.graph.FlatProperties>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  ...
  public static VectorOffset CreateInputPairedVector(FlatBufferBuilder builder, Offset<sd.graph.IntPair>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateInputPairedVectorBlock(FlatBufferBuilder builder, Offset<sd.graph.IntPair>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  ...
  public static VectorOffset CreateOutputTypesVector(FlatBufferBuilder builder, sd.graph.DType[] data) { builder.StartVector(1, data.Length, 1); for (int i = data.Length - 1; i >= 0; i--) builder.AddSbyte((sbyte)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateOutputTypesVectorBlock(FlatBufferBuilder builder, sd.graph.DType[] data) { builder.StartVector(1, data.Length, 1); builder.Add(data); return builder.EndVector(); }
  public static void StartOutputTypesVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(1, numElems, 1); }
  public static void AddScalar(FlatBufferBuilder builder, Offset<sd.graph.FlatArray> scalarOffset) { builder.AddOffset(18, scalarOffset.Value, 0); }
  ...
  public static VectorOffset CreateExtraTypesVector(FlatBufferBuilder builder, sd.graph.DType[] data) { builder.StartVector(1, data.Length, 1); for (int i = data.Length - 1; i >= 0; i--) builder.AddSbyte((sbyte)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateExtraTypesVectorBlock(FlatBufferBuilder builder, sd.graph.DType[] data) { builder.StartVector(1, data.Length, 1); builder.Add(data); return builder.EndVector(); }
  public static void StartExtraTypesVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(1, numElems, 1); }
  public static void AddExtraStrings(FlatBufferBuilder builder, VectorOffset extraStringsOffset) { builder.AddOffset(23, extraStringsOffset.Value, 0); }
  public static VectorOffset CreateExtraStringsVector(FlatBufferBuilder builder, StringOffset[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateExtraStringsVectorBlock(FlatBufferBuilder builder, StringOffset[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static void StartExtraStringsVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static Offset<sd.graph.FlatNode> EndFlatNode(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<sd.graph.FlatNode>(o);
  }
  public static void FinishFlatNodeBuffer(FlatBufferBuilder builder, Offset<sd.graph.FlatNode> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedFlatNodeBuffer(FlatBufferBuilder builder, Offset<sd.graph.FlatNode> offset) { builder.FinishSizePrefixed(offset.Value); }
};
