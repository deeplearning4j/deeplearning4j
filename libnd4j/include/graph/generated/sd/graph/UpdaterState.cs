...
public struct UpdaterState : IFlatbufferObject
{
  ...
  public sd.graph.FlatArray? UpdaterStateValues(int j) { int o = __p.__offset(8); return o != 0 ? (sd.graph.FlatArray?)(new sd.graph.FlatArray()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int UpdaterStateValuesLength { get { int o = __p.__offset(8); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<sd.graph.UpdaterState> CreateUpdaterState(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreateUpdaterStateValuesVector(FlatBufferBuilder builder, Offset<sd.graph.FlatArray>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateUpdaterStateValuesVectorBlock(FlatBufferBuilder builder, Offset<sd.graph.FlatArray>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static void StartUpdaterStateValuesVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static Offset<sd.graph.UpdaterState> EndUpdaterState(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<sd.graph.UpdaterState>(o);
  }
};
