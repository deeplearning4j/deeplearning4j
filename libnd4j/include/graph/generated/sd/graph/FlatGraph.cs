...
public struct FlatGraph : IFlatbufferObject
{
  ...
  public sd.graph.FlatVariable? Variables(int j) { int o = __p.__offset(6); return o != 0 ? (sd.graph.FlatVariable?)(new sd.graph.FlatVariable()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int VariablesLength { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }
  public sd.graph.FlatNode? Nodes(int j) { int o = __p.__offset(8); return o != 0 ? (sd.graph.FlatNode?)(new sd.graph.FlatNode()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int NodesLength { get { int o = __p.__offset(8); return o != 0 ? __p.__vector_len(o) : 0; } }
  public sd.graph.IntPair? Outputs(int j) { int o = __p.__offset(10); return o != 0 ? (sd.graph.IntPair?)(new sd.graph.IntPair()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int OutputsLength { get { int o = __p.__offset(10); return o != 0 ? __p.__vector_len(o) : 0; } }
  public sd.graph.FlatConfiguration? Configuration { get { int o = __p.__offset(12); return o != 0 ? (sd.graph.FlatConfiguration?)(new sd.graph.FlatConfiguration()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
...
#if ENABLE_SPAN_T
  public Span<byte> GetTrainingConfigBytes() { return __p.__vector_as_span<byte>(18, 1); }
#else
  ...
  public sd.graph.UpdaterState? UpdaterState(int j) { int o = __p.__offset(20); return o != 0 ? (sd.graph.UpdaterState?)(new sd.graph.UpdaterState()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int UpdaterStateLength { get { int o = __p.__offset(20); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<sd.graph.FlatGraph> CreateFlatGraph(FlatBufferBuilder builder,
      long id = 0,
      ...
      Offset<sd.graph.FlatConfiguration> configurationOffset = default(Offset<sd.graph.FlatConfiguration>),
  ...
  public static VectorOffset CreateVariablesVector(FlatBufferBuilder builder, Offset<sd.graph.FlatVariable>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateVariablesVectorBlock(FlatBufferBuilder builder, Offset<sd.graph.FlatVariable>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  ...
  public static VectorOffset CreateNodesVector(FlatBufferBuilder builder, Offset<sd.graph.FlatNode>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateNodesVectorBlock(FlatBufferBuilder builder, Offset<sd.graph.FlatNode>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  ...
  public static VectorOffset CreateOutputsVector(FlatBufferBuilder builder, Offset<sd.graph.IntPair>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateOutputsVectorBlock(FlatBufferBuilder builder, Offset<sd.graph.IntPair>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static void StartOutputsVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static void AddConfiguration(FlatBufferBuilder builder, Offset<sd.graph.FlatConfiguration> configurationOffset) { builder.AddOffset(4, configurationOffset.Value, 0); }
  ...
  public static VectorOffset CreateUpdaterStateVector(FlatBufferBuilder builder, Offset<sd.graph.UpdaterState>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateUpdaterStateVectorBlock(FlatBufferBuilder builder, Offset<sd.graph.UpdaterState>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static void StartUpdaterStateVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static Offset<sd.graph.FlatGraph> EndFlatGraph(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<sd.graph.FlatGraph>(o);
  }
  public static void FinishFlatGraphBuffer(FlatBufferBuilder builder, Offset<sd.graph.FlatGraph> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedFlatGraphBuffer(FlatBufferBuilder builder, Offset<sd.graph.FlatGraph> offset) { builder.FinishSizePrefixed(offset.Value); }
};
