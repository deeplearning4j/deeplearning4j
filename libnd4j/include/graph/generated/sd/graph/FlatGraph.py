...
class FlatGraph(object):
    ...
    def Variables(self, j):
        ...
        if o != 0:
            ...
            from sd.graph.FlatVariable import FlatVariable
            obj = FlatVariable()
    ...
    def Nodes(self, j):
        ...
        if o != 0:
            ...
            x += flatbuffers.number_types.UOffsetTFlags.py_type(j) * 4
            x = self._tab.Indirect(x)
            from sd.graph.FlatNode import FlatNode
            obj = FlatNode()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None
    ...
    def Configuration(self):
        ...
        if o != 0:
            ...
            from sd.graph.FlatConfiguration import FlatConfiguration
    ...
    def UpdaterState(self, j):
        ...
        if o != 0:
            ...
            x += flatbuffers.number_types.UOffsetTFlags.py_type(j) * 4
            x = self._tab.Indirect(x)
            from sd.graph.UpdaterState import UpdaterState
            obj = UpdaterState()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None
