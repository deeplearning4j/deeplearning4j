...
public struct UIVariable : IFlatbufferObject
{
  ...
  public sd.graph.IntPair? Id { get { int o = __p.__offset(4); return o != 0 ? (sd.graph.IntPair?)(new sd.graph.IntPair()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
  ...
  public sd.graph.VarType Type { get { int o = __p.__offset(8); return o != 0 ? (sd.graph.VarType)__p.bb.GetSbyte(o + __p.bb_pos) : sd.graph.VarType.VARIABLE; } }
  public sd.graph.DType Datatype { get { int o = __p.__offset(10); return o != 0 ? (sd.graph.DType)__p.bb.GetSbyte(o + __p.bb_pos) : sd.graph.DType.INHERIT; } }
...
#if ENABLE_SPAN_T
  public Span<long> GetShapeBytes() { return __p.__vector_as_span<long>(12, 8); }
#else
...
#if ENABLE_SPAN_T
  public Span<byte> GetOutputOfOpBytes() { return __p.__vector_as_span<byte>(16, 1); }
#else
...
#if ENABLE_SPAN_T
  public Span<byte> GetGradientVariableBytes() { return __p.__vector_as_span<byte>(24, 1); }
#else
...
#if ENABLE_SPAN_T
  public Span<byte> GetUiLabelExtraBytes() { return __p.__vector_as_span<byte>(26, 1); }
#else
  ...
  public sd.graph.FlatArray? ConstantValue { get { int o = __p.__offset(28); return o != 0 ? (sd.graph.FlatArray?)(new sd.graph.FlatArray()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }

  public static Offset<sd.graph.UIVariable> CreateUIVariable(FlatBufferBuilder builder,
      Offset<sd.graph.IntPair> idOffset = default(Offset<sd.graph.IntPair>),
      StringOffset nameOffset = default(StringOffset),
      sd.graph.VarType type = sd.graph.VarType.VARIABLE,
      sd.graph.DType datatype = sd.graph.DType.INHERIT,
      ...
      Offset<sd.graph.FlatArray> constantValueOffset = default(Offset<sd.graph.FlatArray>)) {
  ...
  public static void AddId(FlatBufferBuilder builder, Offset<sd.graph.IntPair> idOffset) { builder.AddOffset(0, idOffset.Value, 0); }
  public static void AddName(FlatBufferBuilder builder, StringOffset nameOffset) { builder.AddOffset(1, nameOffset.Value, 0); }
  public static void AddType(FlatBufferBuilder builder, sd.graph.VarType type) { builder.AddSbyte(2, (sbyte)type, 0); }
  public static void AddDatatype(FlatBufferBuilder builder, sd.graph.DType datatype) { builder.AddSbyte(3, (sbyte)datatype, 0); }
  ...
  public static void AddConstantValue(FlatBufferBuilder builder, Offset<sd.graph.FlatArray> constantValueOffset) { builder.AddOffset(12, constantValueOffset.Value, 0); }
  public static Offset<sd.graph.UIVariable> EndUIVariable(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<sd.graph.UIVariable>(o);
  }
};
