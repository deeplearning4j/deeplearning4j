...
public struct UIOp : IFlatbufferObject
{
...
#if ENABLE_SPAN_T
  public Span<byte> GetOpNameBytes() { return __p.__vector_as_span<byte>(6, 1); }
#else
...
#if ENABLE_SPAN_T
  public Span<byte> GetUiLabelExtraBytes() { return __p.__vector_as_span<byte>(14, 1); }
#else
  ...
  public static Offset<sd.graph.UIOp> CreateUIOp(FlatBufferBuilder builder,
  ...
  public static Offset<sd.graph.UIOp> EndUIOp(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<sd.graph.UIOp>(o);
  }
};
