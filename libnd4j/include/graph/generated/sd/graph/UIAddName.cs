...
public struct UIAddName : IFlatbufferObject
{
  ...
  public static Offset<sd.graph.UIAddName> CreateUIAddName(FlatBufferBuilder builder,
      int nameIdx = 0,
  ...
  public static Offset<sd.graph.UIAddName> EndUIAddName(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<sd.graph.UIAddName>(o);
  }
};
