...
public struct UISystemInfo : IFlatbufferObject
{
  ...
  public static Offset<sd.graph.UISystemInfo> CreateUISystemInfo(FlatBufferBuilder builder,
      int physicalCores = 0) {
  ...
  public static Offset<sd.graph.UISystemInfo> EndUISystemInfo(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<sd.graph.UISystemInfo>(o);
  }
};
