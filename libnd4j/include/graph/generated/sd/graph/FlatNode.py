...
class FlatNode(object):
    ...
    def Properties(self, j):
        ...
        if o != 0:
            ...
            from sd.graph.FlatProperties import FlatProperties
            obj = FlatProperties()
    ...
    # FlatNode
    def ExtraTypesIsNone(self):
        o = flatbuffers.number_types.UOffsetTFlags.py_type(self._tab.Offset(48))
        return o == 0

    # FlatNode
    def ExtraStrings(self, j):
    ...
    # FlatNode
    def ExtraStringsIsNone(self):
        o = flatbuffers.number_types.UOffsetTFlags.py_type(self._tab.Offset(50))
        return o == 0

def FlatNodeStart(builder): builder.StartObject(24)
...
def FlatNodeAddExtraStrings(builder, extraStrings): builder.PrependUOffsetTRelativeSlot(23, flatbuffers.number_types.UOffsetTFlags.py_type(extraStrings), 0)
def FlatNodeStartExtraStringsVector(builder, numElems): return builder.StartVector(4, numElems, 4)
