...
#ifndef FLATBUFFERS_GENERATED_UIGRAPHSTATIC_GRAPH_H_
#define FLATBUFFERS_GENERATED_UIGRAPHSTATIC_GRAPH_H_
...
struct UIStaticInfoRecord FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  graph::UIInfoType infoType() const {
    return static_cast<graph::UIInfoType>(GetField<int8_t>(VT_INFOTYPE, 0));
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int8_t>(verifier, VT_INFOTYPE, 1) &&
           verifier.EndTable();
  }
};
...
struct UIStaticInfoRecordBuilder {
  ...
  void add_infoType(graph::UIInfoType infoType) {
...
inline ::flatbuffers::Offset<UIStaticInfoRecord> CreateUIStaticInfoRecord(
    ...
    graph::UIInfoType infoType = graph::UIInfoType_GRAPH_STRUCTURE) {
...
struct UISystemInfo FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int32_t>(verifier, VT_PHYSICALCORES, 4) &&
           verifier.EndTable();
  }
};
...
struct UIGraphStructure FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<::flatbuffers::Offset<graph::IntPair>> *inputsPair() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<graph::IntPair>> *>(VT_INPUTSPAIR);
  }
  ...
  const ::flatbuffers::Vector<::flatbuffers::Offset<graph::UIVariable>> *variables() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<graph::UIVariable>> *>(VT_VARIABLES);
  }
  const ::flatbuffers::Vector<::flatbuffers::Offset<graph::UIOp>> *ops() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<graph::UIOp>> *>(VT_OPS);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct UIGraphStructureBuilder {
  ...
  void add_inputsPair(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<graph::IntPair>>> inputsPair) {
  ...
  void add_variables(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<graph::UIVariable>>> variables) {
    fbb_.AddOffset(UIGraphStructure::VT_VARIABLES, variables);
  }
  void add_ops(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<graph::UIOp>>> ops) {
...
inline ::flatbuffers::Offset<UIGraphStructure> CreateUIGraphStructure(
    ...
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<graph::IntPair>>> inputsPair = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> outputs = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<graph::UIVariable>>> variables = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<graph::UIOp>>> ops = 0) {
...
inline ::flatbuffers::Offset<UIGraphStructure> CreateUIGraphStructureDirect(
    ...
    const std::vector<::flatbuffers::Offset<graph::IntPair>> *inputsPair = nullptr,
    const std::vector<::flatbuffers::Offset<::flatbuffers::String>> *outputs = nullptr,
    const std::vector<::flatbuffers::Offset<graph::UIVariable>> *variables = nullptr,
    const std::vector<::flatbuffers::Offset<graph::UIOp>> *ops = nullptr) {
  auto inputs__ = inputs ? _fbb.CreateVector<::flatbuffers::Offset<::flatbuffers::String>>(*inputs) : 0;
  auto inputsPair__ = inputsPair ? _fbb.CreateVector<::flatbuffers::Offset<graph::IntPair>>(*inputsPair) : 0;
  auto outputs__ = outputs ? _fbb.CreateVector<::flatbuffers::Offset<::flatbuffers::String>>(*outputs) : 0;
  auto variables__ = variables ? _fbb.CreateVector<::flatbuffers::Offset<graph::UIVariable>>(*variables) : 0;
  auto ops__ = ops ? _fbb.CreateVector<::flatbuffers::Offset<graph::UIOp>>(*ops) : 0;
  return graph::CreateUIGraphStructure(
      _fbb,
      inputs__,
      inputsPair__,
      outputs__,
...
struct UIVariable FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  graph::VarType type() const {
    return static_cast<graph::VarType>(GetField<int8_t>(VT_TYPE, 0));
  }
  graph::DType datatype() const {
    return static_cast<graph::DType>(GetField<int8_t>(VT_DATATYPE, 0));
  }
  ...
  const graph::FlatArray *constantValue() const {
    return GetPointer<const graph::FlatArray *>(VT_CONSTANTVALUE);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct UIVariableBuilder {
  ...
  void add_type(graph::VarType type) {
    fbb_.AddElement<int8_t>(UIVariable::VT_TYPE, static_cast<int8_t>(type), 0);
  }
  void add_datatype(graph::DType datatype) {
  ...
  void add_constantValue(::flatbuffers::Offset<graph::FlatArray> constantValue) {
...
inline ::flatbuffers::Offset<UIVariable> CreateUIVariable(
    ...
    graph::VarType type = graph::VarType_VARIABLE,
    graph::DType datatype = graph::DType_INHERIT,
    ...
    ::flatbuffers::Offset<graph::FlatArray> constantValue = 0) {
...
#endif  // FLATBUFFERS_GENERATED_UIGRAPHSTATIC_GRAPH_H_
