...
struct FlatNode FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<nd4j::graph::FlatProperties>> *properties() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<nd4j::graph::FlatProperties>> *>(VT_PROPERTIES);
  }
...
struct FlatNodeBuilder {
  ...
  void add_properties(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<nd4j::graph::FlatProperties>>> properties) {
...
inline flatbuffers::Offset<FlatNode> CreateFlatNode(
    ...
    int64_t opNum = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<nd4j::graph::FlatProperties>>> properties = 0,
...
inline flatbuffers::Offset<FlatNode> CreateFlatNodeDirect(
    ...
    nd4j::graph::OpType opType = nd4j::graph::OpType_TRANSFORM,
    int64_t opNum = 0,
    const std::vector<flatbuffers::Offset<nd4j::graph::FlatProperties>> *properties = nullptr,
  ...
  return nd4j::graph::CreateFlatNode(
      ...
      opType,
      opNum,
      properties ? _fbb.CreateVector<flatbuffers::Offset<nd4j::graph::FlatProperties>>(*properties) : 0,
