...
struct FlatGraph FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const sd::graph::SequenceItemRoot *sequenceItems() const {
    return GetPointer<const sd::graph::SequenceItemRoot *>(VT_SEQUENCEITEMS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_SEQUENCEITEMS) &&
           verifier.VerifyTable(sequenceItems()) &&
           verifier.EndTable();
  }
};
...
struct FlatGraphBuilder {
  ...
  void add_sequenceItems(flatbuffers::Offset<sd::graph::SequenceItemRoot> sequenceItems) {
    fbb_.AddOffset(FlatGraph::VT_SEQUENCEITEMS, sequenceItems);
  }
...
inline flatbuffers::Offset<FlatGraph> CreateFlatGraph(
    ...
    flatbuffers::Offset<sd::graph::SequenceItemRoot> sequenceItems = 0) {
  FlatGraphBuilder builder_(_fbb);
  builder_.add_id(id);
  builder_.add_sequenceItems(sequenceItems);
...
struct SequenceItem FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_NAME = 4,
    VT_ASSOCIATEDVARIABLE = 6
  };
  const flatbuffers::String *name() const {
    return GetPointer<const flatbuffers::String *>(VT_NAME);
  }
  const flatbuffers::Vector<flatbuffers::Offset<sd::graph::FlatArray>> *associatedVariable() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<sd::graph::FlatArray>> *>(VT_ASSOCIATEDVARIABLE);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT_NAME) &&
           verifier.VerifyString(name()) &&
           VerifyOffset(verifier, VT_ASSOCIATEDVARIABLE) &&
           verifier.VerifyVector(associatedVariable()) &&
           verifier.VerifyVectorOfTables(associatedVariable()) &&
           verifier.EndTable();
  }
};
...
struct SequenceItemBuilder {
  ...
  void add_associatedVariable(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<sd::graph::FlatArray>>> associatedVariable) {
    fbb_.AddOffset(SequenceItem::VT_ASSOCIATEDVARIABLE, associatedVariable);
  }
  explicit SequenceItemBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  SequenceItemBuilder &operator=(const SequenceItemBuilder &);
...
inline flatbuffers::Offset<SequenceItem> CreateSequenceItem(
    ...
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<sd::graph::FlatArray>>> associatedVariable = 0) {
  SequenceItemBuilder builder_(_fbb);
  builder_.add_associatedVariable(associatedVariable);
...
inline flatbuffers::Offset<SequenceItem> CreateSequenceItemDirect(
    ...
    const std::vector<flatbuffers::Offset<sd::graph::FlatArray>> *associatedVariable = nullptr) {
  auto name__ = name ? _fbb.CreateString(name) : 0;
  auto associatedVariable__ = associatedVariable ? _fbb.CreateVector<flatbuffers::Offset<sd::graph::FlatArray>>(*associatedVariable) : 0;
  return sd::graph::CreateSequenceItem(
      _fbb,
      name__,
      associatedVariable__);
}
...
struct SequenceItemRoot FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<sd::graph::SequenceItem>> *sequenceItems() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<sd::graph::SequenceItem>> *>(VT_SEQUENCEITEMS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT_SEQUENCEITEMS) &&
           verifier.VerifyVector(sequenceItems()) &&
           verifier.VerifyVectorOfTables(sequenceItems()) &&
           verifier.EndTable();
  }
};
...
struct SequenceItemRootBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_sequenceItems(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<sd::graph::SequenceItem>>> sequenceItems) {
    fbb_.AddOffset(SequenceItemRoot::VT_SEQUENCEITEMS, sequenceItems);
  }
  explicit SequenceItemRootBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  SequenceItemRootBuilder &operator=(const SequenceItemRootBuilder &);
...
inline flatbuffers::Offset<SequenceItemRoot> CreateSequenceItemRoot(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<sd::graph::SequenceItem>>> sequenceItems = 0) {
...
inline flatbuffers::Offset<SequenceItemRoot> CreateSequenceItemRootDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    const std::vector<flatbuffers::Offset<sd::graph::SequenceItem>> *sequenceItems = nullptr) {
  auto sequenceItems__ = sequenceItems ? _fbb.CreateVector<flatbuffers::Offset<sd::graph::SequenceItem>>(*sequenceItems) : 0;
  return sd::graph::CreateSequenceItemRoot(
      _fbb,
      sequenceItems__);
}
