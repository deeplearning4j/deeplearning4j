...
def UIVariableStart(builder): builder.StartObject(8)
...
def UIVariableAddOutputOfOp(builder, outputOfOp): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(outputOfOp), 0)
def UIVariableAddInputsForOp(builder, inputsForOp): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(inputsForOp), 0)
def UIVariableStartInputsForOpVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def UIVariableAddControlDepsForOp(builder, controlDepsForOp): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(controlDepsForOp), 0)
def UIVariableStartControlDepsForOpVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def UIVariableAddControlDepsForVar(builder, controlDepsForVar): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(controlDepsForVar), 0)
def UIVariableStartControlDepsForVarVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def UIVariableAddGradientVariable(builder, gradientVariable): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(gradientVariable), 0)
