...
public final class FlatProperties extends Table {
  ...
  public nd4j.graph.FlatArray a(int j) { return a(new nd4j.graph.FlatArray(), j); }
  public nd4j.graph.FlatArray a(nd4j.graph.FlatArray obj, int j) { int o = __offset(12); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
