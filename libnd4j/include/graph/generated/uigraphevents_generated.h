...
#ifndef FLATBUFFERS_GENERATED_UIGRAPHEVENTS_GRAPH_H_
#define FLATBUFFERS_GENERATED_UIGRAPHEVENTS_GRAPH_H_
...
struct UIEvent FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  graph::UIEventType eventType() const {
    return static_cast<graph::UIEventType>(GetField<int8_t>(VT_EVENTTYPE, 0));
  }
  graph::UIEventSubtype eventSubType() const {
    return static_cast<graph::UIEventSubtype>(GetField<int8_t>(VT_EVENTSUBTYPE, 0));
  }
  ...
  const graph::FrameIteration *frameIter() const {
    return GetPointer<const graph::FrameIteration *>(VT_FRAMEITER);
  }
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int8_t>(verifier, VT_EVENTTYPE, 1) &&
           VerifyField<int8_t>(verifier, VT_EVENTSUBTYPE, 1) &&
           VerifyField<int32_t>(verifier, VT_NAMEIDX, 4) &&
           VerifyField<int64_t>(verifier, VT_TIMESTAMP, 8) &&
           VerifyField<int32_t>(verifier, VT_ITERATION, 4) &&
           VerifyField<int32_t>(verifier, VT_EPOCH, 4) &&
           VerifyField<int16_t>(verifier, VT_VARIABLEID, 2) &&
           VerifyOffset(verifier, VT_FRAMEITER) &&
           verifier.VerifyTable(frameIter()) &&
           VerifyField<uint16_t>(verifier, VT_PLUGIN, 2) &&
           verifier.EndTable();
  }
};
...
struct UIEventBuilder {
  ...
  void add_eventType(graph::UIEventType eventType) {
    fbb_.AddElement<int8_t>(UIEvent::VT_EVENTTYPE, static_cast<int8_t>(eventType), 0);
  }
  void add_eventSubType(graph::UIEventSubtype eventSubType) {
  ...
  void add_frameIter(::flatbuffers::Offset<graph::FrameIteration> frameIter) {
...
inline ::flatbuffers::Offset<UIEvent> CreateUIEvent(
    ...
    graph::UIEventType eventType = graph::UIEventType_ADD_NAME,
    graph::UIEventSubtype eventSubType = graph::UIEventSubtype_NONE,
    int32_t nameIdx = 0,
    int64_t timestamp = 0,
    int32_t iteration = 0,
    int32_t epoch = 0,
    int16_t variableId = 0,
    ::flatbuffers::Offset<graph::FrameIteration> frameIter = 0,
    uint16_t plugin = 0) {
...
struct FrameIteration FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<uint16_t>(verifier, VT_ITERATION, 2) &&
           verifier.EndTable();
  }
};
...
inline ::flatbuffers::Offset<FrameIteration> CreateFrameIterationDirect(
  ...
  return graph::CreateFrameIteration(
      _fbb,
      frame__,
      iteration);
}
...
struct FlatArrayList FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<::flatbuffers::Offset<graph::FlatArray>> *list() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<graph::FlatArray>> *>(VT_LIST);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct FlatArrayListBuilder {
  ...
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_list(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<graph::FlatArray>>> list) {
...
inline ::flatbuffers::Offset<FlatArrayList> CreateFlatArrayList(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<graph::FlatArray>>> list = 0) {
...
inline ::flatbuffers::Offset<FlatArrayList> CreateFlatArrayListDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    const std::vector<::flatbuffers::Offset<graph::FlatArray>> *list = nullptr) {
  auto list__ = list ? _fbb.CreateVector<::flatbuffers::Offset<graph::FlatArray>>(*list) : 0;
  return graph::CreateFlatArrayList(
      _fbb,
      list__);
}
...
struct UIHistogram FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  graph::UIHistogramType type() const {
    return static_cast<graph::UIHistogramType>(GetField<int8_t>(VT_TYPE, 0));
  }
  uint32_t numbins() const {
    return GetField<uint32_t>(VT_NUMBINS, 0);
  }
  const graph::FlatArray *binranges() const {
    return GetPointer<const graph::FlatArray *>(VT_BINRANGES);
  }
  const graph::FlatArray *y() const {
    return GetPointer<const graph::FlatArray *>(VT_Y);
  }
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<uint32_t>(verifier, VT_NUMBINS, 4) &&
...
struct UIHistogramBuilder {
  ...
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_type(graph::UIHistogramType type) {
  ...
  void add_binranges(::flatbuffers::Offset<graph::FlatArray> binranges) {
    fbb_.AddOffset(UIHistogram::VT_BINRANGES, binranges);
  }
  void add_y(::flatbuffers::Offset<graph::FlatArray> y) {
...
inline ::flatbuffers::Offset<UIHistogram> CreateUIHistogram(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    graph::UIHistogramType type = graph::UIHistogramType_DISCRETE,
    uint32_t numbins = 0,
    ::flatbuffers::Offset<graph::FlatArray> binranges = 0,
    ::flatbuffers::Offset<graph::FlatArray> y = 0,
...
inline ::flatbuffers::Offset<UIHistogram> CreateUIHistogramDirect(
  ...
  return graph::CreateUIHistogram(
      _fbb,
      type,
      numbins,
      binranges,
...
struct UISummaryStatistics FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const graph::FlatArray *min() const {
    return GetPointer<const graph::FlatArray *>(VT_MIN);
  }
  const graph::FlatArray *max() const {
    return GetPointer<const graph::FlatArray *>(VT_MAX);
  }
  double mean() const {
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint32_t>(verifier, VT_BITMASK, 4) &&
           VerifyOffset(verifier, VT_MIN) &&
           verifier.VerifyTable(min()) &&
           VerifyOffset(verifier, VT_MAX) &&
           verifier.VerifyTable(max()) &&
           VerifyField<double>(verifier, VT_MEAN, 8) &&
           VerifyField<double>(verifier, VT_STDEV, 8) &&
           VerifyField<int64_t>(verifier, VT_COUNTZERO, 8) &&
           VerifyField<int64_t>(verifier, VT_COUNTPOSITIVE, 8) &&
           VerifyField<int64_t>(verifier, VT_COUNTNEGATIVE, 8) &&
           VerifyField<int64_t>(verifier, VT_COUNTNAN, 8) &&
           VerifyField<int64_t>(verifier, VT_COUNTINF, 8) &&
           verifier.EndTable();
  }
};
...
struct UISummaryStatisticsBuilder {
  ...
  void add_min(::flatbuffers::Offset<graph::FlatArray> min) {
    fbb_.AddOffset(UISummaryStatistics::VT_MIN, min);
  }
  void add_max(::flatbuffers::Offset<graph::FlatArray> max) {
...
inline ::flatbuffers::Offset<UISummaryStatistics> CreateUISummaryStatistics(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    uint32_t bitmask = 0,
    ::flatbuffers::Offset<graph::FlatArray> min = 0,
    ::flatbuffers::Offset<graph::FlatArray> max = 0,
    double mean = 0.0,
    double stdev = 0.0,
    int64_t countzero = 0,
...
struct UIHardwareState FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<int64_t>(verifier, VT_HOSTMEMORY, 8) &&
           verifier.EndTable();
  }
};
...
inline ::flatbuffers::Offset<UIHardwareState> CreateUIHardwareStateDirect(
  ...
  return graph::CreateUIHardwareState(
      _fbb,
      gpuMemory__,
      hostMemory);
}
...
#endif  // FLATBUFFERS_GENERATED_UIGRAPHEVENTS_GRAPH_H_
