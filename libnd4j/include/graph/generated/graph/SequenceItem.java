...
public final class SequenceItem extends Table {
  ...
  public graph.FlatArray associatedVariable(int j) { return associatedVariable(new graph.FlatArray(), j); }
  public graph.FlatArray associatedVariable(graph.FlatArray obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int associatedVariableLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  public graph.FlatArray.Vector associatedVariableVector() { return associatedVariableVector(new graph.FlatArray.Vector()); }
  public graph.FlatArray.Vector associatedVariableVector(graph.FlatArray.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
