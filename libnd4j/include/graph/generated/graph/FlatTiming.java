...
public final class FlatTiming extends Table {
  ...
  public graph.LongPair timing() { return timing(new graph.LongPair()); }
  public graph.LongPair timing(graph.LongPair obj) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
