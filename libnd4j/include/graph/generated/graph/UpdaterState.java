...
public final class UpdaterState extends Table {
  ...
  public graph.FlatArray updaterStateValues(int j) { return updaterStateValues(new graph.FlatArray(), j); }
  public graph.FlatArray updaterStateValues(graph.FlatArray obj, int j) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int updaterStateValuesLength() { int o = __offset(8); return o != 0 ? __vector_len(o) : 0; }
  public graph.FlatArray.Vector updaterStateValuesVector() { return updaterStateValuesVector(new graph.FlatArray.Vector()); }
  public graph.FlatArray.Vector updaterStateValuesVector(graph.FlatArray.Vector obj) { int o = __offset(8); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
