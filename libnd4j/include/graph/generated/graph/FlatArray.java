...
public final class FlatArray extends Table {
  ...
  public graph.BufferChunk bufferChunks(int j) { return bufferChunks(new graph.BufferChunk(), j); }
  public graph.BufferChunk bufferChunks(graph.BufferChunk obj, int j) { int o = __offset(12); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int bufferChunksLength() { int o = __offset(12); return o != 0 ? __vector_len(o) : 0; }
  public graph.BufferChunk.Vector bufferChunksVector() { return bufferChunksVector(new graph.BufferChunk.Vector()); }
  public graph.BufferChunk.Vector bufferChunksVector(graph.BufferChunk.Vector obj) { int o = __offset(12); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
