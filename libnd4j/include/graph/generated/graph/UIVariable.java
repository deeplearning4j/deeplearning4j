...
public final class UIVariable extends Table {
  ...
  public graph.IntPair id() { return id(new graph.IntPair()); }
  public graph.IntPair id(graph.IntPair obj) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  ...
  public graph.FlatArray constantValue() { return constantValue(new graph.FlatArray()); }
  public graph.FlatArray constantValue(graph.FlatArray obj) { int o = __offset(28); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
