...
public final class UIHistogram extends Table {
  ...
  public graph.FlatArray binranges() { return binranges(new graph.FlatArray()); }
  public graph.FlatArray binranges(graph.FlatArray obj) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  public graph.FlatArray y() { return y(new graph.FlatArray()); }
  public graph.FlatArray y(graph.FlatArray obj) { int o = __offset(10); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
