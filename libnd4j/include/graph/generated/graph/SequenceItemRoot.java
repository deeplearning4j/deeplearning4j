...
public final class SequenceItemRoot extends Table {
  ...
  public graph.SequenceItem sequenceItems(int j) { return sequenceItems(new graph.SequenceItem(), j); }
  public graph.SequenceItem sequenceItems(graph.SequenceItem obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int sequenceItemsLength() { int o = __offset(4); return o != 0 ? __vector_len(o) : 0; }
  public graph.SequenceItem.Vector sequenceItemsVector() { return sequenceItemsVector(new graph.SequenceItem.Vector()); }
  public graph.SequenceItem.Vector sequenceItemsVector(graph.SequenceItem.Vector obj) { int o = __offset(4); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
