...
public final class UIGraphStructure extends Table {
  ...
  public graph.IntPair inputsPair(int j) { return inputsPair(new graph.IntPair(), j); }
  public graph.IntPair inputsPair(graph.IntPair obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int inputsPairLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  public graph.IntPair.Vector inputsPairVector() { return inputsPairVector(new graph.IntPair.Vector()); }
  public graph.IntPair.Vector inputsPairVector(graph.IntPair.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public graph.UIVariable variables(int j) { return variables(new graph.UIVariable(), j); }
  public graph.UIVariable variables(graph.UIVariable obj, int j) { int o = __offset(10); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int variablesLength() { int o = __offset(10); return o != 0 ? __vector_len(o) : 0; }
  public graph.UIVariable.Vector variablesVector() { return variablesVector(new graph.UIVariable.Vector()); }
  public graph.UIVariable.Vector variablesVector(graph.UIVariable.Vector obj) { int o = __offset(10); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public graph.UIOp ops(int j) { return ops(new graph.UIOp(), j); }
  public graph.UIOp ops(graph.UIOp obj, int j) { int o = __offset(12); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int opsLength() { int o = __offset(12); return o != 0 ? __vector_len(o) : 0; }
  public graph.UIOp.Vector opsVector() { return opsVector(new graph.UIOp.Vector()); }
  public graph.UIOp.Vector opsVector(graph.UIOp.Vector obj) { int o = __offset(12); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
