...
public final class FlatResult extends Table {
  ...
  public graph.FlatVariable variables(int j) { return variables(new graph.FlatVariable(), j); }
  public graph.FlatVariable variables(graph.FlatVariable obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int variablesLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  public graph.FlatVariable.Vector variablesVector() { return variablesVector(new graph.FlatVariable.Vector()); }
  public graph.FlatVariable.Vector variablesVector(graph.FlatVariable.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public graph.FlatTiming timing(int j) { return timing(new graph.FlatTiming(), j); }
  public graph.FlatTiming timing(graph.FlatTiming obj, int j) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int timingLength() { int o = __offset(8); return o != 0 ? __vector_len(o) : 0; }
  public graph.FlatTiming.Vector timingVector() { return timingVector(new graph.FlatTiming.Vector()); }
  public graph.FlatTiming.Vector timingVector(graph.FlatTiming.Vector obj) { int o = __offset(8); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
