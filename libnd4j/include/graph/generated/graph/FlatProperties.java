...
public final class FlatProperties extends Table {
  ...
  public graph.FlatArray a(int j) { return a(new graph.FlatArray(), j); }
  public graph.FlatArray a(graph.FlatArray obj, int j) { int o = __offset(12); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int aLength() { int o = __offset(12); return o != 0 ? __vector_len(o) : 0; }
  public graph.FlatArray.Vector aVector() { return aVector(new graph.FlatArray.Vector()); }
  public graph.FlatArray.Vector aVector(graph.FlatArray.Vector obj) { int o = __offset(12); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
