...
public final class UISummaryStatistics extends Table {
  ...
  public graph.FlatArray min() { return min(new graph.FlatArray()); }
  public graph.FlatArray min(graph.FlatArray obj) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  public graph.FlatArray max() { return max(new graph.FlatArray()); }
  public graph.FlatArray max(graph.FlatArray obj) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
