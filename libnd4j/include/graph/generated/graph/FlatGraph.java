...
public final class FlatGraph extends Table {
  ...
  public graph.FlatNode nodes(int j) { return nodes(new graph.FlatNode(), j); }
  public graph.FlatNode nodes(graph.FlatNode obj, int j) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int nodesLength() { int o = __offset(8); return o != 0 ? __vector_len(o) : 0; }
  public graph.FlatNode.Vector nodesVector() { return nodesVector(new graph.FlatNode.Vector()); }
  public graph.FlatNode.Vector nodesVector(graph.FlatNode.Vector obj) { int o = __offset(8); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public graph.IntPair outputs(int j) { return outputs(new graph.IntPair(), j); }
  public graph.IntPair outputs(graph.IntPair obj, int j) { int o = __offset(10); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int outputsLength() { int o = __offset(10); return o != 0 ? __vector_len(o) : 0; }
  public graph.IntPair.Vector outputsVector() { return outputsVector(new graph.IntPair.Vector()); }
  public graph.IntPair.Vector outputsVector(graph.IntPair.Vector obj) { int o = __offset(10); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public graph.FlatConfiguration configuration() { return configuration(new graph.FlatConfiguration()); }
  public graph.FlatConfiguration configuration(graph.FlatConfiguration obj) { int o = __offset(12); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  ...
  public graph.UpdaterState updaterState(int j) { return updaterState(new graph.UpdaterState(), j); }
  public graph.UpdaterState updaterState(graph.UpdaterState obj, int j) { int o = __offset(20); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int updaterStateLength() { int o = __offset(20); return o != 0 ? __vector_len(o) : 0; }
  public graph.UpdaterState.Vector updaterStateVector() { return updaterStateVector(new graph.UpdaterState.Vector()); }
  public graph.UpdaterState.Vector updaterStateVector(graph.UpdaterState.Vector obj) { int o = __offset(20); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public graph.SameDiffSubInstance subInstances(int j) { return subInstances(new graph.SameDiffSubInstance(), j); }
  public graph.SameDiffSubInstance subInstances(graph.SameDiffSubInstance obj, int j) { int o = __offset(26); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int subInstancesLength() { int o = __offset(26); return o != 0 ? __vector_len(o) : 0; }
  public graph.SameDiffSubInstance.Vector subInstancesVector() { return subInstancesVector(new graph.SameDiffSubInstance.Vector()); }
  public graph.SameDiffSubInstance.Vector subInstancesVector(graph.SameDiffSubInstance.Vector obj) { int o = __offset(26); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
