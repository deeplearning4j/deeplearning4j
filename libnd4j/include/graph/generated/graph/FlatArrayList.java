...
public final class FlatArrayList extends Table {
  ...
  public graph.FlatArray list(int j) { return list(new graph.FlatArray(), j); }
  public graph.FlatArray list(graph.FlatArray obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int listLength() { int o = __offset(4); return o != 0 ? __vector_len(o) : 0; }
  public graph.FlatArray.Vector listVector() { return listVector(new graph.FlatArray.Vector()); }
  public graph.FlatArray.Vector listVector(graph.FlatArray.Vector obj) { int o = __offset(4); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
