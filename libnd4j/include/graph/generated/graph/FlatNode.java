...
public final class FlatNode extends Table {
  ...
  public graph.FlatProperties properties(int j) { return properties(new graph.FlatProperties(), j); }
  public graph.FlatProperties properties(graph.FlatProperties obj, int j) { int o = __offset(12); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int propertiesLength() { int o = __offset(12); return o != 0 ? __vector_len(o) : 0; }
  public graph.FlatProperties.Vector propertiesVector() { return propertiesVector(new graph.FlatProperties.Vector()); }
  public graph.FlatProperties.Vector propertiesVector(graph.FlatProperties.Vector obj) { int o = __offset(12); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public graph.IntPair inputPaired(int j) { return inputPaired(new graph.IntPair(), j); }
  public graph.IntPair inputPaired(graph.IntPair obj, int j) { int o = __offset(16); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int inputPairedLength() { int o = __offset(16); return o != 0 ? __vector_len(o) : 0; }
  public graph.IntPair.Vector inputPairedVector() { return inputPairedVector(new graph.IntPair.Vector()); }
  public graph.IntPair.Vector inputPairedVector(graph.IntPair.Vector obj) { int o = __offset(16); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public graph.FlatArray scalar() { return scalar(new graph.FlatArray()); }
  public graph.FlatArray scalar(graph.FlatArray obj) { int o = __offset(40); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
