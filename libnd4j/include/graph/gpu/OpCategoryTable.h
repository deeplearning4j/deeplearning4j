...
inline const std::unordered_map<std::string, TritonOpCategory>& getOpCategoryTable() {
  static const std::unordered_map<std::string, TritonOpCategory> table = {
    ...
    {"rsub_scalar",       TritonOpCategory::UNARY_ELEMENTWISE},
    {"rdiv_scalar",       TritonOpCategory::UNARY_ELEMENTWISE},
    ...
    {"rms_norm_linear",   TritonOpCategory::MATMUL},
    {"RmsNormLinear",     TritonOpCategory::MATMUL},
