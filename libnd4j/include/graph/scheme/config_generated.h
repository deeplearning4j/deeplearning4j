...
inline const char *EnumNameProfilingMode(ProfilingMode e) {
  if (e < ProfilingMode_NONE || e > ProfilingMode_ANY_PANIC) return "";
...
inline const char *EnumNameExecutionMode(ExecutionMode e) {
  if (e < ExecutionMode_SEQUENTIAL || e > ExecutionMode_AUTO) return "";
  const size_t index = static_cast<size_t>(e);
...
inline const char *EnumNameOutputMode(OutputMode e) {
  if (e < OutputMode_IMPLICIT || e > OutputMode_OPTIMIZED) return "";
  const size_t index = static_cast<size_t>(e);
...
inline const char *EnumNameDirection(Direction e) {
  if (e < Direction_FORWARD_ONLY || e > Direction_BACKWARD_ONLY) return "";
  const size_t index = static_cast<size_t>(e);
