...
struct alignas(2) bfloat16 {
 ...
 public:
  ...
  SD_INLINE SD_HOST_DEVICE explicit bfloat16(const T& rhs) {
    *this = rhs;
  }
  ...
  SD_INLINE SD_HOST_DEVICE static bfloat16 min_positive() {
    bfloat16 res;
    res._data = 0x0001; // Smallest positive subnormal value
    return res;
  }
