...
//
    ...
    local_def bfloat16 operator+(const uint16_t& a,           const bfloat16& b)            { return static_cast<bfloat16>(a) + b; }
    ...
    local_def bool operator==(const uint16_t& a,           const bfloat16& b)            { return static_cast<bfloat16>(a) == b; }
