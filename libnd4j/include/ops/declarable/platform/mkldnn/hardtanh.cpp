...
static void hardtanhMKLDNN(NDArray* x, NDArray* z) {
  ...
  dnnl::eltwise_forward::primitive_desc op_prim_desc(engine, dnnl::prop_kind::forward_inference,
                                                      algorithm::eltwise_clip, x_mkl_md, z_mkl_md, -1.0f, 1.0f);
...
static void hardtanhBpMKLDNN(NDArray* x, NDArray* dLdz, NDArray* dLdx) {
  ...
  dnnl::eltwise_forward::primitive_desc op_ff_prim_desc(engine, dnnl::prop_kind::forward_training,
                                                         algorithm::eltwise_clip, x_mkl_md, x_mkl_md, -1.0f, 1.0f);
  ...
  dnnl::eltwise_backward::primitive_desc op_prim_desc(engine, algorithm::eltwise_clip,
                                                       dLdx_mkl_md, dLdz_mkl_md, x_mkl_md, -1.0f, 1.0f, op_ff_prim_desc);
