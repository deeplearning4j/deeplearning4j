...
static void lreluMKLDNN(NDArray* x, NDArray* z, float alpha) {
  ...
  dnnl::eltwise_forward::primitive_desc op_prim_desc(engine, dnnl::prop_kind::forward_inference,
                                                      algorithm::eltwise_relu, x_mkl_md, z_mkl_md, alpha, 0.f);
...
static void lreluBpMKLDNN(NDArray* x, NDArray* dLdz, NDArray* dLdx, float alpha) {
  ...
  dnnl::eltwise_forward::primitive_desc op_ff_prim_desc(engine, dnnl::prop_kind::forward_training,
                                                         algorithm::eltwise_relu, x_mkl_md, x_mkl_md, alpha, 0.f);
  ...
  dnnl::eltwise_backward::primitive_desc op_prim_desc(engine, algorithm::eltwise_relu,
                                                       dLdx_mkl_md, dLdz_mkl_md, x_mkl_md, alpha, 0.f, op_ff_prim_desc);
