...
static void hardsigmoidMKLDNN(NDArray* x, NDArray* z) {
  ...
  dnnl::eltwise_forward::desc op_desc(dnnl::prop_kind::forward_inference, algorithm::eltwise_hardsigmoid, x_mkl_md, 0.2f, 0.5f);
...
static void hardsigmoidBpMKLDNN(NDArray* x, NDArray* dLdz, NDArray* dLdx) {
  ...
  // forward
  dnnl::eltwise_forward::desc op_ff_desc(dnnl::prop_kind::forward_inference, algorithm::eltwise_hardsigmoid, x_mkl_md, 0.2f, 0.5f);
  dnnl::eltwise_forward::primitive_desc op_ff_prim_desc(op_ff_desc, engine);

  // backward description
  dnnl::eltwise_backward::desc op_desc(algorithm::eltwise_hardsigmoid, dLdz_mkl_md, x_mkl_md, 0.2f, 0.5f);
