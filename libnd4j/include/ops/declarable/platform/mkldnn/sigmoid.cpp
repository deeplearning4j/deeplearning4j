...
static void sigmoidMKLDNN(NDArray* x, NDArray* z) {
  ...
  dnnl::eltwise_forward::desc op_desc(dnnl::prop_kind::forward_inference, algorithm::eltwise_logistic, x_mkl_md, 0, 0);
...
static void sigmoidBpMKLDNN(NDArray* x, NDArray* dLdz, NDArray* dLdx) {
  ...
  // forward
  dnnl::eltwise_forward::desc op_ff_desc(dnnl::prop_kind::forward_inference, algorithm::eltwise_logistic, x_mkl_md, 0, 0);
  dnnl::eltwise_forward::primitive_desc op_ff_prim_desc(op_ff_desc, engine);

  // backward description
  dnnl::eltwise_backward::desc op_desc(algorithm::eltwise_logistic, dLdz_mkl_md, x_mkl_md, 0, 0);
