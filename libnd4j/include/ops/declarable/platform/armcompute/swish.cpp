...
//////////////////////////////////////////////////////////////////////////
// Swish: f(x) = x * sigmoid(x) (same as SiLU)
PLATFORM_IMPL(swish, ENGINE_CPU) {
  ...
  // ARM Compute has SWISH activation
  arm_compute::ActivationLayerInfo activationInfo(
      arm_compute::ActivationLayerInfo::ActivationFunction::SWISH);

  arm_compute::NEActivationLayer activation;
  activation.configure(&inTensor, &outTensor, activationInfo);
...
PLATFORM_CHECK(swish, ENGINE_CPU) {
  ...
  Requirements req("ARMCOMPUTE SWISH OP");
