...
PLATFORM_IMPL(silu, ENGINE_CPU) {
  ...
  // ARM Compute has SWISH activation which is SiLU
  arm_compute::ActivationLayerInfo info(arm_compute::ActivationLayerInfo::ActivationFunction::SWISH);
...
PLATFORM_CHECK(silu, ENGINE_CPU) {
  ...
  Requirements req("ARMCOMPUTE SILU OP");
