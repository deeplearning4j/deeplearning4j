...
//////////////////////////////////////////////////////////////////////////
PLATFORM_IMPL(batch_to_space, ENGINE_CPU) {
  ...
  // BatchToSpace is similar to DepthToSpace in ARM Compute
  arm_compute::NEBatchToSpaceLayer batchToSpace;
  batchToSpace.configure(&inTensor, blockSize, blockSize, &outTensor);
...
//////////////////////////////////////////////////////////////////////////
PLATFORM_CHECK(batch_to_space, ENGINE_CPU) {
  auto input = INPUT_VARIABLE(0);
  auto output = OUTPUT_VARIABLE(0);

  Requirements req("ARMCOMPUTE BATCH_TO_SPACE OP");
