...
CUSTOM_OP_IMPL(sru_old, 5, 2, false, 0, 0) {
    ...
    auto gct  = NDArrayFactory::create(state->ordering(), {bS, inSize}, state->dataType(), state->getWorkspace());
...
CUSTOM_OP_IMPL(sru_bp, 8, 4, true, 0, 0) {
    ...
    auto gradBias = NDArrayFactory::create(x->ordering(), {bS, 2*K, N}, gradX->dataType(), block.getWorkspace());
    auto gradU    = NDArrayFactory::create(x->ordering(), {bS, 3*K, N}, gradX->dataType(), block.getWorkspace());
    auto gradHX   = NDArrayFactory::create(x->ordering(), {bS, K, N}, gradX->dataType(), block.getWorkspace());
    auto gct      = NDArrayFactory::create(c->ordering(), {bS, K}, gradX->dataType(), block.getWorkspace());
    auto gradTanh = NDArrayFactory::create(c->ordering(), {bS, K}, gradX->dataType(), block.getWorkspace());
    auto gradCt   = NDArrayFactory::create(c->ordering(), {bS, K}, gradX->dataType(), block.getWorkspace());
    auto ftMinus  = NDArrayFactory::create(c->ordering(), {bS, K}, gradX->dataType(), block.getWorkspace());
    auto rtMinus  = NDArrayFactory::create(c->ordering(), {bS, K}, gradX->dataType(), block.getWorkspace());
    auto temp1    = NDArrayFactory::create(c->ordering(), {bS, K}, gradX->dataType(), block.getWorkspace());
    auto temp2    = NDArrayFactory::create(c->ordering(), {bS, K}, gradX->dataType(), block.getWorkspace());
