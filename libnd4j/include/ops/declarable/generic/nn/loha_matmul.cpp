...
CUSTOM_OP_IMPL(loha_matmul, 6, 1, false, 0, 0) {
  ...
  auto prod1 = NDArrayFactory::create('c', prodShape, input->dataType(), input->getContext());
  auto prod2 = NDArrayFactory::create('c', prodShape, input->dataType(), input->getContext());
...
CUSTOM_OP_IMPL(loha_matmul_bp, 7, 6, false, 0, 0) {
  ...
  *dLdInput += *dLdInputLoha;
  ...
  auto dLdOutTimesInput = NDArrayFactory::create('c', prodShape, input->dataType(), input->getContext());
  {
