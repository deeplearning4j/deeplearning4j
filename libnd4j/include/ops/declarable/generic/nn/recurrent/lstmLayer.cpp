...
//////////////////////////////////////////////////////////////////////////
        CUSTOM_OP_IMPL(lstmLayer_bp, 4, 1, false, 1, 5) {
            ...
            sd_printf("hasBiases %s\n",hasBiases ? "true" : "false");
            sd_printf("hasSeqLen %s\n",hasSeqLen? "true" : "false");
            sd_printf("hasInitH %s\n",hasInitH? "true" : "false");
            sd_printf("hasInitC %s\n",hasInitC? "true" : "false");
            sd_printf("hasPH %s\n",hasPH ? "true" : "false");
            sd_printf("retFullSeq %s\n",retFullSeq ? "true" : "false");
            sd_printf("retLastH %s\n" ,retLastH ? "true" : "false");
            sd_printf("retLastC %s\n",retLastC ? "true" : "false");
            ...
            if(hasPH)
                Wp->printBuffer("Peephole shape buffer");
            if(dLdhL != nullptr)
                sd_printf("dLdhL shape is scalar %d\n",dLdhL->isScalar());
            if(dLdcL != nullptr)
                sd_printf("dLdcL shape is scalar %d\n",dLdcL->isScalar());
            sd_printf("Count  at end is %d\n",count);
            ...
            if (dLdh) {
                ...
                REQUIRE_TRUE(
                        dLdh->isSameShape(expdLdhShape) || dLdh->isScalar(), 0,
