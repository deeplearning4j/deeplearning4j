...
namespace nd4j {
    namespace ops {
        CUSTOM_OP_IMPL(skipgram, 3, 1, true, 0, 0) {
            ...
            auto codes = INPUT_VARIABLE(2);
            auto syn0 = INPUT_VARIABLE(3);

            auto syn1 = INPUT_VARIABLE(4);
            auto syn1neg = INPUT_VARIABLE(5);
            auto expTable = INPUT_VARIABLE(6);

            auto alpha = INPUT_VARIABLE(7);
            auto randomValue = INPUT_VARIABLE(8);

            auto inferenceVector = INPUT_VARIABLE(9);
            ...
            nd4j::ops::helpers::skipgram(*syn0, *syn1, *syn1neg, *expTable, *target, *indices, *codes, *alpha, *randomValue, *inferenceVector);
        ...
        DECLARE_TYPES(skipgram) {
            getOpDescriptor()
                    ...
                    ->setAllowedInputTypes(2, nd4j::DataType::INT8)
                    ...
                    ->setAllowedInputTypes(8, nd4j::DataType::INT64)
