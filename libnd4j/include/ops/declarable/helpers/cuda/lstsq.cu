...
template <typename T>
static SD_KERNEL void fillRegularizerKernel(T* ioMatrixData, const sd::LongType* ioMatrixShape,
                                            const sd::LongType* ioMatrixTads, const sd::LongType* ioMatrixOffsets,
                                            sd::LongType batchSize, sd::LongType rows, T const value) {
