...
///////////////////////////////////////////////////////////////////
template <typename T>
SD_KERNEL SD_INLINE void amsGradUpdaterCuda(const void* vx, const LongType* xShapeInfo, const void* vinv,
