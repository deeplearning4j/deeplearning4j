...
///////////////////////////////////////////////////////////////////
template <typename T>
SD_KERNEL void adaMaxUpdaterCuda(const void* vx, const sd::LongType* xShapeInfo, const void* vinv,
...
///////////////////////////////////////////////////////////////////
template <typename T>
void adaMaxUpdaterCudaLauncher(const int blocksPerGrid, const int threadsPerBlock, const cudaStream_t* stream,
