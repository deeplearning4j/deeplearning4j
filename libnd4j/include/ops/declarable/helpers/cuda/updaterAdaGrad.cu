...
///////////////////////////////////////////////////////////////////
template <typename T>
SD_KERNEL SD_INLINE void adaGradUpdaterCuda(const void* vx, const LongType* xShapeInfo, const void* vin,
