...
//        }
    ...
    BUILD_SINGLE_TEMPLATE(template ND4J_LOCAL void adjustWeights_, (sd::LaunchContext * context, NDArray* input, NDArray* weights, NDArray* output, int minLength, int maxLength), GENERIC_NUMERIC_TYPES);
}
}
}