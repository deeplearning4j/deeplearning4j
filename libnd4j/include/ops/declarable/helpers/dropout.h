...
namespace helpers {
    ...
    template <typename T>
    int alphaDropOutFunctor(nd4j::random::RandomBuffer* rng, NDArray<T>* input, NDArray<T>* output, NDArray<T>* reduceShape, int seed, T probValue, T alpha, T alpha1, T beta);
