...
#ifndef LIBND4J_HELPERS_TWO_WAY_CROSS_ATTENTION_H
#define LIBND4J_HELPERS_TWO_WAY_CROSS_ATTENTION_H
...
SD_LIB_HIDDEN void twoWayCrossAttention(NDArray* tokenQuery, NDArray* tokenKey,
...
SD_LIB_HIDDEN void twoWayCrossAttentionBp(
