...
template void meshgrid<int>(const std::vector<NDArray<int>*>& inArrs, const std::vector<NDArray<int>*>& outArrs, const bool swapFirst2Dims);
template void meshgrid<Nd4jLong>(const std::vector<NDArray<Nd4jLong>*>& inArrs, const std::vector<NDArray<Nd4jLong>*>& outArrs, const bool swapFirst2Dims);
