...
#pragma omp parallel for if(outputList.size() > Environment::getInstance()->elementwiseThreshold()) schedule(static)
            ...
            template void dynamicPartitionFunctor(NDArray<int> const* input, NDArray<int> const* indices, std::vector<NDArray<int>*>& outputList);
            template void dynamicPartitionFunctor(NDArray<Nd4jLong> const* input, NDArray<Nd4jLong> const* indices, std::vector<NDArray<Nd4jLong>*>& outputList);
            ...
            template int dynamicStitchFunctor(std::vector<NDArray<int>*> const& inputs, std::vector<NDArray<int>*> const& indices, NDArray<int>* output);
            template int dynamicStitchFunctor(std::vector<NDArray<Nd4jLong>*> const& inputs, std::vector<NDArray<Nd4jLong>*> const& indices, NDArray<Nd4jLong>* output);
...
#pragma omp parallel for if(outputList.size() > Environment::getInstance()->elementwiseThreshold()) schedule(static)
            ...
            template void dynamicPartitionFunctorBP(NDArray<int> const* input, NDArray<int> const* indices, std::vector<NDArray<int>*> const& inputGradientList, std::vector<NDArray<int>*>& outputList);
            template void dynamicPartitionFunctorBP(NDArray<Nd4jLong> const* input, NDArray<Nd4jLong> const* indices, std::vector<NDArray<Nd4jLong>*> const& inputGradientList, std::vector<NDArray<Nd4jLong>*>& outputList);
            ...
            template int dynamicStitchFunctorBP(std::vector<NDArray<int>*> const& inputs, std::vector<NDArray<int>*> const& indices, NDArray<int> const* gradInput, std::vector<NDArray<int>*>& outputList);
            template int dynamicStitchFunctorBP(std::vector<NDArray<Nd4jLong>*> const& inputs, std::vector<NDArray<Nd4jLong>*> const& indices, NDArray<Nd4jLong> const* gradInput, std::vector<NDArray<Nd4jLong>*>& outputList);
