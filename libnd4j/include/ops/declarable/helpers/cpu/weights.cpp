...
namespace helpers {
    ...
    template void adjustWeights(NDArray<int>* input, NDArray<int>* weights, NDArray<int>* output, int minLength, int maxLength);
    template void adjustWeights(NDArray<Nd4jLong>* input, NDArray<Nd4jLong>* weights, NDArray<Nd4jLong>* output, int minLength, int maxLength);
}
}
}