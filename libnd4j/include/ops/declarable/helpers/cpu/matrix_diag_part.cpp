...
template int matrixDiagPart<int>(const NDArray<int>* input, NDArray<int>* output);
template int matrixDiagPart<Nd4jLong>(const NDArray<Nd4jLong>* input, NDArray<Nd4jLong>* output);
