...
//        }
        ...
        for (auto k = 0; k < shift; k++) {
            ...
            for (auto e = 0; e < alpha->lengthOf(); e++) {
                output->p(pos + e, math::nd4j_igamma<float,float,float>(alpha->e<float>(e), u));
//                output->p(pos + e, math::nd4j_igamma<float,float,float>(alpha->e<float>(e), beta?beta->e<float>(e) * u:u));
            }
        }
    }
