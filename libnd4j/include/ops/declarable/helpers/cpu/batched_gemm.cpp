...
namespace nd4j {
    namespace ops {
        namespace helpers {
            ...
            template <typename T>
            void __bgemm(graph::LaunchContext* context, std::vector<NDArray*>& vA, std::vector<NDArray*>& vB, std::vector<NDArray*>& vC, NDArray* alphas, NDArray* betas, int transA, int transB, int M, int N, int K, int ldA, int ldB, int ldC) {
            ...
            BUILD_SINGLE_TEMPLATE(template void __bgemm, (graph::LaunchContext* context, std::vector<NDArray*>& vA, std::vector<NDArray*>& vB, std::vector<NDArray*>& vC, NDArray* alphas, NDArray* betas, int transA, int transB, int M, int N, int K, int ldA, int ldB, int ldC), FLOAT_TYPES);
        }
    }
}