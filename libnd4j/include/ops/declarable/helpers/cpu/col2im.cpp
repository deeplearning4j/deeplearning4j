...
template void _col2im<int>(nd4j::graph::LaunchContext& context, int *in, int *output, Nd4jLong *outShapeInfo, Nd4jLong *inShapeInfo, int sH, int sW, int pH, int pW, int iH, int iW, int dH, int dW);
template void _col2im<Nd4jLong>(nd4j::graph::LaunchContext& context, Nd4jLong *in, Nd4jLong *output, Nd4jLong *outShapeInfo, Nd4jLong *inShapeInfo, int sH, int sW, int pH, int pW, int iH, int iW, int dH, int dW);
