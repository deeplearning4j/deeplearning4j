...
namespace nd4j {
    namespace ops {
        ...
        Nd4jStatus LegacyTransformSameOp::validateAndExecute(Context &block) {
            ...
            NativeOpExcutioner::execTransformSame(nullptr, opNum, input->getBuffer(), input->getShapeInfo(), z->getBuffer(), z->getShapeInfo(), block.getTArguments()->data(), nullptr, nullptr);
