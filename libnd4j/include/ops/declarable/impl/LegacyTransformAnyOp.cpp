...
namespace nd4j {
    namespace ops {
        ...
        Nd4jStatus LegacyTransformAnyOp::validateAndExecute(Context &block) {
            ...
            NativeOpExecutioner::execTransformAny(nullptr, opNum, input->getBuffer(), input->getShapeInfo(), z->getBuffer(), z->getShapeInfo(), block.getTArguments()->data(), nullptr, nullptr);
