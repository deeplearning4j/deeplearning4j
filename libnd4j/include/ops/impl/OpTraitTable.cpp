...
static const std::unordered_map<std::string, uint32_t>& getTraitTable() {
    ...
    std::call_once(traitTableFlag, []() { TABLE = {
        ...
        {"resize_area",             OP_TRAIT_FULLY_WRITING | OP_TRAIT_VALUE_DEPENDENT_SHAPE},
        {"resize_bicubic",          OP_TRAIT_FULLY_WRITING | OP_TRAIT_VALUE_DEPENDENT_SHAPE},
        {"resize_bilinear",         OP_TRAIT_FULLY_WRITING | OP_TRAIT_VALUE_DEPENDENT_SHAPE},
        {"resize_images",           OP_TRAIT_FULLY_WRITING | OP_TRAIT_VALUE_DEPENDENT_SHAPE},
        {"resize_nearest_neighbor", OP_TRAIT_FULLY_WRITING | OP_TRAIT_VALUE_DEPENDENT_SHAPE},
        ...
        {"moe_weighted_sum",          OP_TRAIT_FULLY_WRITING},
