...
// =============================================================================
// SPECIAL EXECUTION MACROS (No-op implementations)
// =============================================================================
...
#define DECLARE_STANDARD_BINARY_OP(OP_NAME, OPERATION)                                                                 \
  ...
  class OP_NAME {                                                                                                      \
   private:                                                                                                            \
    static SD_INLINE Z op_logic(X d1, Y d2) { return OPERATION; }                                                       \
    static SD_INLINE Z op_logic(X d1, Y d2, Z* params) { return OPERATION; }                                            \
    static SD_INLINE Z op_logic(X d1) { return static_cast<Z>(d1); }                                                    \
    static SD_INLINE Z op_logic(X d1, Y* params) { return OPERATION##_WITH_PARAMS; }                                    \
...
#define DECLARE_BINARY_MATH_OP(OP_NAME, MATH_FUNC)                                                                      \
  ...
  class OP_NAME {                                                                                                     \
   private:                                                                                                           \
    static SD_INLINE Z op_logic(X d1, Y d2) { return sd::math::MATH_FUNC<X, Y, Z>(d1, d2); }                          \
    static SD_INLINE Z op_logic(X d1, Y d2, Z* params) { return sd::math::MATH_FUNC<X, Y, Z>(d1, d2); }                \
    static SD_INLINE Z op_logic(X d1) { return static_cast<Z>(d1); }                                                   \
    static SD_INLINE Z op_logic(X d1, Y* params) { return sd::math::MATH_FUNC<X, Y, Z>(d1, params[0]); }               \
...
#define DECLARE_COMPARISON_OP(OP_NAME, COMPARISON)                                                   \
  ...
  class OP_NAME {                                                                                    \
   private:                                                                                          \
    ...
    static Z op_simd(X d1, X d2) { return op_logic(d1, d2); }                                         \
    static Z op_simd(X d1, X d2, X* params) { return op_logic(d1, d2, params); }                      \
    static Z op_simd(X d1, X* params) { return op_logic(d1, params); }                                \
                                                                                                     \
   public:                                                                                           \
...
#define DECLARE_REVERSE_BINARY_MATH_OP(OP_NAME, MATH_FUNC, START_VAL)                                                   \
  ...
  class OP_NAME {                                                                                                     \
   private:                                                                                                           \
    static SD_INLINE Z op_logic(X d1, Y d2) { return sd::math::MATH_FUNC<Y, X, Z>(d2, d1); }                          \
    static SD_INLINE Z op_logic(X d1, Y d2, Z* params) { return sd::math::MATH_FUNC<Y, X, Z>(d2, d1); }                \
    static SD_INLINE Z op_logic(X d1) { return static_cast<Z>(d1); }                                                   \
    static SD_INLINE Z op_logic(X d1, Y* params) { return sd::math::MATH_FUNC<Y, X, Z>(params[0], d1); }               \
    static Z op_simd(X d1, Y d2) { return op_logic(d1, d2); }                                                          \
    static Z op_simd(X d1, Y d2, Z* params) { return op_logic(d1, d2, params); }                                       \
    static Z op_simd(X d1) { return op_logic(d1); }                                                                    \
    static Z op_simd(X d1, Y* params) { return op_logic(d1, params); }                                                 \
...
#define DECLARE_SQUARED_BINARY_OP(OP_NAME, OPERATION)                                                               \
  ...
  class OP_NAME {                                                                                                   \
   ...
   public:                                                                                                          \
    static Z op(X d1, Y d2) {                                                                                       \
      if constexpr (simdOps::is_simd_unsupported_return_type<Z>::value) return op_logic(d1, d2);                     \
      else return op_simd(d1, d2);                                                                                  \
    }                                                                                                               \
    static Z op(X d1, Y d2, Z* params) {                                                                             \
      if constexpr (simdOps::is_simd_unsupported_return_type<Z>::value) return op_logic(d1, d2, params);             \
      else return op_simd(d1, d2, params);                                                                          \
    }                                                                                                               \
    static Z op(X d1) {                                                                                             \
      if constexpr (simdOps::is_simd_unsupported_return_type<Z>::value) return op_logic(d1);                         \
      else return op_simd(d1);                                                                                      \
    }                                                                                                               \
    static Z op(X d1, Y* params) {                                                                                  \
      if constexpr (simdOps::is_simd_unsupported_return_type<Z>::value) return op_logic(d1, params);                 \
      else return op_simd(d1, params);                                                                              \
    }                                                                                                               \
    SD_OP_DEF static X startingValue() { return static_cast<X>(0.f); }                                              \
  };
...
#define DECLARE_SAFE_DIVISION_OP(OP_NAME, CONDITION)                                                                   \
  ...
  class OP_NAME {                                                                                                    \
   private:                                                                                                          \
    static SD_INLINE Z op_logic(X d1, Y d2) {                                                                         \
      return CONDITION ? static_cast<Z>(0) : sd::math::sd_divide<X, Y, Z>(d1, d2);                                    \
    }                                                                                                                \
    static SD_INLINE Z op_logic(X d1, Y d2, Z* params) {                                                              \
      return CONDITION ? static_cast<Z>(0) : sd::math::sd_divide<X, Y, Z>(d1, d2);                                    \
    }                                                                                                                \
...
// Floor/Truncate division operations
  ...
  class OP_NAME {                                                                                                     \
   private:                                                                                                           \
    static SD_INLINE Z op_logic(X d1, Y d2) {                                                                         \
      ...
      return static_cast<Z>(sd::math::FLOOR_FUNC<double, Z>(divResult));                                              \
    }                                                                                                                 \
    static SD_INLINE Z op_logic(X d1, Y d2, Z* params) {                                                              \
      auto divResult = sd::math::sd_divide<X, Y, double>(d1, d2);                                                     \
      return static_cast<Z>(sd::math::FLOOR_FUNC<double, Z>(divResult));                                              \
    }                                                                                                                 \
    static SD_INLINE Z op_logic(X d1) { return sd::math::FLOOR_FUNC<X, Z>(d1); }                                       \
    static SD_INLINE Z op_logic(X d1, Y* params) {                                                                    \
...
// Modulo operations with special handling
...
#define DECLARE_UNARY_MATH_OP(OP_NAME, MATH_FUNC)                                                                       \
  ...
  class OP_NAME {                                                                                                       \
   private:                                                                                                             \
    static SD_INLINE X op_logic(X d1, X* params) { return sd::math::MATH_FUNC<X, X>(d1); }                               \
...
#define DECLARE_UNARY_SIMPLE_OP(OP_NAME, OPERATION)                                               \
  ...
  class OP_NAME {                                                                                 \
   ...
   public:                                                                                        \
    no_op_exec_special_same no_op_exec_special_same_cuda;                                         \
    static X op(X d1, X* params) {                                                               \
      if constexpr (simdOps::is_simd_unsupported_return_type<X>::value || std::is_same_v<X, bool>) \
        return op_logic(d1, params);                                                             \
      else                                                                                        \
        return op_simd(d1, params);                                                              \
    }                                                                                             \
...
// New macro for simple binary copy/transform operations
...
// New macro for simple binary operations with parameters only
...
#define DECLARE_REDUCE_FLOAT_OP(OP_NAME, REDUCE_TYPE_VAL, STARTING_VAL, MERGE_OP, UPDATE_OP, POST_PROCESS)           \
  ...
  class OP_NAME {                                                                                                  \
   ...
   public:                                                                                                         \
    ...
    template<typename T>                                                                                           \
    static typename std::enable_if<!std::is_same_v<T, InterType>, InterType>::type update(T old, InterType opOutput, Z* extraParams) { \
      return update(static_cast<InterType>(old), opOutput, extraParams);                                          \
    }                                                                                                              \
    template<typename T>                                                                                           \
    static typename std::enable_if<!std::is_same_v<T, InterType>, InterType>::type update(InterType old, T opOutput, Z* extraParams) { \
      return update(old, static_cast<InterType>(opOutput), extraParams);                                          \
    }                                                                                                              \
    template<typename T, typename U>                                                                               \
    static typename std::enable_if<!std::is_same_v<T, InterType> && !std::is_same_v<U, InterType>, InterType>::type update(T old, U opOutput, Z* extraParams) { \
      return update(static_cast<InterType>(old), static_cast<InterType>(opOutput), extraParams);                  \
    }                                                                                                              \
    template<typename U = X, typename V = Z>                                                                       \
    static typename std::enable_if<!std::is_same_v<U, V>, InterType>::type update(InterType old, InterType opOutput, X* extraParams) { \
    ...
    template<typename U = X, typename V = Z>                                                                       \
    static typename std::enable_if<!std::is_same_v<U, V>, InterType>::type op(X d1, X* extraParams) {             \
...
// Squared operation pattern - simplified to avoid macro issues
#define DECLARE_SQUARED_SUBTRACT_OP(OP_NAME, SUBTRACT_FUNC)                                     \
  template <typename X, typename Y, typename Z>                                                 \
  class OP_NAME {                                                                             \
   private:                                                                                   \
    static SD_INLINE Z op_logic(X d1, Y d2) {                                                 \
      Z diff = sd::math::SUBTRACT_FUNC<X,Y,Z>(d1, d2);                                       \
      return sd::math::sd_multiply<Z,Z,Z>(diff, diff);                                        \
    }                                                                                         \
    static SD_INLINE Z op_logic(X d1, Y d2, Z *params) {                                      \
      Z diff = sd::math::SUBTRACT_FUNC<X,Y,Z>(d1, d2);                                       \
    ...
    static SD_INLINE Z op_logic(X d1) { return static_cast<Z>(d1); }                          \
    static SD_INLINE Z op_logic(X d1, Y *params) {                                            \
      Z diff = sd::math::SUBTRACT_FUNC<X,Y,Z>(d1, params[0]);                                \
      return sd::math::sd_multiply<Z,Z,Z>(diff, diff);                                        \
    }                                                                                         \
    SD_OP_DEF static Z op_simd(X d1, Y d2) { return op_logic(d1, d2); }                       \
    SD_OP_DEF static Z op_simd(X d1, Y d2, Z *params) { return op_logic(d1, d2, params); }    \
...
class OP_NAME { \
 public: \
  ...
  static Y postProcess(Y reduction, sd::LongType n, Y *extraParamsRef) { return reduction; } \
  ...
  static Y update(Y old, Y opOutput, Y *extraParamsRef) { return old + opOutput; } \
  static void aggregateExtraParams(Y *extraParamsTotal, Y *extraParamsLocal) {} \
  static Y merge(Y old, Y opOutput, Y *extraParamsRef) { return update(old, opOutput, extraParamsRef); } \
};
...
class OP_NAME { \
 public: \
  ...
  static X *generateExtraParams() { return nullptr; } \
  static void finalizeExtraParams(X *extraParamsRef) {} \
  static Z startingValue(const X *input) { return static_cast<Z>(STARTING_VAL); } \
  static Z postProcess(Z reduction, sd::LongType n, Z *extraParamsRef) { return reduction; } \
  ...
  static Z merge(Z old, Z opOutput, Z *extraParamsRef) { return update(old, opOutput, extraParamsRef); } \
...
class OP_NAME { \
 private: \
  static SD_INLINE Z op_logic(X d1, Y d2) { \
    Z diff = sd::math::SUBTRACT_FUNC<Y,X,Z>(d2, d1); \
    return sd::math::sd_multiply<Z,Z,Z>(diff, diff); \
  } \
  static SD_INLINE Z op_logic(X d1, Y d2, Z *params) { \
    Z diff = sd::math::SUBTRACT_FUNC<Y,X,Z>(d2, d1); \
  ...
  static SD_INLINE Z op_logic(X d1) { return static_cast<Z>(d1); } \
  static SD_INLINE Z op_logic(X d1, Y *params) { \
    Z diff = sd::math::SUBTRACT_FUNC<Y,X,Z>(params[0], d1); \
    return sd::math::sd_multiply<Z,Z,Z>(diff, diff); \
  } \
  static Z op_simd(X d1, Y d2) { return op_logic(d1, d2); } \
  static Z op_simd(X d1, Y d2, Z *params) { return op_logic(d1, d2, params); } \
...
// Unary conditional with function call - for complex conditional logic
#define DECLARE_UNARY_CONDITIONAL_FUNC_OP(OP_NAME, CONDITION, TRUE_FUNC, FALSE_VAL) \
template <typename X> \
class OP_NAME { \
 public: \
  no_op_exec_special_same no_op_exec_special_same_cuda \
  SD_OP_DEF static X op(X d1, X *params) { \
    return (CONDITION) ? TRUE_FUNC : FALSE_VAL; \
  } \
};
...
#define DECLARE_UNARY_MATH_OP_XZ(OP_NAME, MATH_FUNC)                                                    \
  ...
  class OP_NAME {                                                                                       \
   private:                                                                                             \
    static SD_INLINE Z op_logic(X d1, Z* params) { return sd::math::MATH_FUNC<X, Z>(d1); }             \
    static Z op_simd(X d1, Z* params) { return op_logic(d1, params); }                                 \
                                                                                                        \
   public:                                                                                              \
    no_op_exec_special no_op_exec_special_cuda;                                                         \
...
// Unary complex math expression - for operations with complex mathematical formulas
...
class OP_NAME { \
 private: \
  ...
  static X op_simd(X d1, X *params) { return op_logic(d1, params); } /* REMOVE SD_OP_DEF HERE */ \
 public: \
  no_op_exec_special_same no_op_exec_special_same_cuda \
  static X op(X d1, X *params) { \
    if constexpr (simdOps::is_simd_unsupported_return_type<X>::value) \
      ...
      return op_simd(d1, params); /* This will have SIMD for supported types */ \
  } \
};

// Unary complex conditional - for operations with nested conditionals that can't use ternary
...
#define DECLARE_BINARY_MATH_OP_XZ(OP_NAME, MATH_FUNC)                                               \
  ...
  class OP_NAME {                                                                                   \
   private:                                                                                         \
    static SD_INLINE Z op_logic(X d1, Y d2) { return sd::math::MATH_FUNC<X, Z>(d1, static_cast<X>(d2)); } \
    static SD_INLINE Z op_logic(X d1, Y d2, Z* params) { return sd::math::MATH_FUNC<X, Z>(d1, static_cast<X>(d2)); } \
    static SD_INLINE Z op_logic(X d1) { return static_cast<Z>(d1); }                               \
    static SD_INLINE Z op_logic(X d1, Y* params) { return sd::math::MATH_FUNC<X, Z>(d1, static_cast<X>(params[0])); } \
    SD_OP_DEF static Z op_simd(X d1, Y d2) { return op_logic(d1, d2); }                            \
    SD_OP_DEF static Z op_simd(X d1, Y d2, Z* params) { return op_logic(d1, d2, params); }         \
    SD_OP_DEF static Z op_simd(X d1) { return op_logic(d1); }                                      \
    SD_OP_DEF static Z op_simd(X d1, Y* params) { return op_logic(d1, params); }                   \
...
// Bool logic (for boolean input types)
                                     extraParams[0] += static_cast<Y>(static_cast<int>(d1) * static_cast<int>(d1)); \
                                     extraParams[1] += static_cast<Y>(static_cast<int>(d2) * static_cast<int>(d2)); \
...
// Post process - calculate cosine similarity from dot product and norms
                                     reduction / (sd::math::sd_sqrt<Y COMMA Y>(extraParams[0]) * sd::math::sd_sqrt<Y COMMA Y>(extraParams[1]))
)
...
#define DECLARE_POWER_OP(OP_NAME, POWER_FUNC)                                                                       \
  ...
  class OP_NAME {                                                                                                 \
   private:                                                                                                       \
    static SD_INLINE Z op_logic(X d1, Z* params) { return sd::math::POWER_FUNC<X, X, Z>(d1, params[0]); }          \
    static SD_INLINE Z op_logic(X d1, Y d2) { return sd::math::POWER_FUNC<X, Y, Z>(d1, d2); }                       \
    static SD_INLINE Z op_logic(X d1, Y d2, Z* params) { return sd::math::POWER_FUNC<X, Y, Z>(d1, d2); }            \
    static SD_INLINE Z op_logic(X d1) { return d1; }                                                               \
    static Z op_simd(X d1, Z* params) { return op_logic(d1, params); }                                             \
    static Z op_simd(X d1, Y d2) { return op_logic(d1, d2); }                                                      \
    static Z op_simd(X d1, Y d2, Z* params) { return op_logic(d1, d2, params); }                                   \
    static Z op_simd(X d1) { return op_logic(d1); }                                                                \
...
// New macro for simple unary operations that just return the input
...
DECLARE_REDUCE3_OP_WITH_BOOL_SUPPORT(JaccardDistance,
                                     ...
                                     extraParams[0] += num_val; \
                                     extraParams[1] += denom_val; \
                                     ...
                                     2,
                                     0.0f,
                                     (static_cast<Y>(1.0f)) - (extraParams[0] / extraParams[1])
)
...
class OP_NAME { \
 public: \
  ...
  static void finalizeExtraParams(X *extraParams) {} \
  static Y startingValue(const X *input) { return static_cast<Y>(STARTING_VAL); } \
  static Y postProcess(Y reduction, sd::LongType n, Y *extraParams) { return static_cast<Y>(reduction / n); } \
  static Y op(X d1, X d2, Y *extraParams) { \
    if constexpr (std::is_same_v<X COMMA bool>) { \
      return static_cast<Y>(BOOL_LOGIC); \
    } else { \
...
DECLARE_REDUCE3_OP_WITH_BOOL_SUPPORT(CosineDistance,
                                     ...
                                     extraParams[1] += static_cast<Y>(static_cast<int>(d2) * static_cast<int>(d2)); \
                                     return static_cast<Y>(static_cast<int>(d1) * static_cast<int>(d2));,
                                     extraParams[0] += static_cast<Y>(sd::math::sd_abs<X COMMA X>(d1) * sd::math::sd_abs<X COMMA X>(d1)); \
                                     extraParams[1] += static_cast<Y>(sd::math::sd_abs<X COMMA X>(d2) * sd::math::sd_abs<X COMMA X>(d2)); \
                                     return static_cast<Y>(d1 * d2);,
                                     2,
                                     0.0f,
                                     (static_cast<Y>(1.0f)) - (reduction / (sd::math::sd_sqrt<Y COMMA Y>(extraParams[0]) * sd::math::sd_sqrt<Y COMMA Y>(extraParams[1])))
)
...
class DropOut {
 public:
  no_op_exec_special_same no_op_exec_special_same_cuda
  inline SD_DEVICE static X op(X d1, X *params) {
    X prob = params[0];
#ifdef __CUDACC__
    X length = params[1];
...
class CompareAndSet {
 private:
  static SD_INLINE Z op_logic(X dX, Y dY, Z *params) {
  ...
  static Z op_simd(X dX, Y dY, Z *params) { return op_logic(dX, dY, params); }

 public:
  static Z op(X dX, Y dY, Z *params) {
    if constexpr (simdOps::is_simd_unsupported_return_type<Z>::value ||
                  simdOps::is_simd_unsupported_argument_type<X>::value ||
                  simdOps::is_simd_unsupported_argument_type<Y>::value)
...
#define DECLARE_BENCHMARK_REDUCE_OP(OP_NAME, OPERATION)                                           \
  ...
  class OP_NAME {                                                                                 \
   private:                                                                                       \
    static SD_INLINE X op_logic(X d1, X* extraParams) { OPERATION }                              \
    static SD_INLINE X merge_logic(X old, X opOutput, X* extraParams) { return opOutput + old; } \
    static SD_INLINE X update_logic(X old, X opOutput, X* extraParams) { return opOutput + old; } \
    static SD_INLINE X postProcess_logic(X reduction, sd::LongType n, X* extraParams) { return reduction; } \
    SD_OP_DEF static X op_simd(X d1, X* extraParams) { return op_logic(d1, extraParams); }       \
    SD_OP_DEF static X merge_simd(X old, X opOutput, X* extraParams) { return merge_logic(old, opOutput, extraParams); } \
    SD_OP_DEF static X update_simd(X old, X opOutput, X* extraParams) { return update_logic(old, opOutput, extraParams); } \
    SD_OP_DEF static X postProcess_simd(X reduction, sd::LongType n, X* extraParams) { return postProcess_logic(reduction, n, extraParams); } \
                                                                                                  \
   public:                                                                                        \
    no_op_exec_special_accumulation_same no_op_exec_special_accumulation_same_cuda               \
    const static functions::ReduceType reduceType = functions::ReduceType::SUM;                  \
    static X startingValue(const X* input) { return static_cast<X>(0.0f); }                      \
    static X op(X d1, X* extraParams) {                                                          \
      if constexpr (simdOps::is_simd_unsupported_return_type<X>::value)                           \
        return op_logic(d1, extraParams);                                                        \
      else                                                                                        \
  ...
  class OP_NAME {                                                                                 \
   public:                                                                                        \
    using InterType = typename AggregateType<Z>::type;                                           \
                                                                                                  \
   private:                                                                                       \
    static SD_INLINE InterType op_logic(X d1, Z* extraParams) { OPERATION }                      \
    static SD_INLINE InterType merge_logic(InterType old, InterType opOutput, Z* extraParams) { return opOutput + old; } \
    static SD_INLINE InterType update_logic(InterType old, InterType opOutput, Z* extraParams) { return opOutput + old; } \
    static SD_INLINE Z postProcess_logic(InterType reduction, sd::LongType n, Z* extraParams) {  \
      return POST_PROCESS;                                                                        \
    }                                                                                             \
    SD_OP_DEF static InterType op_simd(X d1, Z* extraParams) { return op_logic(d1, extraParams); } \
...
// SIMD-Safe Binary Operation Macro
#define DECLARE_BINARY_SIMD_SAFE_OP(OP_NAME, OPERATION)                                             \
  template <typename X, typename Y, typename Z>                                                 \
  class OP_NAME {                                                                               \
   private:                                                                                     \
    static SD_INLINE Z op_logic(X d1, Y d2, Z* params) { OPERATION }                           \
    SD_OP_DEF static Z op_simd(X d1, Y d2, Z* params) { return op_logic(d1, d2, params); }     \
                                                                                                \
   public:                                                                                      \
    no_op_exec_special no_op_exec_special_cuda;                                                 \
...
// SIMD-Safe Reduce Operation Macro
#define DECLARE_REDUCE_SIMD_SAFE_OP(OP_NAME, OPERATION)                                             \
  template <typename X, typename Z>                                                             \
  class OP_NAME {                                                                               \
   private:                                                                                     \
    static SD_INLINE Z op_logic(X d1, Z* params) { OPERATION }                                 \
    static Z op_simd(X d1, Z* params) { return op_logic(d1, params); }               \
                                                                                                \
   public:                                                                                      \
    ...
    template<typename U = X, typename V = Z>                                                   \
    static typename std::enable_if<!std::is_same_v<U, V>, Z>::type op(X d1, X* extraParams) { \
      return op(d1, reinterpret_cast<Z*>(extraParams));                                        \
    }                                                                                           \
    static X startingValue(const X* input) { return static_cast<X>(0); }                       \
    SD_OP_DEF static Z merge(Z old, Z opOutput, Z* extraParams) { return opOutput + old; }     \
    SD_OP_DEF static Z update(Z old, Z opOutput, Z* extraParams) { return opOutput + old; }    \
    template<typename U = X, typename V = Z>                                                   \
    static typename std::enable_if<!std::is_same_v<U, V>, Z>::type update(Z old, Z opOutput, X* extraParams) { \
      return update(old, opOutput, reinterpret_cast<Z*>(extraParams));                         \
    }                                                                                           \
    SD_OP_DEF static Z postProcess(Z reduction, sd::LongType n, Z* extraParams) { return reduction; } \
    template<typename U = X, typename V = Z>                                                   \
    static typename std::enable_if<!std::is_same_v<U, V>, Z>::type postProcess(Z reduction, sd::LongType n, X* extraParams) { \
      return postProcess(reduction, n, reinterpret_cast<Z*>(extraParams));                     \
    }                                                                                           \
  };

// SIMD-Safe Accumulation Operation Macro (for complex reduce ops)
  ...
  class OP_NAME {                                                                               \
   public:                                                                                      \
    using InterType = typename AggregateType<Z>::type;                                         \
                                                                                                \
   private:                                                                                     \
    static SD_INLINE InterType op_logic(X d1, Z* params) { OPERATION }                         \
    static SD_INLINE InterType merge_logic(InterType old, InterType opOutput, Z* extraParams) { return MERGE_OP; } \
    static SD_INLINE InterType update_logic(InterType old, InterType opOutput, Z* extraParams) { return UPDATE_OP; } \
    static SD_INLINE Z postProcess_logic(InterType reduction, sd::LongType n, Z* extraParams) { \
      return static_cast<Z>(POST_PROCESS);                                                      \
    }                                                                                           \
    SD_OP_DEF static InterType op_simd(X d1, Z* params) { return op_logic(d1, params); }       \
    SD_OP_DEF static InterType merge_simd(InterType old, InterType opOutput, Z* extraParams) { \
      return merge_logic(old, opOutput, extraParams);                                          \
    }                                                                                           \
    SD_OP_DEF static InterType update_simd(InterType old, InterType opOutput, Z* extraParams) { \
...
#define DECLARE_MIXED_ACCUMULATION_SIMD_SAFE_OP(OP_NAME, OP_LOGIC, REDUCE_TYPE_VAL, STARTING_VAL, MERGE_OP, UPDATE_OP, POST_PROCESS) \
  ...
  class OP_NAME {                                                                               \
   private:                                                                                     \
    static SD_INLINE Z op_logic(X d1, Z* params) { OP_LOGIC }                                  \
    static SD_INLINE Z merge_logic(Z old, Z opOutput, Z* extraParams) { return MERGE_OP; }     \
    static SD_INLINE Z update_logic(Z old, Z opOutput, Z* extraParams) { return UPDATE_OP; }   \
    static SD_INLINE Z postProcess_logic(Z reduction, sd::LongType n, Z* extraParams) { return POST_PROCESS; } \
    SD_OP_DEF static Z op_simd(X d1, Z* params) { return op_logic(d1, params); }               \
    SD_OP_DEF static Z merge_simd(Z old, Z opOutput, Z* extraParams) { return merge_logic(old, opOutput, extraParams); } \
    SD_OP_DEF static Z update_simd(Z old, Z opOutput, Z* extraParams) { return update_logic(old, opOutput, extraParams); } \
    SD_OP_DEF static Z postProcess_simd(Z reduction, sd::LongType n, Z* extraParams) { return postProcess_logic(reduction, n, extraParams); } \
                                                                                                \
   public:                                                                                      \
    no_op_exec_special_accumulation no_op_exec_special_accumulation_cuda                       \
    const static functions::ReduceType reduceType = functions::ReduceType::REDUCE_TYPE_VAL;    \
    ...
    template<typename T>                                                                       \
    static typename std::enable_if<!std::is_same_v<T, Z>, Z>::type update(T old, Z opOutput, Z* extraParams) { \
      return update(static_cast<Z>(old), opOutput, extraParams);                              \
    }                                                                                          \
    template<typename T>                                                                       \
    static typename std::enable_if<!std::is_same_v<T, Z>, Z>::type update(Z old, T opOutput, Z* extraParams) { \
      return update(old, static_cast<Z>(opOutput), extraParams);                              \
    }                                                                                          \
    template<typename T, typename U>                                                          \
    static typename std::enable_if<!std::is_same_v<T, Z> && !std::is_same_v<U, Z>, Z>::type update(T old, U opOutput, Z* extraParams) { \
    ...
    template<typename T>                                                                       \
    static typename std::enable_if<!std::is_same_v<T, Z>, Z>::type postProcess(T reduction, sd::LongType n, Z* extraParams) { \
    ...
    template<typename T, typename U = X, typename V = Z>                                      \
    static typename std::enable_if<!std::is_same_v<T, Z> && !std::is_same_v<U, V>, Z>::type postProcess(T reduction, sd::LongType n, X* extraParams) { \
...
#define DECLARE_COMPLEX_ACCUMULATION_SIMD_SAFE_OP(OP_NAME, OP_LOGIC, OP_BINARY_LOGIC, OP_BINARY_NO_PARAMS_LOGIC, REDUCE_TYPE_VAL, STARTING_VAL, MERGE_OP, UPDATE_OP, POST_PROCESS) \
  ...
  class OP_NAME {                                                                               \
   private:                                                                                     \
    static SD_INLINE X op_logic(X d1, X* params) { OP_LOGIC }                                  \
    static SD_INLINE X op_binary_logic(X d1, X d2, X* params) { OP_BINARY_LOGIC }              \
    static SD_INLINE X op_binary_no_params_logic(X d1, X d2) { OP_BINARY_NO_PARAMS_LOGIC }     \
    static X op_simd(X d1, X* params) { return op_logic(d1, params); }                         \
    static X op_binary_simd(X d1, X d2, X* params) { return op_binary_logic(d1, d2, params); } \
    static X op_binary_no_params_simd(X d1, X d2) { return op_binary_no_params_logic(d1, d2); } \
    static SD_INLINE X merge_logic(X old, X opOutput, X* extraParams) { return MERGE_OP; }     \
    static SD_INLINE X update_logic(X old, X opOutput, X* extraParams) { return UPDATE_OP; }   \
    static SD_INLINE X postProcess_logic(X reduction, sd::LongType n, X* extraParams) { return POST_PROCESS; } \
    static X merge_simd(X old, X opOutput, X* extraParams) { return merge_logic(old, opOutput, extraParams); } \
    static X update_simd(X old, X opOutput, X* extraParams) { return update_logic(old, opOutput, extraParams); } \
    static X postProcess_simd(X reduction, sd::LongType n, X* extraParams) { return postProcess_logic(reduction, n, extraParams); } \
                                                                                                \
   public:                                                                                      \
    no_op_exec_special_accumulation_same no_op_exec_special_accumulation_same_cuda             \
    const static functions::ReduceType reduceType = functions::ReduceType::REDUCE_TYPE_VAL;    \
...
#define DECLARE_MULTI_OP_SIMD_SAFE(OP_NAME, BINARY_OP, BINARY_PARAMS_OP, UNARY_OP, UNARY_PARAMS_OP) \
  ...
  class OP_NAME {                                                                              \
   private:                                                                                    \
    static SD_INLINE Z binary_op_logic(X d1, X d2) { BINARY_OP }                              \
    static SD_INLINE Z binary_params_op_logic(X d1, X d2, X* params) { BINARY_PARAMS_OP }     \
    static SD_INLINE Z unary_op_logic(X d1) { UNARY_OP }                                      \
    static SD_INLINE Z unary_params_op_logic(X d1, X* params) { UNARY_PARAMS_OP }             \
    static Z binary_op_simd(X d1, X d2) { return binary_op_logic(d1, d2); }         \
    static Z binary_params_op_simd(X d1, X d2, X* params) { return binary_params_op_logic(d1, d2, params); } \
    static Z unary_op_simd(X d1) { return unary_op_logic(d1); }                     \
    static Z unary_params_op_simd(X d1, X* params) { return unary_params_op_logic(d1, params); } \
                                                                                               \
   public:                                                                                     \
    no_op_exec_special_bool no_op_exec_special_bool_cuda                                       \
    static Z op(X d1, X d2) {                                                                 \
...
DECLARE_MIXED_ACCUMULATION_SIMD_SAFE_OP(IsInfOrNan,
                                        return sd::math::sd_isfin<X>(d1) ? static_cast<Z>(0) : static_cast<Z>(1);,
                                        SUM, static_cast<X>(0),
                                        opOutput == static_cast<Z>(0) && old == static_cast<Z>(0) ? static_cast<Z>(0) : static_cast<Z>(1),
                                        opOutput == static_cast<Z>(0) && old == static_cast<Z>(0) ? static_cast<Z>(0) : static_cast<Z>(1),
                                        reduction != static_cast<Z>(0)
)

// IsFinite operation
DECLARE_MIXED_ACCUMULATION_SIMD_SAFE_OP(IsFinite,
...
class Assign {
 private:
  static SD_INLINE Z op_logic(X d1, X *params) {
...
#define DECLARE_UNARY_CLIPPING_OP(OP_NAME, CLIPPING_LOGIC)                                         \
  ...
  class OP_NAME {                                                                                  \
   private:                                                                                        \
    static SD_INLINE X op_logic(X d1, X *params) { CLIPPING_LOGIC }                               \
    static X op_simd(X d1, X *params) { return op_logic(d1, params); }                            \
                                                                                                   \
   public:                                                                                         \
    no_op_exec_special_same no_op_exec_special_same_cuda;                                          \
...
#define DECLARE_SIMPLE_BINARY_OP(OP_NAME, OPERATION)                                           \
  ...
  class OP_NAME {                                                                             \
   private:                                                                                   \
    ...
    static X op_simd(X d1, X d2) { return op_logic(d1, d2); }                                \
    static X op_simd(X d1, X d2, X *params) { return op_logic(d1, d2, params); }             \
                                                                                              \
   public:                                                                                    \
    static X op(X d1, X d2) {                                                                 \
      if constexpr (simdOps::is_simd_unsupported_return_type<X>::value)                       \
...
class Epsilon {
 private:
  ...
  static SD_INLINE Z op_logic(X d1, X *params) { return static_cast<Z>(d1); }
  static Z op_simd(X d1, X d2) { return op_logic(d1, d2); }
  static Z op_simd(X d1, X d2, X *params) { return op_logic(d1, d2, params); }
  static Z op_simd(X d1, X *params) { return op_logic(d1, params); }
...
class MatchConditionBool {
 private:
  static SD_INLINE Z op_logic(X d1, X *extraParams) {
 ...
 public:
  ...
  static Z op(X d1, X *extraParams) {
    if constexpr (simdOps::is_simd_unsupported_return_type<Z>::value ||
                  simdOps::is_simd_unsupported_argument_type<X>::value)
      return op_logic(d1, extraParams);
    else
...
class IndexAbsoluteMax {
 public:
  ...
  static SD_HOST_DEVICE inline X startingValue(const X *input) { return static_cast<X>(0); }
  static SD_HOST_DEVICE inline functions::indexreduce::IndexValue<X> startingIndexValue(const X *input) {
    functions::indexreduce::IndexValue<X> local;
    local.value = startingValue(input);
    local.index = 0;
...
class BinaryRelativeError {
 private:
  ...
  static SD_INLINE Z op_logic(X d1) { return static_cast<Z>(0); }
  SD_OP_DEF static Z op_simd(X d1, Y d2, Z *params) { return op_logic(d1, d2, params); }
  SD_OP_DEF static Z op_simd(X d1) { return op_logic(d1); }
...
class MatchCondition {
 private:
  static SD_INLINE Z op_logic(X d1, X compare, X eps, int mode) {
    switch (mode) {
  ...
  static Z op_simd_dispatch(X d1, X* extraParams) {
    X compare = extraParams[0];
    X eps = extraParams[1];
    auto mode = static_cast<int>(extraParams[2]);
  ...
  static Z op_simd_dispatch_3param(X d1, X compare, X* extraParams) {
    X eps = extraParams[0];
 ...
 public:
  ...
  SD_OP_DEF static Z merge(Z old, Z opOutput, X* extraParams) { return static_cast<Z>(old + opOutput); }
  SD_OP_DEF static Z update(Z old, Z opOutput, X* extraParams) { return static_cast<Z>(old + opOutput); }
  SD_OP_DEF static Z postProcess(Z reduction, sd::LongType n, X* extraParams) { return static_cast<Z>(reduction); }

  static SD_INLINE Z op(X d1, X compare, X eps, int mode) {
    return op_logic(d1, compare, eps, mode);
  }
  ...
  static Z op(X d1, X compare, X* extraParams) {
    if constexpr (is_simd_unsupported_return_type<Z>::value ||
                  is_simd_unsupported_argument_type<X>::value) {
      X eps = extraParams[0];
      auto mode = static_cast<int>(extraParams[1]);
