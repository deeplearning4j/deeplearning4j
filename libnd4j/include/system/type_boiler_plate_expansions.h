...
#define SD_INT32_IS_INT (std::is_same<Int32Type, int>::value)
#define SD_INT32_IS_LONG (std::is_same<Int32Type, long>::value)

#define SD_INT64_IS_LONG (std::is_same<LongType, long>::value)
#define SD_INT64_IS_LONG_LONG (std::is_same<LongType, long long>::value)

#define SD_UINT32_IS_UINT (std::is_same<UInt32Type, unsigned int>::value)
#define SD_UINT32_IS_ULONG (std::is_same<UInt32Type, unsigned long>::value)

#define SD_UINT64_IS_ULONG (std::is_same<UInt64Type, unsigned long>::value)
#define SD_UINT64_IS_ULONG_LONG (std::is_same<UInt64Type, unsigned long long>::value)
...
#define _EXPAND_RANDOMSINGLE_int16_t(TEMPLATE_NAME, SIGNATURE) \
    template TEMPLATE_NAME<Int16Type> SIGNATURE;
#define _EXPAND_RANDOMSINGLE_Int16Type(TEMPLATE_NAME, SIGNATURE) _EXPAND_RANDOMSINGLE_int16_t(TEMPLATE_NAME, SIGNATURE)

#define _EXPAND_RANDOMSINGLE_uint16_t(TEMPLATE_NAME, SIGNATURE) \
    template TEMPLATE_NAME<UInt16Type> SIGNATURE;
...
#define _EXPAND_RANDOMSINGLE_UInt16Type(TEMPLATE_NAME, SIGNATURE) _EXPAND_RANDOMSINGLE_uint16_t(TEMPLATE_NAME, SIGNATURE)

#define _EXPAND_RANDOMSINGLE_int32_t(TEMPLATE_NAME, SIGNATURE) \
    template TEMPLATE_NAME<Int32Type> SIGNATURE;
...
#define _EXPAND_RANDOMSINGLE_uint32_t(TEMPLATE_NAME, SIGNATURE) \
    template TEMPLATE_NAME<UInt32Type> SIGNATURE;

#define _EXPAND_RANDOMSINGLE_uint32(TEMPLATE_NAME, SIGNATURE) _EXPAND_RANDOMSINGLE_uint32_t(TEMPLATE_NAME, SIGNATURE)
#define _EXPAND_RANDOMSINGLE_UInt32Type(TEMPLATE_NAME, SIGNATURE) _EXPAND_RANDOMSINGLE_uint32_t(TEMPLATE_NAME, SIGNATURE)
...
#define _EXPAND_RANDOMSINGLE_uint64_t(TEMPLATE_NAME, SIGNATURE) \
    template TEMPLATE_NAME<UInt64Type> SIGNATURE;

#define _EXPAND_RANDOMSINGLE_uint64(TEMPLATE_NAME, SIGNATURE) _EXPAND_RANDOMSINGLE_uint64_t(TEMPLATE_NAME, SIGNATURE)
#define _EXPAND_RANDOMSINGLE_UInt64Type(TEMPLATE_NAME, SIGNATURE) _EXPAND_RANDOMSINGLE_uint64_t(TEMPLATE_NAME, SIGNATURE)
...
#define _EXPAND_RANDOMSINGLE_stdstring(TEMPLATE_NAME, SIGNATURE) template TEMPLATE_NAME<stdstring> SIGNATURE;
...
#define _EXPAND_RANDOMDOUBLE2_SECOND_Int16Type(TEMPLATE_NAME, SIGNATURE, FIRST) _EXPAND_RANDOMDOUBLE2_SECOND_int16_t(TEMPLATE_NAME, SIGNATURE, FIRST)
...
#define _EXPAND_RANDOMDOUBLE2_SECOND_UInt16Type(TEMPLATE_NAME, SIGNATURE, FIRST) _EXPAND_RANDOMDOUBLE2_SECOND_uint16_t(TEMPLATE_NAME, SIGNATURE, FIRST)
...
#define _EXPAND_RANDOMDOUBLE2_SECOND_int(TEMPLATE_NAME, SIGNATURE, FIRST) \
    SD_IF_PAIR_ALIAS_COMPILED_DECL(FIRST, int, template TEMPLATE_NAME<FIRST, int> SIGNATURE;)
...
#define _EXPAND_RANDOMDOUBLE2_SECOND_UInt32Type(TEMPLATE_NAME, SIGNATURE, FIRST) _EXPAND_RANDOMDOUBLE2_SECOND_uint32_t(TEMPLATE_NAME, SIGNATURE, FIRST)
...
#define _EXPAND_RANDOMDOUBLE2_SECOND_PlatformUInt64(TEMPLATE_NAME, SIGNATURE, FIRST) _EXPAND_RANDOMDOUBLE2_SECOND_uint64_t(TEMPLATE_NAME, SIGNATURE, FIRST)


#define _EXPAND_RANDOMDOUBLE2_SECOND_ulong(TEMPLATE_NAME, SIGNATURE, FIRST) \
    SD_IF_PAIR_ALIAS_COMPILED_DECL(FIRST, UnsignedLong, template TEMPLATE_NAME<FIRST, UnsignedLong> SIGNATURE;)

#define _EXPAND_RANDOMDOUBLE2_SECOND_char(TEMPLATE_NAME, SIGNATURE, FIRST) \
    SD_IF_PAIR_ALIAS_COMPILED_DECL(FIRST, SignedChar, template TEMPLATE_NAME<FIRST, SignedChar> SIGNATURE;)


// Floating point types - no aliases
#define _EXPAND_RANDOMDOUBLE2_SECOND_float(TEMPLATE_NAME, SIGNATURE, FIRST) SD_IF_PAIR_ALIAS_COMPILED_DECL(FIRST, float, template TEMPLATE_NAME<FIRST, float> SIGNATURE;)
#define _EXPAND_RANDOMDOUBLE2_SECOND_double(TEMPLATE_NAME, SIGNATURE, FIRST) SD_IF_PAIR_ALIAS_COMPILED_DECL(FIRST, double, template TEMPLATE_NAME<FIRST, double> SIGNATURE;)
#define _EXPAND_RANDOMDOUBLE2_SECOND_float16(TEMPLATE_NAME, SIGNATURE, FIRST) SD_IF_PAIR_ALIAS_COMPILED_DECL(FIRST, float16, template TEMPLATE_NAME<FIRST, float16> SIGNATURE;)
#define _EXPAND_RANDOMDOUBLE2_SECOND_bfloat16(TEMPLATE_NAME, SIGNATURE, FIRST) SD_IF_PAIR_ALIAS_COMPILED_DECL(FIRST, bfloat16, template TEMPLATE_NAME<FIRST, bfloat16> SIGNATURE;)
#define _EXPAND_RANDOMDOUBLE2_SECOND_half(TEMPLATE_NAME, SIGNATURE, FIRST) SD_IF_PAIR_ALIAS_COMPILED_DECL(FIRST, float16, template TEMPLATE_NAME<FIRST, float16> SIGNATURE;)
#define _EXPAND_RANDOMDOUBLE2_SECOND_bool(TEMPLATE_NAME, SIGNATURE, FIRST) \
    SD_IF_PAIR_ALIAS_COMPILED_DECL(FIRST, bool, template TEMPLATE_NAME<FIRST, bool> SIGNATURE;)

// Boolean value template parameters (for non-type bool template args in second position)
#define _EXPAND_RANDOMDOUBLE2_SECOND_false(TEMPLATE_NAME, SIGNATURE, FIRST) template TEMPLATE_NAME<FIRST, false> SIGNATURE;
#define _EXPAND_RANDOMDOUBLE2_SECOND_true(TEMPLATE_NAME, SIGNATURE, FIRST) template TEMPLATE_NAME<FIRST, true> SIGNATURE;

// String types
#define _EXPAND_RANDOMDOUBLE2_SECOND_UTF8(TEMPLATE_NAME, SIGNATURE, FIRST) SD_IF_PAIR_ALIAS_COMPILED_DECL(FIRST, utf8string, template TEMPLATE_NAME<FIRST, utf8string> SIGNATURE;)
#define _EXPAND_RANDOMDOUBLE2_SECOND_UTF16(TEMPLATE_NAME, SIGNATURE, FIRST) SD_IF_PAIR_ALIAS_COMPILED_DECL(FIRST, utf16string, template TEMPLATE_NAME<FIRST, utf16string> SIGNATURE;)
#define _EXPAND_RANDOMDOUBLE2_SECOND_UTF32(TEMPLATE_NAME, SIGNATURE, FIRST) SD_IF_PAIR_ALIAS_COMPILED_DECL(FIRST, utf32string, template TEMPLATE_NAME<FIRST, utf32string> SIGNATURE;)
#define _EXPAND_RANDOMDOUBLE2_SECOND_utf8string(TEMPLATE_NAME, SIGNATURE, FIRST) SD_IF_PAIR_ALIAS_COMPILED_DECL(FIRST, utf8string, template TEMPLATE_NAME<FIRST, utf8string> SIGNATURE;)
#define _EXPAND_RANDOMDOUBLE2_SECOND_utf16string(TEMPLATE_NAME, SIGNATURE, FIRST) SD_IF_PAIR_ALIAS_COMPILED_DECL(FIRST, utf16string, template TEMPLATE_NAME<FIRST, utf16string> SIGNATURE;)
#define _EXPAND_RANDOMDOUBLE2_SECOND_utf32string(TEMPLATE_NAME, SIGNATURE, FIRST) SD_IF_PAIR_ALIAS_COMPILED_DECL(FIRST, utf32string, template TEMPLATE_NAME<FIRST, utf32string> SIGNATURE;)
#define _EXPAND_RANDOMDOUBLE2_SECOND_string(TEMPLATE_NAME, SIGNATURE, FIRST) SD_IF_PAIR_ALIAS_COMPILED_DECL(FIRST, stdstring, template TEMPLATE_NAME<FIRST, stdstring> SIGNATURE;)
...
// INT16/UINT16 types first position
#define _EXPAND_RANDOMDOUBLE2_int16_t(TEMPLATE_NAME, SIGNATURE, TYPE_B) \
    CONCAT(_EXPAND_RANDOMDOUBLE2_SECOND_, TYPE_B)(TEMPLATE_NAME, SIGNATURE, Int16Type)
...
#define _EXPAND_RANDOMDOUBLE2_Int16Type(TEMPLATE_NAME, SIGNATURE, TYPE_B) _EXPAND_RANDOMDOUBLE2_int16_t(TEMPLATE_NAME, SIGNATURE, TYPE_B)

#define _EXPAND_RANDOMDOUBLE2_uint16_t(TEMPLATE_NAME, SIGNATURE, TYPE_B) \
    CONCAT(_EXPAND_RANDOMDOUBLE2_SECOND_, TYPE_B)(TEMPLATE_NAME, SIGNATURE, UInt16Type)
...
#define _EXPAND_RANDOMDOUBLE2_UInt16Type(TEMPLATE_NAME, SIGNATURE, TYPE_B) _EXPAND_RANDOMDOUBLE2_uint16_t(TEMPLATE_NAME, SIGNATURE, TYPE_B)

// INT32/UINT32 types first position
#define _EXPAND_RANDOMDOUBLE2_int32_t(TEMPLATE_NAME, SIGNATURE, TYPE_B) \
    CONCAT(_EXPAND_RANDOMDOUBLE2_SECOND_, TYPE_B)(TEMPLATE_NAME, SIGNATURE, Int32Type)
...
#define _EXPAND_RANDOMDOUBLE2_uint32_t(TEMPLATE_NAME, SIGNATURE, TYPE_B) \
    CONCAT(_EXPAND_RANDOMDOUBLE2_SECOND_, TYPE_B)(TEMPLATE_NAME, SIGNATURE, UInt32Type)
...
#define _EXPAND_RANDOMDOUBLE2_UInt32Type(TEMPLATE_NAME, SIGNATURE, TYPE_B) _EXPAND_RANDOMDOUBLE2_uint32_t(TEMPLATE_NAME, SIGNATURE, TYPE_B)

// INT64/UINT64 types first position
...
#define _EXPAND_RANDOMDOUBLE2_uint64_t(TEMPLATE_NAME, SIGNATURE, TYPE_B) \
    CONCAT(_EXPAND_RANDOMDOUBLE2_SECOND_, TYPE_B)(TEMPLATE_NAME, SIGNATURE, UInt64Type)
...
#define _EXPAND_RANDOMDOUBLE2_UInt64Type(TEMPLATE_NAME, SIGNATURE, TYPE_B) _EXPAND_RANDOMDOUBLE2_uint64_t(TEMPLATE_NAME, SIGNATURE, TYPE_B)
...
// Boolean value template parameters (for non-type bool template args)
#define _EXPAND_RANDOMDOUBLE2_false(TEMPLATE_NAME, SIGNATURE, TYPE_B) CONCAT(_EXPAND_RANDOMDOUBLE2_SECOND_, TYPE_B)(TEMPLATE_NAME, SIGNATURE, false)
#define _EXPAND_RANDOMDOUBLE2_true(TEMPLATE_NAME, SIGNATURE, TYPE_B) CONCAT(_EXPAND_RANDOMDOUBLE2_SECOND_, TYPE_B)(TEMPLATE_NAME, SIGNATURE, true)
...
#define _EXPAND_RANDOMSINGLEU_SignedChar(TEMPLATE_NAME, SIGNATURE) \
    template TEMPLATE_NAME SignedChar SIGNATURE;
...
#define _EXPAND_RANDOMSINGLEU_UnsignedChar(TEMPLATE_NAME, SIGNATURE) \
    template TEMPLATE_NAME UnsignedChar SIGNATURE;
...
#define _EXPAND_RANDOMSINGLEU_Int16Type(TEMPLATE_NAME, SIGNATURE) _EXPAND_RANDOMSINGLEU_int16_t(TEMPLATE_NAME, SIGNATURE)
...
#define _EXPAND_RANDOMSINGLEU_UInt16Type(TEMPLATE_NAME, SIGNATURE) _EXPAND_RANDOMSINGLEU_uint16_t(TEMPLATE_NAME, SIGNATURE)
...
#define _EXPAND_RANDOMSINGLEU_UInt32Type(TEMPLATE_NAME, SIGNATURE) _EXPAND_RANDOMSINGLEU_uint32_t(TEMPLATE_NAME, SIGNATURE)
...
#define _EXPAND_RANDOMSINGLEU_UInt64Type(TEMPLATE_NAME, SIGNATURE) _EXPAND_RANDOMSINGLEU_uint64_t(TEMPLATE_NAME, SIGNATURE)
...
#define _EXPAND_RANDOMSINGLEU_ulong(TEMPLATE_NAME, SIGNATURE) \
    template TEMPLATE_NAME UnsignedLong SIGNATURE;
...
#define _EXPAND_RANDOMSINGLEU_stdstring(TEMPLATE_NAME, SIGNATURE) template TEMPLATE_NAME stdstring SIGNATURE;
...
#define _EXPAND_RANDOMDOUBLE2_SECOND_UnsignedChar(TEMPLATE_NAME, SIGNATURE, FIRST) \
    SD_IF_PAIR_ALIAS_COMPILED_DECL(FIRST, UnsignedChar, template TEMPLATE_NAME<FIRST, UnsignedChar> SIGNATURE;)

#define _EXPAND_RANDOMDOUBLE2_SECOND_uint8(TEMPLATE_NAME, SIGNATURE, FIRST) _EXPAND_RANDOMDOUBLE2_SECOND_UnsignedChar(TEMPLATE_NAME, SIGNATURE, FIRST)
#define _EXPAND_RANDOMDOUBLE2_SECOND_uchar(TEMPLATE_NAME, SIGNATURE, FIRST) _EXPAND_RANDOMDOUBLE2_SECOND_UnsignedChar(TEMPLATE_NAME, SIGNATURE, FIRST)

#define _EXPAND_RANDOMDOUBLE2_SECOND_int16_t(TEMPLATE_NAME, SIGNATURE, FIRST) \
    SD_IF_PAIR_ALIAS_COMPILED_DECL(FIRST, Int16Type, template TEMPLATE_NAME<FIRST, Int16Type> SIGNATURE;)
...
#define _EXPAND_RANDOMDOUBLE2_SECOND_uint16_t(TEMPLATE_NAME, SIGNATURE, FIRST) \
    SD_IF_PAIR_ALIAS_COMPILED_DECL(FIRST, UInt16Type, template TEMPLATE_NAME<FIRST, UInt16Type> SIGNATURE;)
...
#define _EXPAND_RANDOMDOUBLE2_SECOND_int32_t(TEMPLATE_NAME, SIGNATURE, FIRST) \
    SD_IF_PAIR_ALIAS_COMPILED_DECL(FIRST, Int32Type, template TEMPLATE_NAME<FIRST, Int32Type> SIGNATURE;)

#define _EXPAND_RANDOMDOUBLE2_SECOND_int32(TEMPLATE_NAME, SIGNATURE, FIRST) _EXPAND_RANDOMDOUBLE2_SECOND_int32_t(TEMPLATE_NAME, SIGNATURE, FIRST)
#define _EXPAND_RANDOMDOUBLE2_SECOND_Int32Type(TEMPLATE_NAME, SIGNATURE, FIRST) _EXPAND_RANDOMDOUBLE2_SECOND_int32_t(TEMPLATE_NAME, SIGNATURE, FIRST)

#define _EXPAND_RANDOMDOUBLE2_SECOND_uint32_t(TEMPLATE_NAME, SIGNATURE, FIRST) \
    SD_IF_PAIR_ALIAS_COMPILED_DECL(FIRST, UInt32Type, template TEMPLATE_NAME<FIRST, UInt32Type> SIGNATURE;)
...
#define _EXPAND_RANDOMDOUBLE2_SECOND_uint64_t(TEMPLATE_NAME, SIGNATURE, FIRST) \
    SD_IF_PAIR_ALIAS_COMPILED_DECL(FIRST, UInt64Type, template TEMPLATE_NAME<FIRST, UInt64Type> SIGNATURE;)
...
#define _EXPAND_RANDOMDOUBLE2_SECOND_UInt64Type(TEMPLATE_NAME, SIGNATURE, FIRST) _EXPAND_RANDOMDOUBLE2_SECOND_uint64_t(TEMPLATE_NAME, SIGNATURE, FIRST)
#define _EXPAND_RANDOMDOUBLE2_SECOND_UnsignedLong(TEMPLATE_NAME, SIGNATURE, FIRST) _EXPAND_RANDOMDOUBLE2_SECOND_uint64_t(TEMPLATE_NAME, SIGNATURE, FIRST)
...
#define _EXPAND_RANDOMDOUBLE2_SECOND_bfloat16(TEMPLATE_NAME, SIGNATURE, FIRST) SD_IF_PAIR_ALIAS_COMPILED_DECL(FIRST, bfloat16, template TEMPLATE_NAME<FIRST, bfloat16> SIGNATURE;)
#define _EXPAND_RANDOMDOUBLE2_SECOND_half(TEMPLATE_NAME, SIGNATURE, FIRST) SD_IF_PAIR_ALIAS_COMPILED_DECL(FIRST, float16, template TEMPLATE_NAME<FIRST, float16> SIGNATURE;)
#define _EXPAND_RANDOMDOUBLE2_SECOND_bool(TEMPLATE_NAME, SIGNATURE, FIRST) SD_IF_PAIR_ALIAS_COMPILED_DECL(FIRST, bool, template TEMPLATE_NAME<FIRST, bool> SIGNATURE;)
...
#define _EXPAND_RANDOMDOUBLE2_ulong(TEMPLATE_NAME, SIGNATURE, TYPE_B) \
    CONCAT(_EXPAND_RANDOMDOUBLE2_SECOND_, TYPE_B)(TEMPLATE_NAME, SIGNATURE, UnsignedLong)
...
#define _EXPAND_RANDOMPAIRWISE2_PAIR_SECOND_SignedChar(TEMPLATE_NAME, SIGNATURE, FIRST) \
    template TEMPLATE_NAME<FIRST, SignedChar, SignedChar> SIGNATURE; \
...
#define _EXPAND_RANDOMPAIRWISE2_PAIR_SECOND_int16_t(TEMPLATE_NAME, SIGNATURE, FIRST) \
    template TEMPLATE_NAME<FIRST, Int16Type, Int16Type> SIGNATURE;
...
#define _EXPAND_RANDOMPAIRWISE2_PAIR_SECOND_Int16Type(TEMPLATE_NAME, SIGNATURE, FIRST) _EXPAND_RANDOMPAIRWISE2_PAIR_SECOND_int16_t(TEMPLATE_NAME, SIGNATURE, FIRST)
...
#define _EXPAND_RANDOMPAIRWISE2_PAIR_SECOND_uint16_t(TEMPLATE_NAME, SIGNATURE, FIRST) \
    template TEMPLATE_NAME<FIRST, UInt16Type, UInt16Type> SIGNATURE;
...
#define _EXPAND_RANDOMPAIRWISE2_PAIR_SECOND_UInt16Type(TEMPLATE_NAME, SIGNATURE, FIRST) _EXPAND_RANDOMPAIRWISE2_PAIR_SECOND_uint16_t(TEMPLATE_NAME, SIGNATURE, FIRST)
...
#define _EXPAND_RANDOMPAIRWISE2_PAIR_SECOND_int32_t(TEMPLATE_NAME, SIGNATURE, FIRST) \
    template TEMPLATE_NAME<FIRST, Int32Type, Int32Type> SIGNATURE;
...
#define _EXPAND_CALL_SINGLE_int32_t(FUNC_NAME, ARGS) \
    FUNC_NAME<Int32Type> ARGS;

#define _EXPAND_RANDOMPAIRWISE2_PAIR_SECOND_uint32_t(TEMPLATE_NAME, SIGNATURE, FIRST) \
    template TEMPLATE_NAME<FIRST, UInt32Type, UInt32Type> SIGNATURE;
...
#define _EXPAND_RANDOMPAIRWISE2_PAIR_SECOND_UInt32Type(TEMPLATE_NAME, SIGNATURE, FIRST) _EXPAND_RANDOMPAIRWISE2_PAIR_SECOND_uint32_t(TEMPLATE_NAME, SIGNATURE, FIRST)
...
#define _EXPAND_RANDOMPAIRWISE2_PAIR_SECOND_int64_t(TEMPLATE_NAME, SIGNATURE, FIRST) \
    template TEMPLATE_NAME<FIRST, LongType, LongType> SIGNATURE;
...
#define _EXPAND_RANDOMPAIRWISE2_PAIR_SECOND_ulong(TEMPLATE_NAME, SIGNATURE, FIRST) \
    template TEMPLATE_NAME<FIRST, UnsignedLong, UnsignedLong> SIGNATURE;
...
#define _EXPAND_RANDOMPAIRWISE2_PAIR_SECOND_UInt64Type(TEMPLATE_NAME, SIGNATURE, FIRST) _EXPAND_RANDOMPAIRWISE2_PAIR_SECOND_uint64_t(TEMPLATE_NAME, SIGNATURE, FIRST)
...
#define _EXPAND_RANDOMPAIRWISE2_TRIPLE_SECOND_UnsignedChar(TEMPLATE_NAME, SIGNATURE, FIRST) \
...
#define _EXPAND_RANDOMPAIRWISE2_TRIPLE_SECOND_int16_t(TEMPLATE_NAME, SIGNATURE, FIRST) \
    template TEMPLATE_NAME<FIRST, Int16Type, FIRST> SIGNATURE;
...
#define _EXPAND_RANDOMPAIRWISE2_TRIPLE_SECOND_Int16Type(TEMPLATE_NAME, SIGNATURE, FIRST) _EXPAND_RANDOMPAIRWISE2_TRIPLE_SECOND_int16_t(TEMPLATE_NAME, SIGNATURE, FIRST)
...
#define _EXPAND_RANDOMPAIRWISE2_TRIPLE_SECOND_uint16_t(TEMPLATE_NAME, SIGNATURE, FIRST) \
    template TEMPLATE_NAME<FIRST, UInt16Type, FIRST> SIGNATURE;
...
#define _EXPAND_RANDOMPAIRWISE2_TRIPLE_SECOND_UInt16Type(TEMPLATE_NAME, SIGNATURE, FIRST) _EXPAND_RANDOMPAIRWISE2_TRIPLE_SECOND_uint16_t(TEMPLATE_NAME, SIGNATURE, FIRST)
...
#define _EXPAND_RANDOMPAIRWISE2_TRIPLE_SECOND_int32_t(TEMPLATE_NAME, SIGNATURE, FIRST) \
    template TEMPLATE_NAME<FIRST, Int32Type, FIRST> SIGNATURE;
...
#define _EXPAND_RANDOMPAIRWISE2_TRIPLE_SECOND_uint32_t(TEMPLATE_NAME, SIGNATURE, FIRST) \
    template TEMPLATE_NAME<FIRST, UInt32Type, FIRST> SIGNATURE;
...
#define _EXPAND_RANDOMPAIRWISE2_TRIPLE_SECOND_UInt32Type(TEMPLATE_NAME, SIGNATURE, FIRST) _EXPAND_RANDOMPAIRWISE2_TRIPLE_SECOND_uint32_t(TEMPLATE_NAME, SIGNATURE, FIRST)
...
#define _EXPAND_RANDOMPAIRWISE2_TRIPLE_SECOND_int64_t(TEMPLATE_NAME, SIGNATURE, FIRST) \
    template TEMPLATE_NAME<FIRST, LongType, FIRST> SIGNATURE;
...
#define _EXPAND_RANDOMPAIRWISE2_TRIPLE_SECOND_uint64_t(TEMPLATE_NAME, SIGNATURE, FIRST) \
    template TEMPLATE_NAME<FIRST, UInt64Type, FIRST> SIGNATURE;
...
#define _EXPAND_RANDOMPAIRWISE2_TRIPLE_SECOND_UInt64Type(TEMPLATE_NAME, SIGNATURE, FIRST) _EXPAND_RANDOMPAIRWISE2_TRIPLE_SECOND_uint64_t(TEMPLATE_NAME, SIGNATURE, FIRST)
...
#define _EXPAND_RANDOMPAIRWISE2_TRIPLE_SECOND_ulong(TEMPLATE_NAME, SIGNATURE, FIRST) \
    template TEMPLATE_NAME<FIRST, UnsignedLong, FIRST> SIGNATURE;
...
#define _EXPAND_RANDOMPAIRWISE2_PAIR_UnsignedChar(TEMPLATE_NAME, SIGNATURE, TYPE_B) \
...
#define _EXPAND_RANDOMPAIRWISE2_PAIR_int16_t(TEMPLATE_NAME, SIGNATURE, TYPE_B) \
    CONCAT(_EXPAND_RANDOMPAIRWISE2_PAIR_SECOND_, TYPE_B)(TEMPLATE_NAME, SIGNATURE, Int16Type)
...
#define _EXPAND_RANDOMPAIRWISE2_PAIR_Int16Type(TEMPLATE_NAME, SIGNATURE, TYPE_B) _EXPAND_RANDOMPAIRWISE2_PAIR_int16_t(TEMPLATE_NAME, SIGNATURE, TYPE_B)
...
#define _EXPAND_RANDOMPAIRWISE2_PAIR_uint16_t(TEMPLATE_NAME, SIGNATURE, TYPE_B) \
    CONCAT(_EXPAND_RANDOMPAIRWISE2_PAIR_SECOND_, TYPE_B)(TEMPLATE_NAME, SIGNATURE, UInt16Type)
...
#define _EXPAND_RANDOMPAIRWISE2_PAIR_UInt16Type(TEMPLATE_NAME, SIGNATURE, TYPE_B) _EXPAND_RANDOMPAIRWISE2_PAIR_uint16_t(TEMPLATE_NAME, SIGNATURE, TYPE_B)
...
#define _EXPAND_RANDOMPAIRWISE2_PAIR_uint32_t(TEMPLATE_NAME, SIGNATURE, TYPE_B) \
    CONCAT(_EXPAND_RANDOMPAIRWISE2_PAIR_SECOND_, TYPE_B)(TEMPLATE_NAME, SIGNATURE, UInt32Type)
...
#define _EXPAND_RANDOMPAIRWISE2_PAIR_UInt32Type(TEMPLATE_NAME, SIGNATURE, TYPE_B) _EXPAND_RANDOMPAIRWISE2_PAIR_uint32_t(TEMPLATE_NAME, SIGNATURE, TYPE_B)
...
#define _EXPAND_RANDOMPAIRWISE2_PAIR_int64_t(TEMPLATE_NAME, SIGNATURE, TYPE_B) \
    CONCAT(_EXPAND_RANDOMPAIRWISE2_PAIR_SECOND_, TYPE_B)(TEMPLATE_NAME, SIGNATURE, LongType)
...
#define _EXPAND_RANDOMPAIRWISE2_PAIR_uint64_t(TEMPLATE_NAME, SIGNATURE, TYPE_B) \
    CONCAT(_EXPAND_RANDOMPAIRWISE2_PAIR_SECOND_, TYPE_B)(TEMPLATE_NAME, SIGNATURE, UInt64Type) \
...
#define _EXPAND_RANDOMPAIRWISE2_PAIR_UInt64Type(TEMPLATE_NAME, SIGNATURE, TYPE_B) _EXPAND_RANDOMPAIRWISE2_PAIR_uint64_t(TEMPLATE_NAME, SIGNATURE, TYPE_B)
...
#define _EXPAND_RANDOMPAIRWISE2_PAIR_ulong(TEMPLATE_NAME, SIGNATURE, TYPE_B) \
    CONCAT(_EXPAND_RANDOMPAIRWISE2_PAIR_SECOND_, TYPE_B)(TEMPLATE_NAME, SIGNATURE, UnsignedLong)
...
#define _EXPAND_RANDOMPAIRWISE2_TRIPLE_UnsignedChar(TEMPLATE_NAME, SIGNATURE, TYPE_B) \
...
#define _EXPAND_RANDOMPAIRWISE2_TRIPLE_int16_t(TEMPLATE_NAME, SIGNATURE, TYPE_B) \
    CONCAT(_EXPAND_RANDOMPAIRWISE2_TRIPLE_SECOND_, TYPE_B)(TEMPLATE_NAME, SIGNATURE, Int16Type) \
...
#define _EXPAND_RANDOMPAIRWISE2_TRIPLE_Int16Type(TEMPLATE_NAME, SIGNATURE, TYPE_B) _EXPAND_RANDOMPAIRWISE2_TRIPLE_int16_t(TEMPLATE_NAME, SIGNATURE, TYPE_B)
...
#define _EXPAND_RANDOMPAIRWISE2_TRIPLE_int32_t(TEMPLATE_NAME, SIGNATURE, TYPE_B) \
    CONCAT(_EXPAND_RANDOMPAIRWISE2_TRIPLE_SECOND_, TYPE_B)(TEMPLATE_NAME, SIGNATURE, Int32Type)
...
#define _EXPAND_RANDOMPAIRWISE2_TRIPLE_UInt16Type(TEMPLATE_NAME, SIGNATURE, TYPE_B) _EXPAND_RANDOMPAIRWISE2_TRIPLE_uint16_t(TEMPLATE_NAME, SIGNATURE, TYPE_B)
...
#define _EXPAND_RANDOMPAIRWISE2_TRIPLE_uint32_t(TEMPLATE_NAME, SIGNATURE, TYPE_B) \
    CONCAT(_EXPAND_RANDOMPAIRWISE2_TRIPLE_SECOND_, TYPE_B)(TEMPLATE_NAME, SIGNATURE, UInt32Type)
...
#define _EXPAND_RANDOMPAIRWISE2_TRIPLE_UInt32Type(TEMPLATE_NAME, SIGNATURE, TYPE_B) _EXPAND_RANDOMPAIRWISE2_TRIPLE_uint32_t(TEMPLATE_NAME, SIGNATURE, TYPE_B)
...
#define _EXPAND_RANDOMPAIRWISE2_TRIPLE_int64_t(TEMPLATE_NAME, SIGNATURE, TYPE_B) \
    CONCAT(_EXPAND_RANDOMPAIRWISE2_TRIPLE_SECOND_, TYPE_B)(TEMPLATE_NAME, SIGNATURE, LongType)
...
#define _EXPAND_RANDOMPAIRWISE2_TRIPLE_uint64_t(TEMPLATE_NAME, SIGNATURE, TYPE_B) \
    CONCAT(_EXPAND_RANDOMPAIRWISE2_TRIPLE_SECOND_, TYPE_B)(TEMPLATE_NAME, SIGNATURE, UInt64Type)
...
#define _EXPAND_RANDOMPAIRWISE2_TRIPLE_UInt64Type(TEMPLATE_NAME, SIGNATURE, TYPE_B) _EXPAND_RANDOMPAIRWISE2_TRIPLE_uint64_t(TEMPLATE_NAME, SIGNATURE, TYPE_B)
...
#define _EXPAND_RANDOMPAIRWISE2_TRIPLE_ulong(TEMPLATE_NAME, SIGNATURE, TYPE_B) \
    CONCAT(_EXPAND_RANDOMPAIRWISE2_TRIPLE_SECOND_, TYPE_B)(TEMPLATE_NAME, SIGNATURE, UnsignedLong)
...
#define _EXPAND_RANDOMTRIPLE3_Z_SignedChar(TEMPLATE_NAME, SIGNATURE, FIRST, SECOND) \
    SD_IF_TRIPLE_ALIAS_COMPILED_DECL(FIRST, SECOND, SignedChar, template TEMPLATE_NAME<FIRST, SECOND, SignedChar> SIGNATURE;)
...
#define _EXPAND_RANDOMTRIPLE3_Z_UnsignedChar(TEMPLATE_NAME, SIGNATURE, FIRST, SECOND) \
    SD_IF_TRIPLE_ALIAS_COMPILED_DECL(FIRST, SECOND, UnsignedChar, template TEMPLATE_NAME<FIRST, SECOND, UnsignedChar> SIGNATURE;)
...
#define _EXPAND_RANDOMTRIPLE3_Z_int16_t(TEMPLATE_NAME, SIGNATURE, FIRST, SECOND) \
    SD_IF_TRIPLE_ALIAS_COMPILED_DECL(FIRST, SECOND, Int16Type, template TEMPLATE_NAME<FIRST, SECOND, Int16Type> SIGNATURE;)
...
#define _EXPAND_RANDOMTRIPLE3_Z_Int16Type(TEMPLATE_NAME, SIGNATURE, FIRST, SECOND) _EXPAND_RANDOMTRIPLE3_Z_int16_t(TEMPLATE_NAME, SIGNATURE, FIRST, SECOND)
...
#define _EXPAND_RANDOMTRIPLE3_Z_uint16_t(TEMPLATE_NAME, SIGNATURE, FIRST, SECOND) \
    SD_IF_TRIPLE_ALIAS_COMPILED_DECL(FIRST, SECOND, UInt16Type, template TEMPLATE_NAME<FIRST, SECOND, UInt16Type> SIGNATURE;)
...
#define _EXPAND_RANDOMTRIPLE3_Z_UInt16Type(TEMPLATE_NAME, SIGNATURE, FIRST, SECOND) _EXPAND_RANDOMTRIPLE3_Z_uint16_t(TEMPLATE_NAME, SIGNATURE, FIRST, SECOND)
...
#define _EXPAND_RANDOMTRIPLE3_Z_int32_t(TEMPLATE_NAME, SIGNATURE, FIRST, SECOND) \
    SD_IF_TRIPLE_ALIAS_COMPILED_DECL(FIRST, SECOND, Int32Type, template TEMPLATE_NAME<FIRST, SECOND, Int32Type> SIGNATURE;)
...
#define _EXPAND_RANDOMTRIPLE3_Z_int(TEMPLATE_NAME, SIGNATURE, FIRST, SECOND) \
    SD_IF_TRIPLE_ALIAS_COMPILED_DECL(FIRST, SECOND, int, template TEMPLATE_NAME<FIRST, SECOND, int> SIGNATURE;)

#define _EXPAND_RANDOMTRIPLE3_Z_uint32_t(TEMPLATE_NAME, SIGNATURE, FIRST, SECOND) \
    SD_IF_TRIPLE_ALIAS_COMPILED_DECL(FIRST, SECOND, UInt32Type, template TEMPLATE_NAME<FIRST, SECOND, UInt32Type> SIGNATURE;)
...
#define _EXPAND_RANDOMTRIPLE3_Z_UInt32Type(TEMPLATE_NAME, SIGNATURE, FIRST, SECOND) _EXPAND_RANDOMTRIPLE3_Z_uint32_t(TEMPLATE_NAME, SIGNATURE, FIRST, SECOND)
...
#define _EXPAND_RANDOMTRIPLE3_Z_int64_t(TEMPLATE_NAME, SIGNATURE, FIRST, SECOND) \
    SD_IF_TRIPLE_ALIAS_COMPILED_DECL(FIRST, SECOND, LongType, template TEMPLATE_NAME<FIRST, SECOND, LongType> SIGNATURE;)
...
#define _EXPAND_RANDOMTRIPLE3_Z_uint64_t(TEMPLATE_NAME, SIGNATURE, FIRST, SECOND) \
    SD_IF_TRIPLE_ALIAS_COMPILED_DECL(FIRST, SECOND, UInt64Type, template TEMPLATE_NAME<FIRST, SECOND, UInt64Type> SIGNATURE;)
...
#define _EXPAND_RANDOMTRIPLE3_Z_UInt64Type(TEMPLATE_NAME, SIGNATURE, FIRST, SECOND) _EXPAND_RANDOMTRIPLE3_Z_uint64_t(TEMPLATE_NAME, SIGNATURE, FIRST, SECOND)
...
#define _EXPAND_RANDOMTRIPLE3_Z_ulong(TEMPLATE_NAME, SIGNATURE, FIRST, SECOND) \
    SD_IF_TRIPLE_ALIAS_COMPILED_DECL(FIRST, SECOND, UnsignedLong, template TEMPLATE_NAME<FIRST, SECOND, UnsignedLong> SIGNATURE;)

#define _EXPAND_RANDOMTRIPLE3_Z_char(TEMPLATE_NAME, SIGNATURE, FIRST, SECOND) \
    SD_IF_TRIPLE_ALIAS_COMPILED_DECL(FIRST, SECOND, SignedChar, template TEMPLATE_NAME<FIRST, SECOND, SignedChar> SIGNATURE;)


#define _EXPAND_RANDOMTRIPLE3_Z_float(TEMPLATE_NAME, SIGNATURE, FIRST, SECOND) SD_IF_TRIPLE_ALIAS_COMPILED_DECL(FIRST, SECOND, float, template TEMPLATE_NAME<FIRST, SECOND, float> SIGNATURE;)
#define _EXPAND_RANDOMTRIPLE3_Z_double(TEMPLATE_NAME, SIGNATURE, FIRST, SECOND) SD_IF_TRIPLE_ALIAS_COMPILED_DECL(FIRST, SECOND, double, template TEMPLATE_NAME<FIRST, SECOND, double> SIGNATURE;)
#define _EXPAND_RANDOMTRIPLE3_Z_float16(TEMPLATE_NAME, SIGNATURE, FIRST, SECOND) SD_IF_TRIPLE_ALIAS_COMPILED_DECL(FIRST, SECOND, float16, template TEMPLATE_NAME<FIRST, SECOND, float16> SIGNATURE;)
#define _EXPAND_RANDOMTRIPLE3_Z_bfloat16(TEMPLATE_NAME, SIGNATURE, FIRST, SECOND) SD_IF_TRIPLE_ALIAS_COMPILED_DECL(FIRST, SECOND, bfloat16, template TEMPLATE_NAME<FIRST, SECOND, bfloat16> SIGNATURE;)
#define _EXPAND_RANDOMTRIPLE3_Z_half(TEMPLATE_NAME, SIGNATURE, FIRST, SECOND) SD_IF_TRIPLE_ALIAS_COMPILED_DECL(FIRST, SECOND, float16, template TEMPLATE_NAME<FIRST, SECOND, float16> SIGNATURE;)
#define _EXPAND_RANDOMTRIPLE3_Z_bool(TEMPLATE_NAME, SIGNATURE, FIRST, SECOND) SD_IF_TRIPLE_ALIAS_COMPILED_DECL(FIRST, SECOND, bool, template TEMPLATE_NAME<FIRST, SECOND, bool> SIGNATURE;)
...
#define _EXPAND_RANDOMTRIPLE3_Y_int16_t(TEMPLATE_NAME, SIGNATURE, FIRST, TYPE_Z) \
    CONCAT(_EXPAND_RANDOMTRIPLE3_Z_, TYPE_Z)(TEMPLATE_NAME, SIGNATURE, FIRST, Int16Type)
...
#define _EXPAND_RANDOMTRIPLE3_Y_Int16Type(TEMPLATE_NAME, SIGNATURE, FIRST, TYPE_Z) _EXPAND_RANDOMTRIPLE3_Y_int16_t(TEMPLATE_NAME, SIGNATURE, FIRST, TYPE_Z)
...
#define _EXPAND_RANDOMTRIPLE3_Y_uint16_t(TEMPLATE_NAME, SIGNATURE, FIRST, TYPE_Z) \
    CONCAT(_EXPAND_RANDOMTRIPLE3_Z_, TYPE_Z)(TEMPLATE_NAME, SIGNATURE, FIRST, UInt16Type)
...
#define _EXPAND_RANDOMTRIPLE3_Y_UInt16Type(TEMPLATE_NAME, SIGNATURE, FIRST, TYPE_Z) _EXPAND_RANDOMTRIPLE3_Y_uint16_t(TEMPLATE_NAME, SIGNATURE, FIRST, TYPE_Z)
...
#define _EXPAND_RANDOMTRIPLE3_Y_int32_t(TEMPLATE_NAME, SIGNATURE, FIRST, TYPE_Z) \
    CONCAT(_EXPAND_RANDOMTRIPLE3_Z_, TYPE_Z)(TEMPLATE_NAME, SIGNATURE, FIRST, Int32Type)
...
#define _EXPAND_RANDOMTRIPLE3_Y_uint32_t(TEMPLATE_NAME, SIGNATURE, FIRST, TYPE_Z) \
    CONCAT(_EXPAND_RANDOMTRIPLE3_Z_, TYPE_Z)(TEMPLATE_NAME, SIGNATURE, FIRST, UInt32Type)
...
#define _EXPAND_RANDOMTRIPLE3_Y_UInt32Type(TEMPLATE_NAME, SIGNATURE, FIRST, TYPE_Z) _EXPAND_RANDOMTRIPLE3_Y_uint32_t(TEMPLATE_NAME, SIGNATURE, FIRST, TYPE_Z)
...
#define _EXPAND_RANDOMDOUBLE2_SECOND_sd_LongType(TEMPLATE_NAME, SIGNATURE, FIRST) \
    ...
    template TEMPLATE_NAME<FIRST, LongType> SIGNATURE; \
...
#define _EXPAND_RANDOMTRIPLE3_Z_sd_LongType(TEMPLATE_NAME, SIGNATURE, FIRST, SECOND) \
    ...
    template TEMPLATE_NAME<FIRST, SECOND, LongType> SIGNATURE; \
...
#define _EXPAND_RANDOMTRIPLE3_Y_uint64_t(TEMPLATE_NAME, SIGNATURE, FIRST, TYPE_Z) \
    CONCAT(_EXPAND_RANDOMTRIPLE3_Z_, TYPE_Z)(TEMPLATE_NAME, SIGNATURE, FIRST, UInt64Type)
...
#define _EXPAND_RANDOMTRIPLE3_Y_UInt64Type(TEMPLATE_NAME, SIGNATURE, FIRST, TYPE_Z) _EXPAND_RANDOMTRIPLE3_Y_uint64_t(TEMPLATE_NAME, SIGNATURE, FIRST, TYPE_Z)
...
#define _EXPAND_RANDOMTRIPLE3_Y_ulong(TEMPLATE_NAME, SIGNATURE, FIRST, TYPE_Z) \
    CONCAT(_EXPAND_RANDOMTRIPLE3_Z_, TYPE_Z)(TEMPLATE_NAME, SIGNATURE, FIRST, UnsignedLong)
...
#define _EXPAND_RANDOMTRIPLE3_X_int16_t(TEMPLATE_NAME, SIGNATURE, TYPE_Y, TYPE_Z) \
    CONCAT(_EXPAND_RANDOMTRIPLE3_Y_, TYPE_Y)(TEMPLATE_NAME, SIGNATURE, Int16Type, TYPE_Z)
...
#define _EXPAND_RANDOMTRIPLE3_X_Int16Type(TEMPLATE_NAME, SIGNATURE, TYPE_Y, TYPE_Z) _EXPAND_RANDOMTRIPLE3_X_int16_t(TEMPLATE_NAME, SIGNATURE, TYPE_Y, TYPE_Z)
...
#define _EXPAND_RANDOMTRIPLE3_X_uint16_t(TEMPLATE_NAME, SIGNATURE, TYPE_Y, TYPE_Z) \
    CONCAT(_EXPAND_RANDOMTRIPLE3_Y_, TYPE_Y)(TEMPLATE_NAME, SIGNATURE, UInt16Type, TYPE_Z)
...
#define _EXPAND_RANDOMTRIPLE3_X_UInt16Type(TEMPLATE_NAME, SIGNATURE, TYPE_Y, TYPE_Z) _EXPAND_RANDOMTRIPLE3_X_uint16_t(TEMPLATE_NAME, SIGNATURE, TYPE_Y, TYPE_Z)
...
#define _EXPAND_RANDOMTRIPLE3_X_int32_t(TEMPLATE_NAME, SIGNATURE, TYPE_Y, TYPE_Z) \
    CONCAT(_EXPAND_RANDOMTRIPLE3_Y_, TYPE_Y)(TEMPLATE_NAME, SIGNATURE, Int32Type, TYPE_Z)
...
#define _EXPAND_RANDOMTRIPLE3_X_uint32_t(TEMPLATE_NAME, SIGNATURE, TYPE_Y, TYPE_Z) \
    CONCAT(_EXPAND_RANDOMTRIPLE3_Y_, TYPE_Y)(TEMPLATE_NAME, SIGNATURE, UInt32Type, TYPE_Z)
...
#define _EXPAND_RANDOMTRIPLE3_X_UInt32Type(TEMPLATE_NAME, SIGNATURE, TYPE_Y, TYPE_Z) _EXPAND_RANDOMTRIPLE3_X_uint32_t(TEMPLATE_NAME, SIGNATURE, TYPE_Y, TYPE_Z)
...
#define _EXPAND_RANDOMTRIPLE3_X_int64_t(TEMPLATE_NAME, SIGNATURE, TYPE_Y, TYPE_Z) \
    CONCAT(_EXPAND_RANDOMTRIPLE3_Y_, TYPE_Y)(TEMPLATE_NAME, SIGNATURE, LongType, TYPE_Z)
...
#define _EXPAND_RANDOMTRIPLE3_X_uint64_t(TEMPLATE_NAME, SIGNATURE, TYPE_Y, TYPE_Z) \
    CONCAT(_EXPAND_RANDOMTRIPLE3_Y_, TYPE_Y)(TEMPLATE_NAME, SIGNATURE, UInt64Type, TYPE_Z)
...
#define _EXPAND_RANDOMTRIPLE3_X_UInt64Type(TEMPLATE_NAME, SIGNATURE, TYPE_Y, TYPE_Z) _EXPAND_RANDOMTRIPLE3_X_uint64_t(TEMPLATE_NAME, SIGNATURE, TYPE_Y, TYPE_Z)
...
#define _EXPAND_RANDOMTRIPLE3_X_ulong(TEMPLATE_NAME, SIGNATURE, TYPE_Y, TYPE_Z) \
    CONCAT(_EXPAND_RANDOMTRIPLE3_Y_, TYPE_Y)(TEMPLATE_NAME, SIGNATURE, UnsignedLong, TYPE_Z)
...
#define _EXPAND_INSTANT_COMBINATION_SECOND_SignedChar(FUNC_NAME, ARGS, FIRST) \
    template void FUNC_NAME<FIRST, SignedChar> ARGS; \
...
#define _EXPAND_INSTANT_COMBINATION_SECOND_UnsignedChar(FUNC_NAME, ARGS, FIRST) \
    template void FUNC_NAME<FIRST, UnsignedChar> ARGS; \
...
#define _EXPAND_INSTANT_COMBINATION_SECOND_int16_t(FUNC_NAME, ARGS, FIRST) \
    template void FUNC_NAME<FIRST, Int16Type> ARGS;
...
#define _EXPAND_INSTANT_COMBINATION_SECOND_Int16Type(FUNC_NAME, ARGS, FIRST) _EXPAND_INSTANT_COMBINATION_SECOND_int16_t(FUNC_NAME, ARGS, FIRST)

#define _EXPAND_INSTANT_COMBINATION_SECOND_uint16_t(FUNC_NAME, ARGS, FIRST) \
    template void FUNC_NAME<FIRST, UInt16Type> ARGS;
...
#define _EXPAND_INSTANT_COMBINATION_SECOND_int32_t(FUNC_NAME, ARGS, FIRST) \
    template void FUNC_NAME<FIRST, Int32Type> ARGS;
...
#define _EXPAND_INSTANT_COMBINATION_SECOND_uint32_t(FUNC_NAME, ARGS, FIRST) \
    template void FUNC_NAME<FIRST, UInt32Type> ARGS;
...
#define _EXPAND_INSTANT_COMBINATION_SECOND_int64_t(FUNC_NAME, ARGS, FIRST) \
    template void FUNC_NAME<FIRST, LongType> ARGS;
...
#define _EXPAND_INSTANT_COMBINATION_SECOND_uint64_t(FUNC_NAME, ARGS, FIRST) \
    template void FUNC_NAME<FIRST, UInt64Type> ARGS; \
...
#define _EXPAND_INSTANT_COMBINATION_SECOND_stdstring(FUNC_NAME, ARGS, FIRST) template void FUNC_NAME<FIRST, stdstring> ARGS;
...
#define _EXPAND_INSTANT_COMBINATION_int16_t(FUNC_NAME, ARGS, TYPE_B) \
    CONCAT(_EXPAND_INSTANT_COMBINATION_SECOND_, TYPE_B)(FUNC_NAME, ARGS, Int16Type) \
...
#define _EXPAND_INSTANT_COMBINATION_Int16Type(FUNC_NAME, ARGS, TYPE_B) _EXPAND_INSTANT_COMBINATION_int16_t(FUNC_NAME, ARGS, TYPE_B)

#define _EXPAND_INSTANT_COMBINATION_uint16_t(FUNC_NAME, ARGS, TYPE_B) \
    CONCAT(_EXPAND_INSTANT_COMBINATION_SECOND_, TYPE_B)(FUNC_NAME, ARGS, UInt16Type)
...
#define _EXPAND_INSTANT_COMBINATION_int32_t(FUNC_NAME, ARGS, TYPE_B) \
    CONCAT(_EXPAND_INSTANT_COMBINATION_SECOND_, TYPE_B)(FUNC_NAME, ARGS, Int32Type) \
...
#define _EXPAND_INSTANT_COMBINATION_uint32_t(FUNC_NAME, ARGS, TYPE_B) \
    CONCAT(_EXPAND_INSTANT_COMBINATION_SECOND_, TYPE_B)(FUNC_NAME, ARGS, UInt32Type)
...
#define _EXPAND_INSTANT_COMBINATION_int64_t(FUNC_NAME, ARGS, TYPE_B) \
    CONCAT(_EXPAND_INSTANT_COMBINATION_SECOND_, TYPE_B)(FUNC_NAME, ARGS, LongType) \
...
#define _EXPAND_INSTANT_COMBINATION_uint64_t(FUNC_NAME, ARGS, TYPE_B) \
    CONCAT(_EXPAND_INSTANT_COMBINATION_SECOND_, TYPE_B)(FUNC_NAME, ARGS, UInt64Type) \
...
#define _EXPAND_INSTANT_COMBINATION_stdstring(FUNC_NAME, ARGS, TYPE_B) CONCAT(_EXPAND_INSTANT_COMBINATION_SECOND_, TYPE_B)(FUNC_NAME, ARGS, stdstring)
...
#define _EXPAND_INSTANT_CLASS_SECOND_SignedChar(FUNC_NAME, ARGS, FIRST) \
    template class FUNC_NAME<FIRST, SignedChar> ARGS; 
...
#define _EXPAND_INSTANT_CLASS_SECOND_UnsignedChar(FUNC_NAME, ARGS, FIRST) \
    template class FUNC_NAME<FIRST, UnsignedChar> ARGS; \
...
#define _EXPAND_INSTANT_CLASS_SECOND_int16_t(FUNC_NAME, ARGS, FIRST) \
    template class FUNC_NAME<FIRST, Int16Type> ARGS;

#define _EXPAND_INSTANT_CLASS_SECOND_int16(FUNC_NAME, ARGS, FIRST) _EXPAND_INSTANT_CLASS_SECOND_int16_t(FUNC_NAME, ARGS, FIRST)
#define _EXPAND_INSTANT_CLASS_SECOND_Int16Type(FUNC_NAME, ARGS, FIRST) _EXPAND_INSTANT_CLASS_SECOND_int16_t(FUNC_NAME, ARGS, FIRST)
...
#define _EXPAND_INSTANT_CLASS_SECOND_uint16_t(FUNC_NAME, ARGS, FIRST) \
    template class FUNC_NAME<FIRST, UInt16Type> ARGS;
...
#define _EXPAND_INSTANT_CLASS_SECOND_int32_t(FUNC_NAME, ARGS, FIRST) \
    template class FUNC_NAME<FIRST, Int32Type> ARGS; \
...
#define _EXPAND_INSTANT_CLASS_SECOND_uint32_t(FUNC_NAME, ARGS, FIRST) \
    template class FUNC_NAME<FIRST, UInt32Type> ARGS;
...
#define _EXPAND_INSTANT_CLASS_SECOND_int64_t(FUNC_NAME, ARGS, FIRST) \
    template class FUNC_NAME<FIRST, LongType> ARGS; \
...
#define _EXPAND_INSTANT_CLASS_SECOND_uint64_t(FUNC_NAME, ARGS, FIRST) \
    template class FUNC_NAME<FIRST, UInt64Type> ARGS; \
...
#define _EXPAND_INSTANT_CLASS_SECOND_stdstring(FUNC_NAME, ARGS, FIRST) template class FUNC_NAME<FIRST, std::string> ARGS;
...
#define _EXPAND_INSTANT_CLASS_int16_t(FUNC_NAME, ARGS, TYPE_B) \
    CONCAT(_EXPAND_INSTANT_CLASS_SECOND_, TYPE_B)(FUNC_NAME, ARGS, Int16Type) \
...
#define _EXPAND_INSTANT_CLASS_Int16Type(FUNC_NAME, ARGS, TYPE_B) _EXPAND_INSTANT_CLASS_int16_t(FUNC_NAME, ARGS, TYPE_B)

#define _EXPAND_INSTANT_CLASS_uint16_t(FUNC_NAME, ARGS, TYPE_B) \
    CONCAT(_EXPAND_INSTANT_CLASS_SECOND_, TYPE_B)(FUNC_NAME, ARGS, UInt16Type)
...
#define _EXPAND_INSTANT_CLASS_int32_t(FUNC_NAME, ARGS, TYPE_B) \
    CONCAT(_EXPAND_INSTANT_CLASS_SECOND_, TYPE_B)(FUNC_NAME, ARGS, Int32Type) \
    CONCAT(_EXPAND_INSTANT_CLASS_SECOND_, TYPE_B)(FUNC_NAME, ARGS, int) \
...
// Undefine before redefining with enhanced version
#undef _EXPAND_INSTANT_CLASS_int
...
#define _EXPAND_INSTANT_CLASS_uint32_t(FUNC_NAME, ARGS, TYPE_B) \
    CONCAT(_EXPAND_INSTANT_CLASS_SECOND_, TYPE_B)(FUNC_NAME, ARGS, UInt32Type)
...
#define _EXPAND_INSTANT_CLASS_uint64_t(FUNC_NAME, ARGS, TYPE_B) \
    CONCAT(_EXPAND_INSTANT_CLASS_SECOND_, TYPE_B)(FUNC_NAME, ARGS, UInt64Type) \
...
#define _EXPAND_INSTANT_CLASS_stdstring(FUNC_NAME, ARGS, TYPE_B) CONCAT(_EXPAND_INSTANT_CLASS_SECOND_, TYPE_B)(FUNC_NAME, ARGS, stdstring)
...
#define _EXPAND_INSTANT_CLASS3_C_SignedChar(FUNC_NAME, ARGS, FIRST, SECOND) \
    extern template class FUNC_NAME<FIRST, SECOND, SignedChar> ARGS;
...
#define _EXPAND_INSTANT_CLASS3_C_int16_t(FUNC_NAME, ARGS, FIRST, SECOND) \
    extern template class FUNC_NAME<FIRST, SECOND, Int16Type> ARGS;
...
#define _EXPAND_INSTANT_CLASS3_C_uint16_t(FUNC_NAME, ARGS, FIRST, SECOND) \
    extern template class FUNC_NAME<FIRST, SECOND, UInt16Type> ARGS;
...
#define _EXPAND_INSTANT_CLASS3_C_int32_t(FUNC_NAME, ARGS, FIRST, SECOND) \
    extern template class FUNC_NAME<FIRST, SECOND, Int32Type> ARGS;
...
#define _EXPAND_INSTANT_CLASS3_C_uint32_t(FUNC_NAME, ARGS, FIRST, SECOND) \
    extern template class FUNC_NAME<FIRST, SECOND, UInt32Type> ARGS;
...
#define _EXPAND_INSTANT_CLASS3_C_uint64_t(FUNC_NAME, ARGS, FIRST, SECOND) \
    extern template class FUNC_NAME<FIRST, SECOND, UInt64Type> ARGS; \
...
#define _EXPAND_INSTANT_CLASS3_B_int16_t(FUNC_NAME, ARGS, FIRST, TYPE_C) \
    CONCAT(_EXPAND_INSTANT_CLASS3_C_, TYPE_C)(FUNC_NAME, ARGS, FIRST, Int16Type)
...
#define _EXPAND_INSTANT_CLASS3_B_uint16_t(FUNC_NAME, ARGS, FIRST, TYPE_C) \
    CONCAT(_EXPAND_INSTANT_CLASS3_C_, TYPE_C)(FUNC_NAME, ARGS, FIRST, UInt16Type)
...
#define _EXPAND_INSTANT_CLASS3_B_int32_t(FUNC_NAME, ARGS, FIRST, TYPE_C) \
    CONCAT(_EXPAND_INSTANT_CLASS3_C_, TYPE_C)(FUNC_NAME, ARGS, FIRST, Int32Type) \
...
#define _EXPAND_INSTANT_CLASS3_B_uint32_t(FUNC_NAME, ARGS, FIRST, TYPE_C) \
    CONCAT(_EXPAND_INSTANT_CLASS3_C_, TYPE_C)(FUNC_NAME, ARGS, FIRST, UInt32Type)
...
#define _EXPAND_INSTANT_CLASS3_B_uint64_t(FUNC_NAME, ARGS, FIRST, TYPE_C) \
    CONCAT(_EXPAND_INSTANT_CLASS3_C_, TYPE_C)(FUNC_NAME, ARGS, FIRST, UInt64Type) \
...
#define _EXPAND_INSTANT_CLASS3_A_int16_t(FUNC_NAME, ARGS, TYPE_B, TYPE_C) \
    CONCAT(_EXPAND_INSTANT_CLASS3_B_, TYPE_B)(FUNC_NAME, ARGS, Int16Type, TYPE_C)
...
#define _EXPAND_INSTANT_CLASS3_A_uint16_t(FUNC_NAME, ARGS, TYPE_B, TYPE_C) \
    CONCAT(_EXPAND_INSTANT_CLASS3_B_, TYPE_B)(FUNC_NAME, ARGS, UInt16Type, TYPE_C)
...
#define _EXPAND_INSTANT_CLASS3_A_int32_t(FUNC_NAME, ARGS, TYPE_B, TYPE_C) \
    CONCAT(_EXPAND_INSTANT_CLASS3_B_, TYPE_B)(FUNC_NAME, ARGS, Int32Type, TYPE_C) \
...
#define _EXPAND_INSTANT_CLASS3_A_uint32_t(FUNC_NAME, ARGS, TYPE_B, TYPE_C) \
    CONCAT(_EXPAND_INSTANT_CLASS3_B_, TYPE_B)(FUNC_NAME, ARGS, UInt32Type, TYPE_C)
...
#define _EXPAND_INSTANT_CLASS3_A_int64_t(FUNC_NAME, ARGS, TYPE_B, TYPE_C) \
    CONCAT(_EXPAND_INSTANT_CLASS3_B_, TYPE_B)(FUNC_NAME, ARGS, LongType, TYPE_C) \
...
#define _EXPAND_INSTANT_CLASS3_A_uint64_t(FUNC_NAME, ARGS, TYPE_B, TYPE_C) \
    CONCAT(_EXPAND_INSTANT_CLASS3_B_, TYPE_B)(FUNC_NAME, ARGS, UInt64Type, TYPE_C) \
...
#define EXPAND_TYPE_APPLY_Int16Type(MACRO) EXPAND_TYPE_APPLY_int16_t(MACRO)
...
#define EXPAND_TYPE_APPLY_UInt16Type(MACRO) EXPAND_TYPE_APPLY_uint16_t(MACRO)
...
#define EXPAND_TYPE_APPLY_UInt32Type(MACRO) EXPAND_TYPE_APPLY_uint32_t(MACRO)
...
#define EXPAND_TYPE_APPLY_UInt64Type(MACRO) EXPAND_TYPE_APPLY_uint64_t(MACRO)
...
#define _EXPAND_CALL_SINGLE_Int16Type(FUNC_NAME, ARGS) _EXPAND_CALL_SINGLE_int16_t(FUNC_NAME, ARGS)

#define _EXPAND_CALL_SINGLE_uint16_t(FUNC_NAME, ARGS) \
    FUNC_NAME<UInt16Type> ARGS;
...
#define _EXPAND_CALL_SINGLE_stdstring(FUNC_NAME, ARGS) _EXPAND_CALL_SINGLE_string(FUNC_NAME, ARGS)

#define _EXPAND_CALL_SINGLE_sd_LongType(FUNC_NAME, ARGS) \
    FUNC_NAME<sd::LongType> ARGS; \
    FUNC_NAME<LongType> ARGS; \
...
#define _EXPAND_CALL_DOUBLE2_SECOND_int16_t(FUNC_NAME, ARGS, FIRST) \
    FUNC_NAME<FIRST, Int16Type> ARGS;
...
#define _EXPAND_CALL_DOUBLE2_SECOND_uint16_t(FUNC_NAME, ARGS, FIRST) \
    FUNC_NAME<FIRST, UInt16Type> ARGS;
...
#define _EXPAND_CALL_DOUBLE2_SECOND_int32_t(FUNC_NAME, ARGS, FIRST) \
    FUNC_NAME<FIRST, Int32Type> ARGS;
...
#define _EXPAND_CALL_DOUBLE2_SECOND_uint32_t(FUNC_NAME, ARGS, FIRST) \
    FUNC_NAME<FIRST, UInt32Type> ARGS;
...
#define _EXPAND_CALL_DOUBLE2_SECOND_uint64_t(FUNC_NAME, ARGS, FIRST) \
    FUNC_NAME<FIRST, UInt64Type> ARGS;
...
#define _EXPAND_CALL_DOUBLE2_int16_t(FUNC_NAME, ARGS, TYPE_B) \
    CONCAT(_EXPAND_CALL_DOUBLE2_SECOND_, TYPE_B)(FUNC_NAME, ARGS, Int16Type)
...
#define _EXPAND_CALL_DOUBLE2_uint16_t(FUNC_NAME, ARGS, TYPE_B) \
    CONCAT(_EXPAND_CALL_DOUBLE2_SECOND_, TYPE_B)(FUNC_NAME, ARGS, UInt16Type)
...
#define _EXPAND_CALL_DOUBLE2_int32_t(FUNC_NAME, ARGS, TYPE_B) \
    CONCAT(_EXPAND_CALL_DOUBLE2_SECOND_, TYPE_B)(FUNC_NAME, ARGS, Int32Type) \
...
#define _EXPAND_CALL_DOUBLE2_uint32_t(FUNC_NAME, ARGS, TYPE_B) \
    CONCAT(_EXPAND_CALL_DOUBLE2_SECOND_, TYPE_B)(FUNC_NAME, ARGS, UInt32Type)
...
#define _EXPAND_CALL_DOUBLE2_int64_t(FUNC_NAME, ARGS, TYPE_B) \
    CONCAT(_EXPAND_CALL_DOUBLE2_SECOND_, TYPE_B)(FUNC_NAME, ARGS, LongType) \
...
#define _EXPAND_CALL_DOUBLE2_uint64_t(FUNC_NAME, ARGS, TYPE_B) \
    CONCAT(_EXPAND_CALL_DOUBLE2_SECOND_, TYPE_B)(FUNC_NAME, ARGS, UInt64Type) \
...
#define _EXPAND_CALL_TRIPLE3_Z_SignedChar(FUNC_NAME, ARGS, FIRST, SECOND) \
    FUNC_NAME<FIRST, SECOND, SignedChar> ARGS;
...
#define _EXPAND_CALL_TRIPLE3_Z_UnsignedChar(FUNC_NAME, ARGS, FIRST, SECOND) \
    FUNC_NAME<FIRST, SECOND, UnsignedChar> ARGS;
...
#define _EXPAND_CALL_TRIPLE3_Z_int16_t(FUNC_NAME, ARGS, FIRST, SECOND) \
    FUNC_NAME<FIRST, SECOND, Int16Type> ARGS;
...
#define _EXPAND_CALL_TRIPLE3_Z_uint16_t(FUNC_NAME, ARGS, FIRST, SECOND) \
    FUNC_NAME<FIRST, SECOND, UInt16Type> ARGS;
...
#define _EXPAND_CALL_TRIPLE3_Z_int32_t(FUNC_NAME, ARGS, FIRST, SECOND) \
    FUNC_NAME<FIRST, SECOND, Int32Type> ARGS; \
...
#define _EXPAND_CALL_TRIPLE3_Z_uint32_t(FUNC_NAME, ARGS, FIRST, SECOND) \
    FUNC_NAME<FIRST, SECOND, UInt32Type> ARGS;
...
#define _EXPAND_CALL_TRIPLE3_Z_int64_t(FUNC_NAME, ARGS, FIRST, SECOND) \
    FUNC_NAME<FIRST, SECOND, LongType> ARGS;
...
#define _EXPAND_CALL_TRIPLE3_Z_uint64_t(FUNC_NAME, ARGS, FIRST, SECOND) \
    FUNC_NAME<FIRST, SECOND, UInt64Type> ARGS; \
...
#define _EXPAND_CALL_TRIPLE3_Y_int16_t(FUNC_NAME, ARGS, FIRST, TYPE_Z) \
    CONCAT(_EXPAND_CALL_TRIPLE3_Z_, TYPE_Z)(FUNC_NAME, ARGS, FIRST, Int16Type)
...
#define _EXPAND_CALL_TRIPLE3_Y_uint16_t(FUNC_NAME, ARGS, FIRST, TYPE_Z) \
    CONCAT(_EXPAND_CALL_TRIPLE3_Z_, TYPE_Z)(FUNC_NAME, ARGS, FIRST, UInt16Type)
...
#define _EXPAND_CALL_TRIPLE3_Y_int32_t(FUNC_NAME, ARGS, FIRST, TYPE_Z) \
    CONCAT(_EXPAND_CALL_TRIPLE3_Z_, TYPE_Z)(FUNC_NAME, ARGS, FIRST, Int32Type) \
...
#define _EXPAND_CALL_TRIPLE3_Y_uint32_t(FUNC_NAME, ARGS, FIRST, TYPE_Z) \
    CONCAT(_EXPAND_CALL_TRIPLE3_Z_, TYPE_Z)(FUNC_NAME, ARGS, FIRST, UInt32Type)
...
#define _EXPAND_CALL_TRIPLE3_Y_uint64_t(FUNC_NAME, ARGS, FIRST, TYPE_Z) \
    CONCAT(_EXPAND_CALL_TRIPLE3_Z_, TYPE_Z)(FUNC_NAME, ARGS, FIRST, UInt64Type) \
...
#define _EXPAND_CALL_TRIPLE3_X_int16_t(FUNC_NAME, ARGS, TYPE_Y, TYPE_Z) \
    CONCAT(_EXPAND_CALL_TRIPLE3_Y_, TYPE_Y)(FUNC_NAME, ARGS, Int16Type, TYPE_Z)
...
#define _EXPAND_CALL_TRIPLE3_X_uint16_t(FUNC_NAME, ARGS, TYPE_Y, TYPE_Z) \
    CONCAT(_EXPAND_CALL_TRIPLE3_Y_, TYPE_Y)(FUNC_NAME, ARGS, UInt16Type, TYPE_Z)
...
#define _EXPAND_CALL_TRIPLE3_X_int32_t(FUNC_NAME, ARGS, TYPE_Y, TYPE_Z) \
    CONCAT(_EXPAND_CALL_TRIPLE3_Y_, TYPE_Y)(FUNC_NAME, ARGS, Int32Type, TYPE_Z) \
...
#define _EXPAND_CALL_TRIPLE3_X_uint32_t(FUNC_NAME, ARGS, TYPE_Y, TYPE_Z) \
    CONCAT(_EXPAND_CALL_TRIPLE3_Y_, TYPE_Y)(FUNC_NAME, ARGS, UInt32Type, TYPE_Z)
...
#define _EXPAND_CALL_TRIPLE3_X_int64_t(FUNC_NAME, ARGS, TYPE_Y, TYPE_Z) \
    CONCAT(_EXPAND_CALL_TRIPLE3_Y_, TYPE_Y)(FUNC_NAME, ARGS, LongType, TYPE_Z)
...
#define _EXPAND_CALL_TRIPLE3_X_uint64_t(FUNC_NAME, ARGS, TYPE_Y, TYPE_Z) \
    CONCAT(_EXPAND_CALL_TRIPLE3_Y_, TYPE_Y)(FUNC_NAME, ARGS, UInt64Type, TYPE_Z) \
