...
// RingBuffer destructor and synchronize: platform-specific implementations in
//   execution/cpu/DataTransferManager.cpp  (CPU build)
//   execution/cuda/DataTransferManager.cu  (CUDA build)
...
// Platform-specific methods (initialize, shutdown, doSyncTransfer, etc.):
//   execution/cpu/DataTransferManager.cpp  (CPU build)
//   execution/cuda/DataTransferManager.cu  (CUDA build)
