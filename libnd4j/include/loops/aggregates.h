...
namespace functions {
    namespace aggregate {
        ...
        public:
            ...
            __device__ inline static void execCuda(void **arguments, int numArguments, Nd4jLong **shapeArguments, int numShapeArguments, int *indexArguments, int numIndexArguments, int **intArrays, int numIntArrays,  void *realArguments, int numRealArguments) {
