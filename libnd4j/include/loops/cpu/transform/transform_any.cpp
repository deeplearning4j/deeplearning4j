...
namespace functions {
    namespace transform {
        ...
        void TransformAny<X, Y>::exec(int opNum,
                ...
                void *extraParams,
                const Nd4jLong n) {
            DISPATCH_BY_OPNUM_TT(exec, PARAMS(x, xEws, z, zEws, extraParams, n), TRANSFORM_ANY_OPS);
		}
		...
		void _CUDA_H TransformAny<X, Z>::exec(
                    void *vx,
                    Nd4jLong *xShapeInfo,
                    void *vz,
                    Nd4jLong *zShapeInfo,
        ...
        template <typename X, typename Z>
        template <typename OpType>
		void _CUDA_H TransformAny<X, Z>::exec(void *vx,
                             Nd4jLong xEws,
                             void *vz,
                             Nd4jLong zEws,
                             void *vextraParams,
