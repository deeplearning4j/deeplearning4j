...
namespace functions {
    namespace transform {
        ...
        void TransformStrict<X>::exec(int opNum,
                ...
                void *extraParams,
                const Nd4jLong n) {
            DISPATCH_BY_OPNUM_T(exec, PARAMS(dx, xStride, result, resultStride, extraParams, n), TRANSFORM_STRICT_OPS);
		}
        ...
        void TransformStrict<X>::exec(
				...
				Nd4jLong *tadOffsets) {
                    DISPATCH_BY_OPNUM_T(exec, PARAMS(dx, xShapeInfo, result, resultShapeInfo, extraParams, tadShapeInfo, tadOffsets), TRANSFORM_STRICT_OPS);
		}
        ...
        template <typename X>
        template <typename OpType>
		void _CUDA_H TransformStrict<X>::exec(void *vx,
                             Nd4jLong xStride,
                             void *vresult,
                             Nd4jLong resultStride,
                             void *vextraParams,
