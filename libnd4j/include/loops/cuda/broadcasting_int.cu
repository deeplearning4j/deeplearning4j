...
//////////////////////////////////////////////////////////////////////////////
// Implementation of the execBroadcast function that dispatches based on opNum
template <typename X>
...
//////////////////////////////////////////////////////////////////////////////
// Implementation of the execBroadcast function that dispatches based on opNum without dimensions
template <typename X>
SD_HOST void BroadcastInt<X>::execBroadcast(
   dim3 &launchDims,
   cudaStream_t *stream,
...
//////////////////////////////////////////////////////////////////////////////
// Implementation of the execInverseBroadcast function that dispatches based on opNum
template <typename X>
...
//////////////////////////////////////////////////////////////////////////////
// Implementation of the BroadcastInt::execBroadcast functions

// Broadcast with dimensions
template <typename X>
template <typename OpClass>
SD_HOST void BroadcastInt<X>::intermediateBroadcast(
   dim3 launchDims,
...
//////////////////////////////////////////////////////////////////////////////
// Implementation of the BroadcastInt::transformCuda device function with cached shape info
template <typename X>
template <typename OpClass>
SD_DEVICE void BroadcastInt<X>::transformCuda(
   void const* vx,
...
//////////////////////////////////////////////////////////////////////////////
// Implementation of the BroadcastInt::transformInverseCuda device function with cached shape info
template <typename X>
template <typename OpClass>
SD_DEVICE void BroadcastInt<X>::transformInverseCuda(
   void const* vx,
