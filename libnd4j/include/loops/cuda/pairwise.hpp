...
template<typename X, typename Y, typename Z>
template<typename OpType>
__device__ void PairWiseTransform<X,Y,Z>::transform(void *vx, Nd4jLong *xShapeInfo, void *vy, Nd4jLong *yShapeInfo, void *vz, Nd4jLong *zShapeInfo, void *vextraParams, Nd4jLong *xIndexes, Nd4jLong *yIndexes, Nd4jLong *zIndexes, int *allocPointer, UnifiedSharedMemory *manager, Nd4jLong *tadOnlyShapeInfo){
