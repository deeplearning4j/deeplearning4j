 ...
 public:
  ...
  void executeOnce() override {
    ...
    NativeOpExecutioner::execBroadcast(LaunchContext::defaultContext(), _opNum, _x->buffer(), _x->shapeInfo(),
                                       ...
                                       /*sd::LongType */ tadOnlyShapeInfoZ, /*sd::LongType */ tadOffsetsZ);
  ...
  OpBenchmark *clone() override { return new BroadcastBenchmark((broadcast::Ops)_opNum, _testName, _x, _y, _z, _axis); }
};
}  // namespace sd
