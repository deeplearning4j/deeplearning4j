...
namespace nd4j {
    DebugInfo 
    DebugInfo::debugStatistics(NDArray const* input) {
        DebugInfo info;
        DebugInfo::retrieveDebugStatistics(&info, input);
        return info;
    }
    void 
    DebugInfo::retrieveDebugStatistics(DebugInfo* info, NDArray const* input) {
        if (nullptr == info)
                return;
