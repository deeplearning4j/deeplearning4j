...
BUILD_DOUBLE_TEMPLATE(template class ReduceFloatWrapper, , LIBND4J_TYPES, FLOAT_TYPES_0);
BUILD_DOUBLE_TEMPLATE(template class TransformFloatWrapper, , LIBND4J_TYPES, FLOAT_TYPES_0);
