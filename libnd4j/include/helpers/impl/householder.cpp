...
template class ND4J_LOCAL Householder<float>;
template class ND4J_LOCAL Householder<float16>;
template class ND4J_LOCAL Householder<bfloat16>;
template class ND4J_LOCAL Householder<double>;
