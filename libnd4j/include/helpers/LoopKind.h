...
class SD_LIB_EXPORT LoopKind {
 public:
  ...
  static SD_INLINE Kind deduceKindOfLoopXYZ(const sd::LongType* xShapeInfo, const sd::LongType* yShapeInfo,
                                            const sd::LongType* zShapeInfo);
  static SD_INLINE Kind deduceKindOfLoopTadXZ(const sd::LongType* xShapeInfo, const sd::LongType* zShapeInfo,
                                              const sd::LongType* tadShapeInfo);
  static SD_INLINE Kind deduceKindOfLoopTadXYZ(const sd::LongType* xTadShapeInfo, const sd::LongType* yTadShapeInfo,
                                               const sd::LongType* zShapeInfo);
  static SD_INLINE Kind deduceKindOfLoopBroadcast(const sd::LongType* xShapeInfo, const sd::LongType* yShapeInfo,
                                                  const sd::LongType* zShapeInfo);
};
...
LoopKind::Kind LoopKind::deduceKindOfLoopXZ(const sd::LongType* xShapeInfo, const sd::LongType* zShapeInfo) {
  ...
  if (xEws == 1 && zEws == 1 && xOrder == zOrder && (shapesSame || xOrder == 'c')) return EWS1;
...
LoopKind::Kind LoopKind::deduceKindOfLoopBroadcast(const sd::LongType* xShapeInfo, const sd::LongType* yShapeInfo,
                                                   const sd::LongType* zShapeInfo) {
...
//////////////////////////////////////////////////////////////////////////////
LoopKind::Kind LoopKind::deduceKindOfLoopXYZ(const sd::LongType* xShapeInfo, const sd::LongType* yShapeInfo,
                                             const sd::LongType* zShapeInfo) {
  const int xRank = shape::rank(xShapeInfo);
  const sd::LongType xEws = shape::elementWiseStride(xShapeInfo);
...
//////////////////////////////////////////////////////////////////////////////
LoopKind::Kind LoopKind::deduceKindOfLoopTadXZ(const sd::LongType* xShapeInfo, const sd::LongType* zShapeInfo,
                                               const sd::LongType* tadShapeInfo) {
  const int xRank = shape::rank(xShapeInfo);
...
//////////////////////////////////////////////////////////////////////////////
LoopKind::Kind LoopKind::deduceKindOfLoopTadXYZ(const sd::LongType* xTadShapeInfo, const sd::LongType* yTadShapeInfo,
                                                const sd::LongType* zShapeInfo) {
