...
#define LST_1(WHAT, TYPE, OPNUM_PAIR) WHAT(TYPE, OPNUM_PAIR)
#define LST_2(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_1(WHAT, TYPE, __VA_ARGS__))
#define LST_3(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_2(WHAT, TYPE, __VA_ARGS__))
#define LST_4(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_3(WHAT, TYPE, __VA_ARGS__))
#define LST_5(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_4(WHAT, TYPE, __VA_ARGS__))
#define LST_6(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_5(WHAT, TYPE, __VA_ARGS__))
#define LST_7(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_6(WHAT, TYPE, __VA_ARGS__))
#define LST_8(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_7(WHAT, TYPE, __VA_ARGS__))
#define LST_9(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_8(WHAT, TYPE, __VA_ARGS__))
#define LST_10(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_9(WHAT, TYPE, __VA_ARGS__))
#define LST_11(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_10(WHAT, TYPE, __VA_ARGS__))
#define LST_12(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_11(WHAT, TYPE, __VA_ARGS__))
#define LST_13(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_12(WHAT, TYPE, __VA_ARGS__))
#define LST_14(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_13(WHAT, TYPE, __VA_ARGS__))
#define LST_15(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_14(WHAT, TYPE, __VA_ARGS__))
#define LST_16(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_15(WHAT, TYPE, __VA_ARGS__))
#define LST_17(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_16(WHAT, TYPE, __VA_ARGS__))
#define LST_18(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_17(WHAT, TYPE, __VA_ARGS__))
#define LST_19(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_18(WHAT, TYPE, __VA_ARGS__))
#define LST_20(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_19(WHAT, TYPE, __VA_ARGS__))
#define LST_21(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_20(WHAT, TYPE, __VA_ARGS__))
#define LST_22(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_21(WHAT, TYPE, __VA_ARGS__))
#define LST_23(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_22(WHAT, TYPE, __VA_ARGS__))
#define LST_24(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_23(WHAT, TYPE, __VA_ARGS__))
#define LST_25(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_24(WHAT, TYPE, __VA_ARGS__))
#define LST_26(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_25(WHAT, TYPE, __VA_ARGS__))
#define LST_27(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_26(WHAT, TYPE, __VA_ARGS__))
#define LST_28(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_27(WHAT, TYPE, __VA_ARGS__))
#define LST_29(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_28(WHAT, TYPE, __VA_ARGS__))
#define LST_30(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_29(WHAT, TYPE, __VA_ARGS__))
#define LST_31(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_30(WHAT, TYPE, __VA_ARGS__))
#define LST_32(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_31(WHAT, TYPE, __VA_ARGS__))
#define LST_33(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_32(WHAT, TYPE, __VA_ARGS__))
#define LST_34(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_33(WHAT, TYPE, __VA_ARGS__))
#define LST_35(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_34(WHAT, TYPE, __VA_ARGS__))
#define LST_36(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_35(WHAT, TYPE, __VA_ARGS__))
#define LST_37(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_36(WHAT, TYPE, __VA_ARGS__))
#define LST_38(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_37(WHAT, TYPE, __VA_ARGS__))
#define LST_39(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_38(WHAT, TYPE, __VA_ARGS__))
#define LST_40(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_39(WHAT, TYPE, __VA_ARGS__))
#define LST_41(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_40(WHAT, TYPE, __VA_ARGS__))
#define LST_42(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_41(WHAT, TYPE, __VA_ARGS__))
#define LST_43(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_42(WHAT, TYPE, __VA_ARGS__))
#define LST_44(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_43(WHAT, TYPE, __VA_ARGS__))
#define LST_45(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_44(WHAT, TYPE, __VA_ARGS__))
#define LST_46(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_45(WHAT, TYPE, __VA_ARGS__))
#define LST_47(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_46(WHAT, TYPE, __VA_ARGS__))
#define LST_48(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_47(WHAT, TYPE, __VA_ARGS__))
#define LST_49(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_48(WHAT, TYPE, __VA_ARGS__))
#define LST_50(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_49(WHAT, TYPE, __VA_ARGS__))
#define LST_51(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_50(WHAT, TYPE, __VA_ARGS__))
#define LST_52(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_51(WHAT, TYPE, __VA_ARGS__))
#define LST_53(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_52(WHAT, TYPE, __VA_ARGS__))
#define LST_54(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_53(WHAT, TYPE, __VA_ARGS__))
#define LST_55(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_54(WHAT, TYPE, __VA_ARGS__))
#define LST_56(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_55(WHAT, TYPE, __VA_ARGS__))
#define LST_57(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_56(WHAT, TYPE, __VA_ARGS__))
#define LST_58(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_57(WHAT, TYPE, __VA_ARGS__))
#define LST_59(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_58(WHAT, TYPE, __VA_ARGS__))
#define LST_60(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_59(WHAT, TYPE, __VA_ARGS__))
#define LST_61(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_60(WHAT, TYPE, __VA_ARGS__))
#define LST_62(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_61(WHAT, TYPE, __VA_ARGS__))
#define LST_63(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_62(WHAT, TYPE, __VA_ARGS__))
#define LST_64(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_63(WHAT, TYPE, __VA_ARGS__))
#define LST_65(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_64(WHAT, TYPE, __VA_ARGS__))
#define LST_66(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_65(WHAT, TYPE, __VA_ARGS__))
#define LST_67(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_66(WHAT, TYPE, __VA_ARGS__))
#define LST_68(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_67(WHAT, TYPE, __VA_ARGS__))
#define LST_69(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_68(WHAT, TYPE, __VA_ARGS__))
#define LST_70(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_69(WHAT, TYPE, __VA_ARGS__))
#define LST_71(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_70(WHAT, TYPE, __VA_ARGS__))
#define LST_72(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_71(WHAT, TYPE, __VA_ARGS__))
#define LST_73(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_72(WHAT, TYPE, __VA_ARGS__))
#define LST_74(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_73(WHAT, TYPE, __VA_ARGS__))
#define LST_75(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_74(WHAT, TYPE, __VA_ARGS__))
#define LST_76(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_75(WHAT, TYPE, __VA_ARGS__))
#define LST_77(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_76(WHAT, TYPE, __VA_ARGS__))
#define LST_78(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_77(WHAT, TYPE, __VA_ARGS__))
#define LST_79(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_78(WHAT, TYPE, __VA_ARGS__))
#define LST_80(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_79(WHAT, TYPE, __VA_ARGS__))
#define LST_81(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_80(WHAT, TYPE, __VA_ARGS__))
#define LST_82(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_81(WHAT, TYPE, __VA_ARGS__))
#define LST_83(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_82(WHAT, TYPE, __VA_ARGS__))
#define LST_84(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_83(WHAT, TYPE, __VA_ARGS__))
#define LST_85(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_84(WHAT, TYPE, __VA_ARGS__))
#define LST_86(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_85(WHAT, TYPE, __VA_ARGS__))
#define LST_87(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_86(WHAT, TYPE, __VA_ARGS__))
#define LST_88(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_87(WHAT, TYPE, __VA_ARGS__))
#define LST_89(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_88(WHAT, TYPE, __VA_ARGS__))
#define LST_90(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_89(WHAT, TYPE, __VA_ARGS__))
#define LST_91(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_90(WHAT, TYPE, __VA_ARGS__))
#define LST_92(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_91(WHAT, TYPE, __VA_ARGS__))
#define LST_93(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_92(WHAT, TYPE, __VA_ARGS__))
#define LST_94(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_93(WHAT, TYPE, __VA_ARGS__))
#define LST_95(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_94(WHAT, TYPE, __VA_ARGS__))
#define LST_96(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_95(WHAT, TYPE, __VA_ARGS__))
#define LST_97(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_96(WHAT, TYPE, __VA_ARGS__))
#define LST_98(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_97(WHAT, TYPE, __VA_ARGS__))
#define LST_99(WHAT, TYPE, OPNUM_PAIR, ...) WHAT(TYPE, OPNUM_PAIR)EVAL(LST_98(WHAT, TYPE, __VA_ARGS__))
...
#define _EXPAND_OP_CALL_OPLIST(VECTOR, NUM_A, TYPE_A) VECTOR.emplace_back(LegacyOp(NUM_A, #TYPE_A));
...
#define _EXPAND_PACKED_CALL_OPLIST(VECTOR, OPNUM_PAIR) EVALUATING_PASTE(_EXPAND, _OP_CALL_OPLIST(VECTOR, UNPAREN(OPNUM_PAIR)))
...
#define GET_MACROS_O(_1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15, _16, _17, _18, _19, _20, _21, _22, _23, _24, _25, _26, _27, _28, _29, _30, _31, _32, _33, _34, _35, _36, _37, _38, _39, _40, _41, _42, _43, _44, _45, _46, _47, _48, _49, _50, _51, _52, _53, _54, _55, _56, _57, _58, _59, _60, _61, _62, _63, _64, _65, _66, _67, _68, _69, _70, _71, _72, _73, _74, _75, _76, _77, _78, _79, _80, _81, _82, _83, _84, _85, _86, _87, _88, _89, _90, _91, _92, _93, _94, _95, _96, _97, _98, _99, NAME,...) NAME
...
#define FOR_EACH_OPLIST(WHAT, VECTOR, ...) EXPAND(GET_MACROS_O(__VA_ARGS__,  LST_99, LST_98, LST_97, LST_96, LST_95, LST_94, LST_93, LST_92, LST_91, LST_90, LST_89, LST_88, LST_87, LST_86, LST_85, LST_84, LST_83, LST_82, LST_81, LST_80, LST_79, LST_78, LST_77, LST_76, LST_75, LST_74, LST_73, LST_72, LST_71, LST_70, LST_69, LST_68, LST_67, LST_66, LST_65, LST_64, LST_63, LST_62, LST_61, LST_60, LST_59, LST_58, LST_57, LST_56, LST_55, LST_54, LST_53, LST_52, LST_51, LST_50, LST_49, LST_48, LST_47, LST_46, LST_45, LST_44, LST_43, LST_42, LST_41, LST_40, LST_39, LST_38, LST_37, LST_36, LST_35, LST_34, LST_33, LST_32, LST_31, LST_30, LST_29, LST_28, LST_27, LST_26, LST_25, LST_24, LST_23, LST_22, LST_21, LST_20, LST_19, LST_18, LST_17, LST_16, LST_15, LST_14, LST_13, LST_12, LST_11, LST_10, LST_9, LST_8, LST_7, LST_6, LST_5, LST_4, LST_3, LST_2, LST_1)(WHAT, VECTOR, __VA_ARGS__))
...
#define _EXEC_OPLIST(VECTOR, ...) EVAL(FOR_EACH_OPLIST(CALL_OPLIST, VECTOR, __VA_ARGS__))
...
#define BUILD_OPLIST(VECTOR, OPS) EVAL(_EXEC_OPLIST(VECTOR, OPS))
...
#define CALL_OPLIST(A, B) EXPAND(_EXPAND_PACKED_CALL_OPLIST(A, B))
