 ...
 * Source: https://raw.githubusercontent.com/openxla/xla/109c47c1bd003dc856fcfa940c1291700a4addb3/xla/pjrt/c/pjrt_c_api.h
 * Commit: 109c47c1bd003dc856fcfa940c1291700a4addb3
 * License: Apache License 2.0 (same as this file)
 * Pinned: 2026-07-02 for deeplearning4j TPU build (no python, no proprietary bits at build time)
 * Update: re-run libnd4j/scripts/vendor-pjrt-header.sh (or manually curl from above URL pinned to a new commit)
 * ============================================================================ */
