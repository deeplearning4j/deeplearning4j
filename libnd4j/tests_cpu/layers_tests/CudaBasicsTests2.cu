...
TEST_F(CudaBasicsTests2, mmulMxV_22) {
    ...
    NDArray a('f', {M,N}, {1.2,1.1,1.0,0.9,0.8,0.7,0.5,0.4,0.3,0.2,0.1,0}, sd::DataType::FLOAT32);
    NDArray temp('f', {M,N,5},
{16,2,-6,7,2,-2,4,-7,6,4,4,6,-3,1,3,9,1,4,9,10,-10,-3,-8,7,-7,-7,6,9,7,-6,8,7,-3,-3,4,-2,5,-3,-3,4,6,-5,-1,7,-5,4,-10,-1,8,0,-7,4,-10,-7,-8,-9,2,9,7,9},
sd::DataType::DOUBLE); NDArray x = temp(6, {0,2}); NDArray y('f', {M}, sd::DataType::FLOAT32);
...
TEST_F(CudaBasicsTests2, mmulMxV_23) {
    ...
    a.permutei({1,0});
    NDArray temp('f', {5,M,N},
{16,2,-6,7,2,-2,4,-7,6,4,4,6,-3,1,3,9,1,4,9,10,-10,-3,-8,7,-7,-7,6,9,7,-6,8,7,-3,-3,4,-2,5,-3,-3,4,6,-5,-1,7,-5,4,-10,-1,8,0,-7,4,-10,-7,-8,-9,2,9,7,9},
sd::DataType::DOUBLE); NDArray x = temp(3, {0,1}); NDArray y('f', {M}, sd::DataType::FLOAT32);
...
TEST_F(CudaBasicsTests2, mmulMxV_24) {
    ...
    NDArray temp('f', {M,N,5},
{16,2,-6,7,2,-2,4,-7,6,4,4,6,-3,1,3,9,1,4,9,10,-10,-3,-8,7,-7,-7,6,9,7,-6,8,7,-3,-3,4,-2,5,-3,-3,4,6,-5,-1,7,-5,4,-10,-1,8,0,-7,4,-10,-7,-8,-9,2,9,7,9},
sd::DataType::DOUBLE); NDArray x = temp(6, {0,2},true); NDArray y('f', {M}, sd::DataType::FLOAT32);
...
TEST_F(CudaBasicsTests2, mmulMxV_25) {
    ...
    NDArray temp('f', {5,M,N},
{16,2,-6,7,2,-2,4,-7,6,4,4,6,-3,1,3,9,1,4,9,10,-10,-3,-8,7,-7,-7,6,9,7,-6,8,7,-3,-3,4,-2,5,-3,-3,4,6,-5,-1,7,-5,4,-10,-1,8,0,-7,4,-10,-7,-8,-9,2,9,7,9},
sd::DataType::DOUBLE); NDArray x = temp(3, {0,1}, true); NDArray y('f', {M}, sd::DataType::FLOAT32);
...
TEST_F(CudaBasicsTests2, mmulMxV_26) {
    ...
    NDArray temp('f',  {5,M,N},
{16,2,-6,7,2,-2,4,-7,6,4,4,6,-3,1,3,9,1,4,9,10,-10,-3,-8,7,-7,-7,6,9,7,-6,8,7,-3,-3,4,-2,5,-3,-3,4,6,-5,-1,7,-5,4,-10,-1,8,0,-7,4,-10,-7,-8,-9,2,9,7,9},
sd::DataType::DOUBLE); NDArray temp1('c', {5,M,N},
{16,2,-6,7,2,-2,4,-7,6,4,4,6,-3,1,3,9,1,4,9,10,-10,-3,-8,7,-7,-7,6,9,7,-6,8,7,-3,-3,4,-2,5,-3,-3,4,6,-5,-1,7,-5,4,-10,-1,8,0,-7,4,-10,-7,-8,-9,2,9,7,9},
sd::DataType::FLOAT32); NDArray x = temp(2, {0,1}); NDArray y = temp1(17, {0,2});
...
sd::DataType::DOUBLE); NDArray temp1('c', {5,M,N},
{16,2,-6,7,2,-2,4,-7,6,4,4,6,-3,1,3,9,1,4,9,10,-10,-3,-8,7,-7,-7,6,9,7,-6,8,7,-3,-3,4,-2,5,-3,-3,4,6,-5,-1,7,-5,4,-10,-1,8,0,-7,4,-10,-7,-8,-9,2,9,7,9},
sd::DataType::FLOAT32); NDArray x = temp(2, {0,1},true); NDArray y = temp1(17, {0,2},true);
