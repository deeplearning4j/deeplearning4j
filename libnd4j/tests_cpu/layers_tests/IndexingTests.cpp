...
TEST_F(IndexingTests, SimpleSlice_4) {
    auto input = NDArrayFactory::_create<double>('c', {3, 2, 3}, {1.0, 1, 1, 2, 2, 2, 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6});
    auto start = NDArrayFactory::_create<double>('c', {3}, {1.0, 0.0, 0.0});
    auto stop = NDArrayFactory::_create<double>('c', {3}, {2.0, 1.0, 3.0});
    auto exp = NDArrayFactory::_create<double>('c', {2, 1, 3}, {3.0, 3.0, 3.0, 5.0, 5.0, 5.0});
...
TEST_F(IndexingTests, MaskedSlice_0) {
    ...
    auto exp = NDArrayFactory::_create<float>('c', {1, 5});
    exp.assign(2.0f);
...
TEST_F(IndexingTests, MaskedSlice_00) {
    ...
    auto exp = NDArrayFactory::_create<float>('c', {1, 2}, {2, 2});
...
TEST_F(IndexingTests, MaskedSlice_2) {
    ...
    auto matrix = NDArrayFactory::_create<float>('c', {3, 3, 3});
...
TEST_F(IndexingTests, MaskedSlice_3) {
    ...
    auto exp = NDArrayFactory::_create<float>('c', {2, 3});
    exp.setBuffer(_expB);
...
TEST_F(IndexingTests, Live_Slice_1) {
    ...
    auto begin = NDArrayFactory::_create<float>('c', {1, 3}, {1.0f, 0.0f, 0.0f});
    auto end = NDArrayFactory::_create<float>('c', {1, 3}, {3.0f, 3.0f, 3.0f});
    auto stride = NDArrayFactory::_create<float>('c', {1, 3}, {1.0f, 1.0f, 1.0f});
...
TEST_F(IndexingTests, Test_StridedSlice_1) {
    auto x = NDArrayFactory::_create<float>('c', {1, 2}, {5.f, 2.f});
    auto a = NDArrayFactory::_create<float>('c', {1, 1}, {0.f});
    auto b = NDArrayFactory::_create<float>('c', {1, 1}, {1.f});
    auto c = NDArrayFactory::_create<float>('c', {1, 1}, {1.f});
...
TEST_F(IndexingTests, Test_StridedSlice_2) {
    ...
    auto a = NDArrayFactory::_create<float>('c', {1, 2}, {1, 1});
    auto b = NDArrayFactory::_create<float>('c', {1, 2}, {2, 2});
    auto c = NDArrayFactory::_create<float>('c', {1, 2}, {1, 1});
    auto exp = NDArrayFactory::_create<float>('c', {1}, {5.0});
...
TEST_F(IndexingTests, Test_StridedSlice_3) {
    auto x = NDArrayFactory::_create<float>('c', {2, 3}, {1, 2, 3, 4, 5, 6});
    auto a = NDArrayFactory::_create<float>('c', {1, 2}, {1, 2});
    auto b = NDArrayFactory::_create<float>('c', {1, 2}, {2, 3});
    auto c = NDArrayFactory::_create<float>('c', {1, 2}, {1, 1});
    auto exp = NDArrayFactory::_create<float>('c', {1}, {6.0});
...
TEST_F(IndexingTests, Test_StridedSlice_4) {
    auto x = NDArrayFactory::_create<float>('c', {1, 2}, {5, 2});
    auto a = NDArrayFactory::_create<float>('c', {1, 1}, {0});
    auto b = NDArrayFactory::_create<float>('c', {1, 1}, {1});
    auto c = NDArrayFactory::_create<float>('c', {1, 1}, {1});
    auto exp = NDArrayFactory::_create<float>(5.0f);
...
TEST_F(IndexingTests, Test_Subarray_Strided_1) {
    ...
    auto exp = NDArrayFactory::_create<float>('c', {3, 2}, {1, 3, 4, 6, 7, 9});
