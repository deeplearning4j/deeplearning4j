...
TEST_F(MultiDataTypeTests, ndarray_applyTrueBroadcast_test2) {
  ...
  x1.applyTrueBroadcast(BroadcastBoolOpsTuple(sd::scalar::EqualTo, sd::pairwise::EqualTo, sd::broadcast::EqualTo), x2,
                        x3);
  ASSERT_EQ(x3, exp1);

  x1.applyTrueBroadcast(BroadcastBoolOpsTuple(sd::scalar::EqualTo, sd::pairwise::EqualTo, sd::broadcast::EqualTo), x4,
                        x3);
  ASSERT_EQ(x3, exp2);

  x4.applyTrueBroadcast(BroadcastBoolOpsTuple(sd::scalar::EqualTo, sd::pairwise::EqualTo, sd::broadcast::EqualTo), x1,
                        x3);
  ASSERT_EQ(x3, exp2);

  x5.applyTrueBroadcast(BroadcastBoolOpsTuple(sd::scalar::EqualTo, sd::pairwise::EqualTo, sd::broadcast::EqualTo), x4,
                        x6);
  ASSERT_EQ(x6, exp3);
}
