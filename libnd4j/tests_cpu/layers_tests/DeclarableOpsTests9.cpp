...
////////////////////////////////////////////////////////////////////////////////
TEST_F(DeclarableOpsTests9, cumprod_test4) {
    
    NDArray<double> inputC('c', {2, 3, 3});
    NDArray<double> axis(1.);
...
//    const bool isGradCorrect = GradCheck::checkGrad(opFF, opBP, argsHolderFF, argsHolderBP);
    ASSERT_TRUE(res->status() == ND4J_STATUS_OK);
    res->at(0)->printIndexedBuffer("Cumulative product of 2x(3x3) ints");
//    ASSERT_TRUE(isGradCorrect);
    delete res;
}

////////////////////////////////////////////////////////////////////////////////
TEST_F(DeclarableOpsTests9, cumprod_test5) {
...
//    const OpArgsHolder<double> argsHolderBP({&inputC, &axis, &gradO}, {}, {exclusive, reverse});
    ...
    nd4j::ops::cumprod_bp<double> opFF;
//    nd4j::ops::cumprod_bp<double> opBP;
    auto res = opFF.execute({&inputC, &axis, &gradO}, {}, {exclusive, reverse});
//    const bool isGradCorrect = GradCheck::checkGrad(opFF, opBP, argsHolderFF, argsHolderBP);
    ASSERT_TRUE(res->status() == ND4J_STATUS_OK);
    res->at(0)->printIndexedBuffer("Cumulative product of 2x(3x3) ints backprop");
//    ASSERT_TRUE(isGradCorrect);
    delete res;
}

////////////////////////////////////////////////////////////////////////////////
TEST_F(DeclarableOpsTests9, cumprod_test6) {
