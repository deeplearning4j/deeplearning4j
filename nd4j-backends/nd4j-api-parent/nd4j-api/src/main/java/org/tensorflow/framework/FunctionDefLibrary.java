...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) == 0x00000001)) {
              function_ = new java.util.ArrayList<FunctionDef>();
              mutable_bitField0_ |= 0x00000001;
            }
            function_.add(
                input.readMessage(FunctionDef.parser(), extensionRegistry));
            break;
          }
          case 18: {
            if (!((mutable_bitField0_ & 0x00000002) == 0x00000002)) {
              gradient_ = new java.util.ArrayList<GradientDef>();
              mutable_bitField0_ |= 0x00000002;
            }
            gradient_.add(
                input.readMessage(GradientDef.parser(), extensionRegistry));
            break;
          }
        }
      }
  ...
  protected FieldAccessorTable
    ...
    return FunctionProtos.internal_static_tensorflow_FunctionDefLibrary_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            FunctionDefLibrary.class, Builder.class);
  }

  public static final int FUNCTION_FIELD_NUMBER = 1;
  private java.util.List<FunctionDef> function_;
  /**
   ...
   * <code>repeated .tensorflow.FunctionDef function = 1;</code>
   */
  public java.util.List<? extends FunctionDefOrBuilder>
   ...
   * <code>repeated .tensorflow.FunctionDef function = 1;</code>
   */
  public FunctionDefOrBuilder getFunctionOrBuilder(
      int index) {
    return function_.get(index);
  }

  public static final int GRADIENT_FIELD_NUMBER = 2;
  private java.util.List<GradientDef> gradient_;
  /**
   ...
   * <code>repeated .tensorflow.GradientDef gradient = 2;</code>
   */
  public java.util.List<? extends GradientDefOrBuilder>
   ...
   * <code>repeated .tensorflow.GradientDef gradient = 2;</code>
   */
  public GradientDefOrBuilder getGradientOrBuilder(
      int index) {
    return gradient_.get(index);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    FunctionDefLibrary other = (FunctionDefLibrary) obj;
  ...
  public static FunctionDefLibrary parseFrom(
  ...
  public static FunctionDefLibrary parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static FunctionDefLibrary parseFrom(
  ...
  public static FunctionDefLibrary parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static FunctionDefLibrary parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static FunctionDefLibrary parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(FunctionDefLibrary prototype) {
  ...
  public static final class Builder extends
    ...
    public FunctionDefLibrary build() {
      FunctionDefLibrary result = buildPartial();
    ...
    public FunctionDefLibrary buildPartial() {
      FunctionDefLibrary result = new FunctionDefLibrary(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof FunctionDefLibrary) {
        return mergeFrom((FunctionDefLibrary)other);
      } else {
    ...
    public Builder mergeFrom(FunctionDefLibrary other) {
      if (other == FunctionDefLibrary.getDefaultInstance()) return this;
      if (functionBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      FunctionDefLibrary parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (FunctionDefLibrary) e.getUnfinishedMessage();
    ...
    private void ensureFunctionIsMutable() {
      if (!((bitField0_ & 0x00000001) == 0x00000001)) {
        function_ = new java.util.ArrayList<FunctionDef>(function_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        FunctionDef, FunctionDef.Builder, FunctionDefOrBuilder> functionBuilder_;
     ...
     */
    public Builder setFunction(
        int index, FunctionDef.Builder builderForValue) {
      if (functionBuilder_ == null) {
        ensureFunctionIsMutable();
     ...
     * <code>repeated .tensorflow.FunctionDef function = 1;</code>
     */
    public Builder addFunction(FunctionDef value) {
      if (functionBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder addAllFunction(
        Iterable<? extends FunctionDef> values) {
      if (functionBuilder_ == null) {
        ensureFunctionIsMutable();
     ...
     * <code>repeated .tensorflow.FunctionDef function = 1;</code>
     */
    public FunctionDef.Builder getFunctionBuilder(
        int index) {
    ...
    public FunctionDef.Builder addFunctionBuilder(
        int index) {
      return getFunctionFieldBuilder().addBuilder(
          index, FunctionDef.getDefaultInstance());
    }
    /**
     * <code>repeated .tensorflow.FunctionDef function = 1;</code>
     */
    public java.util.List<FunctionDef.Builder>
         getFunctionBuilderList() {
      return getFunctionFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        FunctionDef, FunctionDef.Builder, FunctionDefOrBuilder>
        getFunctionFieldBuilder() {
      if (functionBuilder_ == null) {
    ...
    private void ensureGradientIsMutable() {
      if (!((bitField0_ & 0x00000002) == 0x00000002)) {
        gradient_ = new java.util.ArrayList<GradientDef>(gradient_);
        bitField0_ |= 0x00000002;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        GradientDef, GradientDef.Builder, GradientDefOrBuilder> gradientBuilder_;
     ...
     */
    public Builder setGradient(
        int index, GradientDef.Builder builderForValue) {
      if (gradientBuilder_ == null) {
        ensureGradientIsMutable();
     ...
     * <code>repeated .tensorflow.GradientDef gradient = 2;</code>
     */
    public Builder addGradient(GradientDef value) {
      if (gradientBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder addAllGradient(
        Iterable<? extends GradientDef> values) {
      if (gradientBuilder_ == null) {
        ensureGradientIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, gradient_);
     ...
     * <code>repeated .tensorflow.GradientDef gradient = 2;</code>
     */
    public GradientDef.Builder getGradientBuilder(
        int index) {
    ...
    public GradientDef.Builder addGradientBuilder(
        int index) {
      return getGradientFieldBuilder().addBuilder(
          index, GradientDef.getDefaultInstance());
    }
    /**
     * <code>repeated .tensorflow.GradientDef gradient = 2;</code>
     */
    public java.util.List<GradientDef.Builder>
         getGradientBuilderList() {
      return getGradientFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        GradientDef, GradientDef.Builder, GradientDefOrBuilder>
        getGradientFieldBuilder() {
      if (gradientBuilder_ == null) {
  ...
  private static final FunctionDefLibrary DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new FunctionDefLibrary();
  }
