...
/**
 * Logical Or reduction op
 *
 * @author raver119@gmail.com
 */
public class Any extends BaseAccumulation {
    public Any(SameDiff sameDiff, DifferentialFunction i_v, int[] dimensions) {
        super(sameDiff, i_v, dimensions);
    }

    public Any(SameDiff sameDiff, DifferentialFunction i_v, DifferentialFunction i_v2, int[] dimensions) {
        super(sameDiff, i_v, i_v2, dimensions);
    }

    public Any() {}

    public Any(INDArray x, INDArray y, INDArray z, long n) {
        super(x, y, z, n);
    }

    public Any(INDArray x, INDArray y, long n) {
        super(x, y, n);
    }
    ...
    public Any(INDArray x, INDArray y) {
        super(x, y);
    }

    public Any(INDArray x, INDArray y, INDArray z) {
    ...
    public Op opForDimension(int index, int dimension) {
        ...
        if (y() != null)
            ...
            return new Any(xAlongDimension);
