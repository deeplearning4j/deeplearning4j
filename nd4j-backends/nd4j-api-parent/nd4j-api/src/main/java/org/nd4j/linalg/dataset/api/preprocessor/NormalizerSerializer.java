...
public class NormalizerSerializer {
     ...
     * @throws IOException
     * @deprecated Serialize a NormalizerStandardize to the given file
     */
     ...
     * @throws IOException
     * @deprecated Serialize a NormalizerStandardize to the given file path
     */
     ...
     * @throws IOException
     * @deprecated Serialize a NormalizerStandardize to a output stream
     */
     ...
     * @throws IOException
     * @deprecated Restore a NormalizerStandardize that was previously serialized to the given file
     */
     ...
     * @param file       the destination file
     * @throws IOException
     * @deprecated Serialize a MultiNormalizerStandardize to the given file
     */
     ...
     * @param path       the destination file path
     * @throws IOException
     * @deprecated Serialize a MultiNormalizerStandardize to the given file path
     */
     ...
     * @param stream     the output stream to write to
     * @throws IOException
     * @deprecated Serialize a MultiNormalizerStandardize to a output stream
     */
     ...
     * @throws IOException
     * @deprecated Restore a MultiNormalizerStandardize that was previously serialized to the given file
     */
