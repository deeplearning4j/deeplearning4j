...
public class Repeat extends ShapeOp {
    ...
    public Op opForDimension(int index, int dimension) {
        ...
        if (y() != null)
            return new Repeat(xAlongDimension, y.vectorAlongDimension(index, dimension),
                    z.vectorAlongDimension(index, dimension), xAlongDimension.length());
        else
            return new Repeat(xAlongDimension, z.vectorAlongDimension(index, dimension), xAlongDimension.length());
    ...
    public Op opForDimension(int index, int... dimension) {
        ...
        if (y() != null)
            return new Repeat(xAlongDimension, y.tensorAlongDimension(index, dimension),
                    z.tensorAlongDimension(index, dimension), xAlongDimension.length());
        else
            return new Repeat(xAlongDimension, z.tensorAlongDimension(index, dimension), xAlongDimension.length());
