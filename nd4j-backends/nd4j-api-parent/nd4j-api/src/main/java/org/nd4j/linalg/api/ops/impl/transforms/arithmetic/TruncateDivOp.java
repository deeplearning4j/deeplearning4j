...
public class TruncateDivOp extends BaseTransformOp {
    public TruncateDivOp(SameDiff sameDiff, DifferentialFunction i_v1, DifferentialFunction i_v2) {
        super(sameDiff, i_v1, i_v2);
    }

    public TruncateDivOp(SameDiff sameDiff, DifferentialFunction i_v1, DifferentialFunction i_v2, boolean inPlace) {
    ...
    public Op opForDimension(int index, int dimension) {
        ...
        if (y() != null)
            return new TruncateDivOp(xAlongDimension, y.vectorAlongDimension(index, dimension),
                            z.vectorAlongDimension(index, dimension), xAlongDimension.length());
        else
            return new TruncateDivOp(xAlongDimension, z.vectorAlongDimension(index, dimension), xAlongDimension.length());
    ...
    public Op opForDimension(int index, int... dimension) {
        ...
        if (y() != null)
            return new TruncateDivOp(xAlongDimension, y.tensorAlongDimension(index, dimension),
                            z.tensorAlongDimension(index, dimension), xAlongDimension.length());
        else
            return new TruncateDivOp(xAlongDimension, z.tensorAlongDimension(index, dimension), xAlongDimension.length());
