...
public class Pooling2D extends BaseTransformOp {
    ...
    public Pooling2D(INDArray x, int kh, int kw, int sy, int sx, int ph, int pw, boolean isSameMode, Pooling2DType type, INDArray z) {
        super(x);
        this.kh = kh;
        this.kw = kw;
        this.sy = sy;
    ...
    public Object[] extraArgs() {
        return new Object[] {kw, kh, sx, sy, pw, ph, isSameMode ? 1.0 : 0.0, type.ordinal()};
    }
