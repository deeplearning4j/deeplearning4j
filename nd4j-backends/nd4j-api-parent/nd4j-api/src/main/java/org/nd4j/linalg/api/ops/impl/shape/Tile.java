...
public class Tile extends ShapeOp {
   private int[] axis;
    ...
    public Op opForDimension(int index, int dimension) {
        ...
        if (y() != null)
            return new Tile(xAlongDimension, y.vectorAlongDimension(index, dimension),
                    z.vectorAlongDimension(index, dimension), xAlongDimension.length());
        else
            return new Tile(xAlongDimension, z.vectorAlongDimension(index, dimension), xAlongDimension.length());
    ...
    public Op opForDimension(int index, int... dimension) {
        ...
        if (y() != null)
            return new Tile(xAlongDimension, y.tensorAlongDimension(index, dimension),
