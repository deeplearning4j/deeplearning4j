...
public  class OpExecutionerTests extends BaseNd4jTest {
    ...
    public void testSoftmax() {
        ...
        INDArray matrixAssertion = Nd4j.create(new double[]{0.015876241,0.015876241,0.11731043,0.11731043,0.86681336,0.86681336},new int[]{2,3},'f');
    ...
    public void testOtherSoftmax() {
        ...
        Nd4j.getExecutioner().exec(new SoftMax(matrix));
        INDArray assertion = Nd4j.create(new double[]{
                2.9067235E-7,2.9067235E-7,2.9067235E-7,5.8383102E-6,
                5.8383102E-6,5.8383102E-6,1.1726559E-4,
                1.1726559E-4,1.1726559E-4,0.0023553425,
                0.0023553425,0.0023553425,0.047308315,0.047308315,
                0.047308315,0.95021296,0.95021296,0.95021296},new int[]{3,6},'f');
