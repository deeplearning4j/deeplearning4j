...
Many of the top AI researchers in the world are worried about two things:
...
We can find a good example of this in the history of cryptography. Think about how GCHQ invented RSA and public-private keys, but kept them a secret. Then the Stanford and MIT groups discovered those same things independently, a few years later, and published their ideas for the world to read. We're talking that kind of situation. Now imagine that instead of a system of cryptography, we're talking about a superintelligence. 
