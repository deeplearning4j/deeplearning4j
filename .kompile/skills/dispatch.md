---
name: dispatch
display_name: DL4J Kompile Task Dispatch
description: Dispatch tasks to kompile agents for deeplearning4j fixes, investigations, and multi-agent coordination. Ensures all mandatory rules are injected into agent prompts.
category: custom
tools: *
---
