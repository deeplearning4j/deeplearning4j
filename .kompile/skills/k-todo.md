---
name: k-todo
display_name: Kompile Task Tracking
description: Track work progress using kompile's todoread/todowrite tools and bash execution. Covers task lists, progress tracking, and shell command execution within kompile agents.
category: custom
tools: *
---
