---
name: k-process
display_name: Kompile Process & Coordination
description: Manage background processes and coordinate multi-agent file edits using kompile's process manager and edit coordinator. Launch builds, monitor progress, lock files, track agent activity.
category: custom
tools: *
---
