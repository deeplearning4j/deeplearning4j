---
name: k-search-code
display_name: Kompile Code Search & Graph
description: Search and navigate the deeplearning4j codebase using kompile's code_search, code_graph, graph_search, and local_code_index tools. Covers indexing, semantic search, symbol lookup, dependency tracing, and semantic path queries.
category: custom
tools: *
---
