...
public class NGramTokenizerFactoryTest extends BaseDL4JTest {
    ...
    public void testEmptyLines_1() throws Exception {
        var string = "";
        var tokens = new NGramTokenizerFactory(new DefaultTokenizerFactory(), 1, 2).create(string).getTokens();
    ...
    public void testEmptyLines_2() throws Exception {
        var string = "";
        var tf = new NGramTokenizerFactory(new DefaultTokenizerFactory(), 1, 2);
        tf.setTokenPreProcessor(new CommonPreprocessor());
        var tokens = tf.create(string).getTokens();
