...
public class ShapeTestC extends BaseNd4jTestWithBackends {
    ...
    public void testKeepDimsShape_1_T(Nd4jBackend backend) {
        var shape = new int[]{5, 5};
        var axis = new int[]{1, 0, 1};

        var result = Shape.getReducedShape(shape, axis, true, true);
    ...
    public void testKeepDimsShape_1_F(Nd4jBackend backend) {
        var shape = new int[]{5, 5};
        var axis = new int[]{0, 0, 1};

        var result = Shape.getReducedShape(shape, axis, false, true);
    ...
    public void testAxisNormalization_1(Nd4jBackend backend) {
        var axis = new int[] {1, -2};
        var rank = 2;
        var exp = new int[] {0, 1};

        var norm = Shape.normalizeAxis(rank, axis);
