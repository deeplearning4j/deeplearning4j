...
public class TestOnnxConverter {
        ...
        public void testOnnxTraining() throws Exception {
                ...
                SameDiff sameDiff = onnxFrameworkImporter.runImport(classPathResource.getFile().getAbsolutePath(), arr,
                                true,
                                true);
                SDVariable labels = sameDiff.placeHolder("labels", DataType.FLOAT);
                sameDiff.setEagerMode(false);
                SDVariable sdVariable = sameDiff.loss().softmaxCrossEntropy(labels, sameDiff.getVariable("22"),
                                sameDiff.constant(1.0f));
                ...
                setIterator.setPreProcessor((DataSetPreProcessor) toPreProcess -> toPreProcess
                                .setFeatures(toPreProcess.getFeatures().reshape(10, 1, 28, 28)));
        ...
        public void test() throws Exception {
                ...
                java.nio.file.Files.write(newModel.toPath(), modelProto.toByteArray());
