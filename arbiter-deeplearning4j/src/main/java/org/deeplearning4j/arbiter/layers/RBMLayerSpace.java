...
public class RBMLayerSpace extends BasePretrainNetworkLayerSpace<RBM> {
    ...
    protected void setLayerOptionsBuilder(RBM.Builder builder, double[] values) {
        ...
        if (hiddenUnit != null)
            builder.hiddenUnit(hiddenUnit.getValue(values));
        if (visibleUnit != null)
            builder.visibleUnit(visibleUnit.getValue(values));
        if (k != null)
    ...
    public String toString(String delim) {
        ...
        if (hiddenUnit != null)
            sb.append("hiddenUnit: ").append(hiddenUnit).append(delim);
        if (visibleUnit != null)
            sb.append("visibleUnit: ").append(visibleUnit).append(delim);
        if (k != null)
            sb.append("k: ").append(k).append(delim);
        if (sparsity != null)
