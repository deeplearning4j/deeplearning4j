 ...
 */
public class MultiLayerSpaceOld implements ModelParameterSpace<MultiLayerConfiguration> {
    ...
    public MultiLayerSpaceOld(Builder builder){
    ...
    public static class Builder {
        ...
        public MultiLayerSpaceOld build(){
            return new MultiLayerSpaceOld(this);
        }
