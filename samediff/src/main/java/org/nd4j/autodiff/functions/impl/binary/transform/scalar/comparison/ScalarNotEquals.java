...
public class ScalarNotEquals extends AbstractScalarFunction<ArrayField> {
    public ScalarNotEquals() {
    }

    public ScalarNotEquals(SameDiff sameDiff, DifferentialFunction<ArrayField> i_v, int[] shape, Object[] extraArgs) {
        super(sameDiff, i_v, shape, extraArgs);
    }

    public ScalarNotEquals(SameDiff sameDiff, DifferentialFunction<ArrayField> i_v, Object[] extraArgs) {
