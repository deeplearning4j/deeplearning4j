...
public class ScalarSub extends AbstractScalarFunction<ArrayField> {

    public ScalarSub() {
    }

    public ScalarSub(SameDiff sameDiff, DifferentialFunction<ArrayField> i_v, int[] shape, Object[] extraArgs) {
        super(sameDiff, i_v, shape, extraArgs);
    }

    public ScalarSub(SameDiff sameDiff, DifferentialFunction<ArrayField> i_v, Object[] extraArgs) {
