...
public class ScalarLessThan extends AbstractScalarFunction<ArrayField> {
    ...
    public ScalarLessThan(SameDiff sameDiff, DifferentialFunction<ArrayField> i_v, int[] shape, Object[] extraArgs) {
        super(sameDiff, i_v, shape, extraArgs);
    }

    public ScalarLessThan(SameDiff sameDiff, DifferentialFunction<ArrayField> i_v, Object[] extraArgs) {
