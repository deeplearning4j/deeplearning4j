...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return LogMemoryProtos.internal_static_tensorflow_MemoryLogRawDeallocation_descriptor;
  }

  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return LogMemoryProtos.internal_static_tensorflow_MemoryLogRawDeallocation_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            MemoryLogRawDeallocation.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof MemoryLogRawDeallocation)) {
      return super.equals(obj);
    }
    MemoryLogRawDeallocation other = (MemoryLogRawDeallocation) obj;
  ...
  public static MemoryLogRawDeallocation parseFrom(
  ...
  public static MemoryLogRawDeallocation parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static MemoryLogRawDeallocation parseFrom(
  ...
  public static MemoryLogRawDeallocation parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static MemoryLogRawDeallocation parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static MemoryLogRawDeallocation parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(MemoryLogRawDeallocation prototype) {
  ...
  public static final class Builder extends
    ...
    public MemoryLogRawDeallocation getDefaultInstanceForType() {
      return MemoryLogRawDeallocation.getDefaultInstance();
    }

    public MemoryLogRawDeallocation build() {
      MemoryLogRawDeallocation result = buildPartial();
    ...
    public MemoryLogRawDeallocation buildPartial() {
      MemoryLogRawDeallocation result = new MemoryLogRawDeallocation(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof MemoryLogRawDeallocation) {
        return mergeFrom((MemoryLogRawDeallocation)other);
      } else {
    ...
    public Builder mergeFrom(MemoryLogRawDeallocation other) {
      if (other == MemoryLogRawDeallocation.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      MemoryLogRawDeallocation parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (MemoryLogRawDeallocation) e.getUnfinishedMessage();
  ...
  private static final MemoryLogRawDeallocation DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new MemoryLogRawDeallocation();
  }
