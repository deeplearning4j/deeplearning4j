...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) == 0x00000001)) {
              devStats_ = new java.util.ArrayList<DeviceStepStats>();
              mutable_bitField0_ |= 0x00000001;
            }
            devStats_.add(
                input.readMessage(DeviceStepStats.parser(), extensionRegistry));
            break;
          }
        }
      }
  ...
  protected FieldAccessorTable
    ...
    return StepStatsProtos.internal_static_tensorflow_StepStats_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            StepStats.class, Builder.class);
  }

  public static final int DEV_STATS_FIELD_NUMBER = 1;
  private java.util.List<DeviceStepStats> devStats_;
  /**
   * <code>repeated .tensorflow.DeviceStepStats dev_stats = 1;</code>
   */
  public java.util.List<DeviceStepStats> getDevStatsList() {
    return devStats_;
  }
  /**
   * <code>repeated .tensorflow.DeviceStepStats dev_stats = 1;</code>
   */
  public java.util.List<? extends DeviceStepStatsOrBuilder>
   ...
   * <code>repeated .tensorflow.DeviceStepStats dev_stats = 1;</code>
   */
  public DeviceStepStats getDevStats(int index) {
    return devStats_.get(index);
  }
  /**
   * <code>repeated .tensorflow.DeviceStepStats dev_stats = 1;</code>
   */
  public DeviceStepStatsOrBuilder getDevStatsOrBuilder(
      int index) {
    return devStats_.get(index);
  }
  ...
  public static StepStats parseFrom(
  ...
  public static StepStats parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static StepStats parseFrom(
  ...
  public static StepStats parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static StepStats parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static StepStats parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(StepStats prototype) {
  ...
  public static final class Builder extends
    ...
    public StepStats getDefaultInstanceForType() {
      return StepStats.getDefaultInstance();
    }

    public StepStats build() {
      StepStats result = buildPartial();
    ...
    public StepStats buildPartial() {
      StepStats result = new StepStats(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof StepStats) {
        return mergeFrom((StepStats)other);
      } else {
    ...
    public Builder mergeFrom(StepStats other) {
      if (other == StepStats.getDefaultInstance()) return this;
      if (devStatsBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      StepStats parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (StepStats) e.getUnfinishedMessage();
    ...
    private void ensureDevStatsIsMutable() {
      if (!((bitField0_ & 0x00000001) == 0x00000001)) {
        devStats_ = new java.util.ArrayList<DeviceStepStats>(devStats_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        DeviceStepStats, DeviceStepStats.Builder, DeviceStepStatsOrBuilder> devStatsBuilder_;
    ...
    public Builder setDevStats(
        int index, DeviceStepStats value) {
      if (devStatsBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setDevStats(
        int index, DeviceStepStats.Builder builderForValue) {
      if (devStatsBuilder_ == null) {
        ensureDevStatsIsMutable();
     ...
     * <code>repeated .tensorflow.DeviceStepStats dev_stats = 1;</code>
     */
    public Builder addDevStats(DeviceStepStats value) {
      if (devStatsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addDevStats(
        DeviceStepStats.Builder builderForValue) {
      if (devStatsBuilder_ == null) {
        ensureDevStatsIsMutable();
    ...
    public Builder addAllDevStats(
        Iterable<? extends DeviceStepStats> values) {
      if (devStatsBuilder_ == null) {
        ensureDevStatsIsMutable();
     ...
     * <code>repeated .tensorflow.DeviceStepStats dev_stats = 1;</code>
     */
    public DeviceStepStats.Builder getDevStatsBuilder(
        int index) {
    ...
    public DeviceStepStats.Builder addDevStatsBuilder(
        int index) {
      return getDevStatsFieldBuilder().addBuilder(
          index, DeviceStepStats.getDefaultInstance());
    }
    /**
     * <code>repeated .tensorflow.DeviceStepStats dev_stats = 1;</code>
     */
    public java.util.List<DeviceStepStats.Builder>
         getDevStatsBuilderList() {
      return getDevStatsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        DeviceStepStats, DeviceStepStats.Builder, DeviceStepStatsOrBuilder>
        getDevStatsFieldBuilder() {
      if (devStatsBuilder_ == null) {
  ...
  private static final StepStats DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new StepStats();
  }
