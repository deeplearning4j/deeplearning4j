...
FORCEINLINE std::string int_array_to_string(int int_array[], int size_of_array) {
...
FORCEINLINE ::testing::AssertionResult arrsEquals(int n,int *assertion,int *other) {
    for(int i = 0; i < n; i++) {
