...
public class LegacyAsyncDataSetIterator implements DataSetIterator {
     ...
     */
    public LegacyAsyncDataSetIterator(DataSetIterator baseIterator) {
        this(baseIterator, 8);
    }

    public LegacyAsyncDataSetIterator(DataSetIterator iterator, int queueSize, BlockingQueue<DataSet> queue) {
     ...
     */
    public LegacyAsyncDataSetIterator(DataSetIterator iterator, int queueSize, BlockingQueue<DataSet> queue, boolean useWorkspace) {
        if (queueSize <= 0)
     ...
     */
    public LegacyAsyncDataSetIterator(DataSetIterator baseIterator, int queueSize) {
        this(baseIterator, queueSize, new LinkedBlockingQueue<DataSet>(queueSize));
    }

    public LegacyAsyncDataSetIterator(DataSetIterator baseIterator, int queueSize, boolean useWorkspace) {
