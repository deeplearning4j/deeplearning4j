...
@javax.annotation.Generated(value = {"org.deeplearning4j.optimize.listeners.stats.sbe.init.StaticInfoDecoder"})
...
public class StaticInfoDecoder
{
        ...
        implements Iterable<HwDeviceInfoGroupDecoder>, java.util.Iterator<HwDeviceInfoGroupDecoder>
    {
        ...
        private final InitGroupSizeEncodingDecoder dimensions = new InitGroupSizeEncodingDecoder();
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        builder.append(modelNumParams());
        builder.append('|');
        //Token{signal=BEGIN_GROUP, name='hwDeviceInfoGroup', description='null', id=7, version=0, encodedLength=8, offset=24, componentTokenCount=15, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
