    ...
    private static Map<ZooType, ZooModel> select(Map<ZooType, ZooModel> netmap, ZooType zooType, int numLabels,
        ...
        switch (zooType) {
            ...
            case CNN:
                ...
                netmap.putAll(ModelSelector.select(ZooType.TINYYOLO, numLabels, seed, iterations, workspaceMode));
                break;
            // RNN models
            case RNN:
            ...
            case DARKNET19:
                ...
                break;
            case TINYYOLO:
                netmap.put(ZooType.TINYYOLO, new TinyYOLO(numLabels, seed, iterations, workspaceMode));
                break;
            default:
                // do nothing
        }
