...
public class DefaultOpFactory implements OpFactory {
    ...
    public Accumulation createAccum(String name, INDArray x, INDArray y) {
        switch(name) {
            case "sum" : return new Sum(x,y);
            case "max" : return new Max(x,y);
            case "min" : return new Min(x,y);
            case "norm1" : return new Norm1(x,y);
            case "norm2" : return new Norm2(x,y);
    ...
    public TransformOp createTransform(String name, INDArray x, INDArray y) {
        switch(name) {
            case "abs" : return new Abs(x,y);
            case "acos" : return new ACos(x,y);
            case "asin" : return new ASin(x,y);
            case "atan" : return new ATan(x,y);
            case "ceil" : return new Ceil(x,y);
            case "cos" : return new Cos(x,y);
            case "exp" : return new Exp(x,y);
            case "floor" : return new Floor(x,y);
            case "hardtanh" : return new HardTanh(x,y);
            case "identity" : return new Identity(x,y);
            case "log" : return new Log(x,y);
            case "maxout" : return new MaxOut(x,y);
            case "negative" : return new Negative(x,y);
            case "pow" : return new Pow(x,y,2);
            case "round" : return new Round(x,y);
            case "sigmoid" : return new Sigmoid(x,y);
    ...
    public TransformOp createTransform(String name, INDArray x) {
        switch(name) {
            case "abs" : return new Abs(x);
            case "acos" : return new ACos(x);
            case "asin" : return new ASin(x);
            case "atan" : return new ATan(x);
            case "ceil" : return new Ceil(x);
            case "cos" : return new Cos(x);
            case "exp" : return new Exp(x);
            case "floor" : return new Floor(x);
            case "hardtanh" : return new HardTanh(x);
            case "identity" : return new Identity(x);
            case "log" : return new Log(x);
            case "maxout" : return new MaxOut(x);
            case "negative" : return new Negative(x);
            case "pow" : return new Pow(x,2);
            case "round" : return new Round(x);
            case "sigmoid" : return new Sigmoid(x);
    ...
    public TransformOp createTransform(String name, INDArray x, INDArray y, INDArray z) {
        switch(name) {
            case "abs" : return new Abs(x,z);
            case "acos" : return new ACos(x,z);
            case "asin" : return new ASin(x,z);
            case "atan" : return new ATan(x,z);
            case "ceil" : return new Ceil(x,z);
            case "cos" : return new Cos(x,z);
            case "exp" : return new Exp(x,z);
            case "floor" : return new Floor(x,z);
            case "hardtanh" : return new HardTanh(x,z);
            case "identity" : return new Identity(x,z);
            case "log" : return new Log(x,z);
            case "maxout" : return new MaxOut(x,z);
            case "negative" : return new Negative(x,z);
            case "pow" : return new Pow(x,z,2);
            case "round" : return new Round(x,z);
            case "sigmoid" : return new Sigmoid(x,z);
