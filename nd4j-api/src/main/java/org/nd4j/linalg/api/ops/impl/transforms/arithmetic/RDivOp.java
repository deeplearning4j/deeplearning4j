...
public class RDivOp extends BaseTransformOp {
    ...
    public RDivOp(INDArray x, INDArray y, INDArray z, int n) {
        super(x, y, z, n);
    }
    ...
    public TransformDataBufferAction getTransformOpDataBufferAction( int parallelThreshold, int n, DataBuffer x, DataBuffer y,
        ...
        return new RDivOpDataBufferAction(this,parallelThreshold,n,x,y,z,offsetX,offsetY,offsetZ,incrX,incrY,incrZ);
    }
}
