...
public class CNNGradientCheckTest extends BaseDL4JTest {
    ...
    @Test
    public void DEBUG_testCnnSamePaddingMode() {
        int nOut = 2;

        int[] minibatchSizes = {1};
        int width = 5;
        int[] heights = new int[]{4}; //Same padding mode: insensitive to exact input size...
        int[] kernelSizes = new int[]{3};
        int[] inputDepths = {1};
