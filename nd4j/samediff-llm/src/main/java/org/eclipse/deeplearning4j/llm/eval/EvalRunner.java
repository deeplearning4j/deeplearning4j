...
public class EvalRunner {
    ...
    /**
     * Evaluate a text generator on a benchmark task with default config.
     */
    ...
    /**
     * Evaluate a text generator on a benchmark task.
     */
    public EvalResult evaluate(TextGenerator generator, BenchmarkTask task, EvalConfig config) throws IOException {
        ...
        // Collect few-shot examples from the beginning of the dataset
    ...
    /**
     * Evaluate across multiple benchmark tasks.
     */
    ...
    /**
     * Evaluate across multiple benchmark tasks with config.
     */
    ...
    private EvalResult runEvaluation(TextGenerator generator, String benchmarkName,
        ...
        for (Map.Entry<String, List<Double>> entry : categoryScores.entrySet()) {
            aggregatedCategories.put(entry.getKey(),
                    primaryMetric.aggregate(entry.getValue()));
        }
