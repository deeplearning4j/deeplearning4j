...
public class FlatInferenceRequestT {
  private long id;
  ...
  public FlatInferenceRequestT() {
    this.id = 0L;
    this.variables = null;
    this.configuration = null;
  }
  public static FlatInferenceRequestT deserializeFromBinary(byte[] fbBuffer) {
    return FlatInferenceRequest.getRootAsFlatInferenceRequest(ByteBuffer.wrap(fbBuffer)).unpack();
  }
  public byte[] serializeToBinary() {
    FlatBufferBuilder fbb = new FlatBufferBuilder();
    FlatInferenceRequest.finishFlatInferenceRequestBuffer(fbb, FlatInferenceRequest.pack(fbb, this));
