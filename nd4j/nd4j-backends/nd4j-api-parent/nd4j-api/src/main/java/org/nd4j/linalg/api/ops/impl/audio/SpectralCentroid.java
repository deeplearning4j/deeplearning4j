...
@NoArgsConstructor
public class SpectralCentroid extends DynamicCustomOp {
    private int sampleRate = 22050;
    private int fftSize = 2048;

    public SpectralCentroid(@NonNull SameDiff sameDiff, @NonNull SDVariable input,
    ...
    public SpectralCentroid(@NonNull INDArray input, int sampleRate, int fftSize) {
    ...
    public List<SDVariable> doDiff(List<SDVariable> grad) {
        throw new UnsupportedOperationException("Gradient for spectral_centroid not implemented");
    }
