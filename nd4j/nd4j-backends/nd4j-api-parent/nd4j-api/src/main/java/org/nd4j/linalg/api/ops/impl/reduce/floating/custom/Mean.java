...
public class Mean extends BaseDynamicCustomReduction {
    ...
    public Mean(SameDiff sd, SDVariable x, boolean keepDims, int[] dimensions) {
        super(sd,new SDVariable[]{x},keepDims,dimensions);
    }

    public Mean(INDArray x, boolean keepDims, int[] dimensions) {
       super(new INDArray[]{x},keepDims,dimensions);
