...
public final class SequenceItemRoot extends Table {
  ...
  public static SequenceItemRoot getRootAsSequenceItemRoot(ByteBuffer _bb, SequenceItemRoot obj) { _bb.order(java.nio.ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
