...
@NoArgsConstructor
@Getter
public class AdaptiveMaxPooling2D extends DynamicCustomOp {
    ...
    /**
     * Create an adaptive max pooling 2D operation.
     *
     ...
     */
    public AdaptiveMaxPooling2D(@NonNull INDArray input, int outputHeight, int outputWidth, boolean isNCHW) {
    ...
    /**
     * Create an adaptive max pooling 2D operation with default NCHW format.
     *
     * @param input Input tensor [batch, channels, height, width]
     * @param outputHeight Target output height
     * @param outputWidth Target output width
     */
    public AdaptiveMaxPooling2D(@NonNull INDArray input, int outputHeight, int outputWidth) {
        this(input, outputHeight, outputWidth, true);
    }

    /**
     * Create an adaptive max pooling 2D for SameDiff.
     *
     ...
     * @param isNCHW True for NCHW format, false for NHWC
     */
    public AdaptiveMaxPooling2D(@NonNull SameDiff sd, @NonNull SDVariable input,
    ...
    /**
     * Create an adaptive max pooling 2D for SameDiff with default NCHW format.
     *
     * @param sd SameDiff instance
     * @param input Input tensor
     * @param outputHeight Target output height
    ...
    public String opName() {
        return "adaptive_maxpool2d";
    }

    @Override
    public List<SDVariable> doDiff(List<SDVariable> gradient) {
        return Collections.singletonList(
                new AdaptiveMaxPooling2DBp(sameDiff, arg(0), gradient.get(0),
