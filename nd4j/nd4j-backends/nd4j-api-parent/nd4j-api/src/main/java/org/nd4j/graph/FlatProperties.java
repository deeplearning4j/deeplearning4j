...
public final class FlatProperties extends Table {
  ...
  public boolean mutateI(int j, int i) { int o = __offset(6); if (o != 0) { bb.putInt(__vector(o) + j * 4, i); return true; } else { return false; } }
  ...
  public boolean mutateL(int j, long l) { int o = __offset(8); if (o != 0) { bb.putLong(__vector(o) + j * 8, l); return true; } else { return false; } }
  ...
  public boolean mutateD(int j, double d) { int o = __offset(10); if (o != 0) { bb.putDouble(__vector(o) + j * 8, d); return true; } else { return false; } }
  ...
  public boolean mutateB(int j, boolean b) { int o = __offset(14); if (o != 0) { bb.put(__vector(o) + j * 1, (byte)(b ? 1 : 0)); return true; } else { return false; } }
  ...
  public boolean mutateShape(int j, int shape) { int o = __offset(18); if (o != 0) { bb.putInt(__vector(o) + j * 4, shape); return true; } else { return false; } }
  ...
  public FlatPropertiesT unpack() {
    FlatPropertiesT _o = new FlatPropertiesT();
    unpackTo(_o);
    return _o;
  }
  public void unpackTo(FlatPropertiesT _o) {
    String _oName = name();
    _o.setName(_oName);
    int[] _oI = new int[iLength()];
    for (int _j = 0; _j < iLength(); ++_j) {_oI[_j] = i(_j);}
    _o.setI(_oI);
    long[] _oL = new long[lLength()];
    for (int _j = 0; _j < lLength(); ++_j) {_oL[_j] = l(_j);}
    _o.setL(_oL);
    double[] _oD = new double[dLength()];
    for (int _j = 0; _j < dLength(); ++_j) {_oD[_j] = d(_j);}
    _o.setD(_oD);
    org.nd4j.graph.FlatArrayT[] _oA = new org.nd4j.graph.FlatArrayT[aLength()];
    for (int _j = 0; _j < aLength(); ++_j) {_oA[_j] = (a(_j) != null ? a(_j).unpack() : null);}
    _o.setA(_oA);
    boolean[] _oB = new boolean[bLength()];
    for (int _j = 0; _j < bLength(); ++_j) {_oB[_j] = b(_j);}
    _o.setB(_oB);
    String[] _oS = new String[sLength()];
    for (int _j = 0; _j < sLength(); ++_j) {_oS[_j] = s(_j);}
    _o.setS(_oS);
    int[] _oShape = new int[shapeLength()];
    for (int _j = 0; _j < shapeLength(); ++_j) {_oShape[_j] = shape(_j);}
    _o.setShape(_oShape);
  }
  public static int pack(FlatBufferBuilder builder, FlatPropertiesT _o) {
    if (_o == null) return 0;
    int _name = _o.getName() == null ? 0 : builder.createString(_o.getName());
    int _i = 0;
    if (_o.getI() != null) {
      _i = createIVector(builder, _o.getI());
    }
    int _l = 0;
    if (_o.getL() != null) {
      _l = createLVector(builder, _o.getL());
    }
    int _d = 0;
    if (_o.getD() != null) {
      _d = createDVector(builder, _o.getD());
    }
    int _a = 0;
    if (_o.getA() != null) {
      int[] __a = new int[_o.getA().length];
      int _j = 0;
      for (org.nd4j.graph.FlatArrayT _e : _o.getA()) { __a[_j] = org.nd4j.graph.FlatArray.pack(builder, _e); _j++;}
      _a = createAVector(builder, __a);
    }
    int _b = 0;
    if (_o.getB() != null) {
      _b = createBVector(builder, _o.getB());
    }
    int _s = 0;
    if (_o.getS() != null) {
      int[] __s = new int[_o.getS().length];
      int _j = 0;
      for (String _e : _o.getS()) { __s[_j] = builder.createString(_e); _j++;}
