...
public final class FlatVariable extends Table {
  ...
  public boolean mutateShape(int j, long shape) { int o = __offset(10); if (o != 0) { bb.putLong(__vector(o) + j * 8, shape); return true; } else { return false; } }
  ...
  public boolean mutateDevice(int device) { int o = __offset(14); if (o != 0) { bb.putInt(o + bb_pos, device); return true; } else { return false; } }
  public byte variabletype() { int o = __offset(16); return o != 0 ? bb.get(o + bb_pos) : 0; }
  public boolean mutateVariabletype(byte variabletype) { int o = __offset(16); if (o != 0) { bb.put(o + bb_pos, variabletype); return true; } else { return false; } }
  ...
  public FlatVariableT unpack() {
    FlatVariableT _o = new FlatVariableT();
    unpackTo(_o);
    return _o;
  }
  public void unpackTo(FlatVariableT _o) {
    ...
    _o.setShape(_oShape);
    if (ndarray() != null) _o.setNdarray(ndarray().unpack());
    else _o.setNdarray(null);
    int _oDevice = device();
    _o.setDevice(_oDevice);
    byte _oVariabletype = variabletype();
    _o.setVariabletype(_oVariabletype);
    ...
    String[] _oControlDepForOp = new String[controlDepForOpLength()];
    for (int _j = 0; _j < controlDepForOpLength(); ++_j) {_oControlDepForOp[_j] = controlDepForOp(_j);}
    _o.setControlDepForOp(_oControlDepForOp);
  ...
  public static int pack(FlatBufferBuilder builder, FlatVariableT _o) {
    if (_o == null) return 0;
    ...
    int _ndarray = _o.getNdarray() == null ? 0 : org.nd4j.graph.FlatArray.pack(builder, _o.getNdarray());
    int _controlDeps = 0;
    ...
    int _controlDepForOp = 0;
    if (_o.getControlDepForOp() != null) {
      int[] __controlDepForOp = new int[_o.getControlDepForOp().length];
      int _j = 0;
      for (String _e : _o.getControlDepForOp()) { __controlDepForOp[_j] = builder.createString(_e); _j++;}
      _controlDepForOp = createControlDepForOpVector(builder, __controlDepForOp);
    }
