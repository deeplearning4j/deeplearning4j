...
/**
 * Backward pass for Attention Distillation Loss.
 *
 * @author Eclipse Deeplearning4j Contributors
 */
@NoArgsConstructor
public class AttentionDistillationLossBp extends DynamicCustomOp {

    public AttentionDistillationLossBp(SameDiff sameDiff, SDVariable studentAttn, SDVariable teacherAttn) {
        super(null, sameDiff, new SDVariable[]{studentAttn, teacherAttn}, false);
    }

    @Override
    public String opName() {
        return "attention_distillation_loss_grad";
    }
