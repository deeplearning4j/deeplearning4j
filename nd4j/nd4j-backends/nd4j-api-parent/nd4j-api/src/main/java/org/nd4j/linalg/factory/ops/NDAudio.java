...
import org.nd4j.linalg.api.ops.impl.audio.AWeighting;
import org.nd4j.linalg.api.ops.impl.audio.AudioNormalize;
import org.nd4j.linalg.api.ops.impl.audio.AudioResample;
import org.nd4j.linalg.api.ops.impl.audio.ChromaFeatures;
import org.nd4j.linalg.api.ops.impl.audio.GriffinLim;
import org.nd4j.linalg.api.ops.impl.audio.MFCC;
import org.nd4j.linalg.api.ops.impl.audio.MelFilterbank;
import org.nd4j.linalg.api.ops.impl.audio.MelSpectrogram;
import org.nd4j.linalg.api.ops.impl.audio.PitchDetection;
import org.nd4j.linalg.api.ops.impl.audio.PreEmphasis;
import org.nd4j.linalg.api.ops.impl.audio.SpectralCentroid;
import org.nd4j.linalg.api.ops.impl.audio.SpectralRolloff;
import org.nd4j.linalg.api.ops.impl.audio.ZeroCrossingRate;
...
public class NDAudio {
  ...
  public INDArray aWeighting(INDArray frequencies) {
    ...
    INDArray[] __tmp = Nd4j.exec(new AWeighting(frequencies));
    try {
      return __tmp[0];
    } finally {
      if(__tmp != null) {
  ...
  public INDArray audioNormalize(INDArray input, double targetLevel, boolean useRms) {
    ...
    INDArray[] __tmp = Nd4j.exec(new AudioNormalize(input, targetLevel, useRms));
    try {
      return __tmp[0];
    } finally {
      if(__tmp != null) {
  ...
  public INDArray audioNormalize(INDArray input) {
    NDValidation.validateNumerical("audioNormalize", "input", input);
    INDArray[] __tmp = Nd4j.exec(new AudioNormalize(input, 1.0, false));
    try {
      return __tmp[0];
    } finally {
      if(__tmp != null) {
  ...
  public INDArray audioResample(INDArray input, int origSampleRate, int targetSampleRate) {
    ...
    INDArray[] __tmp = Nd4j.exec(new AudioResample(input, origSampleRate, targetSampleRate));
    try {
      return __tmp[0];
    } finally {
      if(__tmp != null) {
  ...
  public INDArray chromaFeatures(INDArray input, int sampleRate, int fftSize, int numChroma) {
    ...
    INDArray[] __tmp = Nd4j.exec(new ChromaFeatures(input, sampleRate, fftSize, numChroma));
    try {
      return __tmp[0];
    } finally {
      if(__tmp != null) {
  ...
  public INDArray chromaFeatures(INDArray input) {
    NDValidation.validateNumerical("chromaFeatures", "input", input);
    INDArray[] __tmp = Nd4j.exec(new ChromaFeatures(input, 22050, 2048, 12));
    try {
      return __tmp[0];
    } finally {
      if(__tmp != null) {
  ...
  public INDArray griffinLim(INDArray magnitudeSpectrogram, int fftSize, int hopLength,
    ...
    INDArray[] __tmp = Nd4j.exec(new GriffinLim(magnitudeSpectrogram, fftSize, hopLength, numIterations));
    try {
      return __tmp[0];
    } finally {
      if(__tmp != null) {
  ...
  public INDArray griffinLim(INDArray magnitudeSpectrogram) {
    NDValidation.validateNumerical("griffinLim", "magnitudeSpectrogram", magnitudeSpectrogram);
    INDArray[] __tmp = Nd4j.exec(new GriffinLim(magnitudeSpectrogram, 2048, 512, 32));
    try {
      return __tmp[0];
    } finally {
      if(__tmp != null) {
  ...
  public INDArray melFilterbank(int numMelBins, int fftSize, int sampleRate, double lowerEdgeHz,
      double upperEdgeHz) {
    INDArray[] __tmp = Nd4j.exec(new MelFilterbank(numMelBins, fftSize, sampleRate, lowerEdgeHz, upperEdgeHz));
    try {
      return __tmp[0];
    } finally {
      if(__tmp != null) {
  ...
  public INDArray melFilterbank(int numMelBins, int fftSize, int sampleRate) {
    INDArray[] __tmp = Nd4j.exec(new MelFilterbank(numMelBins, fftSize, sampleRate, 0.0, 8000.0));
    try {
      return __tmp[0];
    } finally {
      if(__tmp != null) {
  ...
  public INDArray melSpectrogram(INDArray input, int sampleRate, int fftSize, int hopLength,
    ...
    INDArray[] __tmp = Nd4j.exec(new MelSpectrogram(input, sampleRate, fftSize, hopLength, numMelBins, lowerEdgeHz, upperEdgeHz, power));
    try {
      return __tmp[0];
    } finally {
      if(__tmp != null) {
  ...
  public INDArray melSpectrogram(INDArray input) {
    NDValidation.validateNumerical("melSpectrogram", "input", input);
    INDArray[] __tmp = Nd4j.exec(new MelSpectrogram(input, 22050, 2048, 512, 128, 0.0, 8000.0, 2.0));
    try {
      return __tmp[0];
    } finally {
      if(__tmp != null) {
  ...
  public INDArray mfcc(INDArray input, int sampleRate, int fftSize, int hopLength, int numMelBins,
    ...
    INDArray[] __tmp = Nd4j.exec(new MFCC(input, sampleRate, fftSize, hopLength, numMelBins, numMfcc, lowerEdgeHz, upperEdgeHz));
    try {
      return __tmp[0];
    } finally {
      if(__tmp != null) {
  ...
  public INDArray mfcc(INDArray input) {
    NDValidation.validateNumerical("mfcc", "input", input);
    INDArray[] __tmp = Nd4j.exec(new MFCC(input, 22050, 2048, 512, 128, 13, 0.0, 8000.0));
    try {
      return __tmp[0];
    } finally {
      if(__tmp != null) {
  ...
  public INDArray pitchDetection(INDArray input, int sampleRate, int frameLength, int hopLength,
    ...
    INDArray[] __tmp = Nd4j.exec(new PitchDetection(input, sampleRate, frameLength, hopLength, minFreq, maxFreq));
    try {
      return __tmp[0];
    } finally {
      if(__tmp != null) {
  ...
  public INDArray pitchDetection(INDArray input) {
    NDValidation.validateNumerical("pitchDetection", "input", input);
    INDArray[] __tmp = Nd4j.exec(new PitchDetection(input, 22050, 2048, 512, 80.0, 1000.0));
    try {
      return __tmp[0];
    } finally {
      if(__tmp != null) {
  ...
  public INDArray preEmphasis(INDArray input, double coefficient) {
    ...
    INDArray[] __tmp = Nd4j.exec(new PreEmphasis(input, coefficient));
    try {
      return __tmp[0];
    } finally {
      if(__tmp != null) {
  ...
  public INDArray preEmphasis(INDArray input) {
    NDValidation.validateNumerical("preEmphasis", "input", input);
    INDArray[] __tmp = Nd4j.exec(new PreEmphasis(input, 0.97));
    try {
      return __tmp[0];
    } finally {
      if(__tmp != null) {
  ...
  public INDArray spectralCentroid(INDArray input, int sampleRate, int fftSize) {
    ...
    INDArray[] __tmp = Nd4j.exec(new SpectralCentroid(input, sampleRate, fftSize));
    try {
      return __tmp[0];
    } finally {
      if(__tmp != null) {
  ...
  public INDArray spectralCentroid(INDArray input) {
    NDValidation.validateNumerical("spectralCentroid", "input", input);
    INDArray[] __tmp = Nd4j.exec(new SpectralCentroid(input, 22050, 2048));
    try {
      return __tmp[0];
    } finally {
      if(__tmp != null) {
  ...
  public INDArray spectralRolloff(INDArray input, int sampleRate, int fftSize,
    ...
    INDArray[] __tmp = Nd4j.exec(new SpectralRolloff(input, sampleRate, fftSize, rolloffPercent));
    try {
      return __tmp[0];
    } finally {
      if(__tmp != null) {
  ...
  public INDArray spectralRolloff(INDArray input) {
    NDValidation.validateNumerical("spectralRolloff", "input", input);
    INDArray[] __tmp = Nd4j.exec(new SpectralRolloff(input, 22050, 2048, 0.85));
    try {
      return __tmp[0];
    } finally {
      if(__tmp != null) {
  ...
  public INDArray zeroCrossingRate(INDArray input, int frameLength, int hopLength) {
    ...
    INDArray[] __tmp = Nd4j.exec(new ZeroCrossingRate(input, frameLength, hopLength));
    try {
      return __tmp[0];
    } finally {
      if(__tmp != null) {
  ...
  public INDArray zeroCrossingRate(INDArray input) {
    NDValidation.validateNumerical("zeroCrossingRate", "input", input);
    INDArray[] __tmp = Nd4j.exec(new ZeroCrossingRate(input, 2048, 512));
    try {
      return __tmp[0];
    } finally {
      if(__tmp != null) {
