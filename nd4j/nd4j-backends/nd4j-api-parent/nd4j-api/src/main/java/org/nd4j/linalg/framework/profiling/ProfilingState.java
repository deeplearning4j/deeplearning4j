...
/**
 * Profiling subsystem state snapshot.
 * 
 * @author ND4J Team
 */
@Data
...
public class ProfilingState {
    ...
    /**
     * Total profiled time (nanos)
     */
    private long totalTimeNanos;
    
    /**
     * Helper usage percentage
     */
    ...
    /**
     * Get average time per op (microseconds)
     */
    ...
    public String toString() {
        return String.format(
            "Enabled: %s, Frequency: %d, Ops: %d (%.2f s, %.1f µs/op), Helper: %.1f%%",
            enabled ? "YES" : "NO",
            frequency,
            totalOps,
            getTotalTimeSeconds(),
