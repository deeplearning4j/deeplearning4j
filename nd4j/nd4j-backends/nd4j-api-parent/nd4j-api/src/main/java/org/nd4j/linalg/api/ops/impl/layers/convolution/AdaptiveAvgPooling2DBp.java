...
/**
 * Adaptive Average Pooling 2D - Backward Pass
 *
 * @author Eclipse Deeplearning4j
 */
@NoArgsConstructor
@Getter
public class AdaptiveAvgPooling2DBp extends DynamicCustomOp {
    ...
    /**
     * Create backward pass for adaptive average pooling 2D.
     *
     ...
     */
    public AdaptiveAvgPooling2DBp(@NonNull INDArray input, @NonNull INDArray gradOut,
    ...
    /**
     * Create backward pass for adaptive average pooling 2D for SameDiff.
     *
     ...
     */
    public AdaptiveAvgPooling2DBp(@NonNull SameDiff sd, @NonNull SDVariable input,
