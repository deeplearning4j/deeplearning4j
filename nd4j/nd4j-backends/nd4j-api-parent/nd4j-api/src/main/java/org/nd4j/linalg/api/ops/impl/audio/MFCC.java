...
@NoArgsConstructor
public class MFCC extends DynamicCustomOp {
    ...
    public MFCC(@NonNull SameDiff sameDiff, @NonNull SDVariable input,
                int sampleRate, int fftSize, int hopLength, int numMelBins, int numMfcc,
    ...
    public MFCC(@NonNull INDArray input, int sampleRate, int fftSize, int hopLength,
    ...
    public List<SDVariable> doDiff(List<SDVariable> grad) {
        throw new UnsupportedOperationException("Gradient for mfcc not implemented");
    }
