 ...
 * @author Adam Gibson
 */
public class SwishDerivative extends BaseTransformStrictOp {
    public SwishDerivative(SameDiff sameDiff, SDVariable i_v1, SDVariable i_v2) {
        super(sameDiff, i_v1, i_v2);
    }

    public SwishDerivative(SameDiff sameDiff, SDVariable i_v1, SDVariable i_v2, boolean inPlace) {
    ...
    public SwishDerivative(SameDiff sameDiff, SDVariable i_v, Object[] extraArgs) {
