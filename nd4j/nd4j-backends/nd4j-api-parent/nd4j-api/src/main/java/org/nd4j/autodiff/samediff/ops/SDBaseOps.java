...
public class SDBaseOps {
  ...
  public SDVariable mean(SDVariable x, boolean keepDims, int... dimensions) {
    ...
    Preconditions.checkArgument(dimensions.length >= 0, "dimensions has incorrect size/length. Expected: dimensions.length >= 0, got %s", dimensions.length);
    return new org.nd4j.linalg.api.ops.impl.reduce.floating.custom.Mean(sd,x, keepDims, dimensions).outputVariable();
  }
  ...
  public SDVariable mean(String name, SDVariable x, boolean keepDims, int... dimensions) {
    SDValidation.validateNumerical("mean", "x", x);
    Preconditions.checkArgument(dimensions.length >= 0, "dimensions has incorrect size/length. Expected: dimensions.length >= 0, got %s", dimensions.length);
    SDVariable out =  new org.nd4j.linalg.api.ops.impl.reduce.floating.custom.Mean(sd,x, keepDims, dimensions).outputVariable();
    return sd.updateVariableNameAndReference(out, name);
  }
  ...
  public SDVariable mean(SDVariable x, int... dimensions) {
    SDValidation.validateNumerical("mean", "x", x);
    Preconditions.checkArgument(dimensions.length >= 0, "dimensions has incorrect size/length. Expected: dimensions.length >= 0, got %s", dimensions.length);
    return new org.nd4j.linalg.api.ops.impl.reduce.floating.custom.Mean(sd,x, false, dimensions).outputVariable();
  }
  ...
  public SDVariable mean(String name, SDVariable x, int... dimensions) {
    SDValidation.validateNumerical("mean", "x", x);
    Preconditions.checkArgument(dimensions.length >= 0, "dimensions has incorrect size/length. Expected: dimensions.length >= 0, got %s", dimensions.length);
    SDVariable out =  new org.nd4j.linalg.api.ops.impl.reduce.floating.custom.Mean(sd,x, false, dimensions).outputVariable();
    return sd.updateVariableNameAndReference(out, name);
  }
  ...
  public SDVariable mean(SDVariable x, SDVariable dimensions, boolean keepDims) {
    ...
    return new org.nd4j.linalg.api.ops.impl.reduce.floating.custom.Mean(sd,x, dimensions, keepDims).outputVariable();
  }
  ...
  public SDVariable mean(String name, SDVariable x, SDVariable dimensions, boolean keepDims) {
    SDValidation.validateNumerical("mean", "x", x);
    SDValidation.validateInteger("mean", "dimensions", dimensions);
    SDVariable out =  new org.nd4j.linalg.api.ops.impl.reduce.floating.custom.Mean(sd,x, dimensions, keepDims).outputVariable();
    return sd.updateVariableNameAndReference(out, name);
  }
  ...
  public SDVariable mean(SDVariable x, SDVariable dimensions) {
    SDValidation.validateNumerical("mean", "x", x);
    SDValidation.validateInteger("mean", "dimensions", dimensions);
    return new org.nd4j.linalg.api.ops.impl.reduce.floating.custom.Mean(sd,x, dimensions, false).outputVariable();
  }
  ...
  public SDVariable mean(String name, SDVariable x, SDVariable dimensions) {
    SDValidation.validateNumerical("mean", "x", x);
    SDValidation.validateInteger("mean", "dimensions", dimensions);
    SDVariable out =  new org.nd4j.linalg.api.ops.impl.reduce.floating.custom.Mean(sd,x, dimensions, false).outputVariable();
    return sd.updateVariableNameAndReference(out, name);
  }
