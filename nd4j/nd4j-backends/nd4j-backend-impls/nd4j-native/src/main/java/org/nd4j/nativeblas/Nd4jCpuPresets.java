...
@Properties(target = "org.nd4j.nativeblas.Nd4jCpu", helper = "org.nd4j.nativeblas.Nd4jCpuHelper",
                ...
                @Platform(value = {"linux-arm", "linux-ppc"}, preload = {"openblas", "openblas_nolapack", "gomp@.1", "gcc_s@.1", "quadmath@.0", "gfortran@.5", "gfortran@.4", "gfortran@.3", "openblas@.0", "libnd4jcpu"}),
                @Platform(value = "linux-armhf", preload = {"openblas", "openblas_nolapack"}, preloadpath = {"/usr/arm-linux-gnueabihf/lib/", "/usr/lib/arm-linux-gnueabihf/"}),
                @Platform(value = "linux-arm64", preload = {"openblas", "openblas_nolapack"}, preloadpath = {"/usr/aarch64-linux-gnu/lib/", "/usr/lib/aarch64-linux-gnu/"}),
                ...
                //@Platform(value = "macosx", preload = {"gcc_s@.1", "gomp@.1", "stdc++@.6"}, preloadpath = {"/usr/local/lib/gcc/8/", "/usr/local/lib/gcc/7/", "/usr/local/lib/gcc/6/", "/usr/local/lib/gcc/5/"}),
