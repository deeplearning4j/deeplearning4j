...
public class CudaUInt16DataBuffer extends BaseCudaDataBuffer {
    ...
    public CudaUInt16DataBuffer(ByteBuffer underlyingBuffer, DataType dataType, long length) {
        super(underlyingBuffer, dataType, length);
    }

    public CudaUInt16DataBuffer(ByteBuffer underlyingBuffer, DataType dataType, long length, boolean cpuOnly) {
