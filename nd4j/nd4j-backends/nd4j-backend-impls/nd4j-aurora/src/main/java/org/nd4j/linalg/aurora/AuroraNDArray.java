...
public class AuroraNDArray extends BaseNDArray {
    ...
    @Override
    public java.nio.LongBuffer shapeInfo() {
        return java.nio.LongBuffer.wrap(shapeInfoJava());
    }
    ...
    public INDArray unsafeDuplication() {
        ...
        nativeOps.memcpySync(ret.data().addressPointer(), this.data().addressPointer(), this.data().length() * this.data().getElementSize(), 3, null);
