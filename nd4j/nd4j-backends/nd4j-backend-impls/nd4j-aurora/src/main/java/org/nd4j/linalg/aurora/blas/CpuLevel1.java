...
public class CpuLevel1 extends BaseLevel1 {
    ...
    protected float sdsdot(long N, float alpha, INDArray X, int incX, INDArray Y, int incY) {
        return nativeOps.callFloat("blas_sdsdot", (int) N, alpha, (FloatPointer) X.data().addressPointer(), incX,
                        (FloatPointer) Y.data().addressPointer(), incY);
    }

    @Override
    protected double dsdot(long N, INDArray X, int incX, INDArray Y, int incY) {
        return nativeOps.callDouble("cblas_dsdot", (int) N, (FloatPointer) X.data().addressPointer(), incX, (FloatPointer) Y.data().addressPointer(),
                        incY);
    }
    ...
    protected float sdot(long N, INDArray X, int incX, INDArray Y, int incY) {
        if (incX >= 1 && incY >= 1) {
            return nativeOps.callFloat("cblas_sdot", (int) N, (FloatPointer) X.data().addressPointer(), incX,
                            (FloatPointer) Y.data().addressPointer(), incY);
        } else {
            // non-EWS dot variant
            Dot dot = new Dot(X, Y);
    ...
    protected double ddot(long N, INDArray X, int incX, INDArray Y, int incY) {
        if (incX >= 1 && incY >= 1) {
            return nativeOps.callDouble("cblas_ddot", (int) N, (DoublePointer) X.data().addressPointer(), incX,
    ...
    protected float snrm2(long N, INDArray X, int incX) {
        return nativeOps.callFloat("cblas_snrm2", (int) N, (FloatPointer) X.data().addressPointer(), incX);

    }

    @Override
    protected float sasum(long N, INDArray X, int incX) {
        return nativeOps.callFloat("cblas_sasum", (int) N, (FloatPointer) X.data().addressPointer(), incX);
    }
    ...
    protected double dnrm2(long N, INDArray X, int incX) {
        return nativeOps.callDouble("cblas_dnrm2", (int) N, (DoublePointer) X.data().addressPointer(), incX);
    }

    @Override
    protected double dasum(long N, INDArray X, int incX) {
        return nativeOps.callDouble("cblas_dasum", (int) N, (DoublePointer) X.data().addressPointer(), incX);
    }
    ...
    protected int isamax(long N, INDArray X, int incX) {
        return nativeOps.callInt("cblas_isamax", (int) N, (FloatPointer) X.data().addressPointer(), incX);
    }
    ...
    protected int idamax(long N, INDArray X, int incX) {
        return nativeOps.callInt("cblas_idamax", (int) N, (DoublePointer) X.data().addressPointer(), incX);
    }
    ...
    protected void sswap(long N, INDArray X, int incX, INDArray Y, int incY) {
        nativeOps.call("cblas_sswap", (int) N, (FloatPointer) X.data().addressPointer(), incX, (FloatPointer) Y.data().addressPointer(), incY);
    }

    @Override
    protected void scopy(long N, INDArray X, int incX, INDArray Y, int incY) {
        nativeOps.call("cblas_scopy", (int) N, (FloatPointer) X.data().addressPointer(), incX, (FloatPointer) Y.data().addressPointer(), incY);
    }
    ...
    protected void saxpy(long N, float alpha, INDArray X, int incX, INDArray Y, int incY) {
        nativeOps.call("cblas_saxpy", (int) N, alpha, (FloatPointer) X.data().addressPointer(), incX, (FloatPointer) Y.data().addressPointer(),
                        incY);
    }
    ...
    protected void dswap(long N, INDArray X, int incX, INDArray Y, int incY) {
        nativeOps.call("cblas_dswap", (int) N, (DoublePointer) X.data().addressPointer(), incX, (DoublePointer) Y.data().addressPointer(),
                        incY);
    }

    @Override
    protected void dcopy(long N, INDArray X, int incX, INDArray Y, int incY) {
        nativeOps.call("cblas_dcopy", (int) N, (DoublePointer) X.data().addressPointer(), incX, (DoublePointer) Y.data().addressPointer(),
                        incY);
    }
    ...
    protected void daxpy(long N, double alpha, INDArray X, int incX, INDArray Y, int incY) {
        nativeOps.call("cblas_daxpy", (int) N, alpha, (DoublePointer) X.data().addressPointer(), incX,
                        (DoublePointer) Y.data().addressPointer(), incY);
    ...
    protected void srotmg(float d1, float d2, float b1, float b2, INDArray P) {
        nativeOps.call("cblas_srotmg", new FloatPointer(d1), new FloatPointer(d2), new FloatPointer(b1), b2,
                        (FloatPointer) P.data().addressPointer());
    }

    @Override
    protected void srot(long N, INDArray X, int incX, INDArray Y, int incY, float c, float s) {
        nativeOps.call("cblas_srot", (int) N, (FloatPointer) X.data().addressPointer(), incX, (FloatPointer) Y.data().addressPointer(), incY, c,
                        s);
    }

    @Override
    protected void srotm(long N, INDArray X, int incX, INDArray Y, int incY, INDArray P) {
        nativeOps.call("cblas_srotm", (int) N, (FloatPointer) X.data().addressPointer(), incX, (FloatPointer) Y.data().addressPointer(), incY,
                        (FloatPointer) P.data().addressPointer());
    ...
    protected void drotg(double a, double b, double c, double s) {
        nativeOps.call("cblas_drotg", new DoublePointer(a), new DoublePointer(b), new DoublePointer(c), new DoublePointer(s));
    }

    @Override
    protected void drotmg(double d1, double d2, double b1, double b2, INDArray P) {
        nativeOps.call("cblas_drotmg", new DoublePointer(d1), new DoublePointer(d2), new DoublePointer(b1), b2,
                        (DoublePointer) P.data().addressPointer());
    }

    @Override
    protected void drot(long N, INDArray X, int incX, INDArray Y, int incY, double c, double s) {
        nativeOps.call("cblas_drot", (int) N, (DoublePointer) X.data().addressPointer(), incX, (DoublePointer) Y.data().addressPointer(), incY,
                        c, s);
    }
    ...
    protected void drotm(long N, INDArray X, int incX, INDArray Y, int incY, INDArray P) {
        nativeOps.call("cblas_drotm", (int) N, (DoublePointer) X.data().addressPointer(), incX, (DoublePointer) Y.data().addressPointer(), incY,
                        (DoublePointer) P.data().addressPointer());
    }

    @Override
    protected void sscal(long N, float alpha, INDArray X, int incX) {
        nativeOps.call("cblas_sscal", (int) N, alpha, (FloatPointer) X.data().addressPointer(), incX);
    }

    @Override
    protected void dscal(long N, double alpha, INDArray X, int incX) {
        nativeOps.call("cblas_dscal", (int) N, alpha, (DoublePointer) X.data().addressPointer(), incX);
    }
