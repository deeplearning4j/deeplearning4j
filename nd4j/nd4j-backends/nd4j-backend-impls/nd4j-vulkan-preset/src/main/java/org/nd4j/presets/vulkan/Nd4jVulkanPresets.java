...
/**
 * JavaCPP preset for the standalone Vulkan compute backend (libnd4jvulkan).
 *
 * <p>The binding exposes the same shared NativeOps ABI used by CUDA, with
 * {@code nd4jvulkan}/{@code jnind4jvulkan} library identity. Vulkan graph
 * execution is admitted by DSP and dispatched through VulkanReplayHandle; the
 * binding does not inherit a host BLAS preset or expose CPU execution services.</p>
 */
@Properties(target = "org.nd4j.linalg.vulkan.bindings.Nd4jVulkan", helper = "org.nd4j.presets.vulkan.Nd4jVulkanHelper",
        value = {@Platform(define = {"SD_ALL_OPS", "SD_VULKAN", "SD_BACKEND_NAMESPACE sd_vulkan"}, include = {
                ...
                "types/utf8string.h",
                "legacy/NativeOps.h",
                "legacy/vulkan/NativeOpsVulkan.h",
                "dsp/NativeOpsDsp.h",
                "build_info.h",
                ...
                library = "jnind4jvulkan", link = "nd4jvulkan", preload = "libnd4jvulkan"),
                @Platform(value = "linux", link = {"nd4jvulkan", "dl"}, preload = "gomp@.1", preloadpath = {"/lib64/", "/lib/", "/usr/lib64/", "/usr/lib/"}),
...
public class Nd4jVulkanPresets implements LoadEnabled, BuildEnabled, InfoMapper {
    ...
    public void init(ClassProperties properties) {
        properties.get("platform.preload").remove("libnd4jvulkan");
        SharedCompilerRuntime.configure(
                properties,
                Nd4jVulkanPresets.class,
                "org/nd4j/linalg/vulkan/bindings/");
    }
    ...
    public void map(InfoMap infoMap) {
        ...
        logger.info("==============================================");
        logger.info("JavaCPP Preset (Vulkan) - Functrace Configuration:");
        logger.info("  libnd4j.calltrace property: " + calltraceProperty);
        logger.info("  SD_GCC_FUNCTRACE will be: " + (funcTrace ? "DEFINED" : "UNDEFINED"));
        logger.info("==============================================");
        infoMap.put(new Info("thread_local", "SD_LIB_EXPORT", "SD_INLINE", "SD_TLS_EXPORT",
                ...
                // Vulkan exposes the shared core, Triton, and DSP configuration only. CUDA device
                // configuration and host-BLAS controls are intentionally absent from this binding.
                .put(new Info(
                        "sd::config::CudaDeviceConfig",
                        "sd::CudaLimitType",
                        "sd::Environment::cuda",
                        "sd::Environment::blasMajorVersion",
                        "sd::Environment::blasMinorVersion",
                        "sd::Environment::blasPatchVersion",
                        "sd::Environment::capabilities",
                        "sd::Environment::cudaDeviceCount",
                        "sd::Environment::cudaCurrentDevice",
                        "sd::Environment::setCudaCurrentDevice",
                        "sd::Environment::cudaMemoryPinned",
                        "sd::Environment::setCudaMemoryPinned",
                        "sd::Environment::cudaUseManagedMemory",
                        "sd::Environment::setCudaUseManagedMemory",
                        "sd::Environment::cudaMemoryPoolSize",
                        "sd::Environment::setCudaMemoryPoolSize",
                        "sd::Environment::cudaForceP2P",
                        "sd::Environment::setCudaForceP2P",
                        "sd::Environment::cudaAllocatorEnabled",
                        "sd::Environment::setCudaAllocatorEnabled",
                        "sd::Environment::cudaMaxBlocks",
                        "sd::Environment::setCudaMaxBlocks",
                        "sd::Environment::cudaMaxThreadsPerBlock",
                        "sd::Environment::setCudaMaxThreadsPerBlock",
                        "sd::Environment::cudaAsyncExecution",
                        "sd::Environment::setCudaAsyncExecution",
                        "sd::Environment::cudaStreamLimit",
                        "sd::Environment::setCudaStreamLimit",
                        "sd::Environment::cudaUseDeviceHost",
                        "sd::Environment::setCudaUseDeviceHost",
                        "sd::Environment::cudaEventLimit",
                        "sd::Environment::setCudaEventLimit",
                        "sd::Environment::cudaCachingAllocatorLimit",
                        "sd::Environment::setCudaCachingAllocatorLimit",
                        "sd::Environment::cudaPinnedHostLimit",
                        "sd::Environment::setCudaPinnedHostLimit",
                        "sd::Environment::cudaSoftLimitPercent",
                        "sd::Environment::setCudaSoftLimitPercent",
                        "sd::Environment::cudaUseUnifiedMemory",
                        "sd::Environment::setCudaUseUnifiedMemory",
                        "sd::Environment::cudaPrefetchSize",
                        "sd::Environment::setCudaPrefetchSize",
                        "sd::Environment::cudaGraphOptimization",
                        "sd::Environment::setCudaGraphOptimization",
                        "sd::Environment::cudaTensorCoreEnabled",
                        "sd::Environment::setCudaTensorCoreEnabled",
                        "sd::Environment::cudaBlockingSync",
                        "sd::Environment::setCudaBlockingSync",
                        "sd::Environment::cudaDeviceSchedule",
                        "sd::Environment::setCudaDeviceSchedule",
                        "sd::Environment::cudaStackSize",
                        "sd::Environment::setCudaStackSize",
                        "sd::Environment::cudaMallocHeapSize",
                        "sd::Environment::setCudaMallocHeapSize",
                        "sd::Environment::cudaPrintfFifoSize",
                        "sd::Environment::setCudaPrintfFifoSize",
                        "sd::Environment::cudaDevRuntimeSyncDepth",
                        "sd::Environment::setCudaDevRuntimeSyncDepth",
                        "sd::Environment::cudaDevRuntimePendingLaunchCount",
                        "sd::Environment::setCudaDevRuntimePendingLaunchCount",
                        "sd::Environment::cudaMaxL2FetchGranularity",
                        "sd::Environment::setCudaMaxL2FetchGranularity",
                        "sd::Environment::cudaPersistingL2CacheSize",
                        "sd::Environment::setCudaPersistingL2CacheSize",
                        "sd::Environment::setCudaDeviceLimit",
                        "sd::Environment::initCudaEnvironment",
                        "sd::Environment::initCudaDeviceLimits",
                        "sd::config::DspConfig::cublasTf32Enabled",
                        "sd::config::DspConfig::setCublasTf32Enabled",
                        "sd::config::DspConfig::cublasCaptureWorkspace",
                        "sd::config::DspConfig::setCublasCaptureWorkspace",
                        "sd::config::DspConfig::cublasLtGapEnabled",
                        "sd::config::DspConfig::setCublasLtGapEnabled",
                        "sd::config::DspConfig::cublasWorkspaceMb",
                        "sd::config::DspConfig::setCublasWorkspaceMb",
                        "sd::Environment::cublasTf32Enabled",
                        "sd::Environment::setCublasTf32Enabled",
                        "sd::Environment::cublasCaptureWorkspace",
                        "sd::Environment::setCublasCaptureWorkspace",
                        "sd::Environment::dspCublasWorkspaceMb",
                        "sd::Environment::setDspCublasWorkspaceMb",
                        "sd::config::CoreConfig::blasFallback",
                        "sd::Environment::blasFallback",
                        "setOpenBlasThreads",
                        "getOpenBlasThreads",
                        "isSerializeBlasCalls",
                        "setSerializeBlasCalls").skip());
        ...
        infoMap.put(funcTrace ? new Info("__CUDACC__", "MAX_UINT", "HAVE_ONEDNN", "__CUDABLAS__", "__NEC__").define(false)
                ...
                .put(funcTrace ? new Info("__JAVACPP_HACK__", "SD_ALL_OPS", "SD_VULKAN", "SD_GCC_FUNCTRACE").define(true) :
                        new Info("__JAVACPP_HACK__", "SD_ALL_OPS", "SD_VULKAN").define(true))
