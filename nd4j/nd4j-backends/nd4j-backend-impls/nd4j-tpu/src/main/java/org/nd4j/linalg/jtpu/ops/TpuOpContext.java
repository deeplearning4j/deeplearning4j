...
/**
 * TPU-specific operation context.
 *
 * Holds input/output arrays, arguments, and execution state for TPU operations.
 */
public class TpuOpContext implements OpContext {
    ...
    public void setRngStates(long rootState, long nodeState) {
        // TPU uses different RNG mechanism
    }
    ...
    public void allowHelpers(boolean allowed) {
        // TPU always uses platform helpers
    }
