...
@Properties(inherit = openblas.class, target = "org.nd4j.linalg.cpu.nativecpu.bindings.Nd4jCpu", helper = "org.nd4j.presets.cpu.Nd4jCpuHelper",
        value = {@Platform(define = {"SD_ALL_OPS"}, include = {
                ...
                @Platform(extension = {"-onednn", "-onednn-avx512","-onednn-avx2","-","-avx2","-avx512", "-vednn", "-vednn-avx512", "-vednn-avx2", "-compat"}),
                @Platform(extension = { "-vednn", "-vednn-avx512", "-vednn-avx2"} , resource={"libnd4jcpu_device.vso"})
        })
