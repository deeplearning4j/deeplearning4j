...
public class CudaUByteDataBuffer extends BaseCudaDataBuffer {
    ...
    public CudaUByteDataBuffer(ByteBuffer underlyingBuffer, DataType dataType, long length) {
        super(underlyingBuffer, dataType, length);
    }

    public CudaUByteDataBuffer(ByteBuffer underlyingBuffer, DataType dataType, long length, boolean cpuOnly) {
