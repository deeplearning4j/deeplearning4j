...
@Namespace("sd") @NoOffset public static class Environment extends Pointer {
  ...
  public native void setEnableBlas(@Cast("bool") boolean reallyEnable);
  ...
  public native void setLogNativeNDArrayCreation(@Cast("bool") boolean logNativeNDArrayCreation);
  ...
  public native void setLogNDArrayEvents(@Cast("bool") boolean logNDArrayEvents);
  ...
  public native void setDeleteSpecial(@Cast("bool") boolean reallyDelete);
  public native @Cast("bool") boolean isDeletePrimary();
  public native void setDeletePrimary(@Cast("bool") boolean reallyDelete);
  ...
  public native void setCheckOutputChange(@Cast("bool") boolean reallyCheck);
  ...
  public native void setCheckInputChange(@Cast("bool") boolean reallyCheck);
  ...
  public native void setFuncTracePrintDeallocate(@Cast("bool") boolean reallyPrint);
  public native @Cast("bool") boolean isFuncTracePrintAllocate();
  public native void setFuncTracePrintAllocate(@Cast("bool") boolean reallyPrint);

  // NDArray lifecycle tracking methods
  public native @Cast("bool") boolean isLifecycleTracking();
  public native void setLifecycleTracking(@Cast("bool") boolean enabled);
  public native @Cast("bool") boolean isTrackViews();
  public native void setTrackViews(@Cast("bool") boolean track);
  public native @Cast("bool") boolean isTrackDeletions();
  public native void setTrackDeletions(@Cast("bool") boolean track);
  public native int getStackDepth();
  public native void setStackDepth(int depth);
  public native int getReportInterval();
  public native void setReportInterval(int seconds);
  public native @Cast("size_t") long getMaxDeletionHistory();
  public native void setMaxDeletionHistory(@Cast("size_t") long max);
  public native @Cast("bool") boolean isSnapshotFiles();
  public native void setSnapshotFiles(@Cast("bool") boolean enabled);
  public native @Cast("bool") boolean isTrackOperations();
  public native void setTrackOperations(@Cast("bool") boolean enabled);
  ...
  public native void setDeleteShapeInfo(@Cast("bool") boolean deleteShapeInfo);
  ...
  public native void setCudaMemoryPinned(@Cast("bool") boolean pinned);
  public native @Cast("bool") boolean cudaUseManagedMemory();
  public native void setCudaUseManagedMemory(@Cast("bool") boolean managed);
  ...
  public native void setCudaForceP2P(@Cast("bool") boolean forceP2P);
  public native @Cast("bool") boolean cudaAllocatorEnabled();
  public native void setCudaAllocatorEnabled(@Cast("bool") boolean enabled);
  ...
  public native void setCudaAsyncExecution(@Cast("bool") boolean async);
  ...
  public native void setCudaUseDeviceHost(@Cast("bool") boolean useDeviceHost);
  ...
  public native void setCudaUseUnifiedMemory(@Cast("bool") boolean unified);
  ...
  public native void setCudaGraphOptimization(@Cast("bool") boolean enabled);
...
public native void shuffle(@Cast("sd::Pointer*") PointerPointer extras,
                           ...
                           @ByVal org.nd4j.nativeblas.OpaqueNDArrayArr z,
                           int N,
                           @ByVal org.nd4j.nativeblas.OpaqueNDArray dimension,
                           @ByVal org.nd4j.nativeblas.OpaqueNDArray shuffleMap);
...
public native void pullRows(@Cast("sd::Pointer*") PointerPointer extraPointers,
                            @ByVal org.nd4j.nativeblas.OpaqueNDArray x,
                            @ByVal org.nd4j.nativeblas.OpaqueNDArray z,
                            @Cast("sd::LongType") long n,
                            @ByVal org.nd4j.nativeblas.OpaqueNDArray indexes,
...
public native void deleteNDArray(@ByVal org.nd4j.nativeblas.OpaqueNDArray array);

public native @Cast("sd::LongType") long getOpaqueNDArrayOffset(@ByVal org.nd4j.nativeblas.OpaqueNDArray array);


public native @Cast("const sd::LongType*") LongPointer getOpaqueNDArrayShapeInfo(@ByVal org.nd4j.nativeblas.OpaqueNDArray array);
...
public native @ByVal @Name("createOpaqueNDArray") org.nd4j.nativeblas.OpaqueNDArray create(org.nd4j.nativeblas.OpaqueDataBuffer shapeInfo,
                                                ...
                                                org.nd4j.nativeblas.OpaqueDataBuffer specialBuffer,
                                                @Cast("sd::LongType") long offset);


public native @Cast("sd::Pointer") Pointer loadNpyFromHeader(@Cast("sd::Pointer") Pointer data);
public native void saveNpy(@StdString BytePointer fname, @Const org.nd4j.nativeblas.OpaqueDataBuffer data, @Cast("const unsigned int*") IntPointer shape, @Cast("const unsigned int") int ndims,
                           @StdString BytePointer mode);
public native void saveNpy(@StdString String fname, @Const org.nd4j.nativeblas.OpaqueDataBuffer data, @Cast("const unsigned int*") IntBuffer shape, @Cast("const unsigned int") int ndims,
                           @StdString String mode);
public native void saveNpy(@StdString BytePointer fname, @Const org.nd4j.nativeblas.OpaqueDataBuffer data, @Cast("const unsigned int*") int[] shape, @Cast("const unsigned int") int ndims,
                           @StdString BytePointer mode);
public native void saveNpy(@StdString String fname, @Const org.nd4j.nativeblas.OpaqueDataBuffer data, @Cast("const unsigned int*") IntPointer shape, @Cast("const unsigned int") int ndims,
                           @StdString String mode);
public native void saveNpy(@StdString BytePointer fname, @Const org.nd4j.nativeblas.OpaqueDataBuffer data, @Cast("const unsigned int*") IntBuffer shape, @Cast("const unsigned int") int ndims,
                           @StdString BytePointer mode);
public native void saveNpy(@StdString String fname, @Const org.nd4j.nativeblas.OpaqueDataBuffer data, @Cast("const unsigned int*") int[] shape, @Cast("const unsigned int") int ndims,
                           @StdString String mode);
...
public native void inspectArray(@Cast("sd::Pointer*") PointerPointer extraPointers, @Cast("sd::Pointer") Pointer buffer, @Cast("sd::LongType*") LongBuffer shapeInfo, @Cast("sd::Pointer") Pointer specialBuffer,
                                @Cast("sd::LongType*") LongBuffer specialShapeInfo, @Cast("sd::Pointer") Pointer debugInfo);
public native void inspectArray(@Cast("sd::Pointer*") PointerPointer extraPointers, @Cast("sd::Pointer") Pointer buffer, @Cast("sd::LongType*") long[] shapeInfo, @Cast("sd::Pointer") Pointer specialBuffer,
                                @Cast("sd::LongType*") long[] specialShapeInfo, @Cast("sd::Pointer") Pointer debugInfo);
...
public native org.nd4j.nativeblas.OpaqueVariablesSet executeStoredGraph(@Cast("sd::Pointer*") PointerPointer extraPointers,
                                                     @Cast("sd::LongType") long graphId,
                                                     @Cast("sd::Pointer*") PointerPointer inputBuffers,
                                                     @Cast("sd::Pointer*") PointerPointer inputShapes,
 ...
 */
public native @Cast("char*") String getTadPackStackTrace(org.nd4j.nativeblas.OpaqueTadPack pack);

public native org.nd4j.nativeblas.OpaqueTadPack tadOnlyShapeInfo(org.nd4j.nativeblas.OpaqueDataBuffer hXShapeInfo, @Cast("sd::LongType*") LongPointer dimension, @Cast("sd::LongType") long dimensionLength);
public native org.nd4j.nativeblas.OpaqueTadPack tadOnlyShapeInfo(org.nd4j.nativeblas.OpaqueDataBuffer hXShapeInfo, @Cast("sd::LongType*") LongBuffer dimension, @Cast("sd::LongType") long dimensionLength);
public native org.nd4j.nativeblas.OpaqueTadPack tadOnlyShapeInfo(org.nd4j.nativeblas.OpaqueDataBuffer hXShapeInfo, @Cast("sd::LongType*") long[] dimension, @Cast("sd::LongType") long dimensionLength);
public native @ByVal org.nd4j.nativeblas.OpaqueConstantDataBuffer constantBufferLong(@Cast("sd::DataType") int dtype, @Cast("sd::LongType*") LongPointer data, int length);
public native @ByVal org.nd4j.nativeblas.OpaqueConstantDataBuffer constantBufferLong(@Cast("sd::DataType") int dtype, @Cast("sd::LongType*") LongBuffer data, int length);
public native @ByVal org.nd4j.nativeblas.OpaqueConstantDataBuffer constantBufferLong(@Cast("sd::DataType") int dtype, @Cast("sd::LongType*") long[] data, int length);
public native @ByVal org.nd4j.nativeblas.OpaqueConstantDataBuffer constantBufferDouble(@Cast("sd::DataType") int dtype, DoublePointer data, int length);
public native @ByVal org.nd4j.nativeblas.OpaqueConstantDataBuffer constantBufferDouble(@Cast("sd::DataType") int dtype, DoubleBuffer data, int length);
public native @ByVal org.nd4j.nativeblas.OpaqueConstantDataBuffer constantBufferDouble(@Cast("sd::DataType") int dtype, double[] data, int length);
public native @ByVal org.nd4j.nativeblas.OpaqueConstantDataBuffer constantBuffer(@Cast("sd::DataType") int dtype, ConstantDescriptor descriptor);

public native @Cast("char*") String getDeviceName(int device);

public native void execRandom(@Cast("sd::Pointer*") PointerPointer extraPointers, int opNum, @Cast("sd::Pointer") Pointer stateHost, @ByVal org.nd4j.nativeblas.OpaqueNDArray z, Pointer extraArguments);

public native void execRandom2(@Cast("sd::Pointer*") PointerPointer extraPointers, int opNum, @Cast("sd::Pointer") Pointer stateHost, @ByVal org.nd4j.nativeblas.OpaqueNDArray x, @ByVal org.nd4j.nativeblas.OpaqueNDArray z, Pointer extraArguments);

public native void execRandom3(@Cast("sd::Pointer*") PointerPointer extraPointers, int opNum, @Cast("sd::Pointer") Pointer stateHost,
                               @ByVal org.nd4j.nativeblas.OpaqueNDArray x,
                               @ByVal org.nd4j.nativeblas.OpaqueNDArray y, @ByVal org.nd4j.nativeblas.OpaqueNDArray z, Pointer extraArguments);
...
public native @Cast("sd::LongType") long dbBufferLength(org.nd4j.nativeblas.OpaqueDataBuffer dataBuffer);
public native void toggleOpTrace(@Cast("bool") boolean opTrace);
public native void purgeOpTrace();
public native void printOpTrace();
public native void copyBuffer(org.nd4j.nativeblas.OpaqueDataBuffer target, long n,  org.nd4j.nativeblas.OpaqueDataBuffer from, long fromOffset, long targetOffset);
...
public native void printDeviceBuffer(org.nd4j.nativeblas.OpaqueDataBuffer buffer, @Cast("sd::LongType") long offset);
public native void printDeviceBuffer(org.nd4j.nativeblas.OpaqueDataBuffer buffer);
public native void execPairwiseTransform(@Cast("sd::Pointer*") PointerPointer extraPointers, int opNum, @ByVal org.nd4j.nativeblas.OpaqueNDArray x, @ByVal org.nd4j.nativeblas.OpaqueNDArray y, @ByVal org.nd4j.nativeblas.OpaqueNDArray z, Pointer extraParams);
public native void execPairwiseTransformBool(@Cast("sd::Pointer*") PointerPointer extraPointers, int opNum, @ByVal org.nd4j.nativeblas.OpaqueNDArray x, @ByVal org.nd4j.nativeblas.OpaqueNDArray y, Pointer extraParams, @ByVal org.nd4j.nativeblas.OpaqueNDArray z);
public native void execSummaryStatsScalar(@Cast("sd::Pointer*") PointerPointer extraPointers, int opNum, @ByVal org.nd4j.nativeblas.OpaqueNDArray x, Pointer extraParams, @ByVal org.nd4j.nativeblas.OpaqueNDArray z, @Cast("bool") boolean biasCorrected);
public native void execSummaryStatsTad(@Cast("sd::Pointer*") PointerPointer extraPointers, int opNum, @ByVal org.nd4j.nativeblas.OpaqueNDArray x, Pointer extraParams, @ByVal org.nd4j.nativeblas.OpaqueNDArray z,
                                       @ByVal org.nd4j.nativeblas.OpaqueNDArray dimension, @Cast("bool") boolean biasCorrected);
public native void execBroadcastBool(@Cast("sd::Pointer*") PointerPointer extraPointers, int opNum, @ByVal org.nd4j.nativeblas.OpaqueNDArray x, @ByVal org.nd4j.nativeblas.OpaqueNDArray y, @ByVal org.nd4j.nativeblas.OpaqueNDArray z, Pointer extraParams, @ByVal org.nd4j.nativeblas.OpaqueNDArray dimension);
public native void execScalarBool(@Cast("sd::Pointer*") PointerPointer extraPointers, int opNum, @ByVal org.nd4j.nativeblas.OpaqueNDArray x, @ByVal org.nd4j.nativeblas.OpaqueNDArray z, @ByVal org.nd4j.nativeblas.OpaqueNDArray scalar, Pointer extraParams);
////////////////////////////////////////////////////////////////////////
public native void execScalarBoolTad(@Cast("sd::Pointer*") PointerPointer extraPointers, int opNum, @ByVal org.nd4j.nativeblas.OpaqueNDArray x, @ByVal org.nd4j.nativeblas.OpaqueNDArray z, @ByVal org.nd4j.nativeblas.OpaqueNDArray scalar, Pointer extraParams, @ByVal org.nd4j.nativeblas.OpaqueNDArray dimension);
public native void execScalar(@Cast("sd::Pointer*") PointerPointer extraPointers, int opNum, @ByVal org.nd4j.nativeblas.OpaqueNDArray x, @ByVal org.nd4j.nativeblas.OpaqueNDArray z, @ByVal org.nd4j.nativeblas.OpaqueNDArray scalar, Pointer extraParams);
public native void execScalarTad(@Cast("sd::Pointer*") PointerPointer extraPointers, int opNum, @ByVal org.nd4j.nativeblas.OpaqueNDArray x, @ByVal org.nd4j.nativeblas.OpaqueNDArray z, @ByVal org.nd4j.nativeblas.OpaqueNDArray scalar, Pointer extraParams, @ByVal org.nd4j.nativeblas.OpaqueNDArray dimension);
public native void execBroadcast(@Cast("sd::Pointer*") PointerPointer extraPointers, int opNum, @ByVal org.nd4j.nativeblas.OpaqueNDArray x, @ByVal org.nd4j.nativeblas.OpaqueNDArray y, @ByVal org.nd4j.nativeblas.OpaqueNDArray z, Pointer extraParams, @ByVal org.nd4j.nativeblas.OpaqueNDArray dimension);
public native void execReduceFloat(@Cast("sd::Pointer*") PointerPointer extraPointers, int opNum, @ByVal org.nd4j.nativeblas.OpaqueNDArray x, Pointer extraParams, @ByVal org.nd4j.nativeblas.OpaqueNDArray z);
public native void execReduce3All(@Cast("sd::Pointer*") PointerPointer extraPointers, int opNum, @ByVal org.nd4j.nativeblas.OpaqueNDArray x, @ByVal org.nd4j.nativeblas.OpaqueNDArray y, @ByVal org.nd4j.nativeblas.OpaqueNDArray z, @ByVal org.nd4j.nativeblas.OpaqueNDArray dimension, Pointer extraParams);


public native void execReduceLong(@Cast("sd::Pointer*") PointerPointer extraPointers, int opNum, @ByVal org.nd4j.nativeblas.OpaqueNDArray x, Pointer extraParams, @ByVal org.nd4j.nativeblas.OpaqueNDArray z, @ByVal org.nd4j.nativeblas.OpaqueNDArray dimension);
public native void execReduceBool2(@Cast("sd::Pointer*") PointerPointer extraPointers, int opNum, @ByVal org.nd4j.nativeblas.OpaqueNDArray x, Pointer extraParams, @ByVal org.nd4j.nativeblas.OpaqueNDArray z, @ByVal org.nd4j.nativeblas.OpaqueNDArray dimension);
public native void execReduceBool(@Cast("sd::Pointer*") PointerPointer extraPointers, int opNum, @ByVal org.nd4j.nativeblas.OpaqueNDArray x, Pointer extraParams, @ByVal org.nd4j.nativeblas.OpaqueNDArray z, @ByVal org.nd4j.nativeblas.OpaqueNDArray dimension);
public native void execIndexReduce(@Cast("sd::Pointer*") PointerPointer extraPointers, int opNum, @ByVal org.nd4j.nativeblas.OpaqueNDArray x, Pointer extraParams, @ByVal org.nd4j.nativeblas.OpaqueNDArray z, @ByVal org.nd4j.nativeblas.OpaqueNDArray dimension);
public native void execReduceFloat2(@Cast("sd::Pointer*") PointerPointer extraPointers, int opNum, @ByVal org.nd4j.nativeblas.OpaqueNDArray x, Pointer extraParams, @ByVal org.nd4j.nativeblas.OpaqueNDArray z, @ByVal org.nd4j.nativeblas.OpaqueNDArray dimension);
public native void execIndexReduceScalar(@Cast("sd::Pointer*") PointerPointer extraPointers, int opNum, @ByVal org.nd4j.nativeblas.OpaqueNDArray x, Pointer extraParams, @ByVal org.nd4j.nativeblas.OpaqueNDArray z);
public native void execTransformSame(@Cast("sd::Pointer*") PointerPointer extraPointers, int opNum, @ByVal org.nd4j.nativeblas.OpaqueNDArray x, Pointer extraParams, @ByVal org.nd4j.nativeblas.OpaqueNDArray z);
public native void execTransformBool(@Cast("sd::Pointer*") PointerPointer extraPointers, int opNum, @ByVal org.nd4j.nativeblas.OpaqueNDArray x, Pointer extraParams, @ByVal org.nd4j.nativeblas.OpaqueNDArray z);
public native void execTransformAny(@Cast("sd::Pointer*") PointerPointer extraPointers, int opNum, @ByVal org.nd4j.nativeblas.OpaqueNDArray x, Pointer extraParams, @ByVal org.nd4j.nativeblas.OpaqueNDArray z);
public native void execTransformStrict(@Cast("sd::Pointer*") PointerPointer extraPointers, int opNum, @ByVal org.nd4j.nativeblas.OpaqueNDArray x, Pointer extraParams, @ByVal org.nd4j.nativeblas.OpaqueNDArray z);
public native void execTransformFloat(@Cast("sd::Pointer*") PointerPointer extraPointers, int opNum, @ByVal org.nd4j.nativeblas.OpaqueNDArray x, Pointer extraParams, @ByVal org.nd4j.nativeblas.OpaqueNDArray z);
...
public native void execReduceSame(@Cast("sd::Pointer*") PointerPointer extraPointers, int opNum, @ByVal org.nd4j.nativeblas.OpaqueNDArray x,
                                  Pointer extraParams,@ByVal org.nd4j.nativeblas.OpaqueNDArray z);
public native void execReduceSame2(@Cast("sd::Pointer*") PointerPointer extraPointers, int opNum,
                                   @ByVal org.nd4j.nativeblas.OpaqueNDArray x,Pointer extraParams,
                                   @ByVal org.nd4j.nativeblas.OpaqueNDArray z, @ByVal org.nd4j.nativeblas.OpaqueNDArray dimension);
public native void execReduce3(@Cast("sd::Pointer*") PointerPointer extraPointers, int opNum, @ByVal org.nd4j.nativeblas.OpaqueNDArray x, Pointer extraParams, @ByVal org.nd4j.nativeblas.OpaqueNDArray y, @ByVal org.nd4j.nativeblas.OpaqueNDArray z);
public native void execReduce3Scalar(@Cast("sd::Pointer*") PointerPointer extraPointers, int opNum, @ByVal org.nd4j.nativeblas.OpaqueNDArray x, Pointer extraParams, @ByVal org.nd4j.nativeblas.OpaqueNDArray y, @ByVal org.nd4j.nativeblas.OpaqueNDArray z);
public native void execReduce3Tad(@Cast("sd::Pointer*") PointerPointer extraPointers, int opNum, @ByVal org.nd4j.nativeblas.OpaqueNDArray x, Pointer extraParams, @ByVal org.nd4j.nativeblas.OpaqueNDArray y, @ByVal org.nd4j.nativeblas.OpaqueNDArray z, @ByVal org.nd4j.nativeblas.OpaqueNDArray dimension);
...
public native @Cast("bool") boolean checkOpaqueNDArrayElementsNull(@ByVal org.nd4j.nativeblas.OpaqueNDArrayArr elements,int numElements);
public native @Cast("sd::LongType") long getShapeInfoLength(@ByVal org.nd4j.nativeblas.OpaqueNDArray array);
public native @Cast("sd::LongType") long getOpaqueNDArrayLength(@ByVal org.nd4j.nativeblas.OpaqueNDArray array);
public native void sort(@Cast("sd::Pointer*") PointerPointer extraPointers, @ByVal org.nd4j.nativeblas.OpaqueNDArray x, @Cast("bool") boolean descending);
public native void sortTad(@Cast("sd::Pointer*") PointerPointer extraPointers, @ByVal org.nd4j.nativeblas.OpaqueNDArray x,
...
public native void sortTad(@Cast("sd::Pointer*") PointerPointer extraPointers, @ByVal org.nd4j.nativeblas.OpaqueNDArray x,
                           @Cast("sd::LongType*") LongBuffer dimension, @Cast("sd::LongType") long dimensionLength,
                           @Cast("sd::LongType*") LongBuffer tadShapeInfo,  @Cast("sd::LongType*") LongBuffer tadOffsets, @Cast("bool") boolean descending);
public native void sortTad(@Cast("sd::Pointer*") PointerPointer extraPointers, @ByVal org.nd4j.nativeblas.OpaqueNDArray x,
                           @Cast("sd::LongType*") long[] dimension, @Cast("sd::LongType") long dimensionLength,
                           @Cast("sd::LongType*") long[] tadShapeInfo,  @Cast("sd::LongType*") long[] tadOffsets, @Cast("bool") boolean descending);
public native void sortByValue(@Cast("sd::Pointer*") PointerPointer extraPointers, @ByVal org.nd4j.nativeblas.OpaqueNDArray x, @ByVal org.nd4j.nativeblas.OpaqueNDArray y, @Cast("bool") boolean descending);

public native void execReduceLong2(@Cast("sd::Pointer*") PointerPointer extraPointers, int opNum, @ByVal org.nd4j.nativeblas.OpaqueNDArray x,
                                   Pointer extraParams,
                                   @ByVal org.nd4j.nativeblas.OpaqueNDArray z, @ByVal org.nd4j.nativeblas.OpaqueNDArray dimension);

public native void sortTadByKey(@Cast("sd::Pointer*") PointerPointer extraPointers,
                                @ByVal org.nd4j.nativeblas.OpaqueNDArray x,
                                @ByVal org.nd4j.nativeblas.OpaqueNDArray y,
                                @ByVal org.nd4j.nativeblas.OpaqueNDArray dimension,
...
public native @Cast("sd::Pointer") Pointer getConstantDataBufferPrimary(@ByVal org.nd4j.nativeblas.OpaqueConstantDataBuffer dbf);
public native @Cast("sd::Pointer") Pointer getConstantDataBufferSpecial(@ByVal org.nd4j.nativeblas.OpaqueConstantDataBuffer dbf);
public native @Cast("sd::LongType") long getConstantDataBufferLength(@ByVal org.nd4j.nativeblas.OpaqueConstantDataBuffer dbf);
public native @Cast("sd::LongType") long getConstantDataBufferSizeOf(@ByVal org.nd4j.nativeblas.OpaqueConstantDataBuffer dbf);
public native @Cast("sd::Pointer") Pointer getConstantShapeBufferPrimary(@ByVal org.nd4j.nativeblas.OpaqueConstantShapeBuffer dbf);
public native @Cast("sd::Pointer") Pointer getConstantShapeBufferSpecial(@ByVal org.nd4j.nativeblas.OpaqueConstantShapeBuffer dbf);
 ...
 * @return C-string containing the formatted stack trace (caller must NOT free this)
 */
public native @Cast("char*") String getConstantShapeBufferStackTrace(@ByVal org.nd4j.nativeblas.OpaqueConstantShapeBuffer buffer);

public native void markGraphContextInplace(org.nd4j.nativeblas.OpaqueContext ptr, @Cast("bool") boolean reallyInplace);
public native @ByVal org.nd4j.nativeblas.OpaqueNDArray getOutputArrayNative(org.nd4j.nativeblas.OpaqueContext ptr, int idx);
public native @ByVal org.nd4j.nativeblas.OpaqueNDArray getInputArrayNative(org.nd4j.nativeblas.OpaqueContext ptr, int idx);
...
public native void setGraphContextOutputArray(org.nd4j.nativeblas.OpaqueContext ptr, int index,@ByVal org.nd4j.nativeblas.OpaqueNDArray arr);
public native void setGraphContextInputArray(org.nd4j.nativeblas.OpaqueContext ptr,int index,@ByVal org.nd4j.nativeblas.OpaqueNDArray arr);
public native void setGraphContextOutputArraysArr(org.nd4j.nativeblas.OpaqueContext ptr, int numArrays, @ByVal org.nd4j.nativeblas.OpaqueNDArrayArr arr);
public native void setGraphContextInputArraysArr(org.nd4j.nativeblas.OpaqueContext ptr, int numArrays, @ByVal org.nd4j.nativeblas.OpaqueNDArrayArr arr);
...
public native @Cast("sd::Pointer") Pointer lcAllocationPointer(@ByVal org.nd4j.nativeblas.OpaqueLaunchContext lc);
public native @Cast("sd::Pointer") Pointer lcExecutionStream(@ByVal org.nd4j.nativeblas.OpaqueLaunchContext lc);
public native @Cast("sd::Pointer") Pointer lcCopyStream(@ByVal org.nd4j.nativeblas.OpaqueLaunchContext lc);
public native @Cast("sd::Pointer") Pointer lcBlasHandle(@ByVal org.nd4j.nativeblas.OpaqueLaunchContext lc);
...
public native @ByVal org.nd4j.nativeblas.OpaqueConstantShapeBuffer cacheAndStoreShapeBuffer(@Cast("sd::LongType*") LongPointer shapeInfo);
public native @ByVal org.nd4j.nativeblas.OpaqueConstantShapeBuffer cacheAndStoreShapeBuffer(@Cast("sd::LongType*") LongBuffer shapeInfo);
public native @ByVal org.nd4j.nativeblas.OpaqueConstantShapeBuffer cacheAndStoreShapeBuffer(@Cast("sd::LongType*") long[] shapeInfo);
public native @ByVal org.nd4j.nativeblas.OpaqueConstantShapeBuffer shapeBuffer(int rank, @Cast("sd::LongType*") LongPointer shape, @Cast("sd::LongType*") LongPointer strides,
                                                    @Cast("sd::DataType") int dtype, char order, @Cast("sd::LongType") long ews, @Cast("bool") boolean empty);
public native @ByVal org.nd4j.nativeblas.OpaqueConstantShapeBuffer shapeBuffer(int rank, @Cast("sd::LongType*") LongBuffer shape, @Cast("sd::LongType*") LongBuffer strides,
                                                    @Cast("sd::DataType") int dtype, char order, @Cast("sd::LongType") long ews, @Cast("bool") boolean empty);
public native @ByVal org.nd4j.nativeblas.OpaqueConstantShapeBuffer shapeBuffer(int rank, @Cast("sd::LongType*") long[] shape, @Cast("sd::LongType*") long[] strides,
                                                    @Cast("sd::DataType") int dtype, char order, @Cast("sd::LongType") long ews, @Cast("bool") boolean empty);
public native @ByVal org.nd4j.nativeblas.OpaqueConstantShapeBuffer shapeBufferEx(int rank, @Cast("sd::LongType*") LongPointer shape, @Cast("sd::LongType*") LongPointer strides,
                                                      @Cast("sd::DataType") int dtype, char order, @Cast("sd::LongType") long ews,
                                                      @Cast("sd::LongType") long extras);
public native @ByVal org.nd4j.nativeblas.OpaqueConstantShapeBuffer shapeBufferEx(int rank, @Cast("sd::LongType*") LongBuffer shape, @Cast("sd::LongType*") LongBuffer strides,
                                                      @Cast("sd::DataType") int dtype, char order, @Cast("sd::LongType") long ews,
                                                      @Cast("sd::LongType") long extras);
public native @ByVal org.nd4j.nativeblas.OpaqueConstantShapeBuffer shapeBufferEx(int rank, @Cast("sd::LongType*") long[] shape, @Cast("sd::LongType*") long[] strides,
                                                      @Cast("sd::DataType") int dtype, char order, @Cast("sd::LongType") long ews,
                                                      @Cast("sd::LongType") long extras);
...
public native long numpyHeaderLength(org.nd4j.nativeblas.OpaqueDataBuffer opaqueDataBuffer,@Cast("sd::Pointer") Pointer shapeBuffer);
...
public native void setIntermediateResult(org.nd4j.nativeblas.OpaqueContext contextPointer, int index, org.nd4j.nativeblas.OpaqueDataBuffer buffer,
 ...
 */
public native void setLifecycleOpContext(@Cast("char*") String opName);
public native void setLifecycleOpContext(@Cast("char*") BytePointer opName);
 ...
 */
public native @Cast("char*") String getLifecycleOpContext();
 ...
 */
public native void dumpOpExecutionState(@Cast("char*") String message);
public native void dumpOpExecutionState(@Cast("char*") BytePointer message);
 ...
 */
public native void setAllocationContext(@Cast("char*") String opName);
public native void setAllocationContext(@Cast("char*") BytePointer opName);
 ...
 */
public native void updateAllocationJavaStackTrace(@ByVal org.nd4j.nativeblas.OpaqueNDArray array, @Cast("char*") String javaStackTrace);
public native void updateAllocationJavaStackTrace(@ByVal org.nd4j.nativeblas.OpaqueNDArray array, @Cast("char*") BytePointer javaStackTrace);
 ...
 */
public native void recordJavaNDArrayAllocation(@ByVal org.nd4j.nativeblas.OpaqueNDArray array, long size, int dataType, @Cast("bool") boolean isView);

/**
 * Record an NDArray deallocation from Java side.
 * @param array The OpaqueNDArray being deallocated
 */
public native void recordJavaNDArrayDeallocation(@ByVal org.nd4j.nativeblas.OpaqueNDArray array);
 ...
 */
public native void recordJavaDataBufferAllocation(org.nd4j.nativeblas.OpaqueDataBuffer buffer, long size, int dataType, @Cast("bool") boolean isWorkspace);

/**
 * Record a DataBuffer deallocation from Java side.
 * @param buffer The OpaqueDataBuffer being deallocated
 */
public native void recordJavaDataBufferDeallocation(org.nd4j.nativeblas.OpaqueDataBuffer buffer);
 ...
 */
public native void freeString(@Cast("char*") String ptr);
public native void freeString(@Cast("char*") BytePointer ptr);
 ...
 */
public native @Cast("char*") String getNDArrayLifecycleStats();
 ...
 * NOTE: Returns empty JSON "{}" when SD_GCC_FUNCTRACE is not defined.
 */
public native @Cast("char*") String getDataBufferLifecycleStats();
 ...
 * NOTE: No-op when SD_GCC_FUNCTRACE is not defined.
 */
public native void generateNDArrayAllocationFlamegraph(@Cast("char*") String outputPath);
public native void generateNDArrayAllocationFlamegraph(@Cast("char*") BytePointer outputPath);
 ...
 * NOTE: No-op when SD_GCC_FUNCTRACE is not defined.
 */
public native void generateNDArrayDeallocationFlamegraph(@Cast("char*") String outputPath);
public native void generateNDArrayDeallocationFlamegraph(@Cast("char*") BytePointer outputPath);
 ...
 * NOTE: No-op when SD_GCC_FUNCTRACE is not defined.
 */
public native void generateDataBufferAllocationFlamegraph(@Cast("char*") String outputPath, int bufferType);
public native void generateDataBufferAllocationFlamegraph(@Cast("char*") BytePointer outputPath, int bufferType);
 ...
 * NOTE: No-op when SD_GCC_FUNCTRACE is not defined.
 */
public native void generateDataBufferDeallocationFlamegraph(@Cast("char*") String outputPath, int bufferType);
public native void generateDataBufferDeallocationFlamegraph(@Cast("char*") BytePointer outputPath, int bufferType);
 ...
 * NOTE: No-op when SD_GCC_FUNCTRACE is not defined.
 */
public native void generateLifecycleLeakReport(@Cast("char*") String outputPath);
public native void generateLifecycleLeakReport(@Cast("char*") BytePointer outputPath);
 ...
 * NOTE: No-op when SD_GCC_FUNCTRACE is not defined.
 */
public native void generateComprehensiveLeakAnalysis(@Cast("char*") String outputDir);
public native void generateComprehensiveLeakAnalysis(@Cast("char*") BytePointer outputDir);
 ...
 * NOTE: No-op when SD_GCC_FUNCTRACE is not defined.
 */
public native void generateNDArrayTemporalLeakReport(@Cast("char*") String outputPath, int windowCount, double windowDurationSec);
public native void generateNDArrayTemporalLeakReport(@Cast("char*") BytePointer outputPath, int windowCount, double windowDurationSec);
public native void generateTADCacheTemporalLeakReport(@Cast("char*") String outputPath, int windowCount, double windowDurationSec);
public native void generateTADCacheTemporalLeakReport(@Cast("char*") BytePointer outputPath, int windowCount, double windowDurationSec);
 ...
 * NOTE: No-op when SD_GCC_FUNCTRACE is not defined.
 */
public native void generateNDArraySnapshotDiff(@Cast("sd::LongType") long snapshot1, @Cast("sd::LongType") long snapshot2, @Cast("char*") String outputPath);
public native void generateNDArraySnapshotDiff(@Cast("sd::LongType") long snapshot1, @Cast("sd::LongType") long snapshot2, @Cast("char*") BytePointer outputPath);
public native void generateTADCacheSnapshotDiff(@Cast("sd::LongType") long snapshot1, @Cast("sd::LongType") long snapshot2, @Cast("char*") String outputPath);
public native void generateTADCacheSnapshotDiff(@Cast("sd::LongType") long snapshot1, @Cast("sd::LongType") long snapshot2, @Cast("char*") BytePointer outputPath);
 ...
 */
public native void printOpTimingBreakdown(@Cast("char*") String opName);
public native void printOpTimingBreakdown(@Cast("char*") BytePointer opName);

/**
 * Print timing histogram for a specific op.
 * @param opName name of the op to analyze
 */
public native void printOpTimingHistogram(@Cast("char*") String opName);
public native void printOpTimingHistogram(@Cast("char*") BytePointer opName);
 ...
 */
public native int exportOpTimingChromeTrace(@Cast("char*") String filename);
public native int exportOpTimingChromeTrace(@Cast("char*") BytePointer filename);
...
// #endif
  ...
  private native void allocate(Pointer buffer, @Cast("sd::LongType*") LongPointer shapeInfo, LaunchContext context, @Cast("const bool") boolean isBuffAlloc,
            @Cast("sd::LongType") long offset);
  public NDArray(Pointer buffer, @Cast("sd::LongType*") LongBuffer shapeInfo, LaunchContext context, @Cast("const bool") boolean isBuffAlloc,
            @Cast("sd::LongType") long offset) { super((Pointer)null); allocate(buffer, shapeInfo, context, isBuffAlloc, offset); }
  private native void allocate(Pointer buffer, @Cast("sd::LongType*") LongBuffer shapeInfo, LaunchContext context, @Cast("const bool") boolean isBuffAlloc,
            @Cast("sd::LongType") long offset);
  public NDArray(Pointer buffer, @Cast("sd::LongType*") long[] shapeInfo, LaunchContext context, @Cast("const bool") boolean isBuffAlloc,
            @Cast("sd::LongType") long offset) { super((Pointer)null); allocate(buffer, shapeInfo, context, isBuffAlloc, offset); }
  private native void allocate(Pointer buffer, @Cast("sd::LongType*") long[] shapeInfo, LaunchContext context, @Cast("const bool") boolean isBuffAlloc,
            @Cast("sd::LongType") long offset);
  ...
  public NDArray(Pointer buffer, Pointer bufferD, @Cast("sd::LongType*") LongBuffer shapeInfo, LaunchContext context,
            @Cast("const bool") boolean isBuffAlloc, @Cast("const bool") boolean isBuffDAlloc, @Cast("sd::LongType") long offset) { super((Pointer)null); allocate(buffer, bufferD, shapeInfo, context, isBuffAlloc, isBuffDAlloc, offset); }
  private native void allocate(Pointer buffer, Pointer bufferD, @Cast("sd::LongType*") LongBuffer shapeInfo, LaunchContext context,
            @Cast("const bool") boolean isBuffAlloc, @Cast("const bool") boolean isBuffDAlloc, @Cast("sd::LongType") long offset);
  public NDArray(Pointer buffer, Pointer bufferD, @Cast("sd::LongType*") long[] shapeInfo, LaunchContext context,
            @Cast("const bool") boolean isBuffAlloc, @Cast("const bool") boolean isBuffDAlloc, @Cast("sd::LongType") long offset) { super((Pointer)null); allocate(buffer, bufferD, shapeInfo, context, isBuffAlloc, isBuffDAlloc, offset); }
  private native void allocate(Pointer buffer, Pointer bufferD, @Cast("sd::LongType*") long[] shapeInfo, LaunchContext context,
            @Cast("const bool") boolean isBuffAlloc, @Cast("const bool") boolean isBuffDAlloc, @Cast("sd::LongType") long offset);
  ...
  public NDArray( @Cast("sd::LongType*") LongBuffer shapeInfo, @Cast("bool") boolean copyStrides/*=false*/, LaunchContext context/*=LaunchContext::defaultContext()*/, @Cast("bool") boolean nullify/*=true*/) { super((Pointer)null); allocate(shapeInfo, copyStrides, context, nullify); }
  private native void allocate( @Cast("sd::LongType*") LongBuffer shapeInfo, @Cast("bool") boolean copyStrides/*=false*/, LaunchContext context/*=LaunchContext::defaultContext()*/, @Cast("bool") boolean nullify/*=true*/);
  public NDArray( @Cast("sd::LongType*") LongBuffer shapeInfo) { super((Pointer)null); allocate(shapeInfo); }
  private native void allocate( @Cast("sd::LongType*") LongBuffer shapeInfo);
  public NDArray( @Cast("sd::LongType*") long[] shapeInfo, @Cast("bool") boolean copyStrides/*=false*/, LaunchContext context/*=LaunchContext::defaultContext()*/, @Cast("bool") boolean nullify/*=true*/) { super((Pointer)null); allocate(shapeInfo, copyStrides, context, nullify); }
  private native void allocate( @Cast("sd::LongType*") long[] shapeInfo, @Cast("bool") boolean copyStrides/*=false*/, LaunchContext context/*=LaunchContext::defaultContext()*/, @Cast("bool") boolean nullify/*=true*/);
  public NDArray( @Cast("sd::LongType*") long[] shapeInfo) { super((Pointer)null); allocate(shapeInfo); }
  private native void allocate( @Cast("sd::LongType*") long[] shapeInfo);
  ...
  public NDArray(@Cast("sd::LongType*") LongBuffer shapeInfo, @Cast("const sd::DataType") int dtype, @Cast("const bool") boolean copyStrides/*=false*/,
            LaunchContext context/*=LaunchContext::defaultContext()*/, @Cast("const bool") boolean nullify/*=true*/) { super((Pointer)null); allocate(shapeInfo, dtype, copyStrides, context, nullify); }
  private native void allocate(@Cast("sd::LongType*") LongBuffer shapeInfo, @Cast("const sd::DataType") int dtype, @Cast("const bool") boolean copyStrides/*=false*/,
            LaunchContext context/*=LaunchContext::defaultContext()*/, @Cast("const bool") boolean nullify/*=true*/);
  public NDArray(@Cast("sd::LongType*") LongBuffer shapeInfo, @Cast("const sd::DataType") int dtype) { super((Pointer)null); allocate(shapeInfo, dtype); }
  private native void allocate(@Cast("sd::LongType*") LongBuffer shapeInfo, @Cast("const sd::DataType") int dtype);
  public NDArray(@Cast("sd::LongType*") long[] shapeInfo, @Cast("const sd::DataType") int dtype, @Cast("const bool") boolean copyStrides/*=false*/,
            LaunchContext context/*=LaunchContext::defaultContext()*/, @Cast("const bool") boolean nullify/*=true*/) { super((Pointer)null); allocate(shapeInfo, dtype, copyStrides, context, nullify); }
  private native void allocate(@Cast("sd::LongType*") long[] shapeInfo, @Cast("const sd::DataType") int dtype, @Cast("const bool") boolean copyStrides/*=false*/,
            LaunchContext context/*=LaunchContext::defaultContext()*/, @Cast("const bool") boolean nullify/*=true*/);
  public NDArray(@Cast("sd::LongType*") long[] shapeInfo, @Cast("const sd::DataType") int dtype) { super((Pointer)null); allocate(shapeInfo, dtype); }
  private native void allocate(@Cast("sd::LongType*") long[] shapeInfo, @Cast("const sd::DataType") int dtype);

  /**
   *  this constructor creates new array using shape information contained in vector argument
   */
  public NDArray(byte order, @Cast("sd::LongType*") @StdVector LongPointer shape, @Cast("sd::DataType") int dtype/*=sd::DOUBLE*/,
            LaunchContext context/*=LaunchContext::defaultContext()*/) { super((Pointer)null); allocate(order, shape, dtype, context); }
  private native void allocate(byte order, @Cast("sd::LongType*") @StdVector LongPointer shape, @Cast("sd::DataType") int dtype/*=sd::DOUBLE*/,
            LaunchContext context/*=LaunchContext::defaultContext()*/);
  public NDArray(byte order, @Cast("sd::LongType*") @StdVector LongPointer shape) { super((Pointer)null); allocate(order, shape); }
  private native void allocate(byte order, @Cast("sd::LongType*") @StdVector LongPointer shape);
  public NDArray(byte order, @Cast("sd::LongType*") @StdVector LongBuffer shape, @Cast("sd::DataType") int dtype/*=sd::DOUBLE*/,
            LaunchContext context/*=LaunchContext::defaultContext()*/) { super((Pointer)null); allocate(order, shape, dtype, context); }
  private native void allocate(byte order, @Cast("sd::LongType*") @StdVector LongBuffer shape, @Cast("sd::DataType") int dtype/*=sd::DOUBLE*/,
            LaunchContext context/*=LaunchContext::defaultContext()*/);
  public NDArray(byte order, @Cast("sd::LongType*") @StdVector LongBuffer shape) { super((Pointer)null); allocate(order, shape); }
  private native void allocate(byte order, @Cast("sd::LongType*") @StdVector LongBuffer shape);
  public NDArray(byte order, @Cast("sd::LongType*") @StdVector long[] shape, @Cast("sd::DataType") int dtype/*=sd::DOUBLE*/,
            LaunchContext context/*=LaunchContext::defaultContext()*/) { super((Pointer)null); allocate(order, shape, dtype, context); }
  private native void allocate(byte order, @Cast("sd::LongType*") @StdVector long[] shape, @Cast("sd::DataType") int dtype/*=sd::DOUBLE*/,
            LaunchContext context/*=LaunchContext::defaultContext()*/);
  public NDArray(byte order, @Cast("sd::LongType*") @StdVector long[] shape) { super((Pointer)null); allocate(order, shape); }
  private native void allocate(byte order, @Cast("sd::LongType*") @StdVector long[] shape);
   ...
   */
  public NDArray(char order, @Cast("sd::LongType*") @StdVector LongPointer shape,  @StdVector DoublePointer data, @Cast("sd::DataType") int dtype/*=sd::DOUBLE*/,
            LaunchContext context/*=LaunchContext::defaultContext()*/) { super((Pointer)null); allocate(order, shape, data, dtype, context); }
  private native void allocate(char order, @Cast("sd::LongType*") @StdVector LongPointer shape,  @StdVector DoublePointer data, @Cast("sd::DataType") int dtype/*=sd::DOUBLE*/,
            LaunchContext context/*=LaunchContext::defaultContext()*/);
  ...
  public NDArray(char order, @Cast("sd::LongType*") @StdVector LongBuffer shape,  @StdVector DoubleBuffer data, @Cast("sd::DataType") int dtype/*=sd::DOUBLE*/,
            LaunchContext context/*=LaunchContext::defaultContext()*/) { super((Pointer)null); allocate(order, shape, data, dtype, context); }
  private native void allocate(char order, @Cast("sd::LongType*") @StdVector LongBuffer shape,  @StdVector DoubleBuffer data, @Cast("sd::DataType") int dtype/*=sd::DOUBLE*/,
            LaunchContext context/*=LaunchContext::defaultContext()*/);
  ...
  public NDArray(char order, @Cast("sd::LongType*") @StdVector long[] shape,  @StdVector double[] data, @Cast("sd::DataType") int dtype/*=sd::DOUBLE*/,
            LaunchContext context/*=LaunchContext::defaultContext()*/) { super((Pointer)null); allocate(order, shape, data, dtype, context); }
  private native void allocate(char order, @Cast("sd::LongType*") @StdVector long[] shape,  @StdVector double[] data, @Cast("sd::DataType") int dtype/*=sd::DOUBLE*/,
            LaunchContext context/*=LaunchContext::defaultContext()*/);
  ...
  // Static helper methods
  public native @Cast("sd::LongType*") LongPointer reshapeShapeInfo( NDArray array, char order, @Cast("sd::LongType*") @StdVector LongPointer newShape);
  public native @Cast("sd::LongType*") LongBuffer reshapeShapeInfo( NDArray array, char order, @Cast("sd::LongType*") @StdVector LongBuffer newShape);
  public native @Cast("sd::LongType*") long[] reshapeShapeInfo( NDArray array, char order, @Cast("sd::LongType*") @StdVector long[] newShape);
  ...
  public native void copyDataForAssign(NDArray thisArray,  NDArray other, @Cast("const sd::LongType*") LongBuffer otherShapeInfo, @Cast("bool") boolean allowParallelism);
  public native void copyDataForAssign(NDArray thisArray,  NDArray other, @Cast("const sd::LongType*") long[] otherShapeInfo, @Cast("bool") boolean allowParallelism);
  ...
  public native @ByVal NDArray repeat(int axis, @Cast("sd::LongType*") @StdVector LongBuffer repeats);
  public native @ByVal NDArray repeat(int axis, @Cast("sd::LongType*") @StdVector long[] repeats);
  ...
  public native void repeat(int axis, @Cast("sd::LongType*") @StdVector LongBuffer repeats, @ByRef NDArray target);
  public native void repeat(int axis, @Cast("sd::LongType*") @StdVector long[] repeats, @ByRef NDArray target);
...
// #endif
  ...
  public native @Cast("bool") boolean permutei(@Cast("sd::LongType*") @StdVector LongBuffer dimensions, @Cast("const bool") boolean copyToNewBuff, @Cast("const bool") boolean resetStrides);
  public native @Cast("bool") boolean permutei(@Cast("sd::LongType*") @StdVector long[] dimensions, @Cast("const bool") boolean copyToNewBuff, @Cast("const bool") boolean resetStrides);
  public native @Cast("bool") boolean permutei(@Cast("sd::LongType*") LongPointer dimensions, int rank);
  public native @Cast("bool") boolean permutei(@Cast("sd::LongType*") LongBuffer dimensions, int rank);
  public native @Cast("bool") boolean permutei(@Cast("sd::LongType*") long[] dimensions, int rank);
  ...
  public native @Cast("bool") boolean permutei(@Cast("sd::LongType*") LongBuffer dimensions, int rank, @Cast("const bool") boolean resetStrides);
  public native @Cast("bool") boolean permutei(@Cast("sd::LongType*") long[] dimensions, int rank, @Cast("const bool") boolean resetStrides);
  ...
  public native NDArray permute(@Cast("sd::LongType*") @StdVector LongBuffer dimensions, @Cast("bool") boolean copyToNewBuff, @Cast("bool") boolean resetStrides);
  public native NDArray permute(@Cast("sd::LongType*") @StdVector long[] dimensions, @Cast("bool") boolean copyToNewBuff, @Cast("bool") boolean resetStrides);
  ...
  public native NDArray permute(@Cast("sd::LongType*") LongBuffer dimensions, int rank, @Cast("const bool") boolean copyToNewBuff, @Cast("const bool") boolean resetStrides);
  public native NDArray permute(@Cast("sd::LongType*") long[] dimensions, int rank, @Cast("const bool") boolean copyToNewBuff, @Cast("const bool") boolean resetStrides);
  ...
  public native void permute(@Cast("sd::LongType*") LongBuffer dimensions, int rank, @ByRef NDArray target, @Cast("const bool") boolean resetStrides);
  public native void permute(@Cast("sd::LongType*") long[] dimensions, int rank, @ByRef NDArray target, @Cast("const bool") boolean resetStrides);
...
*/
  ...
  public native @StdString @Cast({"char*", "std::string*"}) BytePointer asIndexedString(@Cast("sd::LongType") long _limit/*=-1*/);
  public native @StdString @Cast({"char*", "std::string*"}) BytePointer asIndexedString();
  public native @StdString @Cast({"char*", "std::string*"}) BytePointer asString(@Cast("sd::LongType") long _limit/*=-1*/);
  public native @StdString @Cast({"char*", "std::string*"}) BytePointer asString();
   ...
   */
  public native NDArray dup(byte newOrder/*='a'*/, @Cast("bool") boolean forceOriginalBuffer/*=false*/);
...
// #endif
  ...
  public native @Cast("sd::LongType") long tensorsAlongDimension(@Cast("sd::LongType*") @StdVector LongBuffer dimensions);
  public native @Cast("sd::LongType") long tensorsAlongDimension(@Cast("sd::LongType*") @StdVector long[] dimensions);
  ...
  public native NDArray reshape(char order, @Cast("sd::LongType*") @StdVector LongPointer shape, @Cast("bool") boolean copyToNewBuff/*=true*/);
  public native NDArray reshape(char order, @Cast("sd::LongType*") @StdVector LongPointer shape);
  public native NDArray reshape(char order, @Cast("sd::LongType*") @StdVector LongBuffer shape, @Cast("bool") boolean copyToNewBuff/*=true*/);
  public native NDArray reshape(char order, @Cast("sd::LongType*") @StdVector LongBuffer shape);
  public native NDArray reshape(char order, @Cast("sd::LongType*") @StdVector long[] shape, @Cast("bool") boolean copyToNewBuff/*=true*/);
  public native NDArray reshape(char order, @Cast("sd::LongType*") @StdVector long[] shape);
  ...
  public native NDArray newShapeNoCopy(@Cast("sd::LongType*") @StdVector LongPointer newShape, byte order);
  public native NDArray newShapeNoCopy(@Cast("sd::LongType*") @StdVector LongBuffer newShape, byte order);
  public native NDArray newShapeNoCopy(@Cast("sd::LongType*") @StdVector long[] newShape, byte order);
...
// #endif
  ...
  public native @ByVal ResultSet multipleTensorsAlongDimension(@Cast("sd::LongType*") @StdVector LongBuffer indices,
                                            @Cast("sd::LongType*") @StdVector LongBuffer dimensions);
  public native @ByVal ResultSet multipleTensorsAlongDimension(@Cast("sd::LongType*") @StdVector long[] indices,
                                            @Cast("sd::LongType*") @StdVector long[] dimensions);

  public native @ByVal ResultSet allTensorsAlongDimension(@Cast("sd::LongType*") @StdVector LongPointer dimensions);
  public native @ByVal ResultSet allTensorsAlongDimension(@Cast("sd::LongType*") @StdVector LongBuffer dimensions);
  public native @ByVal ResultSet allTensorsAlongDimension(@Cast("sd::LongType*") @StdVector long[] dimensions);

  public native void printAllTensorsAlongDimension(@Cast("sd::LongType*") @StdVector LongPointer dimensions);
  public native void printAllTensorsAlongDimension(@Cast("sd::LongType*") @StdVector LongBuffer dimensions);
  public native void printAllTensorsAlongDimension(@Cast("sd::LongType*") @StdVector long[] dimensions);
  ...
  public native void printTensorAlongDimension(@Cast("sd::LongType") long index,@Cast("sd::LongType*") @StdVector LongBuffer dimensions);
  public native void printTensorAlongDimension(@Cast("sd::LongType") long index,@Cast("sd::LongType*") @StdVector long[] dimensions);
  ...
  public native void setShapeInfo(@Cast("sd::LongType*") LongBuffer shapeInfo);
  public native void setShapeInfo(@Cast("sd::LongType*") long[] shapeInfo);
  ...
  public native void p(@Cast("const sd::LongType") long i, NDArray value);
   ...
   *  value - scalar value to assign
   */
  public native void p(@Cast("const sd::LongType") long i, @Cast("const sd::LongType") long j, @Cast("const sd::LongType") long k, @Cast("const sd::LongType") long l, NDArray value);
  ...
  public native @Cast("bool") boolean isCommonVector(@Cast("sd::LongType*") @ByRef long[] posOfNonUnityDim);
...
@Namespace("sd") @NoOffset public static class NDArrayList extends Pointer {
  ...
  public native NDArray pick(@Cast("sd::LongType*") @StdVector LongBuffer indices);
  public native NDArray pick(@Cast("sd::LongType*") @StdVector long[] indices);
...
@Namespace("shape") public native @Cast("bool") boolean isViewConst(@Cast("const sd::LongType*") LongBuffer shapeInfo);
@Namespace("shape") public native @Cast("bool") boolean isViewConst(@Cast("const sd::LongType*") long[] shapeInfo);
...
@Namespace("shape") public native @Cast("bool") boolean isEmptyConst(@Cast("const sd::LongType*") LongBuffer shapeInfo);
@Namespace("shape") public native @Cast("bool") boolean isEmptyConst(@Cast("const sd::LongType*") long[] shapeInfo);
...
@Namespace("shape") public native @Cast("sd::LongType*") LongBuffer detachShape(@Cast("sd::LongType*") LongBuffer originalShape);
@Namespace("shape") public native @Cast("sd::LongType*") long[] detachShape(@Cast("sd::LongType*") long[] originalShape);
...
@Namespace("shape") public native @Cast("sd::LongType") long tadLength(@Cast("const sd::LongType*") LongBuffer shapeInfo, @Cast("const sd::LongType*") LongBuffer dimension,
                                                    @Cast("sd::LongType") long dimensionLength);
@Namespace("shape") public native @Cast("sd::LongType") long tadLength(@Cast("const sd::LongType*") long[] shapeInfo, @Cast("const sd::LongType*") long[] dimension,
                                                    @Cast("sd::LongType") long dimensionLength);
...
@Namespace("shape") public native @Cast("bool") boolean isView(@Cast("sd::LongType*") LongBuffer shapeInfo);
@Namespace("shape") public native @Cast("bool") boolean isView(@Cast("sd::LongType*") long[] shapeInfo);
/**
* Returns whether the
* given shape info has an empty flag set.
*/
...
@Namespace("shape") public native @Cast("bool") boolean isEmpty(@Cast("sd::LongType*") LongBuffer shapeInfo);
@Namespace("shape") public native @Cast("bool") boolean isEmpty(@Cast("sd::LongType*") long[] shapeInfo);



@Namespace("shape") public native @Cast("bool") boolean reshapeC(@Cast("const sd::LongType*") LongPointer oldShapeInfo, byte newOrder, @Cast("sd::LongType") long newRank, @Cast("const sd::LongType*") LongPointer newShape,
                                           @Cast("sd::LongType*") LongPointer newShapeInfo);
@Namespace("shape") public native @Cast("bool") boolean reshapeC(@Cast("const sd::LongType*") LongBuffer oldShapeInfo, byte newOrder, @Cast("sd::LongType") long newRank, @Cast("const sd::LongType*") LongBuffer newShape,
                                           @Cast("sd::LongType*") LongBuffer newShapeInfo);
@Namespace("shape") public native @Cast("bool") boolean reshapeC(@Cast("const sd::LongType*") long[] oldShapeInfo, byte newOrder, @Cast("sd::LongType") long newRank, @Cast("const sd::LongType*") long[] newShape,
                                           @Cast("sd::LongType*") long[] newShapeInfo);
/**
...
@Namespace("shape") public native @Cast("sd::LongType*") LongBuffer shapeBuffer(@Cast("sd::LongType") long rank, @Cast("sd::DataType") int dtype, @Cast("sd::LongType*") LongBuffer shape);
@Namespace("shape") public native @Cast("sd::LongType*") long[] shapeBuffer(@Cast("sd::LongType") long rank, @Cast("sd::DataType") int dtype, @Cast("sd::LongType*") long[] shape);
...
@Namespace("shape") public native void updateStrides(@Cast("sd::LongType*") LongPointer shape, byte order, @Cast("bool") boolean resetStridesIfView);
@Namespace("shape") public native void updateStrides(@Cast("sd::LongType*") LongBuffer shape, byte order, @Cast("bool") boolean resetStridesIfView);
@Namespace("shape") public native void updateStrides(@Cast("sd::LongType*") long[] shape, byte order, @Cast("bool") boolean resetStridesIfView);
...
@Namespace("shape") public native void updateStrides(@Cast("const sd::LongType") long rank, @Cast("const sd::LongType*") LongBuffer shapeOnly,
                                                @Cast("sd::LongType*") LongBuffer stridesOnly, byte order);
@Namespace("shape") public native void updateStrides(@Cast("const sd::LongType") long rank, @Cast("const sd::LongType*") long[] shapeOnly,
...
@Namespace("shape") public native void doPermuteShapeInfo(@Cast("sd::LongType*") LongPointer shapeBuffer, @Cast("const sd::LongType*") LongPointer rearrange);
@Namespace("shape") public native void doPermuteShapeInfo(@Cast("sd::LongType*") LongBuffer shapeBuffer, @Cast("const sd::LongType*") LongBuffer rearrange,
                                                     @Cast("sd::LongType") long len/*=-1*/);
@Namespace("shape") public native void doPermuteShapeInfo(@Cast("sd::LongType*") LongBuffer shapeBuffer, @Cast("const sd::LongType*") LongBuffer rearrange);
@Namespace("shape") public native void doPermuteShapeInfo(@Cast("sd::LongType*") long[] shapeBuffer, @Cast("const sd::LongType*") long[] rearrange,
                                                     @Cast("sd::LongType") long len/*=-1*/);
@Namespace("shape") public native void doPermuteShapeInfo(@Cast("sd::LongType*") long[] shapeBuffer, @Cast("const sd::LongType*") long[] rearrange);
...
@Namespace("shape") public native void permute(@ByPtrPtr ShapeInformation info, @Cast("sd::LongType*") LongBuffer rearrange, @Cast("sd::LongType") long rank);
@Namespace("shape") public native void permute(@ByPtrPtr ShapeInformation info, @Cast("sd::LongType*") long[] rearrange, @Cast("sd::LongType") long rank);
...
@Namespace("shape") public native int isVector(@Cast("sd::LongType*") LongBuffer shapeInfo);
@Namespace("shape") public native int isVector(@Cast("sd::LongType*") long[] shapeInfo);
...
@Namespace("shape") public native @Cast("bool") boolean isCommonVector(@Cast("const sd::LongType*") LongBuffer shapeInfo, @Cast("sd::LongType*") @ByRef LongBuffer posOfNonUnityDim);
@Namespace("shape") public native @Cast("bool") boolean isCommonVector(@Cast("const sd::LongType*") long[] shapeInfo, @Cast("sd::LongType*") @ByRef long[] posOfNonUnityDim);

@Namespace("shape") public native @Cast("bool") boolean isRowVector(@Cast("sd::LongType*") LongPointer shapeInfo);
@Namespace("shape") public native @Cast("bool") boolean isRowVector(@Cast("sd::LongType*") LongBuffer shapeInfo);
@Namespace("shape") public native @Cast("bool") boolean isRowVector(@Cast("sd::LongType*") long[] shapeInfo);
...
@Namespace("shape") public native @Cast("sd::LongType") long shapeInfoLength(@Cast("sd::LongType*") LongPointer shape);
@Namespace("shape") public native @Cast("sd::LongType") long shapeInfoLength(@Cast("sd::LongType*") LongBuffer shape);
@Namespace("shape") public native @Cast("sd::LongType") long shapeInfoLength(@Cast("sd::LongType*") long[] shape);
...
@Namespace("shape") public native @Cast("sd::LongType") long rank(@Cast("const sd::LongType*") LongBuffer shapeInfo);
@Namespace("shape") public native @Cast("sd::LongType") long rank(@Cast("const sd::LongType*") long[] shapeInfo);
...
@Namespace("shape") public native @Cast("sd::LongType") long sizeAt(@Cast("const sd::LongType*") LongPointer shapeInfo, @Cast("const sd::LongType") long dim);
@Namespace("shape") public native @Cast("sd::LongType") long sizeAt(@Cast("const sd::LongType*") LongBuffer shapeInfo, @Cast("const sd::LongType") long dim);
@Namespace("shape") public native @Cast("sd::LongType") long sizeAt(@Cast("const sd::LongType*") long[] shapeInfo, @Cast("const sd::LongType") long dim);

@Namespace("shape") public native @Cast("sd::LongType") long strideAt(@Cast("const sd::LongType*") LongPointer shapeInfo, @Cast("const sd::LongType") long dim);
@Namespace("shape") public native @Cast("sd::LongType") long strideAt(@Cast("const sd::LongType*") LongBuffer shapeInfo, @Cast("const sd::LongType") long dim);
@Namespace("shape") public native @Cast("sd::LongType") long strideAt(@Cast("const sd::LongType*") long[] shapeInfo, @Cast("const sd::LongType") long dim);

@Namespace("shape") public native void setShape(@Cast("sd::LongType*") LongPointer shapeInfo, @Cast("sd::LongType*") LongPointer shape);
@Namespace("shape") public native void setShape(@Cast("sd::LongType*") LongBuffer shapeInfo, @Cast("sd::LongType*") LongBuffer shape);
@Namespace("shape") public native void setShape(@Cast("sd::LongType*") long[] shapeInfo, @Cast("sd::LongType*") long[] shape);
...
@Namespace("shape") public native void setStrideConst(@Cast("sd::LongType*") LongBuffer buffer, @Cast("const sd::LongType*") LongBuffer strides);
@Namespace("shape") public native void setStrideConst(@Cast("sd::LongType*") long[] buffer, @Cast("const sd::LongType*") long[] strides);



@Namespace("shape") public native char setOrder(@Cast("sd::LongType*") LongPointer buffer, char c);
@Namespace("shape") public native char setOrder(@Cast("sd::LongType*") LongBuffer buffer, char c);
@Namespace("shape") public native char setOrder(@Cast("sd::LongType*") long[] buffer, char c);




@Namespace("shape") public native void setExtra(@Cast("sd::LongType*") LongPointer buffer, @Cast("sd::LongType") long extra);
@Namespace("shape") public native void setExtra(@Cast("sd::LongType*") LongBuffer buffer, @Cast("sd::LongType") long extra);
@Namespace("shape") public native void setExtra(@Cast("sd::LongType*") long[] buffer, @Cast("sd::LongType") long extra);
/**
...
@Namespace("shape") public native @Cast("sd::LongType*") LongPointer keep(@Cast("sd::LongType*") LongPointer data, @Cast("const sd::LongType*") LongPointer index, int indexLength,
                                                int dataLength);
@Namespace("shape") public native @Cast("sd::LongType*") LongBuffer keep(@Cast("sd::LongType*") LongBuffer data, @Cast("const sd::LongType*") LongBuffer index, int indexLength,
                                                int dataLength);
@Namespace("shape") public native @Cast("sd::LongType*") long[] keep(@Cast("sd::LongType*") long[] data, @Cast("const sd::LongType*") long[] index, int indexLength,
                                                int dataLength);
...
@Namespace("shape") public native void maxIndToMinInd(@Cast("sd::LongType*") LongPointer maxIdxs, @Cast("sd::LongType*") LongPointer minIdxs,
                                                 @Cast("const sd::LongType*") LongPointer maxShapeInfo, @Cast("const sd::LongType*") LongPointer minShapeInfo);
@Namespace("shape") public native void maxIndToMinInd(@Cast("sd::LongType*") LongBuffer maxIdxs, @Cast("sd::LongType*") LongBuffer minIdxs,
                                                 @Cast("const sd::LongType*") LongBuffer maxShapeInfo, @Cast("const sd::LongType*") LongBuffer minShapeInfo,
                                                 @Cast("const sd::LongType*") LongBuffer dimsToExclude/*=nullptr*/,
                                                 @Cast("sd::LongType") long dimsLen/*=-1*/);
@Namespace("shape") public native void maxIndToMinInd(@Cast("sd::LongType*") LongBuffer maxIdxs, @Cast("sd::LongType*") LongBuffer minIdxs,
                                                 @Cast("const sd::LongType*") LongBuffer maxShapeInfo, @Cast("const sd::LongType*") LongBuffer minShapeInfo);
@Namespace("shape") public native void maxIndToMinInd(@Cast("sd::LongType*") long[] maxIdxs, @Cast("sd::LongType*") long[] minIdxs,
                                                 @Cast("const sd::LongType*") long[] maxShapeInfo, @Cast("const sd::LongType*") long[] minShapeInfo,
                                                 @Cast("const sd::LongType*") long[] dimsToExclude/*=nullptr*/,
                                                 @Cast("sd::LongType") long dimsLen/*=-1*/);
@Namespace("shape") public native void maxIndToMinInd(@Cast("sd::LongType*") long[] maxIdxs, @Cast("sd::LongType*") long[] minIdxs,
                                                 @Cast("const sd::LongType*") long[] maxShapeInfo, @Cast("const sd::LongType*") long[] minShapeInfo);
...
@Namespace("shape") public native @Cast("sd::LongType") long tensorsAlongDimension(@Cast("const sd::LongType*") LongBuffer shapeInfo, @Cast("sd::LongType*") LongBuffer dimensions, @Cast("sd::LongType") long dimensionLength);
...
@Namespace("shape") public native @Cast("sd::LongType") long subArrayIndex(@Cast("sd::LongType") long maxIdx, @Cast("const sd::LongType*") long[] maxShapeInfo,
...
@Namespace("shape") public native int outerArrayOffsets(@Cast("sd::LongType*") LongBuffer maxOffsets, @Cast("const sd::LongType") long minIdx,
                                                      @Cast("const sd::LongType*") LongBuffer maxShapeInfo, @Cast("const sd::LongType*") LongBuffer minShapeInfo,
                                                      @Cast("sd::LongType*") LongBuffer memBuff, @Cast("const sd::LongType*") LongBuffer dimsToExclude);
@Namespace("shape") public native int outerArrayOffsets(@Cast("sd::LongType*") long[] maxOffsets, @Cast("const sd::LongType") long minIdx,
                                                      @Cast("const sd::LongType*") long[] maxShapeInfo, @Cast("const sd::LongType*") long[] minShapeInfo,
                                                      @Cast("sd::LongType*") long[] memBuff, @Cast("const sd::LongType*") long[] dimsToExclude);
...
@Namespace("shape") public native int outerArrayOffsets(@Cast("sd::LongType*") LongBuffer maxOffsets, @Cast("const sd::LongType") long minIdx,
                                                   @Cast("const sd::LongType*") LongBuffer maxShapeInfo, @Cast("const sd::LongType*") LongBuffer minShapeInfo,
                                                   @Cast("sd::LongType*") LongBuffer memBuff);
@Namespace("shape") public native int outerArrayOffsets(@Cast("sd::LongType*") long[] maxOffsets, @Cast("const sd::LongType") long minIdx,
                                                   @Cast("const sd::LongType*") long[] maxShapeInfo, @Cast("const sd::LongType*") long[] minShapeInfo,
                                                   @Cast("sd::LongType*") long[] memBuff);
...
@Namespace("shape") public native void calcOffsets(@Cast("const sd::LongType") long rank, @Cast("const sd::LongType*") LongPointer shape, @Cast("const sd::LongType*") LongPointer strides,
                               @Cast("sd::LongType*") LongPointer offsets, byte order/*='c'*/);
@Namespace("shape") public native void calcOffsets(@Cast("const sd::LongType") long rank, @Cast("const sd::LongType*") LongPointer shape, @Cast("const sd::LongType*") LongPointer strides,
                               @Cast("sd::LongType*") LongPointer offsets);
@Namespace("shape") public native void calcOffsets(@Cast("const sd::LongType") long rank, @Cast("const sd::LongType*") LongBuffer shape, @Cast("const sd::LongType*") LongBuffer strides,
                               @Cast("sd::LongType*") LongBuffer offsets, byte order/*='c'*/);
@Namespace("shape") public native void calcOffsets(@Cast("const sd::LongType") long rank, @Cast("const sd::LongType*") LongBuffer shape, @Cast("const sd::LongType*") LongBuffer strides,
                               @Cast("sd::LongType*") LongBuffer offsets);
@Namespace("shape") public native void calcOffsets(@Cast("const sd::LongType") long rank, @Cast("const sd::LongType*") long[] shape, @Cast("const sd::LongType*") long[] strides,
...
@Namespace("shape") public native void checkStridesEwsAndOrder(@Cast("sd::LongType*") LongPointer shapeInfo, byte proposedOrder,
                                                          @Cast("const sd::LongType") long numOfNonUnitDims,
...
@Namespace("shape") public native void calcSubArrsShapeInfoAndOffsets(
    ...
    @Cast("const sd::LongType*") LongPointer dimsToExclude, @Cast("sd::LongType*") LongPointer subArrShapeInfo, @Cast("sd::LongType*") LongPointer subArrOffsets);
@Namespace("shape") public native void calcSubArrsShapeInfoAndOffsets(
    @Cast("const sd::LongType*") LongBuffer wholeShapeInfo, @Cast("const sd::LongType") long numOfSubArrs, @Cast("const sd::LongType") long dimsSize,
    @Cast("const sd::LongType*") LongBuffer dimsToExclude, @Cast("sd::LongType*") LongBuffer subArrShapeInfo, @Cast("sd::LongType*") LongBuffer subArrOffsets,
    @Cast("bool") boolean keepUnitiesInShape/*=false*/);
@Namespace("shape") public native void calcSubArrsShapeInfoAndOffsets(
    @Cast("const sd::LongType*") LongBuffer wholeShapeInfo, @Cast("const sd::LongType") long numOfSubArrs, @Cast("const sd::LongType") long dimsSize,
    @Cast("const sd::LongType*") LongBuffer dimsToExclude, @Cast("sd::LongType*") LongBuffer subArrShapeInfo, @Cast("sd::LongType*") LongBuffer subArrOffsets);
@Namespace("shape") public native void calcSubArrsShapeInfoAndOffsets(
    @Cast("const sd::LongType*") long[] wholeShapeInfo, @Cast("const sd::LongType") long numOfSubArrs, @Cast("const sd::LongType") long dimsSize,
    @Cast("const sd::LongType*") long[] dimsToExclude, @Cast("sd::LongType*") long[] subArrShapeInfo, @Cast("sd::LongType*") long[] subArrOffsets,
    @Cast("bool") boolean keepUnitiesInShape/*=false*/);
@Namespace("shape") public native void calcSubArrsShapeInfoAndOffsets(
    @Cast("const sd::LongType*") long[] wholeShapeInfo, @Cast("const sd::LongType") long numOfSubArrs, @Cast("const sd::LongType") long dimsSize,
    @Cast("const sd::LongType*") long[] dimsToExclude, @Cast("sd::LongType*") long[] subArrShapeInfo, @Cast("sd::LongType*") long[] subArrOffsets);
...
@Namespace("shape") public native int excludeUnitiesFromShapeInfo(@Cast("const sd::LongType*") LongBuffer inShapeInfo,
                                                             @Cast("sd::LongType*") LongBuffer shapeNoUnities,
                                                             @Cast("sd::LongType*") LongBuffer stridesNoUnities);
@Namespace("shape") public native int excludeUnitiesFromShapeInfo(@Cast("const sd::LongType*") long[] inShapeInfo,
                                                             @Cast("sd::LongType*") long[] shapeNoUnities,
                                                             @Cast("sd::LongType*") long[] stridesNoUnities);
...
@Namespace("shape") public native void excludeUnitiesFromShapeInfo(@Cast("const sd::LongType*") LongBuffer inShapeInfo,
                                                              @Cast("const sd::LongType*") LongBuffer dimsToExclude,
                                                              @Cast("const sd::LongType") long dimsSize, @Cast("sd::LongType*") LongBuffer outShapeInfo);
@Namespace("shape") public native void excludeUnitiesFromShapeInfo(@Cast("const sd::LongType*") long[] inShapeInfo,
                                                              @Cast("const sd::LongType*") long[] dimsToExclude,
                                                              @Cast("const sd::LongType") long dimsSize, @Cast("sd::LongType*") long[] outShapeInfo);
...
@Namespace("shape") public native @Cast("sd::LongType*") LongBuffer calcStridesFortran(@Cast("const sd::LongType*") LongBuffer shape, @Cast("sd::LongType") long rank, @Cast("sd::LongType") long startNum);
@Namespace("shape") public native @Cast("sd::LongType*") long[] calcStridesFortran(@Cast("const sd::LongType*") long[] shape, @Cast("sd::LongType") long rank, @Cast("sd::LongType") long startNum);
...
@Namespace("shape") public native @Cast("sd::LongType*") LongBuffer calcStridesFortran(@Cast("const sd::LongType*") LongBuffer shape, int rank, int startNum, @Cast("sd::LongType*") LongBuffer ret);
@Namespace("shape") public native @Cast("sd::LongType*") long[] calcStridesFortran(@Cast("const sd::LongType*") long[] shape, int rank, int startNum, @Cast("sd::LongType*") long[] ret);
...
@Namespace("shape") public native @Cast("char*") String shapeInfoString(@Cast("const sd::LongType*") LongPointer shapeInfo);
@Namespace("shape") public native @Cast("char*") BytePointer shapeInfoString(@Cast("const sd::LongType*") LongBuffer shapeInfo);
@Namespace("shape") public native @Cast("char*") String shapeInfoString(@Cast("const sd::LongType*") long[] shapeInfo);
...
@Namespace("shape") public native @Cast("sd::LongType*") LongBuffer shapeBufferOfNpy(@Cast("sd::LongType") long rank, @Cast("sd::LongType*") LongBuffer shape, @Cast("bool") boolean fortranOrder);
@Namespace("shape") public native @Cast("sd::LongType*") long[] shapeBufferOfNpy(@Cast("sd::LongType") long rank, @Cast("sd::LongType*") long[] shape, @Cast("bool") boolean fortranOrder);
...
@Namespace("shape") public native @Cast("sd::LongType*") LongBuffer calcStrides(@Cast("const sd::LongType*") LongBuffer shape, @Cast("sd::LongType") long rank, @Cast("sd::LongType") long startNum);
@Namespace("shape") public native @Cast("sd::LongType*") long[] calcStrides(@Cast("const sd::LongType*") long[] shape, @Cast("sd::LongType") long rank, @Cast("sd::LongType") long startNum);
...
@Namespace("shape") public native @Cast("char*") String shapeToString(@Cast("const sd::LongType*") LongPointer shapeInfo, @Cast("char*") String message);
@Namespace("shape") public native @Cast("char*") BytePointer shapeToString(@Cast("const sd::LongType*") LongBuffer shapeInfo, @Cast("char*") BytePointer message);
@Namespace("shape") public native @Cast("char*") String shapeToString(@Cast("const sd::LongType*") long[] shapeInfo, @Cast("char*") String message);
@Namespace("shape") public native @Cast("char*") BytePointer shapeToString(@Cast("const sd::LongType*") LongPointer shapeInfo, @Cast("char*") BytePointer message);
@Namespace("shape") public native @Cast("char*") String shapeToString(@Cast("const sd::LongType*") LongBuffer shapeInfo, @Cast("char*") String message);
@Namespace("shape") public native @Cast("char*") BytePointer shapeToString(@Cast("const sd::LongType*") long[] shapeInfo, @Cast("char*") BytePointer message);
...
@Namespace("shape") public native @Cast("sd::LongType*") long[] calcStridesFortran(@Cast("const sd::LongType*") long[] shape, @Cast("sd::LongType") long rank);
...
@Namespace("shape") public native @Cast("sd::LongType*") long[] calcStrides(@Cast("const sd::LongType*") long[] shape, @Cast("sd::LongType") long rank);
...
@Namespace("shape") public native void setStride(@Cast("sd::LongType*") LongBuffer buffer, @Cast("sd::LongType*") LongBuffer strides);
@Namespace("shape") public native void setStride(@Cast("sd::LongType*") long[] buffer, @Cast("sd::LongType*") long[] strides);
...
@Namespace("shape") public native @Cast("sd::LongType") long elementWiseStride(@Cast("const sd::LongType*") LongBuffer buffer);
@Namespace("shape") public native @Cast("sd::LongType") long elementWiseStride(@Cast("const sd::LongType*") long[] buffer);
...
@Namespace("shape") public native int tadOffset(@Cast("sd::LongType*") LongBuffer xInfo, int offset);
@Namespace("shape") public native int tadOffset(@Cast("sd::LongType*") long[] xInfo, int offset);
// #else
// #endif
...
@Namespace("shape") public native void sweepShapeInfoBuffer(@Cast("sd::LongType*") LongBuffer shapeInfoBuffer, @Cast("sd::LongType*") LongBuffer targetBuffer);
@Namespace("shape") public native void sweepShapeInfoBuffer(@Cast("sd::LongType*") long[] shapeInfoBuffer, @Cast("sd::LongType*") long[] targetBuffer);
// #else
// #endif
...
// object
@Namespace("shape") public native void checkDimensions(@Cast("const sd::LongType") long rank, @Cast("sd::LongType*") @StdVector LongPointer dimensions);
@Namespace("shape") public native void checkDimensions(@Cast("const sd::LongType") long rank, @Cast("sd::LongType*") @StdVector LongBuffer dimensions);
@Namespace("shape") public native void checkDimensions(@Cast("const sd::LongType") long rank, @Cast("sd::LongType*") @StdVector long[] dimensions);
...
@Namespace("shape") public native void doPermuteSwap(@Cast("sd::LongType") long length, @Cast("sd::LongType*") long[] shape, @Cast("sd::LongType*") long[] rearrange);
...
@Namespace("shape") public native void fillStrides(@Cast("sd::LongType*") LongBuffer shapeInfo);
@Namespace("shape") public native void fillStrides(@Cast("sd::LongType*") long[] shapeInfo);
...
@Namespace("sd") @NoOffset public static class ShapeList extends Pointer {
  ...
  private native void allocate();
  public ShapeList( @Cast("sd::LongType*") LongBuffer shape/*=nullptr*/) { super((Pointer)null); allocate(shape); }
  private native void allocate( @Cast("sd::LongType*") LongBuffer shape/*=nullptr*/);
  public ShapeList( @Cast("sd::LongType*") long[] shape/*=nullptr*/) { super((Pointer)null); allocate(shape); }
  private native void allocate( @Cast("sd::LongType*") long[] shape/*=nullptr*/);
  ...
  public ShapeList(@Cast("sd::LongType**") @StdVector @ByPtrPtr LongBuffer shapes, @Cast("bool") boolean isWorkspace) { super((Pointer)null); allocate(shapes, isWorkspace); }
  private native void allocate(@Cast("sd::LongType**") @StdVector @ByPtrPtr LongBuffer shapes, @Cast("bool") boolean isWorkspace);
  public ShapeList(@Cast("sd::LongType**") @StdVector @ByPtrPtr long[] shapes, @Cast("bool") boolean isWorkspace) { super((Pointer)null); allocate(shapes, isWorkspace); }
  private native void allocate(@Cast("sd::LongType**") @StdVector @ByPtrPtr long[] shapes, @Cast("bool") boolean isWorkspace);
  ...
  public native void push_back( @Cast("sd::LongType*") LongBuffer shape);
  public native void push_back( @Cast("sd::LongType*") long[] shape);
...
// Parsed from system/CudaLimitType.h
...
@Namespace("sd::ops") @NoOffset public static class OpExecTrace extends Pointer {
  ...
  public native @StdString @Cast({"char*", "std::string*"}) BytePointer opName(); public native OpExecTrace opName(BytePointer setter);
  ...
  public native @ByRef @Cast("std::vector<std::string>*") PointerPointer sArguments(); public native OpExecTrace sArguments(PointerPointer setter);
...
// #endif
  ...
  public native void setInputShapeBuffers(@Cast("const sd::LongType**") @StdVector @ByPtrPtr LongBuffer inputShapeBuffersIn);
  public native void setInputShapeBuffers(@Cast("const sd::LongType**") @StdVector @ByPtrPtr long[] inputShapeBuffersIn);
  ...
  public native void setOutputShapeBuffers(@Cast("const sd::LongType**") @StdVector @ByPtrPtr LongPointer outputShapeBuffersIn);
  public native void setOutputShapeBuffers(@Cast("const sd::LongType**") @StdVector @ByPtrPtr LongBuffer outputShapeBuffersIn);
  public native void setOutputShapeBuffers(@Cast("const sd::LongType**") @StdVector @ByPtrPtr long[] outputShapeBuffersIn);
  public native @StdString @Cast({"char*", "std::string*"}) BytePointer getOpName();
  public native void setOpName(@StdString @Cast({"char*", "std::string*"}) BytePointer opNameIn);
  ...
  public native void setIArgs(@Cast("sd::LongType*") @StdVector LongBuffer iArgsIn);
  public native void setIArgs(@Cast("sd::LongType*") @StdVector long[] iArgsIn);
  ...
  public native @Cast("const std::vector<std::string>*") @ByRef PointerPointer getSArguments();
  public native void setSArguments(@Cast("const std::vector<std::string>*") @ByRef PointerPointer sArgumentsIn);
...
// #endif
  ...
  public native ShapeDescriptor vectorDescriptor(@Cast("const sd::LongType") long length, @Cast("const sd::DataType") int type);

  // create Descriptor with padded buffer.
  public native ShapeDescriptor paddedBufferDescriptor(@Cast("const sd::DataType") int type, byte order,
...
@Namespace("sd") @NoOffset public static class TadDescriptor extends Pointer {
  ...
  public TadDescriptor(@Cast("const sd::LongType*") LongPointer originalShape, @Cast("const sd::LongType*") LongPointer dimensions, @Cast("const sd::LongType") long length,
  ...
  private native void allocate(@Cast("const sd::LongType*") LongPointer originalShape, @Cast("const sd::LongType*") LongPointer dimensions, @Cast("const sd::LongType") long length,
                           @Cast("const bool") boolean keepUnitiesInShape/*=false*/);
  public TadDescriptor(@Cast("const sd::LongType*") LongPointer originalShape, @Cast("const sd::LongType*") LongPointer dimensions, @Cast("const sd::LongType") long length) { super((Pointer)null); allocate(originalShape, dimensions, length); }
  private native void allocate(@Cast("const sd::LongType*") LongPointer originalShape, @Cast("const sd::LongType*") LongPointer dimensions, @Cast("const sd::LongType") long length);
  public TadDescriptor(@Cast("const sd::LongType*") LongBuffer originalShape, @Cast("const sd::LongType*") LongBuffer dimensions, @Cast("const sd::LongType") long length,
                           @Cast("const bool") boolean keepUnitiesInShape/*=false*/) { super((Pointer)null); allocate(originalShape, dimensions, length, keepUnitiesInShape); }
  private native void allocate(@Cast("const sd::LongType*") LongBuffer originalShape, @Cast("const sd::LongType*") LongBuffer dimensions, @Cast("const sd::LongType") long length,
                           @Cast("const bool") boolean keepUnitiesInShape/*=false*/);
  public TadDescriptor(@Cast("const sd::LongType*") LongBuffer originalShape, @Cast("const sd::LongType*") LongBuffer dimensions, @Cast("const sd::LongType") long length) { super((Pointer)null); allocate(originalShape, dimensions, length); }
  private native void allocate(@Cast("const sd::LongType*") LongBuffer originalShape, @Cast("const sd::LongType*") LongBuffer dimensions, @Cast("const sd::LongType") long length);
  public TadDescriptor(@Cast("const sd::LongType*") long[] originalShape, @Cast("const sd::LongType*") long[] dimensions, @Cast("const sd::LongType") long length,
                           @Cast("const bool") boolean keepUnitiesInShape/*=false*/) { super((Pointer)null); allocate(originalShape, dimensions, length, keepUnitiesInShape); }
  private native void allocate(@Cast("const sd::LongType*") long[] originalShape, @Cast("const sd::LongType*") long[] dimensions, @Cast("const sd::LongType") long length,
                           @Cast("const bool") boolean keepUnitiesInShape/*=false*/);
  public TadDescriptor(@Cast("const sd::LongType*") long[] originalShape, @Cast("const sd::LongType*") long[] dimensions, @Cast("const sd::LongType") long length) { super((Pointer)null); allocate(originalShape, dimensions, length); }
  private native void allocate(@Cast("const sd::LongType*") long[] originalShape, @Cast("const sd::LongType*") long[] dimensions, @Cast("const sd::LongType") long length);
...
public native @Cast("char*") String getSupportedTypes();
public native @Cast("const char**") PointerPointer getSupportedTypesArray();
public native int getSupportedTypesCount();
public native @Cast("bool") boolean isTypeSupported(@Cast("char*") String typeName);
public native @Cast("bool") boolean isTypeSupported(@Cast("char*") BytePointer typeName);

// Type metadata functions
public native @Cast("bool") boolean hasSelectiveTypes();
public native @Cast("char*") String getTypeSelectionMode();
public native @Cast("char*") String getBinaryTypeInfo();

public native @Cast("char*") String getMissingTypeError(@Cast("char*") String missingType, @Cast("char*") String context);
public native @Cast("char*") BytePointer getMissingTypeError(@Cast("char*") BytePointer missingType, @Cast("char*") BytePointer context);
public native @Cast("char*") String getDetailedTypeConfig();
...
public native @StdString BytePointer generateTypeMismatchError(@StdString BytePointer operation,
                                      @Cast("const std::vector<std::string>*") @ByRef PointerPointer requiredTypes,
