...
public native void setShapeBuffer(@Cast("sd::LongType*") LongPointer inputShapeData,@Cast("sd::DataType") int dt,@Cast("sd::LongType*") LongPointer bufferToSet,char order/*='c'*/,int elementWiseStride/*=1*/);
...
public native void setShapeBuffer(@Cast("sd::LongType*") LongBuffer inputShapeData,@Cast("sd::DataType") int dt,@Cast("sd::LongType*") LongBuffer bufferToSet,char order/*='c'*/,int elementWiseStride/*=1*/);
...
public native void setShapeBuffer(@Cast("sd::LongType*") long[] inputShapeData,@Cast("sd::DataType") int dt,@Cast("sd::LongType*") long[] bufferToSet,char order/*='c'*/,int elementWiseStride/*=1*/);
