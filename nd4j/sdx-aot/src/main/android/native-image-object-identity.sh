...
SDX_NATIVE_IMAGE_OBJECT_STAGE_FORMAT=6
SDX_NATIVE_IMAGE_OBJECT_CACHE_SCHEMA=target-scoped-managed-content-v4
SDX_NATIVE_IMAGE_OBJECT_CONTRACT=strict-android-arm64-managed-object-v4
SDX_NATIVE_IMAGE_OBJECT_CACHE_TARGET=android-sdx-aot-object-v4
...
sdx_native_image_object_identity_lines() {
  printf '%s\n'     "format=$SDX_NATIVE_IMAGE_OBJECT_STAGE_FORMAT"     "cache_schema=$SDX_NATIVE_IMAGE_OBJECT_CACHE_SCHEMA"     "stage=android-aot-native-image-object"     "target=android-arm64-bionic"     "module=nd4j/sdx-aot"     "image_name=libsdx_llm.o"     "native_profile=cpu-managed-openblas"     "object_contract=$SDX_NATIVE_IMAGE_OBJECT_CONTRACT"     "source_manifest_sha256=$SOURCE_MANIFEST_SHA256"     "runtime_analysis_manifest_sha256=$RUNTIME_ANALYSIS_MANIFEST_SHA256"     "maven_dependency_arguments_sha256=$MAVEN_DEPENDENCY_ARGUMENTS_SHA256"     "javacpp_reachability_generator_sha256=$JAVACPP_REACHABILITY_GENERATOR_SHA256"     "javacpp_reachability_config_sha256=$JAVACPP_REACHABILITY_CONFIG_SHA256"     "javacpp_jni_config_sha256=$JAVACPP_JNI_CONFIG_SHA256"     "javacpp_initialization_config_sha256=$JAVACPP_INITIALIZATION_CONFIG_SHA256"     "javacpp_reachability_manifest_sha256=$JAVACPP_REACHABILITY_MANIFEST_SHA256"     "native_image_build_mode=$NATIVE_IMAGE_BUILD_MODE"     "native_image_optimization=$NATIVE_IMAGE_OPTIMIZATION"     "native_image_optimization_config_sha256=$NATIVE_IMAGE_OPTIMIZATION_CONFIG_SHA256"     "native_image_object_identity_helper_sha256=$NATIVE_IMAGE_OBJECT_IDENTITY_HELPER_SHA256"     "object_builder_sha256=$OBJECT_BUILDER_SHA256"     "libjvm_sha256=$LIBJVM_SHA256"     "liblibchelper_sha256=$LIBLIBCHELPER_SHA256"     "maven_sha256=$MAVEN_SHA256"     "maven_version_sha256=$MAVEN_VERSION_SHA256"     "java_version_sha256=$JAVA_VERSION_SHA256"     "javacpp_jar_sha256=$JAVACPP_JAR_SHA256"     "ndk_revision_sha256=$NDK_REVISION_SHA256"     "graalvm_version_sha256=$GRAALVM_VERSION_SHA256"     "android_api=$ANDROID_API"     "android_abi=arm64-v8a"
}
