...
/**
 * PreImportHook for ONNX GatedDeltaRule / GatedDeltaNet operations.
 *
 * Handles custom ONNX domain ops (e.g., com.nvidia::GatedDeltaNet) and maps
 * them to our fused gated_delta_rule op.
 *
 * Inputs from ONNX:
 *   0: Q [B, L, H, D_k]
 *   1: K [B, L, H, D_k]
 ...
 * Adam Gibson
 */
@PreHookRule(nodeNames = [], opNames = ["GatedDeltaRule", "GatedDeltaNet"], frameworkName = "onnx")
