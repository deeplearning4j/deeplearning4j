...
静态的底层函数是得到分析的输入图像，而动态的另一个函数被称为过滤器，因为该函数会获取图像的信号。两个函数通过乘法产生联系。若想以矩阵而非钟形曲线的方式对卷积进行想象，请见标题“卷积演示”下[Andrej Karpathy的极佳动画演示](https://cs231n.github.io/convolutional-networks/)。
...
*感谢[Andrej Karpathy](https://cs231n.github.io/)提供这一极佳的动画演示。*
...
* 欲一睹DL4J卷积网络的运行实况，请根据[快速入门指南](http://deeplearning4j.org/quickstart.html)的指示运行我们的[示例](https://github.com/deeplearning4j/dl4j-0.0.3.3-examples/tree/master/src/main/java/org/deeplearning4j/convolution)。
