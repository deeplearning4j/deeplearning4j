...
public class JblasComplex {
    ...
    public static ComplexDouble getComplexDouble(IComplexDouble iComplexDouble) {
        if(iComplexDouble instanceof org.nd4j.linalg.jblas.complex.ComplexDouble) {
            return (org.nd4j.linalg.jblas.complex.ComplexDouble) iComplexDouble;
        }
        else
    ...
    public static ComplexFloat getComplexFloat(IComplexFloat iComplexDouble) {
        if(iComplexDouble instanceof org.nd4j.linalg.jblas.complex.ComplexDouble) {
            return (org.nd4j.linalg.jblas.complex.ComplexFloat) iComplexDouble;
        }
        else
