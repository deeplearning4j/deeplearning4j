package org.nd4j.bytebuddy.arrays.create.relative;
 ...
 * @author Adam Gibson
 */
public class RelativeIntArrayCreation implements Implementation {
    ...
    public ByteCodeAppender appender(Target implementationTarget) {
        return new RelativeCreateArrayByteCodeAppender(length);
    }
