 ...
 * @author Adam Gibson
 */
public class IntegerArithmeticByteCodeAppender implements ByteCodeAppender {
     ...
     */
    public IntegerArithmeticByteCodeAppender(int val1, int val2, ByteBuddyIntArithmetic.Operation op) {
        this.val1 = val1;
        this.val2 = val2;
        this.op = ByteBuddyIntArithmetic.opFor(op);
    }
